...
constructor(
    ...
    private val retrieveHandler: Handler<RemoteUser> =
        jsonHandler<RemoteUser>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

    /** Returns a `RemoteUser` object with the given `id`. */
    override fun retrieve(params: UserRetrieveParams, requestOptions: RequestOptions): RemoteUser {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.GET)
                .addPathSegments("ats", "v1", "users", params.getPathParam(0))
