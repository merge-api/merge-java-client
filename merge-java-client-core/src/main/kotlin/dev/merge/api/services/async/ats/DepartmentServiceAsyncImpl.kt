...
class DepartmentServiceAsyncImpl
constructor(
    private val clientOptions: ClientOptions,
) : DepartmentServiceAsync {
    ...
    private val listHandler: Handler<DepartmentListPageAsync.Response> =
        jsonHandler<DepartmentListPageAsync.Response>(clientOptions.jsonMapper)
    ...
    override fun list(
        ...
        return clientOptions.httpClient.executeAsync(request, requestOptions).thenApply { response
            ...
            response
                ...
                .let { DepartmentListPageAsync.of(this, params, it) }
        }
    }
}
