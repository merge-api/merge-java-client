...
constructor(
    ...
    private val listHandler: Handler<EmploymentListPage.Response> =
        jsonHandler<EmploymentListPage.Response>(clientOptions.jsonMapper)
    ...
    override fun list(
        ...
        return clientOptions.httpClient.execute(request, requestOptions).let { response ->
            response
                ...
                .let { EmploymentListPage.of(this, params, it) }
        }
    }
}
