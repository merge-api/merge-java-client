...
constructor(
    ...
    override fun retrieve(params: OfferRetrieveParams, requestOptions: RequestOptions): Offer {
        val request =
            HttpRequest.builder()
    ...
    private val listHandler: Handler<OfferListPage.Response> =
        jsonHandler<OfferListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

    /** Returns a list of `Offer` objects. */
    override fun list(params: OfferListParams, requestOptions: RequestOptions): OfferListPage {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.GET)
        ...
        return clientOptions.httpClient.execute(request, requestOptions).let { response ->
            response
                ...
                .let { OfferListPage.of(this, params, it) }
        }
    }
}
