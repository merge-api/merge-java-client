...
constructor(
    ...
    private val listHandler: Handler<CompanyListPage.Response> =
        jsonHandler<CompanyListPage.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)

    /** Returns a list of `Company` objects. */
    override fun list(params: CompanyListParams, requestOptions: RequestOptions): CompanyListPage {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.GET)
        ...
        return clientOptions.httpClient.execute(request, requestOptions).let { response ->
            response
                ...
                .let { CompanyListPage.of(this, params, it) }
        }
    }
}
