...
import dev.merge.api.services.async.marketing.templates.MetaServiceAsyncImpl
...
constructor(
    ...
    private val listHandler: Handler<TemplateListPageAsync.Response> =
        jsonHandler<TemplateListPageAsync.Response>(clientOptions.jsonMapper)
    ...
    override fun list(
        ...
        return clientOptions.httpClient.executeAsync(request, requestOptions).thenApply { response
            ...
            response
                ...
                .let { TemplateListPageAsync.of(this, params, it) }
        }
    }
}
