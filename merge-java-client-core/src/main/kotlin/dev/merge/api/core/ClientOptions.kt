package dev.merge.api.core

import com.fasterxml.jackson.databind.json.JsonMapper
import com.google.common.collect.ArrayListMultimap
import com.google.common.collect.ListMultimap
import dev.merge.api.core.http.HttpClient
import dev.merge.api.core.http.RetryingHttpClient
...
private constructor(
    ...
    @get:JvmName("accountToken") val accountToken: String?,
) {

    companion object {

        const val PRODUCTION_URL = "https://api.merge.dev/api"
    ...
    class Builder {
        ...
        fun fromEnv() = apply { System.getenv("MERGE_API_KEY")?.let { apiKey(it) } }
        ...
        fun build(): ClientOptions {
            ...
            if (accountToken != null) {
                headers.put("X-Account-Token", accountToken)
            }
