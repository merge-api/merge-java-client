...
constructor(
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
        ...
        this.emailAddress?.let { params.put("email_address", listOf(it.toString())) }
    ...
    class Builder {
        ...
        internal fun from(userListParams: UserListParams) = apply {
            ...
            this.emailAddress = userListParams.emailAddress
            this.expand = userListParams.expand
