...
class TrackingCategoryListParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TrackingCategoryListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(trackingCategoryListParams: TrackingCategoryListParams) = apply {
            this.companyId = trackingCategoryListParams.companyId
            this.createdAfter = trackingCategoryListParams.createdAfter
            this.createdBefore = trackingCategoryListParams.createdBefore
            this.cursor = trackingCategoryListParams.cursor
            this.expand = trackingCategoryListParams.expand
            this.includeDeletedData = trackingCategoryListParams.includeDeletedData
            this.includeRemoteData = trackingCategoryListParams.includeRemoteData
            this.modifiedAfter = trackingCategoryListParams.modifiedAfter
            this.modifiedBefore = trackingCategoryListParams.modifiedBefore
            this.pageSize = trackingCategoryListParams.pageSize
            this.remoteFields = trackingCategoryListParams.remoteFields
            this.remoteId = trackingCategoryListParams.remoteId
            this.showEnumOrigins = trackingCategoryListParams.showEnumOrigins
            additionalQueryParams(trackingCategoryListParams.additionalQueryParams)
            additionalHeaders(trackingCategoryListParams.additionalHeaders)
        }
        ...
        fun build(): TrackingCategoryListParams =
            TrackingCategoryListParams(
                companyId,
                createdAfter,
                createdBefore,
                cursor,
