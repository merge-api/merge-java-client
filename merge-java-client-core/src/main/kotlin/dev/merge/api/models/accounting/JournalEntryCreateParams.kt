...
class JournalEntryCreateParams
constructor(
    private val model: JournalEntryRequest,
    ...
    fun model(): JournalEntryRequest = model
    ...
    @JvmSynthetic
    internal fun getBody(): JournalEntryCreateBody {
        return JournalEntryCreateBody(model, additionalBodyProperties)
    }
    ...
    @JsonDeserialize(builder = JournalEntryCreateBody.Builder::class)
    @NoAutoDetect
    class JournalEntryCreateBody
    internal constructor(
         ...
         */
        @JsonProperty("model") fun model(): JournalEntryRequest? = model
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is JournalEntryCreateBody &&
        ...
        override fun toString() =
            "JournalEntryCreateBody{model=$model, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var model: JournalEntryRequest? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(journalEntryCreateBody: JournalEntryCreateBody) = apply {
                this.model = journalEntryCreateBody.model
                additionalProperties(journalEntryCreateBody.additionalProperties)
            }
             ...
             * ### Description
             *
             * The `JournalEntry` object is used to get a record of all manually created entries
             * made in a company’s general ledger. The journal line items for each journal entry
             * should sum to zero.
             *
             * ### Usage Example
             *
             ...
             */
            @JsonProperty("model")
            fun model(model: JournalEntryRequest) = apply { this.model = model }
            ...
            fun build(): JournalEntryCreateBody =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JournalEntryCreateParams &&
            this.model == other.model &&
    ...
    override fun toString() =
        "JournalEntryCreateParams{model=$model, isDebugMode=$isDebugMode, runAsync=$runAsync, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(journalEntryCreateParams: JournalEntryCreateParams) = apply {
            this.model = journalEntryCreateParams.model
            this.isDebugMode = journalEntryCreateParams.isDebugMode
            this.runAsync = journalEntryCreateParams.runAsync
            additionalQueryParams(journalEntryCreateParams.additionalQueryParams)
            additionalHeaders(journalEntryCreateParams.additionalHeaders)
            additionalBodyProperties(journalEntryCreateParams.additionalBodyProperties)
        }
        ...
        fun build(): JournalEntryCreateParams =
    ...
    private constructor(
        private val transactionDate: OffsetDateTime?,
        private val payments: List<String>?,
        private val memo: String?,
        private val currency: CurrencyEnum?,
        private val exchangeRate: String?,
        private val company: String?,
        private val lines: List<JournalLineRequest>?,
        private val postingStatus: PostingStatusEnum?,
        ...
        @JsonProperty("transaction_date") fun transactionDate(): OffsetDateTime? = transactionDate
        ...
        @JsonProperty("lines") fun lines(): List<JournalLineRequest>? = lines

        /**
         * - `UNPOSTED` - UNPOSTED
         * - `POSTED` - POSTED
         */
        @JsonProperty("posting_status") fun postingStatus(): PostingStatusEnum? = postingStatus
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is JournalEntryRequest &&
        ...
        override fun toString() =
            "JournalEntryRequest{transactionDate=$transactionDate, payments=$payments, memo=$memo, currency=$currency, exchangeRate=$exchangeRate, company=$company, lines=$lines, postingStatus=$postingStatus, integrationParams=$integrationParams, linkedAccountParams=$linkedAccountParams, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var transactionDate: OffsetDateTime? = null
            ...
            private var lines: List<JournalLineRequest>? = null
            private var postingStatus: PostingStatusEnum? = null
            private var integrationParams: JsonValue? = null
            private var linkedAccountParams: JsonValue? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(journalEntryRequest: JournalEntryRequest) = apply {
                this.transactionDate = journalEntryRequest.transactionDate
                this.payments = journalEntryRequest.payments
                this.memo = journalEntryRequest.memo
                this.currency = journalEntryRequest.currency
                this.exchangeRate = journalEntryRequest.exchangeRate
                this.company = journalEntryRequest.company
                this.lines = journalEntryRequest.lines
                this.postingStatus = journalEntryRequest.postingStatus
                this.integrationParams = journalEntryRequest.integrationParams
                this.linkedAccountParams = journalEntryRequest.linkedAccountParams
                additionalProperties(journalEntryRequest.additionalProperties)
            }
            ...
            @JsonProperty("lines")
            fun lines(lines: List<JournalLineRequest>) = apply { this.lines = lines }
            ...
            fun postingStatus(postingStatus: PostingStatusEnum) = apply {
        ...
        private constructor(
            ...
            @JsonProperty("net_amount") fun netAmount(): Double? = netAmount
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is JournalLineRequest &&
            ...
            override fun toString() =
                "JournalLineRequest{remoteId=$remoteId, account=$account, netAmount=$netAmount, trackingCategory=$trackingCategory, trackingCategories=$trackingCategories, contact=$contact, description=$description, exchangeRate=$exchangeRate, integrationParams=$integrationParams, linkedAccountParams=$linkedAccountParams, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                private var netAmount: Double? = null
                ...
                @JvmSynthetic
                internal fun from(journalLineRequest: JournalLineRequest) = apply {
                    this.remoteId = journalLineRequest.remoteId
                    this.account = journalLineRequest.account
                    this.netAmount = journalLineRequest.netAmount
                    this.trackingCategory = journalLineRequest.trackingCategory
                    this.trackingCategories = journalLineRequest.trackingCategories
                    this.contact = journalLineRequest.contact
                    this.description = journalLineRequest.description
                    this.exchangeRate = journalLineRequest.exchangeRate
                    this.integrationParams = journalLineRequest.integrationParams
                    this.linkedAccountParams = journalLineRequest.linkedAccountParams
                    additionalProperties(journalLineRequest.additionalProperties)
                }
                ...
                fun netAmount(netAmount: Double) = apply { this.netAmount = netAmount }
