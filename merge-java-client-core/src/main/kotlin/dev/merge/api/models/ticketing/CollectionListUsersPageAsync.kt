...
class CollectionListUsersPageAsync
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionListUsersPageAsync &&
    ...
    override fun toString() =
        "CollectionListUsersPageAsync{collectionsService=$collectionsService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<CollectionListUsersPageAsync>> {
        return getNextPageParams()
            .map { collectionsService.listUsers(it).thenApply { Optional.of(it) } }
    ...
    constructor(
        ...
        override fun toString() =
            "CollectionListUsersPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: CollectionListUsersPageAsync,
    ) {

        fun forEach(action: Predicate<User>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<CollectionListUsersPageAsync>>.forEach(
                action: (User) -> Boolean,
                executor: Executor
