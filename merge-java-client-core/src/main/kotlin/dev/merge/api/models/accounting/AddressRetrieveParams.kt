...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddressRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "AddressRetrieveParams{id=$id, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(addressRetrieveParams: AddressRetrieveParams) = apply {
            this.id = addressRetrieveParams.id
            this.includeRemoteData = addressRetrieveParams.includeRemoteData
            this.remoteFields = addressRetrieveParams.remoteFields
            this.showEnumOrigins = addressRetrieveParams.showEnumOrigins
            additionalQueryParams(addressRetrieveParams.additionalQueryParams)
            additionalHeaders(addressRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): AddressRetrieveParams =
