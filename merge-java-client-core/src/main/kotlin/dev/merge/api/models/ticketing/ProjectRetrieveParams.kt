...
constructor(
    ...
    override fun toString() =
        "ProjectRetrieveParams{id=$id, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(projectRetrieveParams: ProjectRetrieveParams) = apply {
            this.id = projectRetrieveParams.id
            this.includeRemoteData = projectRetrieveParams.includeRemoteData
            additionalQueryParams(projectRetrieveParams.additionalQueryParams)
            additionalHeaders(projectRetrieveParams.additionalHeaders)
        }
