...
constructor(
    ...
    override fun toString() =
        "TransactionRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(transactionRetrieveParams: TransactionRetrieveParams) = apply {
            ...
            this.expand = transactionRetrieveParams.expand
            this.includeRemoteData = transactionRetrieveParams.includeRemoteData
