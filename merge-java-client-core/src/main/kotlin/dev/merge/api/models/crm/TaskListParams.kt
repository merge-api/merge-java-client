...
constructor(
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(taskListParams: TaskListParams) = apply {
            this.createdAfter = taskListParams.createdAfter
            this.createdBefore = taskListParams.createdBefore
            this.cursor = taskListParams.cursor
            this.expand = taskListParams.expand
            this.includeDeletedData = taskListParams.includeDeletedData
            this.includeRemoteData = taskListParams.includeRemoteData
            this.includeRemoteFields = taskListParams.includeRemoteFields
            this.modifiedAfter = taskListParams.modifiedAfter
            this.modifiedBefore = taskListParams.modifiedBefore
            this.pageSize = taskListParams.pageSize
            this.remoteId = taskListParams.remoteId
            additionalQueryParams(taskListParams.additionalQueryParams)
            additionalHeaders(taskListParams.additionalHeaders)
        }
