...
@JsonDeserialize(builder = ActivityCreateResponse.Builder::class)
@NoAutoDetect
class ActivityCreateResponse
private constructor(
    private val model: JsonField<Activity>,
     ...
     */
    fun model(): Activity = model.getRequired("model")
    ...
    fun validate(): ActivityCreateResponse = apply {
        if (!validated) {
            model().validate()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActivityCreateResponse &&
    ...
    override fun toString() =
        "ActivityCreateResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Activity> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(activityCreateResponse: ActivityCreateResponse) = apply {
            this.model = activityCreateResponse.model
            this.warnings = activityCreateResponse.warnings
            this.errors = activityCreateResponse.errors
            this.logs = activityCreateResponse.logs
            additionalProperties(activityCreateResponse.additionalProperties)
        }
         ...
         * Fetch from the `LIST Activities` endpoint and filter by `ID` to show all activities.
         */
        fun model(model: Activity) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Activity>) = apply { this.model = model }
        ...
        fun build(): ActivityCreateResponse =
