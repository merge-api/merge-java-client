...
class MessageListRecipientsPageAsync
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageListRecipientsPageAsync &&
    ...
    override fun toString() =
        "MessageListRecipientsPageAsync{messagesService=$messagesService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<MessageListRecipientsPageAsync>> {
        return getNextPageParams()
            .map { messagesService.listRecipients(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        fun of(
            ...
            MessageListRecipientsPageAsync(
                messagesService,
                params,
                response,
            )
    ...
    constructor(
        ...
        override fun toString() =
            "MessageListRecipientsPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: MessageListRecipientsPageAsync,
    ) {

        fun forEach(action: Predicate<Contact>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<MessageListRecipientsPageAsync>>.forEach(
