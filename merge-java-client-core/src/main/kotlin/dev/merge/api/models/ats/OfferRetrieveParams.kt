...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OfferRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "OfferRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(offerRetrieveParams: OfferRetrieveParams) = apply {
            this.id = offerRetrieveParams.id
            this.expand = offerRetrieveParams.expand
            this.includeRemoteData = offerRetrieveParams.includeRemoteData
            this.remoteFields = offerRetrieveParams.remoteFields
            this.showEnumOrigins = offerRetrieveParams.showEnumOrigins
            additionalQueryParams(offerRetrieveParams.additionalQueryParams)
            additionalHeaders(offerRetrieveParams.additionalHeaders)
        }
