...
@JsonDeserialize(builder = PurchaseOrderResponse.Builder::class)
@NoAutoDetect
class PurchaseOrderResponse
private constructor(
    private val model: JsonField<PurchaseOrder>,
     ...
     */
    fun model(): PurchaseOrder = model.getRequired("model")
    ...
    fun validate(): PurchaseOrderResponse = apply {
        if (!validated) {
            model().validate()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PurchaseOrderResponse &&
    ...
    override fun toString() =
        "PurchaseOrderResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<PurchaseOrder> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(purchaseOrderResponse: PurchaseOrderResponse) = apply {
            this.model = purchaseOrderResponse.model
            this.warnings = purchaseOrderResponse.warnings
            this.errors = purchaseOrderResponse.errors
            this.logs = purchaseOrderResponse.logs
            additionalProperties(purchaseOrderResponse.additionalProperties)
        }
         ...
         * Fetch from the `LIST PurchaseOrders` endpoint and view a company's purchase orders.
         */
        fun model(model: PurchaseOrder) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<PurchaseOrder>) = apply { this.model = model }
        ...
        fun build(): PurchaseOrderResponse =
