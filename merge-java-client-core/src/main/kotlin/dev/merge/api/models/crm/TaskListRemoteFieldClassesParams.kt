...
class TaskListRemoteFieldClassesParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TaskListRemoteFieldClassesParams &&
    ...
    override fun toString() =
        "TaskListRemoteFieldClassesParams{cursor=$cursor, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(taskListRemoteFieldClassesParams: TaskListRemoteFieldClassesParams) =
            apply {
                this.cursor = taskListRemoteFieldClassesParams.cursor
                this.includeDeletedData = taskListRemoteFieldClassesParams.includeDeletedData
                this.includeRemoteData = taskListRemoteFieldClassesParams.includeRemoteData
                this.includeRemoteFields = taskListRemoteFieldClassesParams.includeRemoteFields
                this.pageSize = taskListRemoteFieldClassesParams.pageSize
                additionalQueryParams(taskListRemoteFieldClassesParams.additionalQueryParams)
                additionalHeaders(taskListRemoteFieldClassesParams.additionalHeaders)
            }
        ...
        fun build(): TaskListRemoteFieldClassesParams =
            TaskListRemoteFieldClassesParams(
                cursor,
                includeDeletedData,
                includeRemoteData,
                includeRemoteFields,
