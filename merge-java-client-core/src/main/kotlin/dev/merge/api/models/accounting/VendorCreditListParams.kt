...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VendorCreditListParams &&
    ...
    override fun toString() =
        "VendorCreditListParams{companyId=$companyId, createdAfter=$createdAfter, createdBefore=$createdBefore, cursor=$cursor, expand=$expand, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, modifiedAfter=$modifiedAfter, modifiedBefore=$modifiedBefore, pageSize=$pageSize, remoteId=$remoteId, transactionDateAfter=$transactionDateAfter, transactionDateBefore=$transactionDateBefore, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(vendorCreditListParams: VendorCreditListParams) = apply {
            this.companyId = vendorCreditListParams.companyId
            this.createdAfter = vendorCreditListParams.createdAfter
            this.createdBefore = vendorCreditListParams.createdBefore
            this.cursor = vendorCreditListParams.cursor
            this.expand = vendorCreditListParams.expand
            this.includeDeletedData = vendorCreditListParams.includeDeletedData
            this.includeRemoteData = vendorCreditListParams.includeRemoteData
            this.modifiedAfter = vendorCreditListParams.modifiedAfter
            this.modifiedBefore = vendorCreditListParams.modifiedBefore
            this.pageSize = vendorCreditListParams.pageSize
            this.remoteId = vendorCreditListParams.remoteId
            this.transactionDateAfter = vendorCreditListParams.transactionDateAfter
            this.transactionDateBefore = vendorCreditListParams.transactionDateBefore
            additionalQueryParams(vendorCreditListParams.additionalQueryParams)
            additionalHeaders(vendorCreditListParams.additionalHeaders)
        }
        ...
        fun build(): VendorCreditListParams =
