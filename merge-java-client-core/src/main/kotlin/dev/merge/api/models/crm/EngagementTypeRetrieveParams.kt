...
class EngagementTypeRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EngagementTypeRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "EngagementTypeRetrieveParams{id=$id, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(engagementTypeRetrieveParams: EngagementTypeRetrieveParams) = apply {
            this.id = engagementTypeRetrieveParams.id
            this.includeRemoteData = engagementTypeRetrieveParams.includeRemoteData
            this.includeRemoteFields = engagementTypeRetrieveParams.includeRemoteFields
            additionalQueryParams(engagementTypeRetrieveParams.additionalQueryParams)
            additionalHeaders(engagementTypeRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): EngagementTypeRetrieveParams =
            EngagementTypeRetrieveParams(
