...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpenseRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "ExpenseRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(expenseRetrieveParams: ExpenseRetrieveParams) = apply {
            this.id = expenseRetrieveParams.id
            this.expand = expenseRetrieveParams.expand
            this.includeRemoteData = expenseRetrieveParams.includeRemoteData
            additionalQueryParams(expenseRetrieveParams.additionalQueryParams)
            additionalHeaders(expenseRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): ExpenseRetrieveParams =
