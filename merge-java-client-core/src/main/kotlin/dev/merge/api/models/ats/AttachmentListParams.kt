...
constructor(
    ...
    class Builder {
        ...
        internal fun from(attachmentListParams: AttachmentListParams) = apply {
            this.candidateId = attachmentListParams.candidateId
            this.createdAfter = attachmentListParams.createdAfter
            this.createdBefore = attachmentListParams.createdBefore
            this.cursor = attachmentListParams.cursor
            this.expand = attachmentListParams.expand
            this.includeDeletedData = attachmentListParams.includeDeletedData
            this.includeRemoteData = attachmentListParams.includeRemoteData
            this.modifiedAfter = attachmentListParams.modifiedAfter
            this.modifiedBefore = attachmentListParams.modifiedBefore
            this.pageSize = attachmentListParams.pageSize
            this.remoteFields = attachmentListParams.remoteFields
            this.remoteId = attachmentListParams.remoteId
            this.showEnumOrigins = attachmentListParams.showEnumOrigins
            additionalQueryParams(attachmentListParams.additionalQueryParams)
            additionalHeaders(attachmentListParams.additionalHeaders)
        }
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val ATTACHMENT_TYPE = RemoteFields(JsonField.of("attachment_type"))
        ...
        fun known(): Known =
            when (this) {
                ATTACHMENT_TYPE -> Known.ATTACHMENT_TYPE
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val ATTACHMENT_TYPE = ShowEnumOrigins(JsonField.of("attachment_type"))
