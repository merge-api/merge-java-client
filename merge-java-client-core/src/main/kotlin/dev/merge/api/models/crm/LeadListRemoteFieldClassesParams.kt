...
class LeadListRemoteFieldClassesParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LeadListRemoteFieldClassesParams &&
    ...
    override fun toString() =
        "LeadListRemoteFieldClassesParams{cursor=$cursor, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(leadListRemoteFieldClassesParams: LeadListRemoteFieldClassesParams) =
            apply {
                this.cursor = leadListRemoteFieldClassesParams.cursor
                this.includeDeletedData = leadListRemoteFieldClassesParams.includeDeletedData
                this.includeRemoteData = leadListRemoteFieldClassesParams.includeRemoteData
                this.includeRemoteFields = leadListRemoteFieldClassesParams.includeRemoteFields
                this.pageSize = leadListRemoteFieldClassesParams.pageSize
                additionalQueryParams(leadListRemoteFieldClassesParams.additionalQueryParams)
                additionalHeaders(leadListRemoteFieldClassesParams.additionalHeaders)
            }
        ...
        fun build(): LeadListRemoteFieldClassesParams =
            LeadListRemoteFieldClassesParams(
                cursor,
                includeDeletedData,
                includeRemoteData,
                includeRemoteFields,
