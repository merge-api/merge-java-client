...
class ContactListRemoteFieldClassesParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContactListRemoteFieldClassesParams &&
    ...
    override fun toString() =
        "ContactListRemoteFieldClassesParams{cursor=$cursor, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(
            contactListRemoteFieldClassesParams: ContactListRemoteFieldClassesParams
        ) = apply {
            this.cursor = contactListRemoteFieldClassesParams.cursor
            this.includeDeletedData = contactListRemoteFieldClassesParams.includeDeletedData
            this.includeRemoteData = contactListRemoteFieldClassesParams.includeRemoteData
            this.includeRemoteFields = contactListRemoteFieldClassesParams.includeRemoteFields
            this.pageSize = contactListRemoteFieldClassesParams.pageSize
            additionalQueryParams(contactListRemoteFieldClassesParams.additionalQueryParams)
            additionalHeaders(contactListRemoteFieldClassesParams.additionalHeaders)
        }
        ...
        fun build(): ContactListRemoteFieldClassesParams =
            ContactListRemoteFieldClassesParams(
                cursor,
                includeDeletedData,
                includeRemoteData,
                includeRemoteFields,
