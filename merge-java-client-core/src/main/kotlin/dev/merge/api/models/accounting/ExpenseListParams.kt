...
constructor(
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(expenseListParams: ExpenseListParams) = apply {
            this.companyId = expenseListParams.companyId
            this.createdAfter = expenseListParams.createdAfter
            this.createdBefore = expenseListParams.createdBefore
            this.cursor = expenseListParams.cursor
            this.expand = expenseListParams.expand
            this.includeDeletedData = expenseListParams.includeDeletedData
            this.includeRemoteData = expenseListParams.includeRemoteData
            this.modifiedAfter = expenseListParams.modifiedAfter
            this.modifiedBefore = expenseListParams.modifiedBefore
            this.pageSize = expenseListParams.pageSize
            this.remoteId = expenseListParams.remoteId
            this.transactionDateAfter = expenseListParams.transactionDateAfter
            this.transactionDateBefore = expenseListParams.transactionDateBefore
            additionalQueryParams(expenseListParams.additionalQueryParams)
            additionalHeaders(expenseListParams.additionalHeaders)
        }
