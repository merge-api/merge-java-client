...
private constructor(
    ...
    override fun toString() =
        "Payment{id=$id, remoteId=$remoteId, transactionDate=$transactionDate, contact=$contact, account=$account, currency=$currency, exchangeRate=$exchangeRate, company=$company, totalAmount=$totalAmount, trackingCategories=$trackingCategories, remoteUpdatedAt=$remoteUpdatedAt, remoteWasDeleted=$remoteWasDeleted, fieldMappings=$fieldMappings, modifiedAt=$modifiedAt, remoteData=$remoteData, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(payment: Payment) = apply {
            this.id = payment.id
            this.remoteId = payment.remoteId
            this.transactionDate = payment.transactionDate
            this.contact = payment.contact
            this.account = payment.account
            this.currency = payment.currency
            this.exchangeRate = payment.exchangeRate
            this.company = payment.company
            this.totalAmount = payment.totalAmount
            this.trackingCategories = payment.trackingCategories
            this.remoteUpdatedAt = payment.remoteUpdatedAt
            this.remoteWasDeleted = payment.remoteWasDeleted
            this.fieldMappings = payment.fieldMappings
            this.modifiedAt = payment.modifiedAt
            this.remoteData = payment.remoteData
