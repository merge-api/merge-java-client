...
constructor(
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
        ...
        this.userId?.let { params.put("user_id", listOf(it.toString())) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActivityListParams &&
    ...
    class Builder {
        ...
        internal fun from(activityListParams: ActivityListParams) = apply {
            this.createdAfter = activityListParams.createdAfter
            this.createdBefore = activityListParams.createdBefore
            this.cursor = activityListParams.cursor
            this.expand = activityListParams.expand
            this.includeDeletedData = activityListParams.includeDeletedData
            this.includeRemoteData = activityListParams.includeRemoteData
            this.modifiedAfter = activityListParams.modifiedAfter
            this.modifiedBefore = activityListParams.modifiedBefore
            this.pageSize = activityListParams.pageSize
            this.remoteFields = activityListParams.remoteFields
            this.remoteId = activityListParams.remoteId
            this.showEnumOrigins = activityListParams.showEnumOrigins
            this.userId = activityListParams.userId
            additionalQueryParams(activityListParams.additionalQueryParams)
            additionalHeaders(activityListParams.additionalHeaders)
        }
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val ACTIVITY_TYPE = RemoteFields(JsonField.of("activity_type"))

            @JvmField
            val ACTIVITY_TYPE_VISIBILITY = RemoteFields(JsonField.of("activity_type,visibility"))

            @JvmField val VISIBILITY = RemoteFields(JsonField.of("visibility"))
        ...
        fun value(): Value =
            when (this) {
                ...
                ACTIVITY_TYPE_VISIBILITY -> Value.ACTIVITY_TYPE_VISIBILITY
        ...
        fun known(): Known =
            when (this) {
                ACTIVITY_TYPE -> Known.ACTIVITY_TYPE
                ACTIVITY_TYPE_VISIBILITY -> Known.ACTIVITY_TYPE_VISIBILITY
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val ACTIVITY_TYPE = ShowEnumOrigins(JsonField.of("activity_type"))

            @JvmField
            val ACTIVITY_TYPE_VISIBILITY = ShowEnumOrigins(JsonField.of("activity_type,visibility"))

            @JvmField val VISIBILITY = ShowEnumOrigins(JsonField.of("visibility"))
