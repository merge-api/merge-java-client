...
constructor(
    ...
    class Builder {
        ...
        internal fun from(templateListParams: TemplateListParams) = apply {
            this.createdAfter = templateListParams.createdAfter
            this.createdBefore = templateListParams.createdBefore
            this.cursor = templateListParams.cursor
            this.includeDeletedData = templateListParams.includeDeletedData
            this.includeRemoteData = templateListParams.includeRemoteData
            this.modifiedAfter = templateListParams.modifiedAfter
            this.modifiedBefore = templateListParams.modifiedBefore
            this.pageSize = templateListParams.pageSize
            this.remoteId = templateListParams.remoteId
            additionalQueryParams(templateListParams.additionalQueryParams)
            additionalHeaders(templateListParams.additionalHeaders)
        }
