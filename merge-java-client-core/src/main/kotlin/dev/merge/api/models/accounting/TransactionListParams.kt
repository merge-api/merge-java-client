...
constructor(
    ...
    class Builder {
        ...
        internal fun from(transactionListParams: TransactionListParams) = apply {
            this.companyId = transactionListParams.companyId
            this.createdAfter = transactionListParams.createdAfter
            this.createdBefore = transactionListParams.createdBefore
            this.cursor = transactionListParams.cursor
            this.expand = transactionListParams.expand
            this.includeDeletedData = transactionListParams.includeDeletedData
            this.includeRemoteData = transactionListParams.includeRemoteData
            this.modifiedAfter = transactionListParams.modifiedAfter
            this.modifiedBefore = transactionListParams.modifiedBefore
            this.pageSize = transactionListParams.pageSize
            this.remoteId = transactionListParams.remoteId
            this.transactionDateAfter = transactionListParams.transactionDateAfter
            this.transactionDateBefore = transactionListParams.transactionDateBefore
