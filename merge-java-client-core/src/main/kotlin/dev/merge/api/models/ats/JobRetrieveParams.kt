...
constructor(
    ...
    override fun toString() =
        "JobRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(jobRetrieveParams: JobRetrieveParams) = apply {
            this.id = jobRetrieveParams.id
            this.expand = jobRetrieveParams.expand
            this.includeRemoteData = jobRetrieveParams.includeRemoteData
            this.remoteFields = jobRetrieveParams.remoteFields
            this.showEnumOrigins = jobRetrieveParams.showEnumOrigins
            additionalQueryParams(jobRetrieveParams.additionalQueryParams)
            additionalHeaders(jobRetrieveParams.additionalHeaders)
        }
