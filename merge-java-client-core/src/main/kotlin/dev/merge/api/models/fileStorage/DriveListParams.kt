...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DriveListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(driveListParams: DriveListParams) = apply {
            this.createdAfter = driveListParams.createdAfter
            this.createdBefore = driveListParams.createdBefore
            this.cursor = driveListParams.cursor
            this.includeDeletedData = driveListParams.includeDeletedData
            this.includeRemoteData = driveListParams.includeRemoteData
            this.modifiedAfter = driveListParams.modifiedAfter
            this.modifiedBefore = driveListParams.modifiedBefore
            this.name = driveListParams.name
            this.pageSize = driveListParams.pageSize
            this.remoteId = driveListParams.remoteId
            additionalQueryParams(driveListParams.additionalQueryParams)
            additionalHeaders(driveListParams.additionalHeaders)
        }
