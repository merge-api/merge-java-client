...
constructor(
    ...
    class Builder {
        ...
        internal fun from(tagListParams: TagListParams) = apply {
            this.createdAfter = tagListParams.createdAfter
            this.createdBefore = tagListParams.createdBefore
            this.cursor = tagListParams.cursor
            this.includeDeletedData = tagListParams.includeDeletedData
            this.includeRemoteData = tagListParams.includeRemoteData
            this.modifiedAfter = tagListParams.modifiedAfter
            this.modifiedBefore = tagListParams.modifiedBefore
            this.pageSize = tagListParams.pageSize
            this.remoteId = tagListParams.remoteId
            additionalQueryParams(tagListParams.additionalQueryParams)
            additionalHeaders(tagListParams.additionalHeaders)
        }
