...
class StageListRemoteFieldClassesParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StageListRemoteFieldClassesParams &&
    ...
    override fun toString() =
        "StageListRemoteFieldClassesParams{cursor=$cursor, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(stageListRemoteFieldClassesParams: StageListRemoteFieldClassesParams) =
            apply {
                this.cursor = stageListRemoteFieldClassesParams.cursor
                this.includeDeletedData = stageListRemoteFieldClassesParams.includeDeletedData
                this.includeRemoteData = stageListRemoteFieldClassesParams.includeRemoteData
                this.includeRemoteFields = stageListRemoteFieldClassesParams.includeRemoteFields
                this.pageSize = stageListRemoteFieldClassesParams.pageSize
                additionalQueryParams(stageListRemoteFieldClassesParams.additionalQueryParams)
                additionalHeaders(stageListRemoteFieldClassesParams.additionalHeaders)
            }
        ...
        fun build(): StageListRemoteFieldClassesParams =
            StageListRemoteFieldClassesParams(
                cursor,
                includeDeletedData,
                includeRemoteData,
                includeRemoteFields,
