...
constructor(
    ...
    class Builder {
        ...
        internal fun from(automationListParams: AutomationListParams) = apply {
            this.createdAfter = automationListParams.createdAfter
            this.createdBefore = automationListParams.createdBefore
            this.cursor = automationListParams.cursor
            this.includeDeletedData = automationListParams.includeDeletedData
            this.includeRemoteData = automationListParams.includeRemoteData
            this.modifiedAfter = automationListParams.modifiedAfter
            this.modifiedBefore = automationListParams.modifiedBefore
            this.pageSize = automationListParams.pageSize
            this.remoteId = automationListParams.remoteId
            additionalQueryParams(automationListParams.additionalQueryParams)
            additionalHeaders(automationListParams.additionalHeaders)
        }
