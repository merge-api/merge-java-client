...
constructor(
    private val model: ExpenseRequest,
    ...
    fun model(): ExpenseRequest = model
    ...
    @JvmSynthetic
    internal fun getBody(): ExpenseCreateBody {
        return ExpenseCreateBody(model, additionalBodyProperties)
    }
    ...
    @JsonDeserialize(builder = ExpenseCreateBody.Builder::class)
    @NoAutoDetect
    ...
    internal constructor(
         ...
         */
        @JsonProperty("model") fun model(): ExpenseRequest? = model
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is ExpenseCreateBody &&
        ...
        override fun toString() =
            "ExpenseCreateBody{model=$model, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var model: ExpenseRequest? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(expenseCreateBody: ExpenseCreateBody) = apply {
                this.model = expenseCreateBody.model
                additionalProperties(expenseCreateBody.additionalProperties)
            }
             ...
             * ### Description
             *
             * The `Expense` object is used to represent a purchase made from a business which can
             * be made with a check, credit card, or cash. Each expense object is dedicated to a
             * grouping of expenses, with each expense recorded in the lines object.
             *
             * ### Usage Example
             *
             * Fetch from the `GET Expense` endpoint and view a company's expense.
             */
            @JsonProperty("model") fun model(model: ExpenseRequest) = apply { this.model = model }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpenseCreateParams &&
            this.model == other.model &&
    ...
    override fun toString() =
        "ExpenseCreateParams{model=$model, isDebugMode=$isDebugMode, runAsync=$runAsync, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(expenseCreateParams: ExpenseCreateParams) = apply {
            this.model = expenseCreateParams.model
            this.isDebugMode = expenseCreateParams.isDebugMode
            this.runAsync = expenseCreateParams.runAsync
            additionalQueryParams(expenseCreateParams.additionalQueryParams)
            additionalHeaders(expenseCreateParams.additionalHeaders)
            additionalBodyProperties(expenseCreateParams.additionalBodyProperties)
        }
         ...
         * Fetch from the `GET Expense` endpoint and view a company's expense.
         */
        fun model(model: ExpenseRequest) = apply { this.model = model }
    ...
    private constructor(
        ...
        private val lines: List<ExpenseLineRequest>?,
        ...
        @JsonProperty("lines") fun lines(): List<ExpenseLineRequest>? = lines
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is ExpenseRequest &&
        ...
        override fun toString() =
            "ExpenseRequest{transactionDate=$transactionDate, account=$account, contact=$contact, totalAmount=$totalAmount, currency=$currency, exchangeRate=$exchangeRate, company=$company, memo=$memo, lines=$lines, trackingCategories=$trackingCategories, integrationParams=$integrationParams, linkedAccountParams=$linkedAccountParams, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var lines: List<ExpenseLineRequest>? = null
            ...
            @JvmSynthetic
            internal fun from(expenseRequest: ExpenseRequest) = apply {
                this.transactionDate = expenseRequest.transactionDate
                this.account = expenseRequest.account
                this.contact = expenseRequest.contact
                this.totalAmount = expenseRequest.totalAmount
                this.currency = expenseRequest.currency
                this.exchangeRate = expenseRequest.exchangeRate
                this.company = expenseRequest.company
                this.memo = expenseRequest.memo
                this.lines = expenseRequest.lines
                this.trackingCategories = expenseRequest.trackingCategories
                this.integrationParams = expenseRequest.integrationParams
                this.linkedAccountParams = expenseRequest.linkedAccountParams
                additionalProperties(expenseRequest.additionalProperties)
            }
            ...
            @JsonProperty("lines")
            fun lines(lines: List<ExpenseLineRequest>) = apply { this.lines = lines }
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is ExpenseLineRequest &&
            ...
            override fun toString() =
                "ExpenseLineRequest{remoteId=$remoteId, item=$item, netAmount=$netAmount, trackingCategory=$trackingCategory, trackingCategories=$trackingCategories, company=$company, account=$account, contact=$contact, description=$description, exchangeRate=$exchangeRate, integrationParams=$integrationParams, linkedAccountParams=$linkedAccountParams, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                @JvmSynthetic
                internal fun from(expenseLineRequest: ExpenseLineRequest) = apply {
                    this.remoteId = expenseLineRequest.remoteId
                    this.item = expenseLineRequest.item
                    this.netAmount = expenseLineRequest.netAmount
                    this.trackingCategory = expenseLineRequest.trackingCategory
                    this.trackingCategories = expenseLineRequest.trackingCategories
                    this.company = expenseLineRequest.company
                    this.account = expenseLineRequest.account
                    this.contact = expenseLineRequest.contact
                    this.description = expenseLineRequest.description
                    this.exchangeRate = expenseLineRequest.exchangeRate
                    this.integrationParams = expenseLineRequest.integrationParams
                    this.linkedAccountParams = expenseLineRequest.linkedAccountParams
                    additionalProperties(expenseLineRequest.additionalProperties)
                }
