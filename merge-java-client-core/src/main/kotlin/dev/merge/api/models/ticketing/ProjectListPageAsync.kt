...
private constructor(
    ...
    constructor(
        ...
        fun results(): List<Project> = results.getNullable("results") ?: listOf()
        ...
        override fun toString() =
            "ProjectListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
