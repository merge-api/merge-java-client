...
constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "NoteRequest{owner=$owner, content=$content, contact=$contact, account=$account, opportunity=$opportunity, integrationParams=$integrationParams, linkedAccountParams=$linkedAccountParams, remoteFields=$remoteFields, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(noteRequest: NoteRequest) = apply {
                ...
                this.remoteFields = noteRequest.remoteFields
