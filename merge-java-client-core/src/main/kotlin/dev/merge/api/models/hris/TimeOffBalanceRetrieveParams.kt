...
class TimeOffBalanceRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TimeOffBalanceRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "TimeOffBalanceRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(timeOffBalanceRetrieveParams: TimeOffBalanceRetrieveParams) = apply {
            this.id = timeOffBalanceRetrieveParams.id
            this.expand = timeOffBalanceRetrieveParams.expand
            this.includeRemoteData = timeOffBalanceRetrieveParams.includeRemoteData
            this.remoteFields = timeOffBalanceRetrieveParams.remoteFields
            this.showEnumOrigins = timeOffBalanceRetrieveParams.showEnumOrigins
            additionalQueryParams(timeOffBalanceRetrieveParams.additionalQueryParams)
            additionalHeaders(timeOffBalanceRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): TimeOffBalanceRetrieveParams =
            TimeOffBalanceRetrieveParams(
