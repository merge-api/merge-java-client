...
class PayrollRunRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PayrollRunRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "PayrollRunRetrieveParams{id=$id, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(payrollRunRetrieveParams: PayrollRunRetrieveParams) = apply {
            this.id = payrollRunRetrieveParams.id
            this.includeRemoteData = payrollRunRetrieveParams.includeRemoteData
            this.remoteFields = payrollRunRetrieveParams.remoteFields
            this.showEnumOrigins = payrollRunRetrieveParams.showEnumOrigins
            additionalQueryParams(payrollRunRetrieveParams.additionalQueryParams)
            additionalHeaders(payrollRunRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): PayrollRunRetrieveParams =
            PayrollRunRetrieveParams(
