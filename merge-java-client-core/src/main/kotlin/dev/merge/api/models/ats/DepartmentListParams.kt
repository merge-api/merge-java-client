...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DepartmentListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(departmentListParams: DepartmentListParams) = apply {
            this.createdAfter = departmentListParams.createdAfter
            this.createdBefore = departmentListParams.createdBefore
            this.cursor = departmentListParams.cursor
            this.includeDeletedData = departmentListParams.includeDeletedData
            this.includeRemoteData = departmentListParams.includeRemoteData
            this.modifiedAfter = departmentListParams.modifiedAfter
            this.modifiedBefore = departmentListParams.modifiedBefore
            this.pageSize = departmentListParams.pageSize
            this.remoteId = departmentListParams.remoteId
            additionalQueryParams(departmentListParams.additionalQueryParams)
            additionalHeaders(departmentListParams.additionalHeaders)
        }
        ...
        fun build(): DepartmentListParams =
            DepartmentListParams(
                createdAfter,
                createdBefore,
                cursor,
