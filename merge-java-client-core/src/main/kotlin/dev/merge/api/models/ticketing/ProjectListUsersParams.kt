...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProjectListUsersParams &&
    ...
    override fun toString() =
        "ProjectListUsersParams{parentId=$parentId, cursor=$cursor, expand=$expand, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(projectListUsersParams: ProjectListUsersParams) = apply {
            this.parentId = projectListUsersParams.parentId
            this.cursor = projectListUsersParams.cursor
            this.expand = projectListUsersParams.expand
            this.includeDeletedData = projectListUsersParams.includeDeletedData
            this.includeRemoteData = projectListUsersParams.includeRemoteData
            this.pageSize = projectListUsersParams.pageSize
            additionalQueryParams(projectListUsersParams.additionalQueryParams)
            additionalHeaders(projectListUsersParams.additionalHeaders)
        }
        ...
        fun build(): ProjectListUsersParams =
            ProjectListUsersParams(
