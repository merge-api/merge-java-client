...
class EeocListPage
private constructor(
    private val eeocsService: EeocService,
    ...
    override fun toString() =
        "EeocListPage{eeocsService=$eeocsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<EeocListPage> {
        return getNextPageParams().map { eeocsService.list(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(eeocsService: EeocService, params: EeocListParams, response: Response) =
            EeocListPage(
                eeocsService,
                params,
                response,
    ...
    constructor(
        ...
        override fun toString() =
            "EeocListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: EeocListPage,
    ) : Iterable<Eeoc> {

        override fun iterator(): Iterator<Eeoc> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
