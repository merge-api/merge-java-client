...
constructor(
    ...
    class Builder {
        ...
        internal fun from(emailListParams: EmailListParams) = apply {
            this.createdAfter = emailListParams.createdAfter
            this.createdBefore = emailListParams.createdBefore
            this.cursor = emailListParams.cursor
            this.includeDeletedData = emailListParams.includeDeletedData
            this.includeRemoteData = emailListParams.includeRemoteData
            this.modifiedAfter = emailListParams.modifiedAfter
            this.modifiedBefore = emailListParams.modifiedBefore
            this.pageSize = emailListParams.pageSize
            this.remoteId = emailListParams.remoteId
            additionalQueryParams(emailListParams.additionalQueryParams)
            additionalHeaders(emailListParams.additionalHeaders)
        }
