...
constructor(
    ...
    override fun toString() =
        "MessageRetrieveParams{id=$id, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(messageRetrieveParams: MessageRetrieveParams) = apply {
            ...
            this.includeRemoteData = messageRetrieveParams.includeRemoteData
            additionalQueryParams(messageRetrieveParams.additionalQueryParams)
            additionalHeaders(messageRetrieveParams.additionalHeaders)
        }
