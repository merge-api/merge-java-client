...
class CreditNoteRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreditNoteRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "CreditNoteRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(creditNoteRetrieveParams: CreditNoteRetrieveParams) = apply {
            this.id = creditNoteRetrieveParams.id
            this.expand = creditNoteRetrieveParams.expand
            this.includeRemoteData = creditNoteRetrieveParams.includeRemoteData
            this.remoteFields = creditNoteRetrieveParams.remoteFields
            this.showEnumOrigins = creditNoteRetrieveParams.showEnumOrigins
            additionalQueryParams(creditNoteRetrieveParams.additionalQueryParams)
            additionalHeaders(creditNoteRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): CreditNoteRetrieveParams =
