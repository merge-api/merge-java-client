...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PayGroupListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(payGroupListParams: PayGroupListParams) = apply {
            this.createdAfter = payGroupListParams.createdAfter
            this.createdBefore = payGroupListParams.createdBefore
            this.cursor = payGroupListParams.cursor
            this.includeDeletedData = payGroupListParams.includeDeletedData
            this.includeRemoteData = payGroupListParams.includeRemoteData
            this.modifiedAfter = payGroupListParams.modifiedAfter
            this.modifiedBefore = payGroupListParams.modifiedBefore
            this.pageSize = payGroupListParams.pageSize
            this.remoteId = payGroupListParams.remoteId
            additionalQueryParams(payGroupListParams.additionalQueryParams)
            additionalHeaders(payGroupListParams.additionalHeaders)
        }
