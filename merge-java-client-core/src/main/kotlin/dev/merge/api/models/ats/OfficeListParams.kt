...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OfficeListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(officeListParams: OfficeListParams) = apply {
            this.createdAfter = officeListParams.createdAfter
            this.createdBefore = officeListParams.createdBefore
            this.cursor = officeListParams.cursor
            this.includeDeletedData = officeListParams.includeDeletedData
            this.includeRemoteData = officeListParams.includeRemoteData
            this.modifiedAfter = officeListParams.modifiedAfter
            this.modifiedBefore = officeListParams.modifiedBefore
            this.pageSize = officeListParams.pageSize
            this.remoteId = officeListParams.remoteId
            additionalQueryParams(officeListParams.additionalQueryParams)
            additionalHeaders(officeListParams.additionalHeaders)
        }
