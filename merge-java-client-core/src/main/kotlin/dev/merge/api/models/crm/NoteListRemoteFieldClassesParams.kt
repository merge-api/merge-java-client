...
class NoteListRemoteFieldClassesParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NoteListRemoteFieldClassesParams &&
    ...
    override fun toString() =
        "NoteListRemoteFieldClassesParams{cursor=$cursor, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(noteListRemoteFieldClassesParams: NoteListRemoteFieldClassesParams) =
            apply {
                this.cursor = noteListRemoteFieldClassesParams.cursor
                this.includeDeletedData = noteListRemoteFieldClassesParams.includeDeletedData
                this.includeRemoteData = noteListRemoteFieldClassesParams.includeRemoteData
                this.includeRemoteFields = noteListRemoteFieldClassesParams.includeRemoteFields
                this.pageSize = noteListRemoteFieldClassesParams.pageSize
                additionalQueryParams(noteListRemoteFieldClassesParams.additionalQueryParams)
                additionalHeaders(noteListRemoteFieldClassesParams.additionalHeaders)
            }
        ...
        fun build(): NoteListRemoteFieldClassesParams =
            NoteListRemoteFieldClassesParams(
                cursor,
                includeDeletedData,
                includeRemoteData,
                includeRemoteFields,
