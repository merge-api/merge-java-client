...
class EngagementListRemoteFieldClassesPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EngagementListRemoteFieldClassesPage &&
    ...
    override fun toString() =
        "EngagementListRemoteFieldClassesPage{engagementsService=$engagementsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<EngagementListRemoteFieldClassesPage> {
        return getNextPageParams().map { engagementsService.listRemoteFieldClasses(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "EngagementListRemoteFieldClassesPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: EngagementListRemoteFieldClassesPage,
