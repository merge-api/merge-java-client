...
constructor(
    ...
    override fun toString() =
        "CommentRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(commentRetrieveParams: CommentRetrieveParams) = apply {
            this.id = commentRetrieveParams.id
            this.expand = commentRetrieveParams.expand
            this.includeRemoteData = commentRetrieveParams.includeRemoteData
            additionalQueryParams(commentRetrieveParams.additionalQueryParams)
            additionalHeaders(commentRetrieveParams.additionalHeaders)
        }
