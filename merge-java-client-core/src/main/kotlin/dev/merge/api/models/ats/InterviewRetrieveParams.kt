...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InterviewRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "InterviewRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(interviewRetrieveParams: InterviewRetrieveParams) = apply {
            this.id = interviewRetrieveParams.id
            this.expand = interviewRetrieveParams.expand
            this.includeRemoteData = interviewRetrieveParams.includeRemoteData
            this.remoteFields = interviewRetrieveParams.remoteFields
            this.showEnumOrigins = interviewRetrieveParams.showEnumOrigins
            additionalQueryParams(interviewRetrieveParams.additionalQueryParams)
            additionalHeaders(interviewRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): InterviewRetrieveParams =
            InterviewRetrieveParams(
