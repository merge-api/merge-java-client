...
private constructor(
    private val model: JsonField<Candidate>,
     ...
     */
    fun model(): Candidate = model.getRequired("model")
    ...
    fun validate(): CandidateResponse = apply {
        if (!validated) {
            model().validate()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CandidateResponse &&
    ...
    override fun toString() =
        "CandidateResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Candidate> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(candidateResponse: CandidateResponse) = apply {
            this.model = candidateResponse.model
            this.warnings = candidateResponse.warnings
            this.errors = candidateResponse.errors
            this.logs = candidateResponse.logs
            additionalProperties(candidateResponse.additionalProperties)
        }
         ...
         * Fetch from the `LIST Candidates` endpoint and filter by `ID` to show all candidates.
         */
        fun model(model: Candidate) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Candidate>) = apply { this.model = model }
