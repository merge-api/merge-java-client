...
constructor(
    ...
    class Builder {
        ...
        internal fun from(journalEntryListParams: JournalEntryListParams) = apply {
            this.companyId = journalEntryListParams.companyId
            this.createdAfter = journalEntryListParams.createdAfter
            this.createdBefore = journalEntryListParams.createdBefore
            this.cursor = journalEntryListParams.cursor
            this.expand = journalEntryListParams.expand
            this.includeDeletedData = journalEntryListParams.includeDeletedData
            this.includeRemoteData = journalEntryListParams.includeRemoteData
            this.modifiedAfter = journalEntryListParams.modifiedAfter
            this.modifiedBefore = journalEntryListParams.modifiedBefore
            this.pageSize = journalEntryListParams.pageSize
            this.remoteId = journalEntryListParams.remoteId
            this.transactionDateAfter = journalEntryListParams.transactionDateAfter
            this.transactionDateBefore = journalEntryListParams.transactionDateBefore
            additionalQueryParams(journalEntryListParams.additionalQueryParams)
            additionalHeaders(journalEntryListParams.additionalHeaders)
        }
