...
@JsonDeserialize(builder = AutomationResponse.Builder::class)
@NoAutoDetect
class AutomationResponse
private constructor(
    private val model: JsonField<Automation>,
     ...
     * configurations.
     */
    fun model(): Automation = model.getRequired("model")
    ...
    fun validate(): AutomationResponse = apply {
        if (!validated) {
            model().validate()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutomationResponse &&
    ...
    override fun toString() =
        "AutomationResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Automation> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(automationResponse: AutomationResponse) = apply {
            this.model = automationResponse.model
            this.warnings = automationResponse.warnings
            this.errors = automationResponse.errors
            this.logs = automationResponse.logs
            additionalProperties(automationResponse.additionalProperties)
        }
         ...
         * configurations.
         */
        fun model(model: Automation) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Automation>) = apply { this.model = model }
