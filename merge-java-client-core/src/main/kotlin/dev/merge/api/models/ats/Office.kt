 ...
 * ### Description
 *
 * The `Office` object is used to represent an office within a company. A given `Job` has the
 * `Office` ID in its offices field.
 *
 * ### Usage Example
 *
...
private constructor(
    ...
    override fun toString() =
        "Office{id=$id, remoteId=$remoteId, name=$name, location=$location, remoteWasDeleted=$remoteWasDeleted, fieldMappings=$fieldMappings, modifiedAt=$modifiedAt, remoteData=$remoteData, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(office: Office) = apply {
            this.id = office.id
            this.remoteId = office.remoteId
            this.name = office.name
            this.location = office.location
            this.remoteWasDeleted = office.remoteWasDeleted
            this.fieldMappings = office.fieldMappings
            this.modifiedAt = office.modifiedAt
            this.remoteData = office.remoteData
            additionalProperties(office.additionalProperties)
        }
