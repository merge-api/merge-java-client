...
constructor(
    ...
    class Builder {
        ...
        internal fun from(itemListParams: ItemListParams) = apply {
            this.companyId = itemListParams.companyId
            this.createdAfter = itemListParams.createdAfter
            this.createdBefore = itemListParams.createdBefore
            this.cursor = itemListParams.cursor
            this.expand = itemListParams.expand
            this.includeDeletedData = itemListParams.includeDeletedData
            this.includeRemoteData = itemListParams.includeRemoteData
            this.modifiedAfter = itemListParams.modifiedAfter
            this.modifiedBefore = itemListParams.modifiedBefore
            this.pageSize = itemListParams.pageSize
            this.remoteFields = itemListParams.remoteFields
            this.remoteId = itemListParams.remoteId
            this.showEnumOrigins = itemListParams.showEnumOrigins
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val PURCHASE_ACCOUNT = Expand(JsonField.of("purchase_account"))

            @JvmField val SALES_ACCOUNT = Expand(JsonField.of("sales_account"))
        ...
        fun known(): Known =
            when (this) {
                ...
                PURCHASE_ACCOUNT -> Known.PURCHASE_ACCOUNT
                SALES_ACCOUNT -> Known.SALES_ACCOUNT
