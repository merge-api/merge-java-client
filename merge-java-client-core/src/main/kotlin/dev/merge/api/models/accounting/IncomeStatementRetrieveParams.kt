...
class IncomeStatementRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IncomeStatementRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "IncomeStatementRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(incomeStatementRetrieveParams: IncomeStatementRetrieveParams) = apply {
            this.id = incomeStatementRetrieveParams.id
            this.expand = incomeStatementRetrieveParams.expand
            this.includeRemoteData = incomeStatementRetrieveParams.includeRemoteData
            additionalQueryParams(incomeStatementRetrieveParams.additionalQueryParams)
            additionalHeaders(incomeStatementRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): IncomeStatementRetrieveParams =
            IncomeStatementRetrieveParams(
