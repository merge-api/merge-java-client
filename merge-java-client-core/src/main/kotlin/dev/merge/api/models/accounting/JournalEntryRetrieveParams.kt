...
constructor(
    ...
    override fun toString() =
        "JournalEntryRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(journalEntryRetrieveParams: JournalEntryRetrieveParams) = apply {
            this.id = journalEntryRetrieveParams.id
            this.expand = journalEntryRetrieveParams.expand
            this.includeRemoteData = journalEntryRetrieveParams.includeRemoteData
            additionalQueryParams(journalEntryRetrieveParams.additionalQueryParams)
            additionalHeaders(journalEntryRetrieveParams.additionalHeaders)
        }
