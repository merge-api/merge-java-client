...
constructor(
    private val model: InvoiceRequest,
    ...
    fun model(): InvoiceRequest = model
    ...
    internal fun getBody(): InvoiceCreateBody {
        return InvoiceCreateBody(model, additionalBodyProperties)
    }
    ...
    internal constructor(
         ...
         * ```
         * If type = accounts_payable `Invoice` is a bill, if type = accounts_receivable it's an
         * invoice.
         * ```
         *     ### Usage Example
         ...
         * ```
         */
        @JsonProperty("model") fun model(): InvoiceRequest? = model
        ...
        override fun toString() =
            "InvoiceCreateBody{model=$model, additionalProperties=$additionalProperties}"
        ...
        class Builder {
             ...
             * ```
             */
            @JsonProperty("model") fun model(model: InvoiceRequest) = apply { this.model = model }
    ...
    override fun toString() =
        "InvoiceCreateParams{model=$model, isDebugMode=$isDebugMode, runAsync=$runAsync, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(invoiceCreateParams: InvoiceCreateParams) = apply {
            this.model = invoiceCreateParams.model
            this.isDebugMode = invoiceCreateParams.isDebugMode
            this.runAsync = invoiceCreateParams.runAsync
         ...
         * ```
         */
        fun model(model: InvoiceRequest) = apply { this.model = model }
    ...
    private constructor(
        ...
        private val totalTaxAmount: Double?,
        private val totalAmount: Double?,
        private val balance: Double?,
        private val payments: List<String>?,
        private val lineItems: List<InvoiceLineItemRequest>?,
         ...
         */
        @JsonProperty("type") fun type(): InvoiceTypeEnum? = type
        ...
        @JsonProperty("paid_on_date") fun paidOnDate(): OffsetDateTime? = paidOnDate
        ...
        @JsonProperty("total_discount") fun totalDiscount(): Double? = totalDiscount

        /** The total amount being paid before taxes. */
        @JsonProperty("sub_total") fun subTotal(): Double? = subTotal

        /** The total amount being paid in taxes. */
        @JsonProperty("total_tax_amount") fun totalTaxAmount(): Double? = totalTaxAmount

        /** The invoice's total amount. */
        @JsonProperty("total_amount") fun totalAmount(): Double? = totalAmount

        /** The invoice's remaining balance. */
        @JsonProperty("balance") fun balance(): Double? = balance

        /** Array of `Payment` object IDs. */
        @JsonProperty("payments") fun payments(): List<String>? = payments

        @JsonProperty("line_items") fun lineItems(): List<InvoiceLineItemRequest>? = lineItems
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is InvoiceRequest &&
                this.type == other.type &&
                this.contact == other.contact &&
                this.number == other.number &&
                this.issueDate == other.issueDate &&
                this.dueDate == other.dueDate &&
                this.paidOnDate == other.paidOnDate &&
        ...
        override fun toString() =
            "InvoiceRequest{type=$type, contact=$contact, number=$number, issueDate=$issueDate, dueDate=$dueDate, paidOnDate=$paidOnDate, memo=$memo, company=$company, currency=$currency, exchangeRate=$exchangeRate, totalDiscount=$totalDiscount, subTotal=$subTotal, totalTaxAmount=$totalTaxAmount, totalAmount=$totalAmount, balance=$balance, payments=$payments, lineItems=$lineItems, integrationParams=$integrationParams, linkedAccountParams=$linkedAccountParams, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var totalTaxAmount: Double? = null
            private var totalAmount: Double? = null
            private var balance: Double? = null
            private var payments: List<String>? = null
            private var lineItems: List<InvoiceLineItemRequest>? = null
            private var integrationParams: JsonValue? = null
            private var linkedAccountParams: JsonValue? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(invoiceRequest: InvoiceRequest) = apply {
                this.type = invoiceRequest.type
                this.contact = invoiceRequest.contact
                this.number = invoiceRequest.number
                this.issueDate = invoiceRequest.issueDate
                this.dueDate = invoiceRequest.dueDate
                this.paidOnDate = invoiceRequest.paidOnDate
                this.memo = invoiceRequest.memo
                this.company = invoiceRequest.company
                this.currency = invoiceRequest.currency
                this.exchangeRate = invoiceRequest.exchangeRate
                this.totalDiscount = invoiceRequest.totalDiscount
                this.subTotal = invoiceRequest.subTotal
                this.totalTaxAmount = invoiceRequest.totalTaxAmount
                this.totalAmount = invoiceRequest.totalAmount
                this.balance = invoiceRequest.balance
                this.payments = invoiceRequest.payments
                this.lineItems = invoiceRequest.lineItems
                this.integrationParams = invoiceRequest.integrationParams
                this.linkedAccountParams = invoiceRequest.linkedAccountParams
                additionalProperties(invoiceRequest.additionalProperties)
            }
             ...
             * - `ACCOUNTS_PAYABLE` - ACCOUNTS_PAYABLE
             */
            @JsonProperty("type") fun type(type: InvoiceTypeEnum) = apply { this.type = type }
            ...
            fun paidOnDate(paidOnDate: OffsetDateTime) = apply { this.paidOnDate = paidOnDate }
            ...
            fun totalDiscount(totalDiscount: Double) = apply { this.totalDiscount = totalDiscount }
            ...
            fun totalTaxAmount(totalTaxAmount: Double) = apply {
            ...
            /** The invoice's remaining balance. */
            @JsonProperty("balance") fun balance(balance: Double) = apply { this.balance = balance }

            /** Array of `Payment` object IDs. */
            @JsonProperty("payments")
            fun payments(payments: List<String>) = apply { this.payments = payments }

            @JsonProperty("line_items")
            fun lineItems(lineItems: List<InvoiceLineItemRequest>) = apply {
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is InvoiceTypeEnum && this.value == other.value
            }
            ...
            companion object {
                ...
                @JvmField
                val ACCOUNTS_RECEIVABLE = InvoiceTypeEnum(JsonField.of("ACCOUNTS_RECEIVABLE"))

                @JvmField val ACCOUNTS_PAYABLE = InvoiceTypeEnum(JsonField.of("ACCOUNTS_PAYABLE"))

                @JvmStatic fun of(value: String) = InvoiceTypeEnum(JsonField.of(value))
            }
            ...
            fun known(): Known =
                when (this) {
                    ...
                    else -> throw MergeInvalidDataException("Unknown InvoiceTypeEnum: $value")
                }
         ...
         * ### Description
         *
         * The `InvoiceLineItem` object represents an itemized record of goods and/or services sold
         * to a customer.
         *
         * ### Usage Example
         *
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is InvoiceLineItemRequest &&
            ...
            override fun toString() =
                "InvoiceLineItemRequest{remoteId=$remoteId, description=$description, unitPrice=$unitPrice, quantity=$quantity, totalAmount=$totalAmount, currency=$currency, exchangeRate=$exchangeRate, item=$item, account=$account, trackingCategory=$trackingCategory, trackingCategories=$trackingCategories, company=$company, integrationParams=$integrationParams, linkedAccountParams=$linkedAccountParams, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                @JvmSynthetic
                internal fun from(invoiceLineItemRequest: InvoiceLineItemRequest) = apply {
                    this.remoteId = invoiceLineItemRequest.remoteId
                    this.description = invoiceLineItemRequest.description
                    this.unitPrice = invoiceLineItemRequest.unitPrice
                    this.quantity = invoiceLineItemRequest.quantity
                    this.totalAmount = invoiceLineItemRequest.totalAmount
                    this.currency = invoiceLineItemRequest.currency
                    this.exchangeRate = invoiceLineItemRequest.exchangeRate
                    this.item = invoiceLineItemRequest.item
                    this.account = invoiceLineItemRequest.account
                    this.trackingCategory = invoiceLineItemRequest.trackingCategory
                    this.trackingCategories = invoiceLineItemRequest.trackingCategories
                    this.company = invoiceLineItemRequest.company
                    this.integrationParams = invoiceLineItemRequest.integrationParams
                    this.linkedAccountParams = invoiceLineItemRequest.linkedAccountParams
                    additionalProperties(invoiceLineItemRequest.additionalProperties)
                }
                ...
                fun build(): InvoiceLineItemRequest =
                    InvoiceLineItemRequest(
                        ...
                        account,
                        trackingCategory,
                        trackingCategories?.toUnmodifiable(),
                        company,
                        integrationParams,
                        linkedAccountParams,
                        additionalProperties.toUnmodifiable(),
