...
constructor(
    ...
    class Builder {
        ...
        internal fun from(companyListParams: CompanyListParams) = apply {
            this.createdAfter = companyListParams.createdAfter
            this.createdBefore = companyListParams.createdBefore
            this.cursor = companyListParams.cursor
            this.includeDeletedData = companyListParams.includeDeletedData
            this.includeRemoteData = companyListParams.includeRemoteData
            this.modifiedAfter = companyListParams.modifiedAfter
            this.modifiedBefore = companyListParams.modifiedBefore
            this.pageSize = companyListParams.pageSize
            this.remoteId = companyListParams.remoteId
            additionalQueryParams(companyListParams.additionalQueryParams)
            additionalHeaders(companyListParams.additionalHeaders)
        }
