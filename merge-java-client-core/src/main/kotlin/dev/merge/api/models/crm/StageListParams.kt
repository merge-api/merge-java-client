...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StageListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(stageListParams: StageListParams) = apply {
            this.createdAfter = stageListParams.createdAfter
            this.createdBefore = stageListParams.createdBefore
            this.cursor = stageListParams.cursor
            this.includeDeletedData = stageListParams.includeDeletedData
            this.includeRemoteData = stageListParams.includeRemoteData
            this.includeRemoteFields = stageListParams.includeRemoteFields
            this.modifiedAfter = stageListParams.modifiedAfter
            this.modifiedBefore = stageListParams.modifiedBefore
            this.pageSize = stageListParams.pageSize
            this.remoteId = stageListParams.remoteId
            additionalQueryParams(stageListParams.additionalQueryParams)
            additionalHeaders(stageListParams.additionalHeaders)
        }
