...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EngagementListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(engagementListParams: EngagementListParams) = apply {
            this.createdAfter = engagementListParams.createdAfter
            this.createdBefore = engagementListParams.createdBefore
            this.cursor = engagementListParams.cursor
            this.expand = engagementListParams.expand
            this.includeDeletedData = engagementListParams.includeDeletedData
            this.includeRemoteData = engagementListParams.includeRemoteData
            this.includeRemoteFields = engagementListParams.includeRemoteFields
            this.modifiedAfter = engagementListParams.modifiedAfter
            this.modifiedBefore = engagementListParams.modifiedBefore
            this.pageSize = engagementListParams.pageSize
            this.remoteId = engagementListParams.remoteId
            additionalQueryParams(engagementListParams.additionalQueryParams)
            additionalHeaders(engagementListParams.additionalHeaders)
        }
        ...
        fun build(): EngagementListParams =
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val CONTACTS = Expand(JsonField.of("contacts"))

            @JvmField val ENGAGEMENT_TYPE = Expand(JsonField.of("engagement_type"))
        ...
        fun known(): Known =
            when (this) {
                ...
                ENGAGEMENT_TYPE -> Known.ENGAGEMENT_TYPE
                OWNER -> Known.OWNER
