...
class IncomeStatementListParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IncomeStatementListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(incomeStatementListParams: IncomeStatementListParams) = apply {
            this.companyId = incomeStatementListParams.companyId
            this.createdAfter = incomeStatementListParams.createdAfter
            this.createdBefore = incomeStatementListParams.createdBefore
            this.cursor = incomeStatementListParams.cursor
            this.expand = incomeStatementListParams.expand
            this.includeDeletedData = incomeStatementListParams.includeDeletedData
            this.includeRemoteData = incomeStatementListParams.includeRemoteData
            this.modifiedAfter = incomeStatementListParams.modifiedAfter
            this.modifiedBefore = incomeStatementListParams.modifiedBefore
            this.pageSize = incomeStatementListParams.pageSize
            this.remoteId = incomeStatementListParams.remoteId
            additionalQueryParams(incomeStatementListParams.additionalQueryParams)
            additionalHeaders(incomeStatementListParams.additionalHeaders)
        }
        ...
        fun build(): IncomeStatementListParams =
            IncomeStatementListParams(
                companyId,
                createdAfter,
                createdBefore,
