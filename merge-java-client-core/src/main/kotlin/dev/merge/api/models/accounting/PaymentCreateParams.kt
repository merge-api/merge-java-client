...
constructor(
    private val model: PaymentRequest,
    ...
    fun model(): PaymentRequest = model
    ...
    internal fun getBody(): PaymentCreateBody {
        return PaymentCreateBody(model, additionalBodyProperties)
    }
    ...
    internal constructor(
         ...
         */
        @JsonProperty("model") fun model(): PaymentRequest? = model
        ...
        override fun toString() =
            "PaymentCreateBody{model=$model, additionalProperties=$additionalProperties}"
        ...
        class Builder {
             ...
             * Fetch from the `GET Payment` endpoint and view an invoice's payment.
             */
            @JsonProperty("model") fun model(model: PaymentRequest) = apply { this.model = model }
    ...
    override fun toString() =
        "PaymentCreateParams{model=$model, isDebugMode=$isDebugMode, runAsync=$runAsync, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(paymentCreateParams: PaymentCreateParams) = apply {
            this.model = paymentCreateParams.model
            this.isDebugMode = paymentCreateParams.isDebugMode
            this.runAsync = paymentCreateParams.runAsync
         ...
         * Fetch from the `GET Payment` endpoint and view an invoice's payment.
         */
        fun model(model: PaymentRequest) = apply { this.model = model }
    ...
    private constructor(
        ...
        override fun toString() =
            "PaymentRequest{transactionDate=$transactionDate, contact=$contact, account=$account, currency=$currency, exchangeRate=$exchangeRate, company=$company, totalAmount=$totalAmount, trackingCategories=$trackingCategories, integrationParams=$integrationParams, linkedAccountParams=$linkedAccountParams, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JvmSynthetic
            internal fun from(paymentRequest: PaymentRequest) = apply {
                this.transactionDate = paymentRequest.transactionDate
                this.contact = paymentRequest.contact
                this.account = paymentRequest.account
                this.currency = paymentRequest.currency
                this.exchangeRate = paymentRequest.exchangeRate
                this.company = paymentRequest.company
                this.totalAmount = paymentRequest.totalAmount
                this.trackingCategories = paymentRequest.trackingCategories
                this.integrationParams = paymentRequest.integrationParams
                this.linkedAccountParams = paymentRequest.linkedAccountParams
                additionalProperties(paymentRequest.additionalProperties)
            }
