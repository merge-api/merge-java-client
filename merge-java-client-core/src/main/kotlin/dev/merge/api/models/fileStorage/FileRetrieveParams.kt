...
constructor(
    ...
    override fun toString() =
        "FileRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(fileRetrieveParams: FileRetrieveParams) = apply {
            this.id = fileRetrieveParams.id
            this.expand = fileRetrieveParams.expand
            this.includeRemoteData = fileRetrieveParams.includeRemoteData
