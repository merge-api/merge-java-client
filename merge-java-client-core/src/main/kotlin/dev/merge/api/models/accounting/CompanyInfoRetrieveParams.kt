...
class CompanyInfoRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CompanyInfoRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "CompanyInfoRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(companyInfoRetrieveParams: CompanyInfoRetrieveParams) = apply {
            this.id = companyInfoRetrieveParams.id
            this.expand = companyInfoRetrieveParams.expand
            this.includeRemoteData = companyInfoRetrieveParams.includeRemoteData
            additionalQueryParams(companyInfoRetrieveParams.additionalQueryParams)
            additionalHeaders(companyInfoRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): CompanyInfoRetrieveParams =
            CompanyInfoRetrieveParams(
