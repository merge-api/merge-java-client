...
class ScorecardListPage
private constructor(
    private val scorecardsService: ScorecardService,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScorecardListPage &&
    ...
    override fun toString() =
        "ScorecardListPage{scorecardsService=$scorecardsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<ScorecardListPage> {
        return getNextPageParams().map { scorecardsService.list(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(
            scorecardsService: ScorecardService,
    ...
    constructor(
        ...
        fun results(): List<Scorecard> = results.getNullable("results") ?: listOf()
        ...
        override fun toString() =
            "ScorecardListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: ScorecardListPage,
    ) : Iterable<Scorecard> {

        override fun iterator(): Iterator<Scorecard> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
