...
class PurchaseOrderRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PurchaseOrderRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "PurchaseOrderRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(purchaseOrderRetrieveParams: PurchaseOrderRetrieveParams) = apply {
            this.id = purchaseOrderRetrieveParams.id
            this.expand = purchaseOrderRetrieveParams.expand
            this.includeRemoteData = purchaseOrderRetrieveParams.includeRemoteData
            this.remoteFields = purchaseOrderRetrieveParams.remoteFields
            this.showEnumOrigins = purchaseOrderRetrieveParams.showEnumOrigins
            additionalQueryParams(purchaseOrderRetrieveParams.additionalQueryParams)
            additionalHeaders(purchaseOrderRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): PurchaseOrderRetrieveParams =
