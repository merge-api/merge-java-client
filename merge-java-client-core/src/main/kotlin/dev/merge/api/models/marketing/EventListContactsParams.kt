...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventListContactsParams &&
    ...
    override fun toString() =
        "EventListContactsParams{parentId=$parentId, cursor=$cursor, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(eventListContactsParams: EventListContactsParams) = apply {
            this.parentId = eventListContactsParams.parentId
            this.cursor = eventListContactsParams.cursor
            this.includeDeletedData = eventListContactsParams.includeDeletedData
            this.includeRemoteData = eventListContactsParams.includeRemoteData
            this.pageSize = eventListContactsParams.pageSize
            additionalQueryParams(eventListContactsParams.additionalQueryParams)
            additionalHeaders(eventListContactsParams.additionalHeaders)
        }
        ...
        fun build(): EventListContactsParams =
            EventListContactsParams(
