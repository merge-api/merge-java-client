...
class CustomObjectRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomObjectRetrieveParams &&
    ...
    override fun toString() =
        "CustomObjectRetrieveParams{customObjectClassId=$customObjectClassId, id=$id, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(customObjectRetrieveParams: CustomObjectRetrieveParams) = apply {
            this.customObjectClassId = customObjectRetrieveParams.customObjectClassId
            this.id = customObjectRetrieveParams.id
            this.includeRemoteData = customObjectRetrieveParams.includeRemoteData
            this.includeRemoteFields = customObjectRetrieveParams.includeRemoteFields
            additionalQueryParams(customObjectRetrieveParams.additionalQueryParams)
            additionalHeaders(customObjectRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): CustomObjectRetrieveParams =
            CustomObjectRetrieveParams(
