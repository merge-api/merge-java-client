...
class CustomObjectClassListParamsTest {

    @Test
    fun createCustomObjectClassListParams() {
        CustomObjectClassListParams.builder()
            .createdAfter(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .createdBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .cursor("string")
            .expand(listOf(CustomObjectClassListParams.Expand.FIELDS))
    ...
    fun getQueryParams() {
        ...
        expected.put("expand", listOf(CustomObjectClassListParams.Expand.FIELDS.toString()))
    ...
    fun getQueryParamsWithoutOptionalFields() {
        val params = CustomObjectClassListParams.builder().build()
        val expected = mutableMapOf<String, List<String>>()
        assertThat(params.getQueryParams()).isEqualTo(expected)
    }
}
