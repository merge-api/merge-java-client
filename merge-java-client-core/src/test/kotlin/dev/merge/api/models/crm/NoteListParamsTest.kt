...
class NoteListParamsTest {

    @Test
    fun createNoteListParams() {
        NoteListParams.builder()
            ...
            .cursor("string")
            .expand(listOf(NoteListParams.Expand.ACCOUNT))
    ...
    fun getQueryParams() {
        ...
        expected.put("expand", listOf(NoteListParams.Expand.ACCOUNT.toString()))
        ...
        expected.put("opportunity_id", listOf("string"))
    ...
    fun getQueryParamsWithoutOptionalFields() {
        val params = NoteListParams.builder().build()
        val expected = mutableMapOf<String, List<String>>()
        assertThat(params.getQueryParams()).isEqualTo(expected)
    }
}
