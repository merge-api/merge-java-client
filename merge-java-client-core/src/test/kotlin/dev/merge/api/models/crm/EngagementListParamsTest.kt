...
class EngagementListParamsTest {

    @Test
    fun createEngagementListParams() {
        EngagementListParams.builder()
            .createdAfter(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .createdBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .cursor("string")
            .expand(listOf(EngagementListParams.Expand.ACCOUNT))
    ...
    fun getQueryParams() {
        ...
        expected.put("expand", listOf(EngagementListParams.Expand.ACCOUNT.toString()))
    ...
    fun getQueryParamsWithoutOptionalFields() {
        val params = EngagementListParams.builder().build()
        val expected = mutableMapOf<String, List<String>>()
        assertThat(params.getQueryParams()).isEqualTo(expected)
    }
}
