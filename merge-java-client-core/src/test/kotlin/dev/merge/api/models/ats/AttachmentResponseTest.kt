...
class AttachmentResponseTest {
    ...
    fun createAttachmentResponse() {
        ...
        assertThat(attachmentResponse.model())
            .isEqualTo(
                Attachment.builder()
                    .id("17a54124-287f-494d-965e-3c5b330c9a68")
                    .remoteId("19202938")
        ...
        assertThat(attachmentResponse.warnings())
            .containsExactly(
                ValidationWarning.builder()
                    .source(
                        ValidationWarning.ValidationProblemSource.builder()
        ...
        assertThat(attachmentResponse.errors())
            .containsExactly(
                ValidationError.builder()
                    .source(
        ...
        assertThat(attachmentResponse.logs().get())
            .containsExactly(
                DebugLog.builder()
                    .logId("99433219-8017-4acd-bb3c-ceb23d663832")
                    .dashboardView(
