...
class BalanceSheetListParamsTest {

    @Test
    fun createBalanceSheetListParams() {
        BalanceSheetListParams.builder()
            .companyId("string")
            .createdAfter(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .createdBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .cursor("string")
            .expand(listOf(BalanceSheetListParams.Expand.COMPANY))
    ...
    fun getQueryParams() {
        ...
        expected.put("expand", listOf(BalanceSheetListParams.Expand.COMPANY.toString()))
    ...
    fun getQueryParamsWithoutOptionalFields() {
        val params = BalanceSheetListParams.builder().build()
        val expected = mutableMapOf<String, List<String>>()
        assertThat(params.getQueryParams()).isEqualTo(expected)
    }
}
