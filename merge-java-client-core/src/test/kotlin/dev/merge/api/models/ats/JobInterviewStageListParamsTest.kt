...
class JobInterviewStageListParamsTest {

    @Test
    fun createJobInterviewStageListParams() {
        JobInterviewStageListParams.builder()
            .createdAfter(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .createdBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .cursor("string")
            .expand(listOf(JobInterviewStageListParams.Expand.JOB))
    ...
    fun getQueryParams() {
        ...
        expected.put("expand", listOf(JobInterviewStageListParams.Expand.JOB.toString()))
    ...
    fun getQueryParamsWithoutOptionalFields() {
        val params = JobInterviewStageListParams.builder().build()
        val expected = mutableMapOf<String, List<String>>()
        assertThat(params.getQueryParams()).isEqualTo(expected)
    }
}
