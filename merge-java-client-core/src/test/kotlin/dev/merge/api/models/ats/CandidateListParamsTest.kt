...
class CandidateListParamsTest {

    @Test
    fun createCandidateListParams() {
        CandidateListParams.builder()
            .createdAfter(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .createdBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .cursor("string")
            .emailAddresses("string")
            .expand(listOf(CandidateListParams.Expand.APPLICATIONS))
            .firstName("string")
    ...
    fun getQueryParams() {
        ...
        expected.put("email_addresses", listOf("string"))
        expected.put("expand", listOf(CandidateListParams.Expand.APPLICATIONS.toString()))
    ...
    fun getQueryParamsWithoutOptionalFields() {
        val params = CandidateListParams.builder().build()
        val expected = mutableMapOf<String, List<String>>()
        assertThat(params.getQueryParams()).isEqualTo(expected)
    }
}
