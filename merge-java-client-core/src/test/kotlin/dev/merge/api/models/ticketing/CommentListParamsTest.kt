...
class CommentListParamsTest {

    @Test
    fun createCommentListParams() {
        CommentListParams.builder()
            .createdAfter(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .createdBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .cursor("string")
            .expand(listOf(CommentListParams.Expand.CONTACT))
    ...
    fun getQueryParams() {
        ...
        expected.put("expand", listOf(CommentListParams.Expand.CONTACT.toString()))
        ...
        expected.put("ticket_id", listOf("string"))
