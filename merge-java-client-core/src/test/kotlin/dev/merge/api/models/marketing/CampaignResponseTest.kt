...
class CampaignResponseTest {
    ...
    fun createCampaignResponse() {
        ...
        assertThat(campaignResponse.model())
            .isEqualTo(
                Campaign.builder()
                    .name("New Customer Campaign")
                    .uniqueOpens(123L)
        ...
        assertThat(campaignResponse.warnings())
            .containsExactly(
                ValidationWarning.builder()
                    .source(
                        ValidationWarning.ValidationProblemSource.builder()
        ...
        assertThat(campaignResponse.errors())
            .containsExactly(
                ValidationError.builder()
                    .source(
        ...
        assertThat(campaignResponse.logs().get())
            .containsExactly(
                DebugLog.builder()
                    .logId("99433219-8017-4acd-bb3c-ceb23d663832")
                    .dashboardView(
