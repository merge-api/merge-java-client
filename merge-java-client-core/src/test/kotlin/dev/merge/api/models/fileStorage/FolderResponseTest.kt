...
class FolderResponseTest {
    ...
    fun createFolderResponse() {
        ...
        assertThat(folderResponse.model())
            .isEqualTo(
                Folder.builder()
                    .id("fba1fbc6-67c0-4cb2-a176-7896acd2ffd5")
                    .remoteId("14")
        ...
        assertThat(folderResponse.warnings())
            .containsExactly(
                ValidationWarning.builder()
                    .source(
                        ValidationWarning.ValidationProblemSource.builder()
        ...
        assertThat(folderResponse.errors())
            .containsExactly(
                ValidationError.builder()
                    .source(
        ...
        assertThat(folderResponse.logs().get())
            .containsExactly(
                DebugLog.builder()
                    .logId("99433219-8017-4acd-bb3c-ceb23d663832")
                    .dashboardView(
