...
class TaskListParamsTest {

    @Test
    fun createTaskListParams() {
        TaskListParams.builder()
            .createdAfter(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .createdBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .cursor("string")
            .expand(listOf(TaskListParams.Expand.ACCOUNT))
    ...
    fun getQueryParams() {
        ...
        expected.put("expand", listOf(TaskListParams.Expand.ACCOUNT.toString()))
    ...
    fun getQueryParamsWithoutOptionalFields() {
        val params = TaskListParams.builder().build()
        val expected = mutableMapOf<String, List<String>>()
        assertThat(params.getQueryParams()).isEqualTo(expected)
    }
}
