...
private constructor(
    ...
    fun results(): List<Job> = response().results()
    ...
    fun getNextPageParams(): Optional<JobListParams> {
        ...
        return Optional.of(JobListParams.builder().from(params).cursor(next()).build())
    }
    ...
    constructor(
        ...
        private val results: JsonField<List<Job>>,
        ...
        fun results(): List<Job> = results.getRequired("results")
        ...
        fun _results(): Optional<JsonField<List<Job>>> = Optional.ofNullable(results)
        ...
        override fun toString() =
            "JobListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var results: JsonField<List<Job>> = JsonMissing.of()
            ...
            fun results(results: List<Job>) = results(JsonField.of(results))

            @JsonProperty("results")
            fun results(results: JsonField<List<Job>>) = apply { this.results = results }
    ...
    class AutoPager
    constructor(
        private val firstPage: JobListPageAsync,
    ) {
