...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CompanyInfoListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(companyInfoListParams: CompanyInfoListParams) = apply {
            this.createdAfter = companyInfoListParams.createdAfter
            this.createdBefore = companyInfoListParams.createdBefore
            this.cursor = companyInfoListParams.cursor
            this.expand = companyInfoListParams.expand
            this.includeDeletedData = companyInfoListParams.includeDeletedData
            this.includeRemoteData = companyInfoListParams.includeRemoteData
            this.modifiedAfter = companyInfoListParams.modifiedAfter
            this.modifiedBefore = companyInfoListParams.modifiedBefore
            this.pageSize = companyInfoListParams.pageSize
            this.remoteId = companyInfoListParams.remoteId
            additionalQueryParams(companyInfoListParams.additionalQueryParams)
            additionalHeaders(companyInfoListParams.additionalHeaders)
        }
        ...
        fun build(): CompanyInfoListParams =
            CompanyInfoListParams(
                createdAfter,
                createdBefore,
                cursor,
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val ADDRESSES = Expand(JsonField.of("addresses"))

            @JvmField val PHONE_NUMBERS = Expand(JsonField.of("phone_numbers"))
        ...
        fun known(): Known =
            when (this) {
                ...
                PHONE_NUMBERS -> Known.PHONE_NUMBERS
