...
class JobInterviewStageListParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JobInterviewStageListParams &&
    ...
    override fun toString() =
        "JobInterviewStageListParams{createdAfter=$createdAfter, createdBefore=$createdBefore, cursor=$cursor, expand=$expand, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, jobId=$jobId, modifiedAfter=$modifiedAfter, modifiedBefore=$modifiedBefore, pageSize=$pageSize, remoteId=$remoteId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(jobInterviewStageListParams: JobInterviewStageListParams) = apply {
            this.createdAfter = jobInterviewStageListParams.createdAfter
            this.createdBefore = jobInterviewStageListParams.createdBefore
            this.cursor = jobInterviewStageListParams.cursor
            this.expand = jobInterviewStageListParams.expand
            this.includeDeletedData = jobInterviewStageListParams.includeDeletedData
            this.includeRemoteData = jobInterviewStageListParams.includeRemoteData
            this.jobId = jobInterviewStageListParams.jobId
            this.modifiedAfter = jobInterviewStageListParams.modifiedAfter
            this.modifiedBefore = jobInterviewStageListParams.modifiedBefore
            this.pageSize = jobInterviewStageListParams.pageSize
            this.remoteId = jobInterviewStageListParams.remoteId
            additionalQueryParams(jobInterviewStageListParams.additionalQueryParams)
            additionalHeaders(jobInterviewStageListParams.additionalHeaders)
        }
        ...
        fun build(): JobInterviewStageListParams =
            JobInterviewStageListParams(
                createdAfter,
                createdBefore,
                cursor,
