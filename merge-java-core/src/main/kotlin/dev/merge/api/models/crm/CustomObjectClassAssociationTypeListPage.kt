...
class CustomObjectClassAssociationTypeListPage
private constructor(
    private val associationTypesService: AssociationTypeService,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomObjectClassAssociationTypeListPage &&
    ...
    override fun toString() =
        "CustomObjectClassAssociationTypeListPage{associationTypesService=$associationTypesService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<CustomObjectClassAssociationTypeListPage> {
        return getNextPageParams().map { associationTypesService.list(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(
            associationTypesService: AssociationTypeService,
    ...
    constructor(
        ...
        fun results(): List<AssociationType> = results.getNullable("results") ?: listOf()
        ...
        override fun toString() =
            "CustomObjectClassAssociationTypeListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: CustomObjectClassAssociationTypeListPage,
    ) : Iterable<AssociationType> {

        override fun iterator(): Iterator<AssociationType> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<AssociationType> {
