...
private constructor(
    private val model: JsonField<Contact>,
     ...
     */
    fun model(): Contact = model.getRequired("model")
    ...
    override fun toString() =
        "ContactResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Contact> = JsonMissing.of()
        ...
        internal fun from(contactResponse: ContactResponse) = apply {
            this.model = contactResponse.model
            this.warnings = contactResponse.warnings
            this.errors = contactResponse.errors
            this.logs = contactResponse.logs
            additionalProperties(contactResponse.additionalProperties)
        }
         ...
         * Fetch from the `GET /api/mktg/v1/contact` endpoint and view their phone numbers.
         */
        fun model(model: Contact) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Contact>) = apply { this.model = model }
