...
class CashFlowStatementListParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CashFlowStatementListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(cashFlowStatementListParams: CashFlowStatementListParams) = apply {
            this.companyId = cashFlowStatementListParams.companyId
            this.createdAfter = cashFlowStatementListParams.createdAfter
            this.createdBefore = cashFlowStatementListParams.createdBefore
            this.cursor = cashFlowStatementListParams.cursor
            this.expand = cashFlowStatementListParams.expand
            this.includeDeletedData = cashFlowStatementListParams.includeDeletedData
            this.includeRemoteData = cashFlowStatementListParams.includeRemoteData
            this.modifiedAfter = cashFlowStatementListParams.modifiedAfter
            this.modifiedBefore = cashFlowStatementListParams.modifiedBefore
            this.pageSize = cashFlowStatementListParams.pageSize
            this.remoteId = cashFlowStatementListParams.remoteId
            additionalQueryParams(cashFlowStatementListParams.additionalQueryParams)
            additionalHeaders(cashFlowStatementListParams.additionalHeaders)
        }
        ...
        fun build(): CashFlowStatementListParams =
            CashFlowStatementListParams(
                companyId,
                createdAfter,
                createdBefore,
                cursor,
