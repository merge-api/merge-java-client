...
class EngagementTypeListRemoteFieldClassesPageAsync
private constructor(
    private val engagementTypesService: EngagementTypeServiceAsync,
    private val params: EngagementTypeListRemoteFieldClassesParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EngagementTypeListRemoteFieldClassesPageAsync &&
    ...
    override fun toString() =
        "EngagementTypeListRemoteFieldClassesPageAsync{engagementTypesService=$engagementTypesService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<EngagementTypeListRemoteFieldClassesParams> {
        if (!hasNextPage()) {
            return Optional.empty()
        }

        return Optional.of(
            EngagementTypeListRemoteFieldClassesParams.builder().from(params).cursor(next()).build()
        )
    }

    fun getNextPage(): CompletableFuture<Optional<EngagementTypeListRemoteFieldClassesPageAsync>> {
        return getNextPageParams()
            .map { engagementTypesService.listRemoteFieldClasses(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        fun of(
            ...
            EngagementTypeListRemoteFieldClassesPageAsync(
                engagementTypesService,
                params,
                response,
            )
    ...
    constructor(
        ...
        override fun toString() =
            "EngagementTypeListRemoteFieldClassesPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: EngagementTypeListRemoteFieldClassesPageAsync,
    ) {
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<EngagementTypeListRemoteFieldClassesPageAsync>>.forEach(
