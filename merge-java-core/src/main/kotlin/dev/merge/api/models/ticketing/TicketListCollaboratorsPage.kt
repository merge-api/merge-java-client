...
class TicketListCollaboratorsPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TicketListCollaboratorsPage &&
    ...
    override fun toString() =
        "TicketListCollaboratorsPage{ticketsService=$ticketsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<TicketListCollaboratorsPage> {
        return getNextPageParams().map { ticketsService.listCollaborators(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "TicketListCollaboratorsPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: TicketListCollaboratorsPage,
    ) : Iterable<User> {
