...
class StageListRemoteFieldClassesPageAsync
private constructor(
    private val stagesService: StageServiceAsync,
    private val params: StageListRemoteFieldClassesParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StageListRemoteFieldClassesPageAsync &&
    ...
    override fun toString() =
        "StageListRemoteFieldClassesPageAsync{stagesService=$stagesService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<StageListRemoteFieldClassesParams> {
        if (!hasNextPage()) {
            return Optional.empty()
        }

        return Optional.of(
            StageListRemoteFieldClassesParams.builder().from(params).cursor(next()).build()
        )
    }

    fun getNextPage(): CompletableFuture<Optional<StageListRemoteFieldClassesPageAsync>> {
        return getNextPageParams()
            .map { stagesService.listRemoteFieldClasses(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(
            stagesService: StageServiceAsync,
            params: StageListRemoteFieldClassesParams,
            response: Response
        ) =
            StageListRemoteFieldClassesPageAsync(
                stagesService,
                params,
                response,
            )
    ...
    constructor(
        ...
        override fun toString() =
            "StageListRemoteFieldClassesPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: StageListRemoteFieldClassesPageAsync,
    ) {
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<StageListRemoteFieldClassesPageAsync>>.forEach(
