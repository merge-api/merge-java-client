...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActivityListPage &&
    ...
    override fun toString() =
        "ActivityListPage{activitiesService=$activitiesService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<ActivityListParams> {
        ...
        return Optional.of(ActivityListParams.builder().from(params).cursor(next()).build())
    }

    fun getNextPage(): Optional<ActivityListPage> {
        return getNextPageParams().map { activitiesService.list(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(activitiesService: ActivityService, params: ActivityListParams, response: Response) =
            ActivityListPage(
                activitiesService,
                params,
                response,
    ...
    constructor(
        ...
        fun results(): List<Activity> = results.getRequired("results")
        ...
        override fun toString() =
            "ActivityListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: ActivityListPage,
    ) : Iterable<Activity> {
