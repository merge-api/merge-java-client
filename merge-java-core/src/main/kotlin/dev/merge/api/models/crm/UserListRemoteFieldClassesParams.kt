...
class UserListRemoteFieldClassesParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserListRemoteFieldClassesParams &&
    ...
    override fun toString() =
        "UserListRemoteFieldClassesParams{cursor=$cursor, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(userListRemoteFieldClassesParams: UserListRemoteFieldClassesParams) =
            apply {
                this.cursor = userListRemoteFieldClassesParams.cursor
                this.includeDeletedData = userListRemoteFieldClassesParams.includeDeletedData
                this.includeRemoteData = userListRemoteFieldClassesParams.includeRemoteData
                this.includeRemoteFields = userListRemoteFieldClassesParams.includeRemoteFields
                this.pageSize = userListRemoteFieldClassesParams.pageSize
                additionalQueryParams(userListRemoteFieldClassesParams.additionalQueryParams)
                additionalHeaders(userListRemoteFieldClassesParams.additionalHeaders)
            }
        ...
        fun build(): UserListRemoteFieldClassesParams =
            UserListRemoteFieldClassesParams(
                cursor,
                includeDeletedData,
                includeRemoteData,
                includeRemoteFields,
