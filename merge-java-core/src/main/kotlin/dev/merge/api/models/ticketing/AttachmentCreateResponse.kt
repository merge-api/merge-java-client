...
@JsonDeserialize(builder = AttachmentCreateResponse.Builder::class)
@NoAutoDetect
class AttachmentCreateResponse
private constructor(
    private val model: JsonField<Attachment>,
     ...
     * TODO
     */
    fun model(): Attachment = model.getRequired("model")
    ...
    fun validate(): AttachmentCreateResponse = apply {
        if (!validated) {
            model().validate()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AttachmentCreateResponse &&
    ...
    override fun toString() =
        "AttachmentCreateResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Attachment> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(attachmentCreateResponse: AttachmentCreateResponse) = apply {
            this.model = attachmentCreateResponse.model
            this.warnings = attachmentCreateResponse.warnings
            this.errors = attachmentCreateResponse.errors
            this.logs = attachmentCreateResponse.logs
            additionalProperties(attachmentCreateResponse.additionalProperties)
        }
         ...
         * TODO
         */
        fun model(model: Attachment) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Attachment>) = apply { this.model = model }
        ...
        fun build(): AttachmentCreateResponse =
