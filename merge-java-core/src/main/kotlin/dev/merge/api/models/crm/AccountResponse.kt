...
@JsonDeserialize(builder = AccountResponse.Builder::class)
@NoAutoDetect
class AccountResponse
private constructor(
    private val model: JsonField<Account>,
     ...
     * TODO
     */
    fun model(): Account = model.getRequired("model")
    ...
    override fun toString() =
        "AccountResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Account> = JsonMissing.of()
        ...
        internal fun from(accountResponse: AccountResponse) = apply {
            this.model = accountResponse.model
            this.warnings = accountResponse.warnings
            this.errors = accountResponse.errors
            this.logs = accountResponse.logs
            additionalProperties(accountResponse.additionalProperties)
        }
         ...
         * TODO
         */
        fun model(model: Account) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Account>) = apply { this.model = model }
