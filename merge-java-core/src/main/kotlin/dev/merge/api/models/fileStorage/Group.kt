 ...
 * ### Description
 *
 * The `Group` object is used to represent any subset of `User`s. This can extend to company domains
 * as well.
 *
 * ### Usage Example
 *
...
private constructor(
    ...
    /**
     * The users that belong in the group. If null, this typically means it's either a domain or the
     * third-party platform does not surface this information.
     */
    fun users(): List<String> = users.getRequired("users")
     ...
     * third-party platform does not surface this information.
     */
    @JsonProperty("users") @ExcludeMissing fun _users() = users
    ...
    override fun toString() =
        "Group{id=$id, remoteId=$remoteId, name=$name, users=$users, fieldMappings=$fieldMappings, modifiedAt=$modifiedAt, remoteData=$remoteData, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var users: JsonField<List<String>> = JsonMissing.of()
        ...
        /**
         * The users that belong in the group. If null, this typically means it's either a domain or
         * the third-party platform does not surface this information.
         */
        fun users(users: List<String>) = users(JsonField.of(users))
        ...
        @JsonProperty("users")
        @ExcludeMissing
        fun users(users: JsonField<List<String>>) = apply { this.users = users }
