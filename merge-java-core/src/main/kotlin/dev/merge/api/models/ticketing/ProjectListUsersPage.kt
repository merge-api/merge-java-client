...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProjectListUsersPage &&
    ...
    override fun toString() =
        "ProjectListUsersPage{projectsService=$projectsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<ProjectListUsersPage> {
        return getNextPageParams().map { projectsService.listUsers(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "ProjectListUsersPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: ProjectListUsersPage,
    ) : Iterable<User> {
