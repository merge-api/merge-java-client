...
class ContactListListSubscribersPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContactListListSubscribersPage &&
    ...
    override fun toString() =
        "ContactListListSubscribersPage{contactListsService=$contactListsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<ContactListListSubscribersPage> {
        return getNextPageParams().map { contactListsService.listSubscribers(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "ContactListListSubscribersPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: ContactListListSubscribersPage,
    ) : Iterable<Contact> {

        override fun iterator(): Iterator<Contact> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
