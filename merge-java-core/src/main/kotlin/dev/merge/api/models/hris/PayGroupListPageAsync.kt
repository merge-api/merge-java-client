...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PayGroupListPageAsync &&
    ...
    override fun toString() =
        "PayGroupListPageAsync{payGroupsService=$payGroupsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<PayGroupListParams> {
        ...
        return Optional.of(PayGroupListParams.builder().from(params).cursor(next()).build())
    }

    fun getNextPage(): CompletableFuture<Optional<PayGroupListPageAsync>> {
    ...
    constructor(
        ...
        fun results(): List<PayGroup> = results.getRequired("results")
        ...
        override fun toString() =
            "PayGroupListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: PayGroupListPageAsync,
    ) {

        fun forEach(action: Predicate<PayGroup>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<PayGroupListPageAsync>>.forEach(
                action: (PayGroup) -> Boolean,
                executor: Executor
        ...
        fun toList(executor: Executor): CompletableFuture<List<PayGroup>> {
            val values = mutableListOf<PayGroup>()
