...
private constructor(
    ...
    fun results(): List<Message> = response().results()
    ...
    fun getNextPageParams(): Optional<MessageListParams> {
        ...
        return Optional.of(MessageListParams.builder().from(params).cursor(next()).build())
    }
    ...
    constructor(
        ...
        private val results: JsonField<List<Message>>,
        ...
        fun results(): List<Message> = results.getRequired("results")
        ...
        fun _results(): Optional<JsonField<List<Message>>> = Optional.ofNullable(results)
        ...
        override fun toString() =
            "MessageListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var results: JsonField<List<Message>> = JsonMissing.of()
            ...
            fun results(results: List<Message>) = results(JsonField.of(results))

            @JsonProperty("results")
            fun results(results: JsonField<List<Message>>) = apply { this.results = results }
