...
class LeadListRemoteFieldClassesPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LeadListRemoteFieldClassesPage &&
    ...
    override fun toString() =
        "LeadListRemoteFieldClassesPage{leadsService=$leadsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<LeadListRemoteFieldClassesPage> {
        return getNextPageParams().map { leadsService.listRemoteFieldClasses(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "LeadListRemoteFieldClassesPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: LeadListRemoteFieldClassesPage,
