...
private constructor(
    ...
    fun getNextPageParams(): Optional<FileListParams> {
        ...
        return Optional.of(FileListParams.builder().from(params).cursor(next()).build())
    }
    ...
    constructor(
        ...
        fun results(): List<File> = results.getRequired("results")
        ...
        override fun toString() =
            "FileListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
