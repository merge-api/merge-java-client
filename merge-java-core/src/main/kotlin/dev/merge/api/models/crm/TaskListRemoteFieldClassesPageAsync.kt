...
class TaskListRemoteFieldClassesPageAsync
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TaskListRemoteFieldClassesPageAsync &&
    ...
    override fun toString() =
        "TaskListRemoteFieldClassesPageAsync{tasksService=$tasksService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<TaskListRemoteFieldClassesParams> {
        ...
        return Optional.of(
            TaskListRemoteFieldClassesParams.builder().from(params).cursor(next()).build()
        )
    }

    fun getNextPage(): CompletableFuture<Optional<TaskListRemoteFieldClassesPageAsync>> {
        return getNextPageParams()
            .map { tasksService.listRemoteFieldClasses(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(
            tasksService: TaskServiceAsync,
            params: TaskListRemoteFieldClassesParams,
            response: Response
        ) =
            TaskListRemoteFieldClassesPageAsync(
                tasksService,
                params,
                response,
            )
    ...
    constructor(
        ...
        override fun toString() =
            "TaskListRemoteFieldClassesPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: TaskListRemoteFieldClassesPageAsync,
    ) {
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<TaskListRemoteFieldClassesPageAsync>>.forEach(
