...
private constructor(
    ...
    override fun toString() =
        "ValidationError{source=$source, title=$title, detail=$detail, problemType=$problemType, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(validationError: ValidationError) = apply {
            this.source = validationError.source
            this.title = validationError.title
            this.detail = validationError.detail
            this.problemType = validationError.problemType
            additionalProperties(validationError.additionalProperties)
        }
