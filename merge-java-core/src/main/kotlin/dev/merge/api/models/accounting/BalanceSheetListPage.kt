...
class BalanceSheetListPage
private constructor(
    private val balanceSheetsService: BalanceSheetService,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BalanceSheetListPage &&
    ...
    override fun toString() =
        "BalanceSheetListPage{balanceSheetsService=$balanceSheetsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<BalanceSheetListPage> {
        return getNextPageParams().map { balanceSheetsService.list(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(
            balanceSheetsService: BalanceSheetService,
    ...
    constructor(
        ...
        override fun toString() =
            "BalanceSheetListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: BalanceSheetListPage,
    ) : Iterable<BalanceSheet> {

        override fun iterator(): Iterator<BalanceSheet> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<BalanceSheet> {
