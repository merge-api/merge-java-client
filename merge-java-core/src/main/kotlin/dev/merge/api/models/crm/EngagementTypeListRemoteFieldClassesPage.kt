...
class EngagementTypeListRemoteFieldClassesPage
private constructor(
    private val engagementTypesService: EngagementTypeService,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EngagementTypeListRemoteFieldClassesPage &&
    ...
    override fun toString() =
        "EngagementTypeListRemoteFieldClassesPage{engagementTypesService=$engagementTypesService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<EngagementTypeListRemoteFieldClassesPage> {
        return getNextPageParams().map { engagementTypesService.listRemoteFieldClasses(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(
            engagementTypesService: EngagementTypeService,
    ...
    constructor(
        ...
        override fun toString() =
            "EngagementTypeListRemoteFieldClassesPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: EngagementTypeListRemoteFieldClassesPage,
