...
@JsonDeserialize(builder = TaskCreateResponse.Builder::class)
@NoAutoDetect
class TaskCreateResponse
private constructor(
    private val model: JsonField<Task>,
     ...
     * TODO
     */
    fun model(): Task = model.getRequired("model")
    ...
    fun validate(): TaskCreateResponse = apply {
        if (!validated) {
            model().validate()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TaskCreateResponse &&
    ...
    override fun toString() =
        "TaskCreateResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Task> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(taskCreateResponse: TaskCreateResponse) = apply {
            this.model = taskCreateResponse.model
            this.warnings = taskCreateResponse.warnings
            this.errors = taskCreateResponse.errors
            this.logs = taskCreateResponse.logs
            additionalProperties(taskCreateResponse.additionalProperties)
        }
         ...
         * TODO
         */
        fun model(model: Task) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Task>) = apply { this.model = model }
