...
constructor(
    ...
    override fun toString() =
        "AttachmentRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(attachmentRetrieveParams: AttachmentRetrieveParams) = apply {
            ...
            this.expand = attachmentRetrieveParams.expand
            this.includeRemoteData = attachmentRetrieveParams.includeRemoteData
            this.remoteFields = attachmentRetrieveParams.remoteFields
            this.showEnumOrigins = attachmentRetrieveParams.showEnumOrigins
            additionalQueryParams(attachmentRetrieveParams.additionalQueryParams)
            additionalHeaders(attachmentRetrieveParams.additionalHeaders)
        }
