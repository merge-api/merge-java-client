...
class EventListContactsPageAsync
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventListContactsPageAsync &&
    ...
    override fun toString() =
        "EventListContactsPageAsync{eventsService=$eventsService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<EventListContactsPageAsync>> {
        return getNextPageParams()
            .map { eventsService.listContacts(it).thenApply { Optional.of(it) } }
    ...
    constructor(
        ...
        override fun toString() =
            "EventListContactsPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: EventListContactsPageAsync,
    ) {

        fun forEach(action: Predicate<Contact>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<EventListContactsPageAsync>>.forEach(
