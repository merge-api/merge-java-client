 ...
 * ### Description
 *
 * The `CashFlowStatement` object shows operating activities, investing activities, and financing
 * activities over a period of time (month, quarter, or year).
 *
 * ### Usage Example
 *
...
private constructor(
    ...
    private val cashAtBeginningOfPeriod: JsonField<Double>,
    private val cashAtEndOfPeriod: JsonField<Double>,
    private val operatingActivities: JsonField<List<ReportItem>>,
    private val investingActivities: JsonField<List<ReportItem>>,
    private val financingActivities: JsonField<List<ReportItem>>,
    private val remoteGeneratedAt: JsonField<OffsetDateTime>,
    ...
    fun cashAtBeginningOfPeriod(): Optional<Double> =
        Optional.ofNullable(cashAtBeginningOfPeriod.getNullable("cash_at_beginning_of_period"))

    /** Cash and cash equivalents at the beginning of the cash flow statement's period. */
    fun cashAtEndOfPeriod(): Optional<Double> =
        Optional.ofNullable(cashAtEndOfPeriod.getNullable("cash_at_end_of_period"))

    fun operatingActivities(): Optional<List<ReportItem>> =
        Optional.ofNullable(operatingActivities.getNullable("operating_activities"))

    fun investingActivities(): Optional<List<ReportItem>> =
        Optional.ofNullable(investingActivities.getNullable("investing_activities"))

    fun financingActivities(): Optional<List<ReportItem>> =
        Optional.ofNullable(financingActivities.getNullable("financing_activities"))

    /** The time that cash flow statement was generated by the accounting system. */
    fun remoteGeneratedAt(): Optional<OffsetDateTime> =
        Optional.ofNullable(remoteGeneratedAt.getNullable("remote_generated_at"))
    ...
    @ExcludeMissing
    fun _cashAtBeginningOfPeriod() = cashAtBeginningOfPeriod

    /** Cash and cash equivalents at the beginning of the cash flow statement's period. */
    @JsonProperty("cash_at_end_of_period")
    @ExcludeMissing
    fun _cashAtEndOfPeriod() = cashAtEndOfPeriod

    @JsonProperty("operating_activities")
    @ExcludeMissing
    fun _operatingActivities() = operatingActivities

    @JsonProperty("investing_activities")
    @ExcludeMissing
    fun _investingActivities() = investingActivities

    @JsonProperty("financing_activities")
    @ExcludeMissing
    fun _financingActivities() = financingActivities

    /** The time that cash flow statement was generated by the accounting system. */
    @JsonProperty("remote_generated_at")
    @ExcludeMissing
    fun _remoteGeneratedAt() = remoteGeneratedAt
    ...
    fun validate(): CashFlowStatement = apply {
        if (!validated) {
            id()
            remoteId()
            name()
            ...
            cashAtEndOfPeriod()
            operatingActivities().map { it.forEach { it.validate() } }
            investingActivities().map { it.forEach { it.validate() } }
            financingActivities().map { it.forEach { it.validate() } }
            remoteGeneratedAt()
            remoteWasDeleted()
            modifiedAt()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CashFlowStatement &&
            ...
            this.cashAtBeginningOfPeriod == other.cashAtBeginningOfPeriod &&
            this.cashAtEndOfPeriod == other.cashAtEndOfPeriod &&
            this.operatingActivities == other.operatingActivities &&
            this.investingActivities == other.investingActivities &&
            this.financingActivities == other.financingActivities &&
            this.remoteGeneratedAt == other.remoteGeneratedAt &&
    ...
    override fun toString() =
        "CashFlowStatement{id=$id, remoteId=$remoteId, name=$name, currency=$currency, company=$company, startPeriod=$startPeriod, endPeriod=$endPeriod, cashAtBeginningOfPeriod=$cashAtBeginningOfPeriod, cashAtEndOfPeriod=$cashAtEndOfPeriod, operatingActivities=$operatingActivities, investingActivities=$investingActivities, financingActivities=$financingActivities, remoteGeneratedAt=$remoteGeneratedAt, remoteWasDeleted=$remoteWasDeleted, fieldMappings=$fieldMappings, modifiedAt=$modifiedAt, remoteData=$remoteData, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var cashAtBeginningOfPeriod: JsonField<Double> = JsonMissing.of()
        private var cashAtEndOfPeriod: JsonField<Double> = JsonMissing.of()
        private var operatingActivities: JsonField<List<ReportItem>> = JsonMissing.of()
        private var investingActivities: JsonField<List<ReportItem>> = JsonMissing.of()
        private var financingActivities: JsonField<List<ReportItem>> = JsonMissing.of()
        private var remoteGeneratedAt: JsonField<OffsetDateTime> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(cashFlowStatement: CashFlowStatement) = apply {
            this.id = cashFlowStatement.id
            this.remoteId = cashFlowStatement.remoteId
            this.name = cashFlowStatement.name
            this.currency = cashFlowStatement.currency
            this.company = cashFlowStatement.company
            this.startPeriod = cashFlowStatement.startPeriod
            this.endPeriod = cashFlowStatement.endPeriod
            this.cashAtBeginningOfPeriod = cashFlowStatement.cashAtBeginningOfPeriod
            this.cashAtEndOfPeriod = cashFlowStatement.cashAtEndOfPeriod
            this.operatingActivities = cashFlowStatement.operatingActivities
            this.investingActivities = cashFlowStatement.investingActivities
            this.financingActivities = cashFlowStatement.financingActivities
            this.remoteGeneratedAt = cashFlowStatement.remoteGeneratedAt
            this.remoteWasDeleted = cashFlowStatement.remoteWasDeleted
            this.fieldMappings = cashFlowStatement.fieldMappings
            this.modifiedAt = cashFlowStatement.modifiedAt
            this.remoteData = cashFlowStatement.remoteData
            additionalProperties(cashFlowStatement.additionalProperties)
        }
        ...
        /** Cash and cash equivalents at the beginning of the cash flow statement's period. */
        fun cashAtBeginningOfPeriod(cashAtBeginningOfPeriod: Double) =
            cashAtBeginningOfPeriod(JsonField.of(cashAtBeginningOfPeriod))

        /** Cash and cash equivalents at the beginning of the cash flow statement's period. */
        @JsonProperty("cash_at_beginning_of_period")
        @ExcludeMissing
        fun cashAtBeginningOfPeriod(cashAtBeginningOfPeriod: JsonField<Double>) = apply {
            this.cashAtBeginningOfPeriod = cashAtBeginningOfPeriod
        }

        /** Cash and cash equivalents at the beginning of the cash flow statement's period. */
        fun cashAtEndOfPeriod(cashAtEndOfPeriod: Double) =
            cashAtEndOfPeriod(JsonField.of(cashAtEndOfPeriod))

        /** Cash and cash equivalents at the beginning of the cash flow statement's period. */
        @JsonProperty("cash_at_end_of_period")
        @ExcludeMissing
        fun cashAtEndOfPeriod(cashAtEndOfPeriod: JsonField<Double>) = apply {
            this.cashAtEndOfPeriod = cashAtEndOfPeriod
        }

        fun operatingActivities(operatingActivities: List<ReportItem>) =
            operatingActivities(JsonField.of(operatingActivities))

        @JsonProperty("operating_activities")
        @ExcludeMissing
        fun operatingActivities(operatingActivities: JsonField<List<ReportItem>>) = apply {
            this.operatingActivities = operatingActivities
        }

        fun investingActivities(investingActivities: List<ReportItem>) =
            investingActivities(JsonField.of(investingActivities))

        @JsonProperty("investing_activities")
        @ExcludeMissing
        fun investingActivities(investingActivities: JsonField<List<ReportItem>>) = apply {
            this.investingActivities = investingActivities
        }

        fun financingActivities(financingActivities: List<ReportItem>) =
            financingActivities(JsonField.of(financingActivities))

        @JsonProperty("financing_activities")
        @ExcludeMissing
        fun financingActivities(financingActivities: JsonField<List<ReportItem>>) = apply {
            this.financingActivities = financingActivities
        }

        /** The time that cash flow statement was generated by the accounting system. */
        fun remoteGeneratedAt(remoteGeneratedAt: OffsetDateTime) =
            remoteGeneratedAt(JsonField.of(remoteGeneratedAt))

        /** The time that cash flow statement was generated by the accounting system. */
        @JsonProperty("remote_generated_at")
        @ExcludeMissing
        fun remoteGeneratedAt(remoteGeneratedAt: JsonField<OffsetDateTime>) = apply {
        ...
        fun build(): CashFlowStatement =
            CashFlowStatement(
                ...
                cashAtBeginningOfPeriod,
                cashAtEndOfPeriod,
                operatingActivities.map { it.toUnmodifiable() },
                investingActivities.map { it.toUnmodifiable() },
                financingActivities.map { it.toUnmodifiable() },
                remoteGeneratedAt,
                remoteWasDeleted,
                fieldMappings,
                modifiedAt,
