...
class OpportunityListRemoteFieldClassesParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OpportunityListRemoteFieldClassesParams &&
    ...
    override fun toString() =
        "OpportunityListRemoteFieldClassesParams{cursor=$cursor, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(
            opportunityListRemoteFieldClassesParams: OpportunityListRemoteFieldClassesParams
        ) = apply {
            this.cursor = opportunityListRemoteFieldClassesParams.cursor
            this.includeDeletedData = opportunityListRemoteFieldClassesParams.includeDeletedData
            this.includeRemoteData = opportunityListRemoteFieldClassesParams.includeRemoteData
            this.includeRemoteFields = opportunityListRemoteFieldClassesParams.includeRemoteFields
            this.pageSize = opportunityListRemoteFieldClassesParams.pageSize
            additionalQueryParams(opportunityListRemoteFieldClassesParams.additionalQueryParams)
            additionalHeaders(opportunityListRemoteFieldClassesParams.additionalHeaders)
        }
        ...
        fun build(): OpportunityListRemoteFieldClassesParams =
            OpportunityListRemoteFieldClassesParams(
                cursor,
                includeDeletedData,
                includeRemoteData,
                includeRemoteFields,
