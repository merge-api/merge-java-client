...
constructor(
    ...
    private val model: PatchedContactRequest,
    ...
    fun model(): PatchedContactRequest = model
    ...
    @JvmSynthetic
    internal fun getBody(): ContactUpdateBody {
        return ContactUpdateBody(model, additionalBodyProperties)
    }
    ...
    @JsonDeserialize(builder = ContactUpdateBody.Builder::class)
    @NoAutoDetect
    ...
    internal constructor(
         ...
         * ### Description
         *
         * The `Contact` object is used to represent an existing point of contact at a company in a
         * CRM system.
         *
         * ### Usage Example
         *
         * TODO
         */
        @JsonProperty("model") fun model(): PatchedContactRequest? = model
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is ContactUpdateBody &&
        ...
        override fun toString() =
            "ContactUpdateBody{model=$model, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var model: PatchedContactRequest? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(contactUpdateBody: ContactUpdateBody) = apply {
                this.model = contactUpdateBody.model
                additionalProperties(contactUpdateBody.additionalProperties)
            }
             ...
             * ### Description
             *
             * The `Contact` object is used to represent an existing point of contact at a company
             * in a CRM system.
             *
             * ### Usage Example
             *
             ...
             */
            @JsonProperty("model")
            fun model(model: PatchedContactRequest) = apply { this.model = model }
    ...
    override fun toString() =
        "ContactUpdateParams{id=$id, model=$model, isDebugMode=$isDebugMode, runAsync=$runAsync, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(contactUpdateParams: ContactUpdateParams) = apply {
            this.id = contactUpdateParams.id
            this.model = contactUpdateParams.model
            this.isDebugMode = contactUpdateParams.isDebugMode
            this.runAsync = contactUpdateParams.runAsync
            additionalQueryParams(contactUpdateParams.additionalQueryParams)
            additionalHeaders(contactUpdateParams.additionalHeaders)
            additionalBodyProperties(contactUpdateParams.additionalBodyProperties)
        }
     ...
     * ### Description
     *
     * The `Contact` object is used to represent an existing point of contact at a company in a CRM
     * system.
     *
     * ### Usage Example
     *
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PatchedContactRequest &&
        ...
        override fun toString() =
            "PatchedContactRequest{firstName=$firstName, lastName=$lastName, account=$account, addresses=$addresses, emailAddresses=$emailAddresses, phoneNumbers=$phoneNumbers, lastActivityAt=$lastActivityAt, integrationParams=$integrationParams, linkedAccountParams=$linkedAccountParams, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JvmSynthetic
            internal fun from(patchedContactRequest: PatchedContactRequest) = apply {
                this.firstName = patchedContactRequest.firstName
                this.lastName = patchedContactRequest.lastName
                this.account = patchedContactRequest.account
                this.addresses = patchedContactRequest.addresses
                this.emailAddresses = patchedContactRequest.emailAddresses
                this.phoneNumbers = patchedContactRequest.phoneNumbers
                this.lastActivityAt = patchedContactRequest.lastActivityAt
                this.integrationParams = patchedContactRequest.integrationParams
                this.linkedAccountParams = patchedContactRequest.linkedAccountParams
                additionalProperties(patchedContactRequest.additionalProperties)
            }
            ...
            fun build(): PatchedContactRequest =
