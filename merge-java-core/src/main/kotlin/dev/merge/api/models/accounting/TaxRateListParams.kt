...
constructor(
    ...
    class Builder {
        ...
        internal fun from(taxRateListParams: TaxRateListParams) = apply {
            this.companyId = taxRateListParams.companyId
            this.createdAfter = taxRateListParams.createdAfter
            this.createdBefore = taxRateListParams.createdBefore
            this.cursor = taxRateListParams.cursor
            this.expand = taxRateListParams.expand
            this.includeDeletedData = taxRateListParams.includeDeletedData
            this.includeRemoteData = taxRateListParams.includeRemoteData
            this.modifiedAfter = taxRateListParams.modifiedAfter
            this.modifiedBefore = taxRateListParams.modifiedBefore
            this.pageSize = taxRateListParams.pageSize
            this.remoteId = taxRateListParams.remoteId
            additionalQueryParams(taxRateListParams.additionalQueryParams)
            additionalHeaders(taxRateListParams.additionalHeaders)
        }
