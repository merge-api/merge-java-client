...
private constructor(
    ...
    private val fiscalYearEndMonth: JsonField<Long>,
    private val fiscalYearEndDay: JsonField<Long>,
    ...
    fun fiscalYearEndMonth(): Optional<Long> =
        Optional.ofNullable(fiscalYearEndMonth.getNullable("fiscal_year_end_month"))

    /** The company's fiscal year end day. */
    fun fiscalYearEndDay(): Optional<Long> =
        Optional.ofNullable(fiscalYearEndDay.getNullable("fiscal_year_end_day"))
    ...
    /** The company's urls. */
    fun urls(): Optional<List<String>> = Optional.ofNullable(urls.getNullable("urls"))
    ...
    @ExcludeMissing
    fun _fiscalYearEndMonth() = fiscalYearEndMonth

    /** The company's fiscal year end day. */
    @JsonProperty("fiscal_year_end_day") @ExcludeMissing fun _fiscalYearEndDay() = fiscalYearEndDay
    ...
    fun validate(): CompanyInfo = apply {
        if (!validated) {
            id()
            remoteId()
            name()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CompanyInfo &&
            ...
            this.fiscalYearEndMonth == other.fiscalYearEndMonth &&
            this.fiscalYearEndDay == other.fiscalYearEndDay &&
    ...
    override fun toString() =
        "CompanyInfo{id=$id, remoteId=$remoteId, name=$name, legalName=$legalName, taxNumber=$taxNumber, fiscalYearEndMonth=$fiscalYearEndMonth, fiscalYearEndDay=$fiscalYearEndDay, currency=$currency, remoteCreatedAt=$remoteCreatedAt, urls=$urls, addresses=$addresses, phoneNumbers=$phoneNumbers, remoteWasDeleted=$remoteWasDeleted, fieldMappings=$fieldMappings, modifiedAt=$modifiedAt, remoteData=$remoteData, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var fiscalYearEndMonth: JsonField<Long> = JsonMissing.of()
        private var fiscalYearEndDay: JsonField<Long> = JsonMissing.of()
        ...
        private var urls: JsonField<List<String>> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(companyInfo: CompanyInfo) = apply {
            this.id = companyInfo.id
            this.remoteId = companyInfo.remoteId
            this.name = companyInfo.name
            this.legalName = companyInfo.legalName
            this.taxNumber = companyInfo.taxNumber
            this.fiscalYearEndMonth = companyInfo.fiscalYearEndMonth
            this.fiscalYearEndDay = companyInfo.fiscalYearEndDay
            this.currency = companyInfo.currency
            this.remoteCreatedAt = companyInfo.remoteCreatedAt
            this.urls = companyInfo.urls
            this.addresses = companyInfo.addresses
            this.phoneNumbers = companyInfo.phoneNumbers
            this.remoteWasDeleted = companyInfo.remoteWasDeleted
            this.fieldMappings = companyInfo.fieldMappings
            this.modifiedAt = companyInfo.modifiedAt
            this.remoteData = companyInfo.remoteData
            additionalProperties(companyInfo.additionalProperties)
        }
        ...
        /** The company's fiscal year end month. */
        fun fiscalYearEndMonth(fiscalYearEndMonth: Long) =
            fiscalYearEndMonth(JsonField.of(fiscalYearEndMonth))

        /** The company's fiscal year end month. */
        @JsonProperty("fiscal_year_end_month")
        @ExcludeMissing
        fun fiscalYearEndMonth(fiscalYearEndMonth: JsonField<Long>) = apply {
            this.fiscalYearEndMonth = fiscalYearEndMonth
        }

        /** The company's fiscal year end day. */
        fun fiscalYearEndDay(fiscalYearEndDay: Long) =
            fiscalYearEndDay(JsonField.of(fiscalYearEndDay))

        /** The company's fiscal year end day. */
        @JsonProperty("fiscal_year_end_day")
        @ExcludeMissing
        fun fiscalYearEndDay(fiscalYearEndDay: JsonField<Long>) = apply {
        ...
        @JsonProperty("urls")
        @ExcludeMissing
        fun urls(urls: JsonField<List<String>>) = apply { this.urls = urls }
