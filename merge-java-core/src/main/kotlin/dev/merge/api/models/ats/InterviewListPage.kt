...
private constructor(
    private val interviewsService: InterviewService,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InterviewListPage &&
    ...
    override fun toString() =
        "InterviewListPage{interviewsService=$interviewsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<InterviewListParams> {
        ...
        return Optional.of(InterviewListParams.builder().from(params).cursor(next()).build())
    }

    fun getNextPage(): Optional<InterviewListPage> {
        return getNextPageParams().map { interviewsService.list(it) }
    }
    ...
    constructor(
        ...
        fun results(): List<ScheduledInterview> = results.getRequired("results")
        ...
        override fun toString() =
            "InterviewListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: InterviewListPage,
    ) : Iterable<ScheduledInterview> {

        override fun iterator(): Iterator<ScheduledInterview> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<ScheduledInterview> {
