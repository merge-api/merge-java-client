...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NoteRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "NoteRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(noteRetrieveParams: NoteRetrieveParams) = apply {
            this.id = noteRetrieveParams.id
            this.expand = noteRetrieveParams.expand
            this.includeRemoteData = noteRetrieveParams.includeRemoteData
            this.includeRemoteFields = noteRetrieveParams.includeRemoteFields
            additionalQueryParams(noteRetrieveParams.additionalQueryParams)
            additionalHeaders(noteRetrieveParams.additionalHeaders)
        }
