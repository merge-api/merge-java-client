...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CandidateRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "CandidateRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(candidateRetrieveParams: CandidateRetrieveParams) = apply {
            this.id = candidateRetrieveParams.id
            this.expand = candidateRetrieveParams.expand
            this.includeRemoteData = candidateRetrieveParams.includeRemoteData
            additionalQueryParams(candidateRetrieveParams.additionalQueryParams)
            additionalHeaders(candidateRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): CandidateRetrieveParams =
            CandidateRetrieveParams(
