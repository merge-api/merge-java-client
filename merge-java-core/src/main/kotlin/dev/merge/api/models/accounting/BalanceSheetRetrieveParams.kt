...
class BalanceSheetRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BalanceSheetRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "BalanceSheetRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(balanceSheetRetrieveParams: BalanceSheetRetrieveParams) = apply {
            this.id = balanceSheetRetrieveParams.id
            this.expand = balanceSheetRetrieveParams.expand
            this.includeRemoteData = balanceSheetRetrieveParams.includeRemoteData
            additionalQueryParams(balanceSheetRetrieveParams.additionalQueryParams)
            additionalHeaders(balanceSheetRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): BalanceSheetRetrieveParams =
            BalanceSheetRetrieveParams(
