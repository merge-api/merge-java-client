...
@JsonDeserialize(builder = CampaignResponse.Builder::class)
@NoAutoDetect
class CampaignResponse
private constructor(
    private val model: JsonField<Campaign>,
     ...
     */
    fun model(): Campaign = model.getRequired("model")
    ...
    override fun toString() =
        "CampaignResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Campaign> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(campaignResponse: CampaignResponse) = apply {
            this.model = campaignResponse.model
            this.warnings = campaignResponse.warnings
            this.errors = campaignResponse.errors
            this.logs = campaignResponse.logs
            additionalProperties(campaignResponse.additionalProperties)
        }
         ...
         * Fetch from the `GET /api/mktg/v1/campaigns` endpoint and view their unique opens.
         */
        fun model(model: Campaign) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Campaign>) = apply { this.model = model }
