...
class DepartmentListPageAsync
private constructor(
    private val departmentsService: DepartmentServiceAsync,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DepartmentListPageAsync &&
    ...
    override fun toString() =
        "DepartmentListPageAsync{departmentsService=$departmentsService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<DepartmentListPageAsync>> {
        return getNextPageParams()
            .map { departmentsService.list(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(
            departmentsService: DepartmentServiceAsync,
            params: DepartmentListParams,
            response: Response
        ) =
            DepartmentListPageAsync(
                departmentsService,
                params,
                response,
            )
    ...
    constructor(
        ...
        fun results(): List<Department> = results.getNullable("results") ?: listOf()
        ...
        override fun toString() =
            "DepartmentListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: DepartmentListPageAsync,
    ) {

        fun forEach(action: Predicate<Department>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<DepartmentListPageAsync>>.forEach(
                action: (Department) -> Boolean,
                executor: Executor
        ...
        fun toList(executor: Executor): CompletableFuture<List<Department>> {
            val values = mutableListOf<Department>()
