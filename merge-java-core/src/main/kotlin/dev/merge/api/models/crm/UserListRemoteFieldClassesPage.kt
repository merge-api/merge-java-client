...
class UserListRemoteFieldClassesPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserListRemoteFieldClassesPage &&
    ...
    override fun toString() =
        "UserListRemoteFieldClassesPage{usersService=$usersService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<UserListRemoteFieldClassesPage> {
        return getNextPageParams().map { usersService.listRemoteFieldClasses(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "UserListRemoteFieldClassesPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: UserListRemoteFieldClassesPage,
