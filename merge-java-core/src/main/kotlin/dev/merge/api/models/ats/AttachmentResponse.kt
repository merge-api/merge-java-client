...
private constructor(
    ...
    override fun toString() =
        "AttachmentResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(attachmentResponse: AttachmentResponse) = apply {
            this.model = attachmentResponse.model
            this.warnings = attachmentResponse.warnings
            this.errors = attachmentResponse.errors
            this.logs = attachmentResponse.logs
            additionalProperties(attachmentResponse.additionalProperties)
        }
