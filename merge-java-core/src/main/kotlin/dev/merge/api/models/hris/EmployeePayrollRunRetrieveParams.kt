...
class EmployeePayrollRunRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmployeePayrollRunRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "EmployeePayrollRunRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(employeePayrollRunRetrieveParams: EmployeePayrollRunRetrieveParams) =
            apply {
                this.id = employeePayrollRunRetrieveParams.id
                this.expand = employeePayrollRunRetrieveParams.expand
                this.includeRemoteData = employeePayrollRunRetrieveParams.includeRemoteData
                additionalQueryParams(employeePayrollRunRetrieveParams.additionalQueryParams)
                additionalHeaders(employeePayrollRunRetrieveParams.additionalHeaders)
            }
        ...
        fun build(): EmployeePayrollRunRetrieveParams =
            EmployeePayrollRunRetrieveParams(
