...
constructor(
    ...
    override fun toString() =
        "TemplateRetrieveParams{id=$id, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(templateRetrieveParams: TemplateRetrieveParams) = apply {
            ...
            this.includeRemoteData = templateRetrieveParams.includeRemoteData
            additionalQueryParams(templateRetrieveParams.additionalQueryParams)
            additionalHeaders(templateRetrieveParams.additionalHeaders)
        }
