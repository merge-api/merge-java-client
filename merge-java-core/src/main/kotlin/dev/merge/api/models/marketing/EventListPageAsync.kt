...
private constructor(
    ...
    constructor(
        ...
        fun results(): List<Event> = results.getNullable("results") ?: listOf()
        ...
        override fun toString() =
            "EventListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
