...
constructor(
    ...
    override fun toString() =
        "AccountRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(accountRetrieveParams: AccountRetrieveParams) = apply {
            ...
            this.includeRemoteFields = accountRetrieveParams.includeRemoteFields
