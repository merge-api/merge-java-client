...
constructor(
    ...
    override fun toString() =
        "TagRetrieveParams{id=$id, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(tagRetrieveParams: TagRetrieveParams) = apply {
            this.id = tagRetrieveParams.id
            this.includeRemoteData = tagRetrieveParams.includeRemoteData
            additionalQueryParams(tagRetrieveParams.additionalQueryParams)
            additionalHeaders(tagRetrieveParams.additionalHeaders)
        }
