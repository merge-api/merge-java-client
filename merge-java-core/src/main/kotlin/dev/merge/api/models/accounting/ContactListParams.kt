...
constructor(
    ...
    class Builder {
        ...
        internal fun from(contactListParams: ContactListParams) = apply {
            this.companyId = contactListParams.companyId
            this.createdAfter = contactListParams.createdAfter
            this.createdBefore = contactListParams.createdBefore
            this.cursor = contactListParams.cursor
            this.expand = contactListParams.expand
            this.includeDeletedData = contactListParams.includeDeletedData
            this.includeRemoteData = contactListParams.includeRemoteData
            this.modifiedAfter = contactListParams.modifiedAfter
            this.modifiedBefore = contactListParams.modifiedBefore
            this.pageSize = contactListParams.pageSize
            this.remoteFields = contactListParams.remoteFields
            this.remoteId = contactListParams.remoteId
            this.showEnumOrigins = contactListParams.showEnumOrigins
            additionalQueryParams(contactListParams.additionalQueryParams)
            additionalHeaders(contactListParams.additionalHeaders)
        }
