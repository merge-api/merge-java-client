...
constructor(
    ...
    override fun toString() =
        "CollectionRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(collectionRetrieveParams: CollectionRetrieveParams) = apply {
            ...
            this.expand = collectionRetrieveParams.expand
            this.includeRemoteData = collectionRetrieveParams.includeRemoteData
            this.remoteFields = collectionRetrieveParams.remoteFields
            this.showEnumOrigins = collectionRetrieveParams.showEnumOrigins
            additionalQueryParams(collectionRetrieveParams.additionalQueryParams)
            additionalHeaders(collectionRetrieveParams.additionalHeaders)
        }
