...
class NoteResponse
private constructor(
    private val model: JsonField<Note>,
     ...
     * TODO
     */
    fun model(): Note = model.getRequired("model")
    ...
    fun validate(): NoteResponse = apply {
        if (!validated) {
            model().validate()
    ...
    override fun toString() =
        "NoteResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Note> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(noteResponse: NoteResponse) = apply {
            this.model = noteResponse.model
            this.warnings = noteResponse.warnings
            this.errors = noteResponse.errors
            this.logs = noteResponse.logs
            additionalProperties(noteResponse.additionalProperties)
        }
         ...
         * TODO
         */
        fun model(model: Note) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Note>) = apply { this.model = model }
