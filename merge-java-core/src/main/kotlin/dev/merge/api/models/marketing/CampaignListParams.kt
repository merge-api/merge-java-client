...
constructor(
    ...
    class Builder {
        ...
        internal fun from(campaignListParams: CampaignListParams) = apply {
            this.createdAfter = campaignListParams.createdAfter
            this.createdBefore = campaignListParams.createdBefore
            this.cursor = campaignListParams.cursor
            this.includeDeletedData = campaignListParams.includeDeletedData
            this.includeRemoteData = campaignListParams.includeRemoteData
            this.modifiedAfter = campaignListParams.modifiedAfter
            this.modifiedBefore = campaignListParams.modifiedBefore
            this.pageSize = campaignListParams.pageSize
            this.remoteId = campaignListParams.remoteId
            additionalQueryParams(campaignListParams.additionalQueryParams)
            additionalHeaders(campaignListParams.additionalHeaders)
        }
