...
constructor(
    ...
    private val interviewId: String?,
    ...
    fun interviewId(): Optional<String> = Optional.ofNullable(interviewId)

    fun interviewerId(): Optional<String> = Optional.ofNullable(interviewerId)
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
        ...
        this.interviewId?.let { params.put("interview_id", listOf(it.toString())) }
        this.interviewerId?.let { params.put("interviewer_id", listOf(it.toString())) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScorecardListParams &&
            ...
            this.interviewerId == other.interviewerId &&
    ...
    override fun toString() =
        "ScorecardListParams{applicationId=$applicationId, createdAfter=$createdAfter, createdBefore=$createdBefore, cursor=$cursor, expand=$expand, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, interviewId=$interviewId, interviewerId=$interviewerId, modifiedAfter=$modifiedAfter, modifiedBefore=$modifiedBefore, pageSize=$pageSize, remoteFields=$remoteFields, remoteId=$remoteId, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        private var interviewerId: String? = null
        ...
        @JvmSynthetic
        internal fun from(scorecardListParams: ScorecardListParams) = apply {
            this.applicationId = scorecardListParams.applicationId
            this.createdAfter = scorecardListParams.createdAfter
            this.createdBefore = scorecardListParams.createdBefore
            this.cursor = scorecardListParams.cursor
            this.expand = scorecardListParams.expand
            this.includeDeletedData = scorecardListParams.includeDeletedData
            this.includeRemoteData = scorecardListParams.includeRemoteData
            this.interviewId = scorecardListParams.interviewId
            this.interviewerId = scorecardListParams.interviewerId
            this.modifiedAfter = scorecardListParams.modifiedAfter
            this.modifiedBefore = scorecardListParams.modifiedBefore
            this.pageSize = scorecardListParams.pageSize
            this.remoteFields = scorecardListParams.remoteFields
            this.remoteId = scorecardListParams.remoteId
            this.showEnumOrigins = scorecardListParams.showEnumOrigins
            additionalQueryParams(scorecardListParams.additionalQueryParams)
            additionalHeaders(scorecardListParams.additionalHeaders)
        }
        ...
        fun interviewId(interviewId: String) = apply { this.interviewId = interviewId }

        /** If provided, will only return scorecards for this interviewer. */
        fun interviewerId(interviewerId: String) = apply { this.interviewerId = interviewerId }
