...
class CandidateListPageAsync
private constructor(
    private val candidatesService: CandidateServiceAsync,
    private val params: CandidateListParams,
    ...
    fun results(): List<Candidate> = response().results()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CandidateListPageAsync &&
    ...
    override fun toString() =
        "CandidateListPageAsync{candidatesService=$candidatesService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<CandidateListParams> {
        if (!hasNextPage()) {
            return Optional.empty()
        }

        return Optional.of(CandidateListParams.builder().from(params).cursor(next()).build())
    }

    fun getNextPage(): CompletableFuture<Optional<CandidateListPageAsync>> {
    ...
    constructor(
        ...
        private val results: JsonField<List<Candidate>>,
        ...
        fun results(): List<Candidate> = results.getRequired("results")
        ...
        fun _results(): Optional<JsonField<List<Candidate>>> = Optional.ofNullable(results)
        ...
        override fun toString() =
            "CandidateListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var results: JsonField<List<Candidate>> = JsonMissing.of()
            ...
            fun results(results: List<Candidate>) = results(JsonField.of(results))

            @JsonProperty("results")
            fun results(results: JsonField<List<Candidate>>) = apply { this.results = results }
    ...
    class AutoPager
    constructor(
        private val firstPage: CandidateListPageAsync,
    ) {

        fun forEach(action: Predicate<Candidate>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<CandidateListPageAsync>>.forEach(
