...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RejectReasonListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(rejectReasonListParams: RejectReasonListParams) = apply {
            this.createdAfter = rejectReasonListParams.createdAfter
            this.createdBefore = rejectReasonListParams.createdBefore
            this.cursor = rejectReasonListParams.cursor
            this.includeDeletedData = rejectReasonListParams.includeDeletedData
            this.includeRemoteData = rejectReasonListParams.includeRemoteData
            this.modifiedAfter = rejectReasonListParams.modifiedAfter
            this.modifiedBefore = rejectReasonListParams.modifiedBefore
            this.pageSize = rejectReasonListParams.pageSize
            this.remoteId = rejectReasonListParams.remoteId
            additionalQueryParams(rejectReasonListParams.additionalQueryParams)
            additionalHeaders(rejectReasonListParams.additionalHeaders)
        }
        ...
        fun build(): RejectReasonListParams =
            RejectReasonListParams(
                createdAfter,
                createdBefore,
                cursor,
