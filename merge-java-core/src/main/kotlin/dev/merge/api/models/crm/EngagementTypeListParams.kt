...
class EngagementTypeListParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EngagementTypeListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(engagementTypeListParams: EngagementTypeListParams) = apply {
            this.createdAfter = engagementTypeListParams.createdAfter
            this.createdBefore = engagementTypeListParams.createdBefore
            this.cursor = engagementTypeListParams.cursor
            this.includeDeletedData = engagementTypeListParams.includeDeletedData
            this.includeRemoteData = engagementTypeListParams.includeRemoteData
            this.includeRemoteFields = engagementTypeListParams.includeRemoteFields
            this.modifiedAfter = engagementTypeListParams.modifiedAfter
            this.modifiedBefore = engagementTypeListParams.modifiedBefore
            this.pageSize = engagementTypeListParams.pageSize
            this.remoteId = engagementTypeListParams.remoteId
            additionalQueryParams(engagementTypeListParams.additionalQueryParams)
            additionalHeaders(engagementTypeListParams.additionalHeaders)
        }
        ...
        fun build(): EngagementTypeListParams =
            EngagementTypeListParams(
                createdAfter,
                createdBefore,
                cursor,
                includeDeletedData,
