...
class CustomObjectClassAssociationTypeListParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomObjectClassAssociationTypeListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(
            customObjectClassAssociationTypeListParams: CustomObjectClassAssociationTypeListParams
        ) = apply {
            this.customObjectClassId =
                customObjectClassAssociationTypeListParams.customObjectClassId
            this.createdAfter = customObjectClassAssociationTypeListParams.createdAfter
            this.createdBefore = customObjectClassAssociationTypeListParams.createdBefore
            this.cursor = customObjectClassAssociationTypeListParams.cursor
            this.expand = customObjectClassAssociationTypeListParams.expand
            this.includeDeletedData = customObjectClassAssociationTypeListParams.includeDeletedData
            this.includeRemoteData = customObjectClassAssociationTypeListParams.includeRemoteData
            this.modifiedAfter = customObjectClassAssociationTypeListParams.modifiedAfter
            this.modifiedBefore = customObjectClassAssociationTypeListParams.modifiedBefore
            this.pageSize = customObjectClassAssociationTypeListParams.pageSize
            this.remoteId = customObjectClassAssociationTypeListParams.remoteId
            additionalQueryParams(customObjectClassAssociationTypeListParams.additionalQueryParams)
            additionalHeaders(customObjectClassAssociationTypeListParams.additionalHeaders)
        }
        ...
        fun build(): CustomObjectClassAssociationTypeListParams =
            CustomObjectClassAssociationTypeListParams(
