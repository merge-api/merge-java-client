...
private constructor(
    ...
    fun results(): List<Transaction> = response().results()
    ...
    fun getNextPageParams(): Optional<TransactionListParams> {
        ...
        return Optional.of(TransactionListParams.builder().from(params).cursor(next()).build())
    }
    ...
    constructor(
        ...
        private val results: JsonField<List<Transaction>>,
        ...
        fun results(): List<Transaction> = results.getRequired("results")
        ...
        fun _results(): Optional<JsonField<List<Transaction>>> = Optional.ofNullable(results)
        ...
        override fun toString() =
            "TransactionListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var results: JsonField<List<Transaction>> = JsonMissing.of()
            ...
            fun results(results: List<Transaction>) = results(JsonField.of(results))

            @JsonProperty("results")
            fun results(results: JsonField<List<Transaction>>) = apply { this.results = results }
