...
private constructor(
    ...
    fun results(): List<Payment> = response().results()
    ...
    fun getNextPageParams(): Optional<PaymentListParams> {
        ...
        return Optional.of(PaymentListParams.builder().from(params).cursor(next()).build())
    }
    ...
    constructor(
        ...
        private val results: JsonField<List<Payment>>,
        ...
        fun results(): List<Payment> = results.getRequired("results")
        ...
        fun _results(): Optional<JsonField<List<Payment>>> = Optional.ofNullable(results)
        ...
        override fun toString() =
            "PaymentListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var results: JsonField<List<Payment>> = JsonMissing.of()
            ...
            fun results(results: List<Payment>) = results(JsonField.of(results))

            @JsonProperty("results")
            fun results(results: JsonField<List<Payment>>) = apply { this.results = results }
