...
private constructor(
    private val model: JsonField<Engagement>,
     ...
     * TODO
     */
    fun model(): Engagement = model.getRequired("model")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EngagementResponse &&
    ...
    override fun toString() =
        "EngagementResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Engagement> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(engagementResponse: EngagementResponse) = apply {
            this.model = engagementResponse.model
            this.warnings = engagementResponse.warnings
            this.errors = engagementResponse.errors
            this.logs = engagementResponse.logs
            additionalProperties(engagementResponse.additionalProperties)
        }
         ...
         * TODO
         */
        fun model(model: Engagement) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Engagement>) = apply { this.model = model }
