...
class AccountListRemoteFieldClassesPageAsync
private constructor(
    private val accountsService: AccountServiceAsync,
    private val params: AccountListRemoteFieldClassesParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountListRemoteFieldClassesPageAsync &&
    ...
    override fun toString() =
        "AccountListRemoteFieldClassesPageAsync{accountsService=$accountsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<AccountListRemoteFieldClassesParams> {
        if (!hasNextPage()) {
            return Optional.empty()
        }

        return Optional.of(
            AccountListRemoteFieldClassesParams.builder().from(params).cursor(next()).build()
        )
    }

    fun getNextPage(): CompletableFuture<Optional<AccountListRemoteFieldClassesPageAsync>> {
        return getNextPageParams()
            .map { accountsService.listRemoteFieldClasses(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        fun of(
            ...
            AccountListRemoteFieldClassesPageAsync(
                accountsService,
                params,
                response,
            )
    ...
    constructor(
        ...
        override fun toString() =
            "AccountListRemoteFieldClassesPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: AccountListRemoteFieldClassesPageAsync,
    ) {
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<AccountListRemoteFieldClassesPageAsync>>.forEach(
