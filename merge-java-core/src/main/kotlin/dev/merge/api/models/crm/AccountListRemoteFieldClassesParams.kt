...
class AccountListRemoteFieldClassesParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountListRemoteFieldClassesParams &&
    ...
    override fun toString() =
        "AccountListRemoteFieldClassesParams{cursor=$cursor, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(
            accountListRemoteFieldClassesParams: AccountListRemoteFieldClassesParams
        ) = apply {
            this.cursor = accountListRemoteFieldClassesParams.cursor
            this.includeDeletedData = accountListRemoteFieldClassesParams.includeDeletedData
            this.includeRemoteData = accountListRemoteFieldClassesParams.includeRemoteData
            this.includeRemoteFields = accountListRemoteFieldClassesParams.includeRemoteFields
            this.pageSize = accountListRemoteFieldClassesParams.pageSize
            additionalQueryParams(accountListRemoteFieldClassesParams.additionalQueryParams)
            additionalHeaders(accountListRemoteFieldClassesParams.additionalHeaders)
        }
        ...
        fun build(): AccountListRemoteFieldClassesParams =
            AccountListRemoteFieldClassesParams(
                cursor,
                includeDeletedData,
                includeRemoteData,
                includeRemoteFields,
