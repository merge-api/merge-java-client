...
class NoteListRemoteFieldClassesPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NoteListRemoteFieldClassesPage &&
    ...
    override fun toString() =
        "NoteListRemoteFieldClassesPage{notesService=$notesService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<NoteListRemoteFieldClassesParams> {
        ...
        return Optional.of(
            NoteListRemoteFieldClassesParams.builder()
                .from(params)
    ...
    fun getNextPage(): Optional<NoteListRemoteFieldClassesPage> {
        return getNextPageParams().map { notesService.listRemoteFieldClasses(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "NoteListRemoteFieldClassesPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: NoteListRemoteFieldClassesPage,
