...
private constructor(
    ...
    fun results(): List<Item> = response().results()
    ...
    fun getNextPageParams(): Optional<ItemListParams> {
        ...
        return Optional.of(ItemListParams.builder().from(params).cursor(next()).build())
    }
    ...
    constructor(
        ...
        private val results: JsonField<List<Item>>,
        ...
        fun results(): List<Item> = results.getRequired("results")
        ...
        fun _results(): Optional<JsonField<List<Item>>> = Optional.ofNullable(results)
        ...
        override fun toString() =
            "ItemListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var results: JsonField<List<Item>> = JsonMissing.of()
            ...
            fun results(results: List<Item>) = results(JsonField.of(results))

            @JsonProperty("results")
            fun results(results: JsonField<List<Item>>) = apply { this.results = results }
