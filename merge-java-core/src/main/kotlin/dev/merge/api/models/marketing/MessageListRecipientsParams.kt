...
class MessageListRecipientsParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageListRecipientsParams &&
    ...
    override fun toString() =
        "MessageListRecipientsParams{parentId=$parentId, cursor=$cursor, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(messageListRecipientsParams: MessageListRecipientsParams) = apply {
            this.parentId = messageListRecipientsParams.parentId
            this.cursor = messageListRecipientsParams.cursor
            this.includeDeletedData = messageListRecipientsParams.includeDeletedData
            this.includeRemoteData = messageListRecipientsParams.includeRemoteData
            this.pageSize = messageListRecipientsParams.pageSize
            additionalQueryParams(messageListRecipientsParams.additionalQueryParams)
            additionalHeaders(messageListRecipientsParams.additionalHeaders)
        }
        ...
        fun build(): MessageListRecipientsParams =
            MessageListRecipientsParams(
