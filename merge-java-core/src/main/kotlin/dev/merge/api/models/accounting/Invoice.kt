...
class Invoice
private constructor(
    private val type: JsonField<InvoiceTypeEnum>,
    ...
    private val paidOnDate: JsonField<OffsetDateTime>,
    ...
    private val totalDiscount: JsonField<Double>,
    ...
    private val lineItems: JsonField<List<InvoiceLineItem>>,
     ...
     */
    fun type(): Optional<InvoiceTypeEnum> = Optional.ofNullable(type.getNullable("type"))
    ...
    fun paidOnDate(): Optional<OffsetDateTime> =
        Optional.ofNullable(paidOnDate.getNullable("paid_on_date"))
    ...
    fun totalDiscount(): Optional<Double> =
        Optional.ofNullable(totalDiscount.getNullable("total_discount"))

    /** The total amount being paid before taxes. */
    fun subTotal(): Optional<Double> = Optional.ofNullable(subTotal.getNullable("sub_total"))
    ...
    fun lineItems(): Optional<List<InvoiceLineItem>> =
    ...
    /** The invoice's paid date. */
    @JsonProperty("paid_on_date") @ExcludeMissing fun _paidOnDate() = paidOnDate
    ...
    /** The total discounts applied to the total cost. */
    @JsonProperty("total_discount") @ExcludeMissing fun _totalDiscount() = totalDiscount

    /** The total amount being paid before taxes. */
    @JsonProperty("sub_total") @ExcludeMissing fun _subTotal() = subTotal

    /** The total amount being paid in taxes. */
    @JsonProperty("total_tax_amount") @ExcludeMissing fun _totalTaxAmount() = totalTaxAmount
    ...
    override fun toString() =
        "Invoice{type=$type, contact=$contact, number=$number, issueDate=$issueDate, dueDate=$dueDate, paidOnDate=$paidOnDate, memo=$memo, company=$company, currency=$currency, exchangeRate=$exchangeRate, totalDiscount=$totalDiscount, subTotal=$subTotal, totalTaxAmount=$totalTaxAmount, totalAmount=$totalAmount, balance=$balance, remoteUpdatedAt=$remoteUpdatedAt, payments=$payments, lineItems=$lineItems, trackingCategories=$trackingCategories, remoteWasDeleted=$remoteWasDeleted, id=$id, remoteId=$remoteId, fieldMappings=$fieldMappings, modifiedAt=$modifiedAt, remoteData=$remoteData, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var type: JsonField<InvoiceTypeEnum> = JsonMissing.of()
        ...
        private var paidOnDate: JsonField<OffsetDateTime> = JsonMissing.of()
        ...
        private var totalDiscount: JsonField<Double> = JsonMissing.of()
        ...
        private var lineItems: JsonField<List<InvoiceLineItem>> = JsonMissing.of()
        ...
        internal fun from(invoice: Invoice) = apply {
            ...
            this.paidOnDate = invoice.paidOnDate
            ...
            this.remoteUpdatedAt = invoice.remoteUpdatedAt
            this.payments = invoice.payments
            this.lineItems = invoice.lineItems
            this.trackingCategories = invoice.trackingCategories
            this.remoteWasDeleted = invoice.remoteWasDeleted
            this.id = invoice.id
            this.remoteId = invoice.remoteId
            this.fieldMappings = invoice.fieldMappings
            this.modifiedAt = invoice.modifiedAt
            this.remoteData = invoice.remoteData
         ...
         * - `ACCOUNTS_PAYABLE` - ACCOUNTS_PAYABLE
         */
        fun type(type: InvoiceTypeEnum) = type(JsonField.of(type))
        ...
        @JsonProperty("type")
        @ExcludeMissing
        fun type(type: JsonField<InvoiceTypeEnum>) = apply { this.type = type }
        ...
        /** The invoice's paid date. */
        fun paidOnDate(paidOnDate: OffsetDateTime) = paidOnDate(JsonField.of(paidOnDate))

        /** The invoice's paid date. */
        @JsonProperty("paid_on_date")
        @ExcludeMissing
        fun paidOnDate(paidOnDate: JsonField<OffsetDateTime>) = apply {
        ...
        /** The total discounts applied to the total cost. */
        fun totalDiscount(totalDiscount: Double) = totalDiscount(JsonField.of(totalDiscount))

        /** The total discounts applied to the total cost. */
        @JsonProperty("total_discount")
        @ExcludeMissing
        fun totalDiscount(totalDiscount: JsonField<Double>) = apply {
        ...
        /** The total amount being paid in taxes. */
        fun totalTaxAmount(totalTaxAmount: Double) = totalTaxAmount(JsonField.of(totalTaxAmount))
        ...
        fun lineItems(lineItems: List<InvoiceLineItem>) = lineItems(JsonField.of(lineItems))

        @JsonProperty("line_items")
        @ExcludeMissing
        fun lineItems(lineItems: JsonField<List<InvoiceLineItem>>) = apply {
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val ACCOUNTS_RECEIVABLE = InvoiceTypeEnum(JsonField.of("ACCOUNTS_RECEIVABLE"))
     ...
     * ### Description
     *
     * The `InvoiceLineItem` object represents an itemized record of goods and/or services sold to a
     * customer.
     *
     * ### Usage Example
     *
    ...
    private constructor(
        ...
        override fun toString() =
            "InvoiceLineItem{remoteId=$remoteId, description=$description, unitPrice=$unitPrice, quantity=$quantity, totalAmount=$totalAmount, currency=$currency, exchangeRate=$exchangeRate, item=$item, account=$account, trackingCategory=$trackingCategory, trackingCategories=$trackingCategories, company=$company, id=$id, fieldMappings=$fieldMappings, modifiedAt=$modifiedAt, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(invoiceLineItem: InvoiceLineItem) = apply {
                this.remoteId = invoiceLineItem.remoteId
                this.description = invoiceLineItem.description
                this.unitPrice = invoiceLineItem.unitPrice
                this.quantity = invoiceLineItem.quantity
                this.totalAmount = invoiceLineItem.totalAmount
                this.currency = invoiceLineItem.currency
                this.exchangeRate = invoiceLineItem.exchangeRate
                this.item = invoiceLineItem.item
                this.account = invoiceLineItem.account
                this.trackingCategory = invoiceLineItem.trackingCategory
                this.trackingCategories = invoiceLineItem.trackingCategories
                this.company = invoiceLineItem.company
                this.id = invoiceLineItem.id
                this.fieldMappings = invoiceLineItem.fieldMappings
                this.modifiedAt = invoiceLineItem.modifiedAt
            ...
            @JsonProperty("total_amount")
            @ExcludeMissing
            fun totalAmount(totalAmount: JsonField<Double>) = apply {
