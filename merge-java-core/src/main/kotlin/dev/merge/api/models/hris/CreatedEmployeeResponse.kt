...
@JsonDeserialize(builder = CreatedEmployeeResponse.Builder::class)
@NoAutoDetect
class CreatedEmployeeResponse
private constructor(
    private val model: JsonField<Employee>,
     ...
     */
    fun model(): Employee = model.getRequired("model")
    ...
    fun validate(): CreatedEmployeeResponse = apply {
        if (!validated) {
            model().validate()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreatedEmployeeResponse &&
    ...
    override fun toString() =
        "CreatedEmployeeResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Employee> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(createdEmployeeResponse: CreatedEmployeeResponse) = apply {
            this.model = createdEmployeeResponse.model
            this.warnings = createdEmployeeResponse.warnings
            this.errors = createdEmployeeResponse.errors
            this.logs = createdEmployeeResponse.logs
            additionalProperties(createdEmployeeResponse.additionalProperties)
        }
         ...
         * Fetch from the `LIST Employee` endpoint and filter by `ID` to show all employees.
         */
        fun model(model: Employee) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Employee>) = apply { this.model = model }
        ...
        fun build(): CreatedEmployeeResponse =
