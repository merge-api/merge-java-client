...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CandidateListPage &&
    ...
    override fun toString() =
        "CandidateListPage{candidatesService=$candidatesService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<CandidateListPage> {
    ...
    constructor(
        ...
        override fun toString() =
            "CandidateListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: CandidateListPage,
    ) : Iterable<Candidate> {
