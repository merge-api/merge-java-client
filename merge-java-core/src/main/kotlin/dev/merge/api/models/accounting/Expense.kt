 ...
 * ### Description
 *
 * The `Expense` object is used to represent a purchase made from a business which can be made with
 * a check, credit card, or cash. Each expense object is dedicated to a grouping of expenses, with
 * each expense recorded in the lines object.
 *
 * ### Usage Example
 *
...
private constructor(
    ...
    private val lines: JsonField<List<ExpenseLine>>,
    ...
    fun lines(): Optional<List<ExpenseLine>> = Optional.ofNullable(lines.getNullable("lines"))
    ...
    override fun toString() =
        "Expense{transactionDate=$transactionDate, remoteCreatedAt=$remoteCreatedAt, account=$account, contact=$contact, totalAmount=$totalAmount, currency=$currency, exchangeRate=$exchangeRate, company=$company, memo=$memo, lines=$lines, trackingCategories=$trackingCategories, remoteWasDeleted=$remoteWasDeleted, id=$id, remoteId=$remoteId, fieldMappings=$fieldMappings, modifiedAt=$modifiedAt, remoteData=$remoteData, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var lines: JsonField<List<ExpenseLine>> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(expense: Expense) = apply {
            this.transactionDate = expense.transactionDate
            this.remoteCreatedAt = expense.remoteCreatedAt
            this.account = expense.account
            this.contact = expense.contact
            this.totalAmount = expense.totalAmount
            this.currency = expense.currency
            this.exchangeRate = expense.exchangeRate
            this.company = expense.company
            this.memo = expense.memo
            this.lines = expense.lines
            this.trackingCategories = expense.trackingCategories
            this.remoteWasDeleted = expense.remoteWasDeleted
            this.id = expense.id
            this.remoteId = expense.remoteId
            this.fieldMappings = expense.fieldMappings
            this.modifiedAt = expense.modifiedAt
            this.remoteData = expense.remoteData
            additionalProperties(expense.additionalProperties)
        }
        ...
        fun lines(lines: List<ExpenseLine>) = lines(JsonField.of(lines))

        @JsonProperty("lines")
        @ExcludeMissing
        fun lines(lines: JsonField<List<ExpenseLine>>) = apply { this.lines = lines }
    ...
    private constructor(
        ...
        override fun toString() =
            "ExpenseLine{remoteId=$remoteId, item=$item, netAmount=$netAmount, trackingCategory=$trackingCategory, trackingCategories=$trackingCategories, company=$company, account=$account, contact=$contact, description=$description, exchangeRate=$exchangeRate, modifiedAt=$modifiedAt, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JvmSynthetic
            internal fun from(expenseLine: ExpenseLine) = apply {
                this.remoteId = expenseLine.remoteId
                this.item = expenseLine.item
                this.netAmount = expenseLine.netAmount
                this.trackingCategory = expenseLine.trackingCategory
                this.trackingCategories = expenseLine.trackingCategories
                this.company = expenseLine.company
                this.account = expenseLine.account
                this.contact = expenseLine.contact
                this.description = expenseLine.description
                this.exchangeRate = expenseLine.exchangeRate
                this.modifiedAt = expenseLine.modifiedAt
                additionalProperties(expenseLine.additionalProperties)
            }
