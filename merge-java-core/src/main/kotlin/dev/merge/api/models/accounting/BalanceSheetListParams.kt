...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BalanceSheetListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(balanceSheetListParams: BalanceSheetListParams) = apply {
            this.companyId = balanceSheetListParams.companyId
            this.createdAfter = balanceSheetListParams.createdAfter
            this.createdBefore = balanceSheetListParams.createdBefore
            this.cursor = balanceSheetListParams.cursor
            this.expand = balanceSheetListParams.expand
            this.includeDeletedData = balanceSheetListParams.includeDeletedData
            this.includeRemoteData = balanceSheetListParams.includeRemoteData
            this.modifiedAfter = balanceSheetListParams.modifiedAfter
            this.modifiedBefore = balanceSheetListParams.modifiedBefore
            this.pageSize = balanceSheetListParams.pageSize
            this.remoteId = balanceSheetListParams.remoteId
            additionalQueryParams(balanceSheetListParams.additionalQueryParams)
            additionalHeaders(balanceSheetListParams.additionalHeaders)
        }
        ...
        fun build(): BalanceSheetListParams =
            BalanceSheetListParams(
                companyId,
                createdAfter,
                createdBefore,
                cursor,
