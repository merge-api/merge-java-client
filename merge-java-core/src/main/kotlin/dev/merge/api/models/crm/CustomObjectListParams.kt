...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomObjectListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(customObjectListParams: CustomObjectListParams) = apply {
            this.customObjectClassId = customObjectListParams.customObjectClassId
            this.createdAfter = customObjectListParams.createdAfter
            this.createdBefore = customObjectListParams.createdBefore
            this.cursor = customObjectListParams.cursor
            this.includeDeletedData = customObjectListParams.includeDeletedData
            this.includeRemoteData = customObjectListParams.includeRemoteData
            this.includeRemoteFields = customObjectListParams.includeRemoteFields
            this.modifiedAfter = customObjectListParams.modifiedAfter
            this.modifiedBefore = customObjectListParams.modifiedBefore
            this.pageSize = customObjectListParams.pageSize
            this.remoteId = customObjectListParams.remoteId
            additionalQueryParams(customObjectListParams.additionalQueryParams)
            additionalHeaders(customObjectListParams.additionalHeaders)
        }
        ...
        fun build(): CustomObjectListParams =
