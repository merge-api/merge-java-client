...
private constructor(
    ...
    private val classification: JsonField<ClassificationEnum>,
    private val type: JsonField<String>,
    private val status: JsonField<AccountStatusEnum>,
    private val currentBalance: JsonField<Double>,
    private val currency: JsonField<CurrencyEnum>,
    private val accountNumber: JsonField<String>,
    private val parentAccount: JsonField<String>,
    ...
    private val numberOfEmployees: JsonField<Long>,
     ...
     * - `REVENUE` - REVENUE
     */
    fun classification(): Optional<ClassificationEnum> =
        Optional.ofNullable(classification.getNullable("classification"))
     ...
     * - `INACTIVE` - INACTIVE
     */
    fun status(): Optional<AccountStatusEnum> = Optional.ofNullable(status.getNullable("status"))

    /** The account's current balance. */
    fun currentBalance(): Optional<Double> =
        Optional.ofNullable(currentBalance.getNullable("current_balance"))
    ...
    fun parentAccount(): Optional<String> =
        Optional.ofNullable(parentAccount.getNullable("parent_account"))
    ...
    fun domains(): Optional<List<String>> = Optional.ofNullable(domains.getNullable("domains"))

    /** The account's owner. */
    fun owner(): Optional<String> = Optional.ofNullable(owner.getNullable("owner"))

    /** The account's industry. */
    fun industry(): Optional<String> = Optional.ofNullable(industry.getNullable("industry"))

    /** The account's website. */
    fun website(): Optional<String> = Optional.ofNullable(website.getNullable("website"))

    /** The account's number of employees. */
    fun numberOfEmployees(): Optional<Long> =
        Optional.ofNullable(numberOfEmployees.getNullable("number_of_employees"))
    ...
    /**
     * The last date (either most recent or furthest in the future) of when an activity occurs in an
     * account.
     */
     ...
     * - `REVENUE` - REVENUE
     */
    @JsonProperty("classification") @ExcludeMissing fun _classification() = classification
    ...
    /** ID of the parent account. */
    @JsonProperty("parent_account") @ExcludeMissing fun _parentAccount() = parentAccount
    ...
    /** The account's domain names. */
    @JsonProperty("domains") @ExcludeMissing fun _domains() = domains
    ...
    @ExcludeMissing
    fun _numberOfEmployees() = numberOfEmployees
    ...
    override fun toString() =
        "Account{id=$id, remoteId=$remoteId, name=$name, description=$description, classification=$classification, type=$type, status=$status, currentBalance=$currentBalance, currency=$currency, accountNumber=$accountNumber, parentAccount=$parentAccount, company=$company, remoteWasDeleted=$remoteWasDeleted, fieldMappings=$fieldMappings, modifiedAt=$modifiedAt, remoteData=$remoteData, domains=$domains, owner=$owner, industry=$industry, website=$website, numberOfEmployees=$numberOfEmployees, addresses=$addresses, phoneNumbers=$phoneNumbers, lastActivityAt=$lastActivityAt, remoteUpdatedAt=$remoteUpdatedAt, remoteCreatedAt=$remoteCreatedAt, remoteFields=$remoteFields, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var classification: JsonField<ClassificationEnum> = JsonMissing.of()
        private var type: JsonField<String> = JsonMissing.of()
        private var status: JsonField<AccountStatusEnum> = JsonMissing.of()
        private var currentBalance: JsonField<Double> = JsonMissing.of()
        private var currency: JsonField<CurrencyEnum> = JsonMissing.of()
        private var accountNumber: JsonField<String> = JsonMissing.of()
        private var parentAccount: JsonField<String> = JsonMissing.of()
        ...
        private var domains: JsonField<List<String>> = JsonMissing.of()
        private var owner: JsonField<String> = JsonMissing.of()
        private var industry: JsonField<String> = JsonMissing.of()
        private var website: JsonField<String> = JsonMissing.of()
        private var numberOfEmployees: JsonField<Long> = JsonMissing.of()
        ...
        internal fun from(account: Account) = apply {
            ...
            this.remoteWasDeleted = account.remoteWasDeleted
            this.fieldMappings = account.fieldMappings
            this.modifiedAt = account.modifiedAt
            this.remoteData = account.remoteData
            this.domains = account.domains
            ...
            this.remoteUpdatedAt = account.remoteUpdatedAt
            this.remoteCreatedAt = account.remoteCreatedAt
            this.remoteFields = account.remoteFields
         ...
         * - `REVENUE` - REVENUE
         */
        fun classification(classification: ClassificationEnum) =
        ...
        @ExcludeMissing
        fun classification(classification: JsonField<ClassificationEnum>) = apply {
         ...
         * - `INACTIVE` - INACTIVE
         */
        fun status(status: AccountStatusEnum) = status(JsonField.of(status))
        ...
        @JsonProperty("status")
        @ExcludeMissing
        fun status(status: JsonField<AccountStatusEnum>) = apply { this.status = status }

        /** The account's current balance. */
        fun currentBalance(currentBalance: Double) = currentBalance(JsonField.of(currentBalance))
        ...
        /** ID of the parent account. */
        fun parentAccount(parentAccount: String) = parentAccount(JsonField.of(parentAccount))

        /** ID of the parent account. */
        @JsonProperty("parent_account")
        @ExcludeMissing
        fun parentAccount(parentAccount: JsonField<String>) = apply {
        ...
        @ExcludeMissing
        fun domains(domains: JsonField<List<String>>) = apply { this.domains = domains }
        ...
        /** The account's number of employees. */
        fun numberOfEmployees(numberOfEmployees: Long) =
            numberOfEmployees(JsonField.of(numberOfEmployees))

        /** The account's number of employees. */
        @JsonProperty("number_of_employees")
        @ExcludeMissing
        fun numberOfEmployees(numberOfEmployees: JsonField<Long>) = apply {
