...
class EngagementListRemoteFieldClassesPageAsync
private constructor(
    private val engagementsService: EngagementServiceAsync,
    private val params: EngagementListRemoteFieldClassesParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EngagementListRemoteFieldClassesPageAsync &&
    ...
    override fun toString() =
        "EngagementListRemoteFieldClassesPageAsync{engagementsService=$engagementsService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<EngagementListRemoteFieldClassesPageAsync>> {
        return getNextPageParams()
            .map { engagementsService.listRemoteFieldClasses(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        fun of(
            ...
            EngagementListRemoteFieldClassesPageAsync(
                engagementsService,
                params,
                response,
            )
    ...
    constructor(
        ...
        override fun toString() =
            "EngagementListRemoteFieldClassesPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: EngagementListRemoteFieldClassesPageAsync,
    ) {
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<EngagementListRemoteFieldClassesPageAsync>>.forEach(
