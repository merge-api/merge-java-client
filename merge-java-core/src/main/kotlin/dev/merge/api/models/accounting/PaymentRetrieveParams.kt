...
constructor(
    ...
    override fun toString() =
        "PaymentRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(paymentRetrieveParams: PaymentRetrieveParams) = apply {
            this.id = paymentRetrieveParams.id
            this.expand = paymentRetrieveParams.expand
            this.includeRemoteData = paymentRetrieveParams.includeRemoteData
            additionalQueryParams(paymentRetrieveParams.additionalQueryParams)
            additionalHeaders(paymentRetrieveParams.additionalHeaders)
        }
