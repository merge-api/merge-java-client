...
class EventListContactsPage
private constructor(
    private val eventsService: EventService,
    private val params: EventListContactsParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventListContactsPage &&
    ...
    override fun toString() =
        "EventListContactsPage{eventsService=$eventsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<EventListContactsParams> {
        if (!hasNextPage()) {
            return Optional.empty()
        }

        return Optional.of(EventListContactsParams.builder().from(params).cursor(next()).build())
    }

    fun getNextPage(): Optional<EventListContactsPage> {
        return getNextPageParams().map { eventsService.listContacts(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(eventsService: EventService, params: EventListContactsParams, response: Response) =
    ...
    constructor(
        ...
        override fun toString() =
            "EventListContactsPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: EventListContactsPage,
    ) : Iterable<Contact> {
