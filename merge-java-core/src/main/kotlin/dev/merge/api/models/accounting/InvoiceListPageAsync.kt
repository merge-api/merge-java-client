...
private constructor(
    ...
    fun results(): List<Invoice> = response().results()
    ...
    fun getNextPageParams(): Optional<InvoiceListParams> {
        ...
        return Optional.of(InvoiceListParams.builder().from(params).cursor(next()).build())
    }
    ...
    constructor(
        ...
        private val results: JsonField<List<Invoice>>,
        ...
        fun results(): List<Invoice> = results.getRequired("results")
        ...
        fun _results(): Optional<JsonField<List<Invoice>>> = Optional.ofNullable(results)
        ...
        override fun toString() =
            "InvoiceListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var results: JsonField<List<Invoice>> = JsonMissing.of()
            ...
            fun results(results: List<Invoice>) = results(JsonField.of(results))

            @JsonProperty("results")
            fun results(results: JsonField<List<Invoice>>) = apply { this.results = results }
