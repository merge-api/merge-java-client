...
class LeadListRemoteFieldClassesPageAsync
private constructor(
    private val leadsService: LeadServiceAsync,
    private val params: LeadListRemoteFieldClassesParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LeadListRemoteFieldClassesPageAsync &&
    ...
    override fun toString() =
        "LeadListRemoteFieldClassesPageAsync{leadsService=$leadsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<LeadListRemoteFieldClassesParams> {
        if (!hasNextPage()) {
            return Optional.empty()
        }

        return Optional.of(
            LeadListRemoteFieldClassesParams.builder().from(params).cursor(next()).build()
        )
    }

    fun getNextPage(): CompletableFuture<Optional<LeadListRemoteFieldClassesPageAsync>> {
        return getNextPageParams()
            .map { leadsService.listRemoteFieldClasses(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(
            leadsService: LeadServiceAsync,
            params: LeadListRemoteFieldClassesParams,
            response: Response
        ) =
            LeadListRemoteFieldClassesPageAsync(
                leadsService,
                params,
                response,
            )
    ...
    constructor(
        ...
        override fun toString() =
            "LeadListRemoteFieldClassesPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: LeadListRemoteFieldClassesPageAsync,
    ) {
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<LeadListRemoteFieldClassesPageAsync>>.forEach(
