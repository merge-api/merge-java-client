...
class TrackingCategoryRetrieveParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TrackingCategoryRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "TrackingCategoryRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(trackingCategoryRetrieveParams: TrackingCategoryRetrieveParams) = apply {
            this.id = trackingCategoryRetrieveParams.id
            this.expand = trackingCategoryRetrieveParams.expand
            this.includeRemoteData = trackingCategoryRetrieveParams.includeRemoteData
            this.remoteFields = trackingCategoryRetrieveParams.remoteFields
            this.showEnumOrigins = trackingCategoryRetrieveParams.showEnumOrigins
            additionalQueryParams(trackingCategoryRetrieveParams.additionalQueryParams)
            additionalHeaders(trackingCategoryRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): TrackingCategoryRetrieveParams =
            TrackingCategoryRetrieveParams(
