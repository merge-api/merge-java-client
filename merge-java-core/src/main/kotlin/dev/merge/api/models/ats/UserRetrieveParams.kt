...
constructor(
    ...
    override fun toString() =
        "UserRetrieveParams{id=$id, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(userRetrieveParams: UserRetrieveParams) = apply {
            ...
            this.includeRemoteData = userRetrieveParams.includeRemoteData
            this.remoteFields = userRetrieveParams.remoteFields
            this.showEnumOrigins = userRetrieveParams.showEnumOrigins
