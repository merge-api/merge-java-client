...
constructor(
    ...
    override fun toString() =
        "GroupRetrieveParams{id=$id, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(groupRetrieveParams: GroupRetrieveParams) = apply {
            this.id = groupRetrieveParams.id
            this.includeRemoteData = groupRetrieveParams.includeRemoteData
            this.remoteFields = groupRetrieveParams.remoteFields
            this.showEnumOrigins = groupRetrieveParams.showEnumOrigins
