...
class UserListRemoteFieldClassesPageAsync
private constructor(
    private val usersService: UserServiceAsync,
    private val params: UserListRemoteFieldClassesParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserListRemoteFieldClassesPageAsync &&
    ...
    override fun toString() =
        "UserListRemoteFieldClassesPageAsync{usersService=$usersService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<UserListRemoteFieldClassesParams> {
        if (!hasNextPage()) {
            return Optional.empty()
        }

        return Optional.of(
            UserListRemoteFieldClassesParams.builder().from(params).cursor(next()).build()
        )
    }

    fun getNextPage(): CompletableFuture<Optional<UserListRemoteFieldClassesPageAsync>> {
        return getNextPageParams()
            .map { usersService.listRemoteFieldClasses(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        fun of(
            ...
            UserListRemoteFieldClassesPageAsync(
                usersService,
                params,
                response,
            )
    ...
    constructor(
        ...
        override fun toString() =
            "UserListRemoteFieldClassesPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: UserListRemoteFieldClassesPageAsync,
    ) {
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<UserListRemoteFieldClassesPageAsync>>.forEach(
