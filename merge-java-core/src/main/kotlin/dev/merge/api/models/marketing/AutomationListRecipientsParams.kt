...
class AutomationListRecipientsParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutomationListRecipientsParams &&
    ...
    override fun toString() =
        "AutomationListRecipientsParams{parentId=$parentId, cursor=$cursor, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(automationListRecipientsParams: AutomationListRecipientsParams) = apply {
            this.parentId = automationListRecipientsParams.parentId
            this.cursor = automationListRecipientsParams.cursor
            this.includeDeletedData = automationListRecipientsParams.includeDeletedData
            this.includeRemoteData = automationListRecipientsParams.includeRemoteData
            this.pageSize = automationListRecipientsParams.pageSize
            additionalQueryParams(automationListRecipientsParams.additionalQueryParams)
            additionalHeaders(automationListRecipientsParams.additionalHeaders)
        }
        ...
        fun build(): AutomationListRecipientsParams =
            AutomationListRecipientsParams(
