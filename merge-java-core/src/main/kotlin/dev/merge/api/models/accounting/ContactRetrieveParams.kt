...
constructor(
    ...
    override fun toString() =
        "ContactRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(contactRetrieveParams: ContactRetrieveParams) = apply {
            this.id = contactRetrieveParams.id
            this.expand = contactRetrieveParams.expand
            this.includeRemoteData = contactRetrieveParams.includeRemoteData
            this.remoteFields = contactRetrieveParams.remoteFields
            this.showEnumOrigins = contactRetrieveParams.showEnumOrigins
            additionalQueryParams(contactRetrieveParams.additionalQueryParams)
            additionalHeaders(contactRetrieveParams.additionalHeaders)
        }
