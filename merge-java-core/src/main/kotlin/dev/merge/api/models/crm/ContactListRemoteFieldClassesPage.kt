...
class ContactListRemoteFieldClassesPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContactListRemoteFieldClassesPage &&
    ...
    override fun toString() =
        "ContactListRemoteFieldClassesPage{contactsService=$contactsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<ContactListRemoteFieldClassesPage> {
        return getNextPageParams().map { contactsService.listRemoteFieldClasses(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "ContactListRemoteFieldClassesPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: ContactListRemoteFieldClassesPage,
