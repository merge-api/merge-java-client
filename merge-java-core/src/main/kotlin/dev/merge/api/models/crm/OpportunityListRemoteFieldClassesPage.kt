...
class OpportunityListRemoteFieldClassesPage
private constructor(
    private val opportunitiesService: OpportunityService,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OpportunityListRemoteFieldClassesPage &&
    ...
    override fun toString() =
        "OpportunityListRemoteFieldClassesPage{opportunitiesService=$opportunitiesService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<OpportunityListRemoteFieldClassesPage> {
        return getNextPageParams().map { opportunitiesService.listRemoteFieldClasses(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(
            opportunitiesService: OpportunityService,
    ...
    constructor(
        ...
        override fun toString() =
            "OpportunityListRemoteFieldClassesPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: OpportunityListRemoteFieldClassesPage,
