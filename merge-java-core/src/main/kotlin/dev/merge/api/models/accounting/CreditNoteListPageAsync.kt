...
private constructor(
    ...
    fun results(): List<CreditNote> = response().results()
    ...
    fun getNextPageParams(): Optional<CreditNoteListParams> {
        ...
        return Optional.of(CreditNoteListParams.builder().from(params).cursor(next()).build())
    }
    ...
    constructor(
        ...
        private val results: JsonField<List<CreditNote>>,
        ...
        fun results(): List<CreditNote> = results.getRequired("results")
        ...
        fun _results(): Optional<JsonField<List<CreditNote>>> = Optional.ofNullable(results)
        ...
        override fun toString() =
            "CreditNoteListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var results: JsonField<List<CreditNote>> = JsonMissing.of()
            ...
            fun results(results: List<CreditNote>) = results(JsonField.of(results))

            @JsonProperty("results")
            fun results(results: JsonField<List<CreditNote>>) = apply { this.results = results }
