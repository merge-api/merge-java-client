...
constructor(
    ...
    override fun toString() =
        "CompanyRetrieveParams{id=$id, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(companyRetrieveParams: CompanyRetrieveParams) = apply {
            this.id = companyRetrieveParams.id
            this.includeRemoteData = companyRetrieveParams.includeRemoteData
            additionalQueryParams(companyRetrieveParams.additionalQueryParams)
            additionalHeaders(companyRetrieveParams.additionalHeaders)
        }
