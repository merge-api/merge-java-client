...
class ContactListListSubscribersParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContactListListSubscribersParams &&
    ...
    override fun toString() =
        "ContactListListSubscribersParams{parentId=$parentId, cursor=$cursor, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(contactListListSubscribersParams: ContactListListSubscribersParams) =
            apply {
                this.parentId = contactListListSubscribersParams.parentId
                this.cursor = contactListListSubscribersParams.cursor
                this.includeDeletedData = contactListListSubscribersParams.includeDeletedData
                this.includeRemoteData = contactListListSubscribersParams.includeRemoteData
                this.pageSize = contactListListSubscribersParams.pageSize
                additionalQueryParams(contactListListSubscribersParams.additionalQueryParams)
                additionalHeaders(contactListListSubscribersParams.additionalHeaders)
            }
        ...
        fun build(): ContactListListSubscribersParams =
            ContactListListSubscribersParams(
