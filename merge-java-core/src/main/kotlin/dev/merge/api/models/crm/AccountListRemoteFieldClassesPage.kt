...
class AccountListRemoteFieldClassesPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountListRemoteFieldClassesPage &&
    ...
    override fun toString() =
        "AccountListRemoteFieldClassesPage{accountsService=$accountsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<AccountListRemoteFieldClassesPage> {
        return getNextPageParams().map { accountsService.listRemoteFieldClasses(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "AccountListRemoteFieldClassesPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: AccountListRemoteFieldClassesPage,
