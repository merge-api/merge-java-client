...
private constructor(
    ...
    override fun toString() =
        "ContactListPage{contactsService=$contactsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<ContactListPage> {
        return getNextPageParams().map { contactsService.list(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(contactsService: ContactService, params: ContactListParams, response: Response) =
            ContactListPage(
                contactsService,
                params,
                response,
    ...
    constructor(
        ...
        override fun toString() =
            "ContactListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: ContactListPage,
    ) : Iterable<Contact> {
