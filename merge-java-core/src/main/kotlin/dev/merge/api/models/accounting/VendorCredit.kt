 ...
 * ### Description
 *
 * The `VendorCredit` object is an accounts receivable transaction used to show that a customer is
 * owed a gift or refund. A vendor credit will contain information on the amount of credit owed to
 * the customer, the vendor that owes the credit, and the account.
 *
 * ### Usage Example
 *
...
private constructor(
    ...
    private val lines: JsonField<List<VendorCreditLine>>,
    ...
    fun lines(): Optional<List<VendorCreditLine>> = Optional.ofNullable(lines.getNullable("lines"))
    ...
    override fun toString() =
        "VendorCredit{id=$id, remoteId=$remoteId, number=$number, transactionDate=$transactionDate, vendor=$vendor, totalAmount=$totalAmount, currency=$currency, exchangeRate=$exchangeRate, company=$company, lines=$lines, trackingCategories=$trackingCategories, remoteWasDeleted=$remoteWasDeleted, fieldMappings=$fieldMappings, modifiedAt=$modifiedAt, remoteData=$remoteData, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var lines: JsonField<List<VendorCreditLine>> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(vendorCredit: VendorCredit) = apply {
            this.id = vendorCredit.id
            this.remoteId = vendorCredit.remoteId
            this.number = vendorCredit.number
            this.transactionDate = vendorCredit.transactionDate
            this.vendor = vendorCredit.vendor
            this.totalAmount = vendorCredit.totalAmount
            this.currency = vendorCredit.currency
            this.exchangeRate = vendorCredit.exchangeRate
            this.company = vendorCredit.company
            this.lines = vendorCredit.lines
            this.trackingCategories = vendorCredit.trackingCategories
            this.remoteWasDeleted = vendorCredit.remoteWasDeleted
            this.fieldMappings = vendorCredit.fieldMappings
            this.modifiedAt = vendorCredit.modifiedAt
            this.remoteData = vendorCredit.remoteData
            additionalProperties(vendorCredit.additionalProperties)
        }
        ...
        fun lines(lines: List<VendorCreditLine>) = lines(JsonField.of(lines))

        @JsonProperty("lines")
        @ExcludeMissing
        fun lines(lines: JsonField<List<VendorCreditLine>>) = apply { this.lines = lines }
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is VendorCreditLine &&
                this.remoteId == other.remoteId &&
        ...
        override fun toString() =
            "VendorCreditLine{remoteId=$remoteId, netAmount=$netAmount, trackingCategory=$trackingCategory, trackingCategories=$trackingCategories, description=$description, account=$account, company=$company, exchangeRate=$exchangeRate, modifiedAt=$modifiedAt, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JvmSynthetic
            internal fun from(vendorCreditLine: VendorCreditLine) = apply {
                this.remoteId = vendorCreditLine.remoteId
                this.netAmount = vendorCreditLine.netAmount
                this.trackingCategory = vendorCreditLine.trackingCategory
                this.trackingCategories = vendorCreditLine.trackingCategories
                this.description = vendorCreditLine.description
                this.account = vendorCreditLine.account
                this.company = vendorCreditLine.company
                this.exchangeRate = vendorCreditLine.exchangeRate
                this.modifiedAt = vendorCreditLine.modifiedAt
                additionalProperties(vendorCreditLine.additionalProperties)
            }
