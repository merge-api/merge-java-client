...
private constructor(
    ...
    constructor(
        ...
        fun forEach(
            action: Predicate<AccountingAttachment>,
            executor: Executor
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<AttachmentListPageAsync>>.forEach(
                action: (AccountingAttachment) -> Boolean,
                executor: Executor
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(executor: Executor): CompletableFuture<List<AccountingAttachment>> {
            val values = mutableListOf<AccountingAttachment>()
