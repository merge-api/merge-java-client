...
private constructor(
    private val model: JsonField<Application>,
     ...
     */
    fun model(): Application = model.getRequired("model")
    ...
    fun validate(): ApplicationResponse = apply {
        if (!validated) {
            model().validate()
    ...
    override fun toString() =
        "ApplicationResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Application> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(applicationResponse: ApplicationResponse) = apply {
            this.model = applicationResponse.model
            this.warnings = applicationResponse.warnings
            this.errors = applicationResponse.errors
            this.logs = applicationResponse.logs
            additionalProperties(applicationResponse.additionalProperties)
        }
         ...
         * Fetch from the `LIST Applications` endpoint and filter by `ID` to show all applications.
         */
        fun model(model: Application) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Application>) = apply { this.model = model }
