...
class CollectionListUsersParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionListUsersParams &&
    ...
    override fun toString() =
        "CollectionListUsersParams{parentId=$parentId, cursor=$cursor, expand=$expand, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(collectionListUsersParams: CollectionListUsersParams) = apply {
            this.parentId = collectionListUsersParams.parentId
            this.cursor = collectionListUsersParams.cursor
            this.expand = collectionListUsersParams.expand
            this.includeDeletedData = collectionListUsersParams.includeDeletedData
            this.includeRemoteData = collectionListUsersParams.includeRemoteData
            this.pageSize = collectionListUsersParams.pageSize
            additionalQueryParams(collectionListUsersParams.additionalQueryParams)
            additionalHeaders(collectionListUsersParams.additionalHeaders)
        }
        ...
        fun build(): CollectionListUsersParams =
            CollectionListUsersParams(
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val TEAMS = Expand(JsonField.of("teams"))
