...
class ContactListRemoteFieldClassesPageAsync
private constructor(
    private val contactsService: ContactServiceAsync,
    private val params: ContactListRemoteFieldClassesParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContactListRemoteFieldClassesPageAsync &&
            this.contactsService == other.contactsService &&
    ...
    override fun toString() =
        "ContactListRemoteFieldClassesPageAsync{contactsService=$contactsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<ContactListRemoteFieldClassesParams> {
        if (!hasNextPage()) {
            return Optional.empty()
        }

        return Optional.of(
            ContactListRemoteFieldClassesParams.builder().from(params).cursor(next()).build()
        )
    }

    fun getNextPage(): CompletableFuture<Optional<ContactListRemoteFieldClassesPageAsync>> {
        return getNextPageParams()
            .map { contactsService.listRemoteFieldClasses(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(
            contactsService: ContactServiceAsync,
            params: ContactListRemoteFieldClassesParams,
            response: Response
        ) =
            ContactListRemoteFieldClassesPageAsync(
                contactsService,
                params,
                response,
            )
    ...
    constructor(
        ...
        override fun toString() =
            "ContactListRemoteFieldClassesPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: ContactListRemoteFieldClassesPageAsync,
    ) {
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<ContactListRemoteFieldClassesPageAsync>>.forEach(
