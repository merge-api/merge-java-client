...
private constructor(
    ...
    constructor(
        ...
        fun results(): List<Account> = results.getNullable("results") ?: listOf()
        ...
        override fun toString() =
            "AccountListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
