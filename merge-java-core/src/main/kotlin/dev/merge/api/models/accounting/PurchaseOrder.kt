 ...
 * ### Description
 *
 * The `PurchaseOrder` object is a record of request for a product or service between a buyer and
 * seller.
 *
 * ### Usage Example
 *
...
class PurchaseOrder
private constructor(
    private val status: JsonField<PurchaseOrderStatusEnum>,
    private val issueDate: JsonField<OffsetDateTime>,
    private val deliveryDate: JsonField<OffsetDateTime>,
    private val deliveryAddress: JsonField<String>,
    ...
    private val lineItems: JsonField<List<PurchaseOrderLineItem>>,
     ...
     * - `DELETED` - DELETED
     */
    fun status(): Optional<PurchaseOrderStatusEnum> =
        Optional.ofNullable(status.getNullable("status"))

    /** The purchase order's issue date. */
    fun issueDate(): Optional<OffsetDateTime> =
        Optional.ofNullable(issueDate.getNullable("issue_date"))

    /** The purchase order's delivery date. */
    fun deliveryDate(): Optional<OffsetDateTime> =
        Optional.ofNullable(deliveryDate.getNullable("delivery_date"))

    /** The purchase order's delivery address. */
    fun deliveryAddress(): Optional<String> =
        Optional.ofNullable(deliveryAddress.getNullable("delivery_address"))

    /** The contact making the purchase order. */
    fun customer(): Optional<String> = Optional.ofNullable(customer.getNullable("customer"))

    /** The party fulfilling the purchase order. */
    fun vendor(): Optional<String> = Optional.ofNullable(vendor.getNullable("vendor"))
    ...
    fun lineItems(): Optional<List<PurchaseOrderLineItem>> =
    ...
    /** The purchase order's issue date. */
    @JsonProperty("issue_date") @ExcludeMissing fun _issueDate() = issueDate

    /** The purchase order's delivery date. */
    @JsonProperty("delivery_date") @ExcludeMissing fun _deliveryDate() = deliveryDate

    /** The purchase order's delivery address. */
    @JsonProperty("delivery_address") @ExcludeMissing fun _deliveryAddress() = deliveryAddress
    ...
    override fun toString() =
        "PurchaseOrder{status=$status, issueDate=$issueDate, deliveryDate=$deliveryDate, deliveryAddress=$deliveryAddress, customer=$customer, vendor=$vendor, memo=$memo, company=$company, totalAmount=$totalAmount, currency=$currency, exchangeRate=$exchangeRate, lineItems=$lineItems, trackingCategories=$trackingCategories, remoteCreatedAt=$remoteCreatedAt, remoteUpdatedAt=$remoteUpdatedAt, remoteWasDeleted=$remoteWasDeleted, id=$id, remoteId=$remoteId, fieldMappings=$fieldMappings, modifiedAt=$modifiedAt, remoteData=$remoteData, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var status: JsonField<PurchaseOrderStatusEnum> = JsonMissing.of()
        private var issueDate: JsonField<OffsetDateTime> = JsonMissing.of()
        private var deliveryDate: JsonField<OffsetDateTime> = JsonMissing.of()
        private var deliveryAddress: JsonField<String> = JsonMissing.of()
        ...
        private var lineItems: JsonField<List<PurchaseOrderLineItem>> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(purchaseOrder: PurchaseOrder) = apply {
            this.status = purchaseOrder.status
            this.issueDate = purchaseOrder.issueDate
            this.deliveryDate = purchaseOrder.deliveryDate
            this.deliveryAddress = purchaseOrder.deliveryAddress
            this.customer = purchaseOrder.customer
            this.vendor = purchaseOrder.vendor
            this.memo = purchaseOrder.memo
            this.company = purchaseOrder.company
            this.totalAmount = purchaseOrder.totalAmount
            this.currency = purchaseOrder.currency
            this.exchangeRate = purchaseOrder.exchangeRate
            this.lineItems = purchaseOrder.lineItems
            this.trackingCategories = purchaseOrder.trackingCategories
            this.remoteCreatedAt = purchaseOrder.remoteCreatedAt
            this.remoteUpdatedAt = purchaseOrder.remoteUpdatedAt
            this.remoteWasDeleted = purchaseOrder.remoteWasDeleted
            this.id = purchaseOrder.id
            this.remoteId = purchaseOrder.remoteId
            this.fieldMappings = purchaseOrder.fieldMappings
            this.modifiedAt = purchaseOrder.modifiedAt
            this.remoteData = purchaseOrder.remoteData
            additionalProperties(purchaseOrder.additionalProperties)
        }
         ...
         * - `DELETED` - DELETED
         */
        fun status(status: PurchaseOrderStatusEnum) = status(JsonField.of(status))
        ...
        @JsonProperty("status")
        @ExcludeMissing
        fun status(status: JsonField<PurchaseOrderStatusEnum>) = apply { this.status = status }
        ...
        /** The purchase order's delivery date. */
        fun deliveryDate(deliveryDate: OffsetDateTime) = deliveryDate(JsonField.of(deliveryDate))

        /** The purchase order's delivery date. */
        @JsonProperty("delivery_date")
        @ExcludeMissing
        fun deliveryDate(deliveryDate: JsonField<OffsetDateTime>) = apply {
            this.deliveryDate = deliveryDate
        }

        /** The purchase order's delivery address. */
        fun deliveryAddress(deliveryAddress: String) =
            deliveryAddress(JsonField.of(deliveryAddress))

        /** The purchase order's delivery address. */
        @JsonProperty("delivery_address")
        @ExcludeMissing
        fun deliveryAddress(deliveryAddress: JsonField<String>) = apply {
        ...
        fun lineItems(lineItems: List<PurchaseOrderLineItem>) = lineItems(JsonField.of(lineItems))

        @JsonProperty("line_items")
        @ExcludeMissing
        fun lineItems(lineItems: JsonField<List<PurchaseOrderLineItem>>) = apply {
    ...
    private constructor(
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw MergeInvalidDataException("Unknown PurchaseOrderStatusEnum: $value")
            }
    ...
    private constructor(
        ...
        private val trackingCategories: JsonField<List<String>>,
        private val taxAmount: JsonField<String>,
        ...
        fun taxAmount(): Optional<String> = Optional.ofNullable(taxAmount.getNullable("tax_amount"))
         ...
         * - `ZWL` - Zimbabwean Dollar (2009)
         */
        fun currency(): Optional<CurrencyEnum> =
        ...
        /** The purchase order line item's tax amount. */
        @JsonProperty("tax_amount") @ExcludeMissing fun _taxAmount() = taxAmount
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PurchaseOrderLineItem &&
                this.remoteId == other.remoteId &&
        ...
        override fun toString() =
            "PurchaseOrderLineItem{remoteId=$remoteId, description=$description, unitPrice=$unitPrice, quantity=$quantity, item=$item, account=$account, trackingCategory=$trackingCategory, trackingCategories=$trackingCategories, taxAmount=$taxAmount, totalLineAmount=$totalLineAmount, currency=$currency, exchangeRate=$exchangeRate, company=$company, modifiedAt=$modifiedAt, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var trackingCategories: JsonField<List<String>> = JsonMissing.of()
            private var taxAmount: JsonField<String> = JsonMissing.of()
            ...
            @JvmSynthetic
            internal fun from(purchaseOrderLineItem: PurchaseOrderLineItem) = apply {
                this.remoteId = purchaseOrderLineItem.remoteId
                this.description = purchaseOrderLineItem.description
                this.unitPrice = purchaseOrderLineItem.unitPrice
                this.quantity = purchaseOrderLineItem.quantity
                this.item = purchaseOrderLineItem.item
                this.account = purchaseOrderLineItem.account
                this.trackingCategory = purchaseOrderLineItem.trackingCategory
                this.trackingCategories = purchaseOrderLineItem.trackingCategories
                this.taxAmount = purchaseOrderLineItem.taxAmount
                this.totalLineAmount = purchaseOrderLineItem.totalLineAmount
                this.currency = purchaseOrderLineItem.currency
                this.exchangeRate = purchaseOrderLineItem.exchangeRate
                this.company = purchaseOrderLineItem.company
                this.modifiedAt = purchaseOrderLineItem.modifiedAt
                additionalProperties(purchaseOrderLineItem.additionalProperties)
            }
            ...
            /** The purchase order line item's tax amount. */
            fun taxAmount(taxAmount: String) = taxAmount(JsonField.of(taxAmount))

            /** The purchase order line item's tax amount. */
            @JsonProperty("tax_amount")
            @ExcludeMissing
            fun taxAmount(taxAmount: JsonField<String>) = apply { this.taxAmount = taxAmount }
            ...
            fun build(): PurchaseOrderLineItem =
