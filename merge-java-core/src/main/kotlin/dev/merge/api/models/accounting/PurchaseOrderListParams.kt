...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PurchaseOrderListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(purchaseOrderListParams: PurchaseOrderListParams) = apply {
            this.companyId = purchaseOrderListParams.companyId
            this.createdAfter = purchaseOrderListParams.createdAfter
            this.createdBefore = purchaseOrderListParams.createdBefore
            this.cursor = purchaseOrderListParams.cursor
            this.expand = purchaseOrderListParams.expand
            this.includeDeletedData = purchaseOrderListParams.includeDeletedData
            this.includeRemoteData = purchaseOrderListParams.includeRemoteData
            this.issueDateAfter = purchaseOrderListParams.issueDateAfter
            this.issueDateBefore = purchaseOrderListParams.issueDateBefore
            this.modifiedAfter = purchaseOrderListParams.modifiedAfter
            this.modifiedBefore = purchaseOrderListParams.modifiedBefore
            this.pageSize = purchaseOrderListParams.pageSize
            this.remoteFields = purchaseOrderListParams.remoteFields
            this.remoteId = purchaseOrderListParams.remoteId
            this.showEnumOrigins = purchaseOrderListParams.showEnumOrigins
            additionalQueryParams(purchaseOrderListParams.additionalQueryParams)
            additionalHeaders(purchaseOrderListParams.additionalHeaders)
        }
        ...
        fun build(): PurchaseOrderListParams =
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val DELIVERY_ADDRESS = Expand(JsonField.of("delivery_address"))
        ...
        fun known(): Known =
            when (this) {
                ...
                DELIVERY_ADDRESS -> Known.DELIVERY_ADDRESS
