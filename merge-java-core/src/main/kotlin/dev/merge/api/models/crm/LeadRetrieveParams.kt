...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LeadRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "LeadRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(leadRetrieveParams: LeadRetrieveParams) = apply {
            this.id = leadRetrieveParams.id
            this.expand = leadRetrieveParams.expand
            this.includeRemoteData = leadRetrieveParams.includeRemoteData
            this.includeRemoteFields = leadRetrieveParams.includeRemoteFields
            additionalQueryParams(leadRetrieveParams.additionalQueryParams)
            additionalHeaders(leadRetrieveParams.additionalHeaders)
        }
