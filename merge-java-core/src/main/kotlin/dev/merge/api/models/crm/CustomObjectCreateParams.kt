...
class CustomObjectCreateParams
constructor(
    ...
    @JvmSynthetic
    internal fun getBody(): CustomObjectCreateBody {
        return CustomObjectCreateBody(model, additionalBodyProperties)
    }
    ...
    @JsonDeserialize(builder = CustomObjectCreateBody.Builder::class)
    @NoAutoDetect
    class CustomObjectCreateBody
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is CustomObjectCreateBody &&
        ...
        override fun toString() =
            "CustomObjectCreateBody{model=$model, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JvmSynthetic
            internal fun from(customObjectCreateBody: CustomObjectCreateBody) = apply {
                this.model = customObjectCreateBody.model
                additionalProperties(customObjectCreateBody.additionalProperties)
            }
            ...
            fun build(): CustomObjectCreateBody =
                CustomObjectCreateBody(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomObjectCreateParams &&
    ...
    override fun toString() =
        "CustomObjectCreateParams{customObjectClassId=$customObjectClassId, model=$model, isDebugMode=$isDebugMode, runAsync=$runAsync, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(customObjectCreateParams: CustomObjectCreateParams) = apply {
            this.customObjectClassId = customObjectCreateParams.customObjectClassId
            this.model = customObjectCreateParams.model
            this.isDebugMode = customObjectCreateParams.isDebugMode
            this.runAsync = customObjectCreateParams.runAsync
            additionalQueryParams(customObjectCreateParams.additionalQueryParams)
            additionalHeaders(customObjectCreateParams.additionalHeaders)
            additionalBodyProperties(customObjectCreateParams.additionalBodyProperties)
        }
        ...
        fun build(): CustomObjectCreateParams =
