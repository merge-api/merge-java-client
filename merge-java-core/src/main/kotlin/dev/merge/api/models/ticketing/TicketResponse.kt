...
@JsonDeserialize(builder = TicketResponse.Builder::class)
@NoAutoDetect
class TicketResponse
private constructor(
    private val model: JsonField<Ticket>,
     ...
     * TODO
     */
    fun model(): Ticket = model.getRequired("model")
    ...
    override fun toString() =
        "TicketResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Ticket> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(ticketResponse: TicketResponse) = apply {
            this.model = ticketResponse.model
            this.warnings = ticketResponse.warnings
            this.errors = ticketResponse.errors
            this.logs = ticketResponse.logs
            additionalProperties(ticketResponse.additionalProperties)
        }
         ...
         * TODO
         */
        fun model(model: Ticket) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Ticket>) = apply { this.model = model }
