 ...
 * ### Description
 *
 * The `Transaction` includes different types of transactions. The Transactions object does not
 * cover expenses, credit notes, vendor credit, invoices, purchase orders, and journal entries. See
 * the “transaction_type” field for more information.
 *
 * ### Usage Example
 *
...
class Transaction
private constructor(
    private val transactionType: JsonField<String>,
    ...
    private val lineItems: JsonField<List<TransactionLineItem>>,
    ...
    /**
     * The type of transaction, which can by any transaction object not already included in Merge’s
     * common model.
     */
    fun transactionType(): Optional<String> =
        Optional.ofNullable(transactionType.getNullable("transaction_type"))
    ...
    fun totalAmount(): Optional<String> =
    ...
    fun lineItems(): Optional<List<TransactionLineItem>> =
     ...
     * common model.
     */
    @JsonProperty("transaction_type") @ExcludeMissing fun _transactionType() = transactionType
    ...
    override fun toString() =
        "Transaction{transactionType=$transactionType, number=$number, transactionDate=$transactionDate, account=$account, contact=$contact, totalAmount=$totalAmount, currency=$currency, exchangeRate=$exchangeRate, company=$company, trackingCategories=$trackingCategories, lineItems=$lineItems, remoteWasDeleted=$remoteWasDeleted, id=$id, remoteId=$remoteId, fieldMappings=$fieldMappings, modifiedAt=$modifiedAt, remoteData=$remoteData, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var transactionType: JsonField<String> = JsonMissing.of()
        ...
        private var totalAmount: JsonField<String> = JsonMissing.of()
        ...
        private var lineItems: JsonField<List<TransactionLineItem>> = JsonMissing.of()
        ...
        internal fun from(transaction: Transaction) = apply {
            ...
            this.trackingCategories = transaction.trackingCategories
            this.lineItems = transaction.lineItems
            this.remoteWasDeleted = transaction.remoteWasDeleted
            this.id = transaction.id
            this.remoteId = transaction.remoteId
            this.fieldMappings = transaction.fieldMappings
            this.modifiedAt = transaction.modifiedAt
            this.remoteData = transaction.remoteData
            additionalProperties(transaction.additionalProperties)
        }

        /**
         * The type of transaction, which can by any transaction object not already included in
         * Merge’s common model.
         */
        ...
        @ExcludeMissing
        fun transactionType(transactionType: JsonField<String>) = apply {
        ...
        @ExcludeMissing
        fun totalAmount(totalAmount: JsonField<String>) = apply { this.totalAmount = totalAmount }
        ...
        fun lineItems(lineItems: List<TransactionLineItem>) = lineItems(JsonField.of(lineItems))

        @JsonProperty("line_items")
        @ExcludeMissing
        fun lineItems(lineItems: JsonField<List<TransactionLineItem>>) = apply {
    ...
    private constructor(
        ...
        override fun toString() =
            "TransactionLineItem{remoteId=$remoteId, memo=$memo, unitPrice=$unitPrice, quantity=$quantity, item=$item, account=$account, trackingCategory=$trackingCategory, trackingCategories=$trackingCategories, totalLineAmount=$totalLineAmount, taxRate=$taxRate, currency=$currency, exchangeRate=$exchangeRate, company=$company, modifiedAt=$modifiedAt, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(transactionLineItem: TransactionLineItem) = apply {
                this.remoteId = transactionLineItem.remoteId
                this.memo = transactionLineItem.memo
                this.unitPrice = transactionLineItem.unitPrice
                this.quantity = transactionLineItem.quantity
                this.item = transactionLineItem.item
                this.account = transactionLineItem.account
                this.trackingCategory = transactionLineItem.trackingCategory
                this.trackingCategories = transactionLineItem.trackingCategories
                this.totalLineAmount = transactionLineItem.totalLineAmount
                this.taxRate = transactionLineItem.taxRate
                this.currency = transactionLineItem.currency
                this.exchangeRate = transactionLineItem.exchangeRate
                this.company = transactionLineItem.company
                this.modifiedAt = transactionLineItem.modifiedAt
