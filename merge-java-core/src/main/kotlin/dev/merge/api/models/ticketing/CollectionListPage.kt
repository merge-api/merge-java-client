...
private constructor(
    ...
    override fun toString() =
        "CollectionListPage{collectionsService=$collectionsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<CollectionListPage> {
        return getNextPageParams().map { collectionsService.list(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "CollectionListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: CollectionListPage,
    ) : Iterable<Collection> {

        override fun iterator(): Iterator<Collection> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
