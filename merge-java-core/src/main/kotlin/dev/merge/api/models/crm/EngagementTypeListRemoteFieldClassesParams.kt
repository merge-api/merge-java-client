...
class EngagementTypeListRemoteFieldClassesParams
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EngagementTypeListRemoteFieldClassesParams &&
    ...
    override fun toString() =
        "EngagementTypeListRemoteFieldClassesParams{cursor=$cursor, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, pageSize=$pageSize, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(
            engagementTypeListRemoteFieldClassesParams: EngagementTypeListRemoteFieldClassesParams
        ) = apply {
            this.cursor = engagementTypeListRemoteFieldClassesParams.cursor
            this.includeDeletedData = engagementTypeListRemoteFieldClassesParams.includeDeletedData
            this.includeRemoteData = engagementTypeListRemoteFieldClassesParams.includeRemoteData
            this.includeRemoteFields =
                engagementTypeListRemoteFieldClassesParams.includeRemoteFields
            this.pageSize = engagementTypeListRemoteFieldClassesParams.pageSize
            additionalQueryParams(engagementTypeListRemoteFieldClassesParams.additionalQueryParams)
            additionalHeaders(engagementTypeListRemoteFieldClassesParams.additionalHeaders)
        }
        ...
        fun build(): EngagementTypeListRemoteFieldClassesParams =
            EngagementTypeListRemoteFieldClassesParams(
                cursor,
                includeDeletedData,
                includeRemoteData,
                includeRemoteFields,
