...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailListRecipientsPage &&
    ...
    override fun toString() =
        "EmailListRecipientsPage{emailsService=$emailsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<EmailListRecipientsPage> {
        return getNextPageParams().map { emailsService.listRecipients(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(emailsService: EmailService, params: EmailListRecipientsParams, response: Response) =
    ...
    constructor(
        ...
        override fun toString() =
            "EmailListRecipientsPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: EmailListRecipientsPage,
    ) : Iterable<Contact> {
