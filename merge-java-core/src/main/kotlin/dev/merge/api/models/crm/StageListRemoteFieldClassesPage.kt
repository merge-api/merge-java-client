...
class StageListRemoteFieldClassesPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StageListRemoteFieldClassesPage &&
    ...
    override fun toString() =
        "StageListRemoteFieldClassesPage{stagesService=$stagesService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<StageListRemoteFieldClassesPage> {
        return getNextPageParams().map { stagesService.listRemoteFieldClasses(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "StageListRemoteFieldClassesPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: StageListRemoteFieldClassesPage,
