...
constructor(
    ...
    override fun toString() =
        "ItemRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(itemRetrieveParams: ItemRetrieveParams) = apply {
            this.id = itemRetrieveParams.id
            this.expand = itemRetrieveParams.expand
            this.includeRemoteData = itemRetrieveParams.includeRemoteData
            this.remoteFields = itemRetrieveParams.remoteFields
            this.showEnumOrigins = itemRetrieveParams.showEnumOrigins
            additionalQueryParams(itemRetrieveParams.additionalQueryParams)
            additionalHeaders(itemRetrieveParams.additionalHeaders)
        }
