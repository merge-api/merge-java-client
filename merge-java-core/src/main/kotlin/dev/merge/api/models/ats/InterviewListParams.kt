...
constructor(
    ...
    private val jobInterviewStageId: String?,
    ...
    fun jobInterviewStageId(): Optional<String> = Optional.ofNullable(jobInterviewStageId)
    ...
    fun organizerId(): Optional<String> = Optional.ofNullable(organizerId)
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
        ...
        this.jobInterviewStageId?.let {
            params.put("job_interview_stage_id", listOf(it.toString()))
        }
        ...
        this.organizerId?.let { params.put("organizer_id", listOf(it.toString())) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InterviewListParams &&
            ...
            this.jobInterviewStageId == other.jobInterviewStageId &&
    ...
    override fun toString() =
        "InterviewListParams{applicationId=$applicationId, createdAfter=$createdAfter, createdBefore=$createdBefore, cursor=$cursor, expand=$expand, includeDeletedData=$includeDeletedData, includeRemoteData=$includeRemoteData, jobInterviewStageId=$jobInterviewStageId, modifiedAfter=$modifiedAfter, modifiedBefore=$modifiedBefore, organizerId=$organizerId, pageSize=$pageSize, remoteFields=$remoteFields, remoteId=$remoteId, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        private var jobInterviewStageId: String? = null
        ...
        @JvmSynthetic
        internal fun from(interviewListParams: InterviewListParams) = apply {
            this.applicationId = interviewListParams.applicationId
            this.createdAfter = interviewListParams.createdAfter
            this.createdBefore = interviewListParams.createdBefore
            this.cursor = interviewListParams.cursor
            this.expand = interviewListParams.expand
            this.includeDeletedData = interviewListParams.includeDeletedData
            this.includeRemoteData = interviewListParams.includeRemoteData
            this.jobInterviewStageId = interviewListParams.jobInterviewStageId
            this.modifiedAfter = interviewListParams.modifiedAfter
            this.modifiedBefore = interviewListParams.modifiedBefore
            this.organizerId = interviewListParams.organizerId
            this.pageSize = interviewListParams.pageSize
            this.remoteFields = interviewListParams.remoteFields
            this.remoteId = interviewListParams.remoteId
            this.showEnumOrigins = interviewListParams.showEnumOrigins
            additionalQueryParams(interviewListParams.additionalQueryParams)
            additionalHeaders(interviewListParams.additionalHeaders)
        }
        ...
        fun jobInterviewStageId(jobInterviewStageId: String) = apply {
        ...
        fun organizerId(organizerId: String) = apply { this.organizerId = organizerId }
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val INTERVIEWERS = Expand(JsonField.of("interviewers"))

            @JvmField val JOB_INTERVIEW_STAGE = Expand(JsonField.of("job_interview_stage"))

            @JvmField val ORGANIZER = Expand(JsonField.of("organizer"))
        ...
        fun known(): Known =
            when (this) {
                ...
                INTERVIEWERS -> Known.INTERVIEWERS
                JOB_INTERVIEW_STAGE -> Known.JOB_INTERVIEW_STAGE
                ORGANIZER -> Known.ORGANIZER
