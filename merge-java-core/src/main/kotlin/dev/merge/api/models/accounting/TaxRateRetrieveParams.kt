...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TaxRateRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "TaxRateRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(taxRateRetrieveParams: TaxRateRetrieveParams) = apply {
            this.id = taxRateRetrieveParams.id
            this.expand = taxRateRetrieveParams.expand
            this.includeRemoteData = taxRateRetrieveParams.includeRemoteData
            additionalQueryParams(taxRateRetrieveParams.additionalQueryParams)
            additionalHeaders(taxRateRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): TaxRateRetrieveParams =
