...
class PurchaseOrderCreateParams
constructor(
    private val model: PurchaseOrderRequest,
    ...
    fun model(): PurchaseOrderRequest = model
    ...
    @JvmSynthetic
    internal fun getBody(): PurchaseOrderCreateBody {
        return PurchaseOrderCreateBody(model, additionalBodyProperties)
    }
    ...
    @JsonDeserialize(builder = PurchaseOrderCreateBody.Builder::class)
    @NoAutoDetect
    class PurchaseOrderCreateBody
    internal constructor(
         ...
         * ### Description
         *
         * The `PurchaseOrder` object is a record of request for a product or service between a
         * buyer and seller.
         *
         * ### Usage Example
         *
         ...
         */
        @JsonProperty("model") fun model(): PurchaseOrderRequest? = model
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PurchaseOrderCreateBody &&
        ...
        override fun toString() =
            "PurchaseOrderCreateBody{model=$model, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var model: PurchaseOrderRequest? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(purchaseOrderCreateBody: PurchaseOrderCreateBody) = apply {
                this.model = purchaseOrderCreateBody.model
                additionalProperties(purchaseOrderCreateBody.additionalProperties)
            }
             ...
             */
            @JsonProperty("model")
            fun model(model: PurchaseOrderRequest) = apply { this.model = model }
            ...
            fun build(): PurchaseOrderCreateBody =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PurchaseOrderCreateParams &&
            this.model == other.model &&
    ...
    override fun toString() =
        "PurchaseOrderCreateParams{model=$model, isDebugMode=$isDebugMode, runAsync=$runAsync, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(purchaseOrderCreateParams: PurchaseOrderCreateParams) = apply {
            this.model = purchaseOrderCreateParams.model
            this.isDebugMode = purchaseOrderCreateParams.isDebugMode
            this.runAsync = purchaseOrderCreateParams.runAsync
            additionalQueryParams(purchaseOrderCreateParams.additionalQueryParams)
            additionalHeaders(purchaseOrderCreateParams.additionalHeaders)
            additionalBodyProperties(purchaseOrderCreateParams.additionalBodyProperties)
        }
        ...
        fun build(): PurchaseOrderCreateParams =
     ...
     * ### Description
     *
     * The `PurchaseOrder` object is a record of request for a product or service between a buyer
     * and seller.
     *
     * ### Usage Example
     *
    ...
    private constructor(
        private val status: PurchaseOrderStatusEnum?,
        private val issueDate: OffsetDateTime?,
        private val deliveryDate: OffsetDateTime?,
        ...
        private val exchangeRate: String?,
        private val lineItems: List<PurchaseOrderLineItemRequest>?,
         ...
         * - `DELETED` - DELETED
         */
        @JsonProperty("status") fun status(): PurchaseOrderStatusEnum? = status
        ...
        @JsonProperty("delivery_date") fun deliveryDate(): OffsetDateTime? = deliveryDate

        /** The purchase order's delivery address. */
        @JsonProperty("delivery_address") fun deliveryAddress(): String? = deliveryAddress

        /** The contact making the purchase order. */
        @JsonProperty("customer") fun customer(): String? = customer

        /** The party fulfilling the purchase order. */
        @JsonProperty("vendor") fun vendor(): String? = vendor
        ...
        @JsonProperty("total_amount") fun totalAmount(): Double? = totalAmount
        ...
        @JsonProperty("exchange_rate") fun exchangeRate(): String? = exchangeRate

        @JsonProperty("line_items") fun lineItems(): List<PurchaseOrderLineItemRequest>? = lineItems
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PurchaseOrderRequest &&
        ...
        override fun toString() =
            "PurchaseOrderRequest{status=$status, issueDate=$issueDate, deliveryDate=$deliveryDate, deliveryAddress=$deliveryAddress, customer=$customer, vendor=$vendor, memo=$memo, company=$company, totalAmount=$totalAmount, currency=$currency, exchangeRate=$exchangeRate, lineItems=$lineItems, integrationParams=$integrationParams, linkedAccountParams=$linkedAccountParams, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var status: PurchaseOrderStatusEnum? = null
            private var issueDate: OffsetDateTime? = null
            private var deliveryDate: OffsetDateTime? = null
            ...
            private var lineItems: List<PurchaseOrderLineItemRequest>? = null
            private var integrationParams: JsonValue? = null
            private var linkedAccountParams: JsonValue? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(purchaseOrderRequest: PurchaseOrderRequest) = apply {
                this.status = purchaseOrderRequest.status
                this.issueDate = purchaseOrderRequest.issueDate
                this.deliveryDate = purchaseOrderRequest.deliveryDate
                this.deliveryAddress = purchaseOrderRequest.deliveryAddress
                this.customer = purchaseOrderRequest.customer
                this.vendor = purchaseOrderRequest.vendor
                this.memo = purchaseOrderRequest.memo
                this.company = purchaseOrderRequest.company
                this.totalAmount = purchaseOrderRequest.totalAmount
                this.currency = purchaseOrderRequest.currency
                this.exchangeRate = purchaseOrderRequest.exchangeRate
                this.lineItems = purchaseOrderRequest.lineItems
                this.integrationParams = purchaseOrderRequest.integrationParams
                this.linkedAccountParams = purchaseOrderRequest.linkedAccountParams
                additionalProperties(purchaseOrderRequest.additionalProperties)
            }
             ...
             */
            @JsonProperty("status")
            fun status(status: PurchaseOrderStatusEnum) = apply { this.status = status }
            ...
            fun deliveryDate(deliveryDate: OffsetDateTime) = apply {
                this.deliveryDate = deliveryDate
            }

            /** The purchase order's delivery address. */
            @JsonProperty("delivery_address")
            fun deliveryAddress(deliveryAddress: String) = apply {
                this.deliveryAddress = deliveryAddress
            }

            /** The contact making the purchase order. */
            @JsonProperty("customer")
            fun customer(customer: String) = apply { this.customer = customer }

            /** The party fulfilling the purchase order. */
            @JsonProperty("vendor") fun vendor(vendor: String) = apply { this.vendor = vendor }
            ...
            fun totalAmount(totalAmount: Double) = apply { this.totalAmount = totalAmount }
            ...
            fun exchangeRate(exchangeRate: String) = apply { this.exchangeRate = exchangeRate }

            @JsonProperty("line_items")
            fun lineItems(lineItems: List<PurchaseOrderLineItemRequest>) = apply {
            ...
            fun build(): PurchaseOrderRequest =
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is PurchaseOrderStatusEnum && this.value == other.value
            }
            ...
            companion object {
                ...
                @JvmField val DRAFT = PurchaseOrderStatusEnum(JsonField.of("DRAFT"))

                @JvmField val SUBMITTED = PurchaseOrderStatusEnum(JsonField.of("SUBMITTED"))

                @JvmField val AUTHORIZED = PurchaseOrderStatusEnum(JsonField.of("AUTHORIZED"))

                @JvmField val BILLED = PurchaseOrderStatusEnum(JsonField.of("BILLED"))

                @JvmField val DELETED = PurchaseOrderStatusEnum(JsonField.of("DELETED"))

                @JvmStatic fun of(value: String) = PurchaseOrderStatusEnum(JsonField.of(value))
            }
            ...
            fun known(): Known =
                when (this) {
                    ...
                    DELETED -> Known.DELETED
                        ...
                        throw MergeInvalidDataException("Unknown PurchaseOrderStatusEnum: $value")
                }
         ...
         */
        @JsonDeserialize(builder = PurchaseOrderLineItemRequest.Builder::class)
        @NoAutoDetect
        ...
        private constructor(
            ...
            private val trackingCategory: String?,
            private val trackingCategories: List<String>?,
            private val taxAmount: String?,
            private val totalLineAmount: String?,
            private val currency: CurrencyEnum?,
            private val exchangeRate: String?,
            private val company: String?,
            private val integrationParams: JsonValue?,
            ...
            @JsonProperty("remote_id") fun remoteId(): String? = remoteId
            ...
            @JsonProperty("item") fun item(): String? = item
            ...
            @JsonProperty("tracking_category") fun trackingCategory(): String? = trackingCategory

            /** The purchase order line item's associated tracking categories. */
            @JsonProperty("tracking_categories")
            fun trackingCategories(): List<String>? = trackingCategories

            /** The purchase order line item's tax amount. */
            @JsonProperty("tax_amount") fun taxAmount(): String? = taxAmount

            /** The purchase order line item's total amount. */
            @JsonProperty("total_line_amount") fun totalLineAmount(): String? = totalLineAmount
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is PurchaseOrderLineItemRequest &&
            ...
            override fun toString() =
                "PurchaseOrderLineItemRequest{remoteId=$remoteId, description=$description, unitPrice=$unitPrice, quantity=$quantity, item=$item, account=$account, trackingCategory=$trackingCategory, trackingCategories=$trackingCategories, taxAmount=$taxAmount, totalLineAmount=$totalLineAmount, currency=$currency, exchangeRate=$exchangeRate, company=$company, integrationParams=$integrationParams, linkedAccountParams=$linkedAccountParams, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                private var trackingCategory: String? = null
                private var trackingCategories: List<String>? = null
                private var taxAmount: String? = null
                private var totalLineAmount: String? = null
                private var currency: CurrencyEnum? = null
                private var exchangeRate: String? = null
                private var company: String? = null
                private var integrationParams: JsonValue? = null
                ...
                @JvmSynthetic
                internal fun from(purchaseOrderLineItemRequest: PurchaseOrderLineItemRequest) =
                    apply {
                        this.remoteId = purchaseOrderLineItemRequest.remoteId
                        this.description = purchaseOrderLineItemRequest.description
                        this.unitPrice = purchaseOrderLineItemRequest.unitPrice
                        this.quantity = purchaseOrderLineItemRequest.quantity
                        this.item = purchaseOrderLineItemRequest.item
                        this.account = purchaseOrderLineItemRequest.account
                        this.trackingCategory = purchaseOrderLineItemRequest.trackingCategory
                        this.trackingCategories = purchaseOrderLineItemRequest.trackingCategories
                        this.taxAmount = purchaseOrderLineItemRequest.taxAmount
                        this.totalLineAmount = purchaseOrderLineItemRequest.totalLineAmount
                        this.currency = purchaseOrderLineItemRequest.currency
                        this.exchangeRate = purchaseOrderLineItemRequest.exchangeRate
                        this.company = purchaseOrderLineItemRequest.company
                        this.integrationParams = purchaseOrderLineItemRequest.integrationParams
                        this.linkedAccountParams = purchaseOrderLineItemRequest.linkedAccountParams
                        additionalProperties(purchaseOrderLineItemRequest.additionalProperties)
                    }
                ...
                @JsonProperty("item") fun item(item: String) = apply { this.item = item }
                ...
                fun trackingCategory(trackingCategory: String) = apply {
                    this.trackingCategory = trackingCategory
                }

                /** The purchase order line item's associated tracking categories. */
                @JsonProperty("tracking_categories")
                fun trackingCategories(trackingCategories: List<String>) = apply {
                    this.trackingCategories = trackingCategories
                }

                /** The purchase order line item's tax amount. */
                @JsonProperty("tax_amount")
                fun taxAmount(taxAmount: String) = apply { this.taxAmount = taxAmount }

                /** The purchase order line item's total amount. */
                @JsonProperty("total_line_amount")
                fun totalLineAmount(totalLineAmount: String) = apply {
                ...
                fun build(): PurchaseOrderLineItemRequest =
                    PurchaseOrderLineItemRequest(
                        ...
                        account,
                        trackingCategory,
                        checkNotNull(trackingCategories) {
                                "`trackingCategories` is required but was not set"
                            }
                            .toUnmodifiable(),
                        taxAmount,
                        totalLineAmount,
