...
private constructor(
    ...
    fun results(): List<Project> = response().results()
    ...
    fun getNextPageParams(): Optional<ProjectListParams> {
        ...
        return Optional.of(ProjectListParams.builder().from(params).cursor(next()).build())
    }
    ...
    constructor(
        ...
        private val results: JsonField<List<Project>>,
        ...
        fun results(): List<Project> = results.getRequired("results")
        ...
        fun _results(): Optional<JsonField<List<Project>>> = Optional.ofNullable(results)
        ...
        override fun toString() =
            "ProjectListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var results: JsonField<List<Project>> = JsonMissing.of()
            ...
            fun results(results: List<Project>) = results(JsonField.of(results))

            @JsonProperty("results")
            fun results(results: JsonField<List<Project>>) = apply { this.results = results }
