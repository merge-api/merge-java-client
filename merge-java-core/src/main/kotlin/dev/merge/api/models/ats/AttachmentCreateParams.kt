...
constructor(
    ...
    internal constructor(
        ...
        override fun toString() =
            "AttachmentCreateBody{model=$model, remoteUserId=$remoteUserId, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(attachmentCreateBody: AttachmentCreateBody) = apply {
                ...
                this.remoteUserId = attachmentCreateBody.remoteUserId
    ...
    override fun toString() =
        "AttachmentCreateParams{model=$model, remoteUserId=$remoteUserId, isDebugMode=$isDebugMode, runAsync=$runAsync, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(attachmentCreateParams: AttachmentCreateParams) = apply {
            ...
            this.remoteUserId = attachmentCreateParams.remoteUserId
