...
class OfferListPageAsync
private constructor(
    private val offersService: OfferServiceAsync,
    private val params: OfferListParams,
    ...
    fun results(): List<Offer> = response().results()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OfferListPageAsync &&
    ...
    override fun toString() =
        "OfferListPageAsync{offersService=$offersService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<OfferListParams> {
        if (!hasNextPage()) {
            return Optional.empty()
        }

        return Optional.of(OfferListParams.builder().from(params).cursor(next()).build())
    }

    fun getNextPage(): CompletableFuture<Optional<OfferListPageAsync>> {
    ...
    companion object {
        ...
        @JvmStatic
        fun of(offersService: OfferServiceAsync, params: OfferListParams, response: Response) =
            OfferListPageAsync(
                offersService,
                params,
                response,
    ...
    constructor(
        ...
        private val results: JsonField<List<Offer>>,
        ...
        fun results(): List<Offer> = results.getRequired("results")
        ...
        fun _results(): Optional<JsonField<List<Offer>>> = Optional.ofNullable(results)
        ...
        override fun toString() =
            "OfferListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var results: JsonField<List<Offer>> = JsonMissing.of()
            ...
            fun results(results: List<Offer>) = results(JsonField.of(results))

            @JsonProperty("results")
            fun results(results: JsonField<List<Offer>>) = apply { this.results = results }
    ...
    class AutoPager
    constructor(
        private val firstPage: OfferListPageAsync,
    ) {

        fun forEach(action: Predicate<Offer>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<OfferListPageAsync>>.forEach(
