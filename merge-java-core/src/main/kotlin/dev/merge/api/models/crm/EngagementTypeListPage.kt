...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EngagementTypeListPage &&
    ...
    override fun toString() =
        "EngagementTypeListPage{engagementTypesService=$engagementTypesService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<EngagementTypeListParams> {
        ...
        return Optional.of(EngagementTypeListParams.builder().from(params).cursor(next()).build())
    }

    fun getNextPage(): Optional<EngagementTypeListPage> {
        return getNextPageParams().map { engagementTypesService.list(it) }
    }
    ...
    constructor(
        ...
        fun results(): List<EngagementType> = results.getRequired("results")
        ...
        override fun toString() =
            "EngagementTypeListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: EngagementTypeListPage,
    ) : Iterable<EngagementType> {

        override fun iterator(): Iterator<EngagementType> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<EngagementType> {
