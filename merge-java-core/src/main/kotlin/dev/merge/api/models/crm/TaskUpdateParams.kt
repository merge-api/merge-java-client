...
constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "PatchedTaskRequest{subject=$subject, content=$content, owner=$owner, account=$account, completedDate=$completedDate, dueDate=$dueDate, status=$status, integrationParams=$integrationParams, linkedAccountParams=$linkedAccountParams, additionalProperties=$additionalProperties}"
