...
@JsonDeserialize(builder = CustomObjectResponse.Builder::class)
@NoAutoDetect
class CustomObjectResponse
private constructor(
    private val model: JsonField<CustomObject>,
     ...
     * TODO
     */
    fun model(): CustomObject = model.getRequired("model")
    ...
    fun validate(): CustomObjectResponse = apply {
        if (!validated) {
            model().validate()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomObjectResponse &&
    ...
    override fun toString() =
        "CustomObjectResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<CustomObject> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(customObjectResponse: CustomObjectResponse) = apply {
            this.model = customObjectResponse.model
            this.warnings = customObjectResponse.warnings
            this.errors = customObjectResponse.errors
            this.logs = customObjectResponse.logs
            additionalProperties(customObjectResponse.additionalProperties)
        }
         ...
         * TODO
         */
        fun model(model: CustomObject) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<CustomObject>) = apply { this.model = model }
        ...
        fun build(): CustomObjectResponse =
