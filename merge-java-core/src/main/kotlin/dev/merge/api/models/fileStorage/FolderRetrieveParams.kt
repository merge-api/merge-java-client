...
constructor(
    ...
    override fun toString() =
        "FolderRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(folderRetrieveParams: FolderRetrieveParams) = apply {
            this.id = folderRetrieveParams.id
            this.expand = folderRetrieveParams.expand
            this.includeRemoteData = folderRetrieveParams.includeRemoteData
            additionalQueryParams(folderRetrieveParams.additionalQueryParams)
            additionalHeaders(folderRetrieveParams.additionalHeaders)
        }
