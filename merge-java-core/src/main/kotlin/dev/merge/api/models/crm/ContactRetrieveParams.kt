...
constructor(
    ...
    override fun toString() =
        "ContactRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, includeRemoteFields=$includeRemoteFields, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(contactRetrieveParams: ContactRetrieveParams) = apply {
            ...
            this.includeRemoteFields = contactRetrieveParams.includeRemoteFields
