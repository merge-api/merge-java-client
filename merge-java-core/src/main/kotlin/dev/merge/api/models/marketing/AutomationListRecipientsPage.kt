...
class AutomationListRecipientsPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutomationListRecipientsPage &&
    ...
    override fun toString() =
        "AutomationListRecipientsPage{automationsService=$automationsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<AutomationListRecipientsPage> {
        return getNextPageParams().map { automationsService.listRecipients(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "AutomationListRecipientsPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: AutomationListRecipientsPage,
    ) : Iterable<Contact> {
