...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApplicationListPage &&
    ...
    override fun toString() =
        "ApplicationListPage{applicationsService=$applicationsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<ApplicationListParams> {
        ...
        return Optional.of(ApplicationListParams.builder().from(params).cursor(next()).build())
    }

    fun getNextPage(): Optional<ApplicationListPage> {
    ...
    constructor(
        ...
        fun results(): List<Application> = results.getRequired("results")
        ...
        override fun toString() =
            "ApplicationListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: ApplicationListPage,
