...
private constructor(
    ...
    override fun toString() =
        "Project{id=$id, remoteId=$remoteId, name=$name, description=$description, remoteWasDeleted=$remoteWasDeleted, fieldMappings=$fieldMappings, modifiedAt=$modifiedAt, remoteData=$remoteData, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(project: Project) = apply {
            this.id = project.id
            this.remoteId = project.remoteId
            this.name = project.name
            this.description = project.description
            this.remoteWasDeleted = project.remoteWasDeleted
            this.fieldMappings = project.fieldMappings
            this.modifiedAt = project.modifiedAt
            this.remoteData = project.remoteData
