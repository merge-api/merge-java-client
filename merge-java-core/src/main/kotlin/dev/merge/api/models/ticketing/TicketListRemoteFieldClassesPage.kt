...
class TicketListRemoteFieldClassesPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TicketListRemoteFieldClassesPage &&
    ...
    override fun toString() =
        "TicketListRemoteFieldClassesPage{ticketsService=$ticketsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<TicketListRemoteFieldClassesPage> {
        return getNextPageParams().map { ticketsService.listRemoteFieldClasses(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "TicketListRemoteFieldClassesPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: TicketListRemoteFieldClassesPage,
