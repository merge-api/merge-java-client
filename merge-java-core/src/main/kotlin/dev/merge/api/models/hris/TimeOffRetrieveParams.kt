...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TimeOffRetrieveParams &&
            this.id == other.id &&
    ...
    override fun toString() =
        "TimeOffRetrieveParams{id=$id, expand=$expand, includeRemoteData=$includeRemoteData, remoteFields=$remoteFields, showEnumOrigins=$showEnumOrigins, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(timeOffRetrieveParams: TimeOffRetrieveParams) = apply {
            this.id = timeOffRetrieveParams.id
            this.expand = timeOffRetrieveParams.expand
            this.includeRemoteData = timeOffRetrieveParams.includeRemoteData
            this.remoteFields = timeOffRetrieveParams.remoteFields
            this.showEnumOrigins = timeOffRetrieveParams.showEnumOrigins
            additionalQueryParams(timeOffRetrieveParams.additionalQueryParams)
            additionalHeaders(timeOffRetrieveParams.additionalHeaders)
        }
        ...
        fun build(): TimeOffRetrieveParams =
            TimeOffRetrieveParams(
