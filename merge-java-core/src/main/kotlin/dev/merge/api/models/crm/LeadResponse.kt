...
@JsonDeserialize(builder = LeadResponse.Builder::class)
@NoAutoDetect
class LeadResponse
private constructor(
    private val model: JsonField<Lead>,
     ...
     * TODO
     */
    fun model(): Lead = model.getRequired("model")
    ...
    fun validate(): LeadResponse = apply {
        if (!validated) {
            model().validate()
    ...
    override fun toString() =
        "LeadResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<Lead> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(leadResponse: LeadResponse) = apply {
            this.model = leadResponse.model
            this.warnings = leadResponse.warnings
            this.errors = leadResponse.errors
            this.logs = leadResponse.logs
            additionalProperties(leadResponse.additionalProperties)
        }
         ...
         * TODO
         */
        fun model(model: Lead) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<Lead>) = apply { this.model = model }
