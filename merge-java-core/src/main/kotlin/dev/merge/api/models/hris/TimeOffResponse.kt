...
private constructor(
    private val model: JsonField<TimeOff>,
     ...
     */
    fun model(): TimeOff = model.getRequired("model")
    ...
    fun validate(): TimeOffResponse = apply {
        if (!validated) {
            model().validate()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TimeOffResponse &&
    ...
    override fun toString() =
        "TimeOffResponse{model=$model, warnings=$warnings, errors=$errors, logs=$logs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        private var model: JsonField<TimeOff> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(timeOffResponse: TimeOffResponse) = apply {
            this.model = timeOffResponse.model
            this.warnings = timeOffResponse.warnings
            this.errors = timeOffResponse.errors
            this.logs = timeOffResponse.logs
            additionalProperties(timeOffResponse.additionalProperties)
        }
         ...
         * Fetch from the `LIST TimeOffs` endpoint and filter by `ID` to show all time off requests.
         */
        fun model(model: TimeOff) = model(JsonField.of(model))
        ...
        @JsonProperty("model")
        @ExcludeMissing
        fun model(model: JsonField<TimeOff>) = apply { this.model = model }
