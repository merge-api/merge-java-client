...
private constructor(
    ...
    constructor(
        ...
        fun results(): List<RemoteUser> = results.getNullable("results") ?: listOf()
        ...
        override fun toString() =
            "UserListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    constructor(
        ...
        override fun iterator(): Iterator<RemoteUser> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
