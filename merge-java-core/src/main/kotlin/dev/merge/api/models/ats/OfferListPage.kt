...
private constructor(
    ...
    override fun toString() =
        "OfferListPage{offersService=$offersService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<OfferListPage> {
    ...
    companion object {
        ...
        @JvmStatic
        fun of(offersService: OfferService, params: OfferListParams, response: Response) =
            OfferListPage(
                offersService,
                params,
                response,
    ...
    constructor(
        ...
        override fun toString() =
            "OfferListPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: OfferListPage,
    ) : Iterable<Offer> {
