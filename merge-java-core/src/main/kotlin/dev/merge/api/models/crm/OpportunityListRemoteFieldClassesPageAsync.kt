...
class OpportunityListRemoteFieldClassesPageAsync
private constructor(
    private val opportunitiesService: OpportunityServiceAsync,
    private val params: OpportunityListRemoteFieldClassesParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OpportunityListRemoteFieldClassesPageAsync &&
    ...
    override fun toString() =
        "OpportunityListRemoteFieldClassesPageAsync{opportunitiesService=$opportunitiesService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<OpportunityListRemoteFieldClassesParams> {
        if (!hasNextPage()) {
            return Optional.empty()
        }

        return Optional.of(
            OpportunityListRemoteFieldClassesParams.builder().from(params).cursor(next()).build()
        )
    }

    fun getNextPage(): CompletableFuture<Optional<OpportunityListRemoteFieldClassesPageAsync>> {
        return getNextPageParams()
            .map { opportunitiesService.listRemoteFieldClasses(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        fun of(
            ...
            OpportunityListRemoteFieldClassesPageAsync(
                opportunitiesService,
                params,
                response,
            )
    ...
    constructor(
        ...
        override fun toString() =
            "OpportunityListRemoteFieldClassesPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: OpportunityListRemoteFieldClassesPageAsync,
    ) {
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<OpportunityListRemoteFieldClassesPageAsync>>.forEach(
