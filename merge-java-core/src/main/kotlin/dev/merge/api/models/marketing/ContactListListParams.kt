...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContactListListParams &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(contactListListParams: ContactListListParams) = apply {
            this.createdAfter = contactListListParams.createdAfter
            this.createdBefore = contactListListParams.createdBefore
            this.cursor = contactListListParams.cursor
            this.includeDeletedData = contactListListParams.includeDeletedData
            this.includeRemoteData = contactListListParams.includeRemoteData
            this.modifiedAfter = contactListListParams.modifiedAfter
            this.modifiedBefore = contactListListParams.modifiedBefore
            this.pageSize = contactListListParams.pageSize
            this.remoteId = contactListListParams.remoteId
            additionalQueryParams(contactListListParams.additionalQueryParams)
            additionalHeaders(contactListListParams.additionalHeaders)
        }
        ...
        fun build(): ContactListListParams =
            ContactListListParams(
                createdAfter,
                createdBefore,
                cursor,
