...
class CampaignListContactsPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CampaignListContactsPage &&
    ...
    override fun toString() =
        "CampaignListContactsPage{campaignsService=$campaignsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<CampaignListContactsParams> {
        ...
        return Optional.of(CampaignListContactsParams.builder().from(params).cursor(next()).build())
    }

    fun getNextPage(): Optional<CampaignListContactsPage> {
        return getNextPageParams().map { campaignsService.listContacts(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "CampaignListContactsPage.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: CampaignListContactsPage,
    ) : Iterable<Contact> {
