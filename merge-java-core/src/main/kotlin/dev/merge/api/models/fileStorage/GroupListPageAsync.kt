...
private constructor(
    ...
    fun results(): List<Group> = response().results()
    ...
    fun getNextPageParams(): Optional<GroupListParams> {
        ...
        return Optional.of(GroupListParams.builder().from(params).cursor(next()).build())
    }
    ...
    constructor(
        ...
        private val results: JsonField<List<Group>>,
        ...
        fun results(): List<Group> = results.getRequired("results")
        ...
        fun _results(): Optional<JsonField<List<Group>>> = Optional.ofNullable(results)
        ...
        override fun toString() =
            "GroupListPageAsync.Response{next=$next, previous=$previous, results=$results, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            private var results: JsonField<List<Group>> = JsonMissing.of()
            ...
            fun results(results: List<Group>) = results(JsonField.of(results))

            @JsonProperty("results")
            fun results(results: JsonField<List<Group>>) = apply { this.results = results }
