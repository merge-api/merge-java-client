...
constructor(
    ...
    class Builder {
        ...
        internal fun from(actionListParams: ActionListParams) = apply {
            this.createdAfter = actionListParams.createdAfter
            this.createdBefore = actionListParams.createdBefore
            this.cursor = actionListParams.cursor
            this.includeDeletedData = actionListParams.includeDeletedData
            this.includeRemoteData = actionListParams.includeRemoteData
            this.modifiedAfter = actionListParams.modifiedAfter
            this.modifiedBefore = actionListParams.modifiedBefore
            this.pageSize = actionListParams.pageSize
            this.remoteId = actionListParams.remoteId
            additionalQueryParams(actionListParams.additionalQueryParams)
            additionalHeaders(actionListParams.additionalHeaders)
        }
