...
import dev.merge.api.errors.MergeIoException
...
private constructor(
    ...
    private fun shouldRetry(throwable: Throwable): Boolean {
        // Only retry IOException and MergeIoException, other exceptions are not intended to be
        // retried
        return throwable is IOException || throwable is MergeIoException
    }
