...
import dev.merge.api.services.async.marketing.automations.MetaServiceAsyncImpl
...
constructor(
    ...
    private val listHandler: Handler<AutomationListPageAsync.Response> =
        jsonHandler<AutomationListPageAsync.Response>(clientOptions.jsonMapper)
    ...
    override fun list(
        ...
        return clientOptions.httpClient.executeAsync(request, requestOptions).thenApply { response
            ...
            response
                ...
                .let { AutomationListPageAsync.of(this, params, it) }
        }
    }

    private val listRecipientsHandler: Handler<AutomationListRecipientsPageAsync.Response> =
        jsonHandler<AutomationListRecipientsPageAsync.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
    ...
    override fun listRecipients(
        ...
        return clientOptions.httpClient.executeAsync(request, requestOptions).thenApply { response
            ...
            response
                ...
                .let { AutomationListRecipientsPageAsync.of(this, params, it) }
        }
    }
}
