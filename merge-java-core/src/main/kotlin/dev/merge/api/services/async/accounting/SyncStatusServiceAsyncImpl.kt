...
import dev.merge.api.models.accounting.SyncStatusListPageAsync
import dev.merge.api.models.accounting.SyncStatusListParams
import dev.merge.api.models.accounting.SyncStatusResyncParams
    ...
    override fun list(
        ...
        val request =
            HttpRequest.builder()
                ...
                .addPathSegments("accounting", "v1", "sync-status")
