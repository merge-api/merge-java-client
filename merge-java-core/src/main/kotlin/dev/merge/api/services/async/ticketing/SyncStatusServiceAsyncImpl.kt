...
import dev.merge.api.models.ticketing.SyncStatusListPageAsync
import dev.merge.api.models.ticketing.SyncStatusListParams
import dev.merge.api.models.ticketing.SyncStatusResyncParams
    ...
    override fun list(
        ...
        val request =
            HttpRequest.builder()
                ...
                .addPathSegments("ticketing", "v1", "sync-status")
    ...
    override fun resync(
        ...
        val request =
            HttpRequest.builder()
                ...
                .addPathSegments("ticketing", "v1", "sync-status", "resync")
                .putAllQueryParams(params.getQueryParams())
                .putAllHeaders(clientOptions.headers)
                .putAllHeaders(params.getHeaders())
