...
constructor(
    ...
    private val listHandler: Handler<RejectReasonListPage.Response> =
        jsonHandler<RejectReasonListPage.Response>(clientOptions.jsonMapper)
    ...
    override fun list(
        ...
        return clientOptions.httpClient.execute(request, requestOptions).let { response ->
            response
                ...
                .let { RejectReasonListPage.of(this, params, it) }
        }
    }
}
