...
class CompanyInfoListParamsTest {

    @Test
    fun createCompanyInfoListParams() {
        CompanyInfoListParams.builder()
            .createdAfter(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .createdBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .cursor("string")
            .expand(listOf(CompanyInfoListParams.Expand.ADDRESSES))
    ...
    fun getQueryParams() {
        ...
        expected.put("expand", listOf(CompanyInfoListParams.Expand.ADDRESSES.toString()))
    ...
    fun getQueryParamsWithoutOptionalFields() {
        val params = CompanyInfoListParams.builder().build()
        val expected = mutableMapOf<String, List<String>>()
        assertThat(params.getQueryParams()).isEqualTo(expected)
    }
}
