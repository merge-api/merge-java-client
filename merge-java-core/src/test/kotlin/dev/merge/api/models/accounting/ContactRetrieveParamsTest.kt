...
class ContactRetrieveParamsTest {
    ...
    fun getQueryParams() {
        ...
        expected.put("expand", listOf(ContactRetrieveParams.Expand.ADDRESSES.toString()))
        expected.put("include_remote_data", listOf("true"))
        expected.put("remote_fields", listOf(ContactRetrieveParams.RemoteFields.STATUS.toString()))
        expected.put(
            "show_enum_origins",
            listOf(ContactRetrieveParams.ShowEnumOrigins.STATUS.toString())
        )
