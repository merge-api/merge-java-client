...
class CashFlowStatementListParamsTest {

    @Test
    fun createCashFlowStatementListParams() {
        CashFlowStatementListParams.builder()
            .companyId("string")
            .createdAfter(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .createdBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .cursor("string")
            .expand(listOf(CashFlowStatementListParams.Expand.COMPANY))
    ...
    fun getQueryParams() {
        ...
        expected.put("expand", listOf(CashFlowStatementListParams.Expand.COMPANY.toString()))
    ...
    fun getQueryParamsWithoutOptionalFields() {
        val params = CashFlowStatementListParams.builder().build()
        val expected = mutableMapOf<String, List<String>>()
        assertThat(params.getQueryParams()).isEqualTo(expected)
    }
}
