...
class VendorCreditListParamsTest {

    @Test
    fun createVendorCreditListParams() {
        VendorCreditListParams.builder()
            .companyId("string")
            .createdAfter(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .createdBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .cursor("string")
            .expand(listOf(VendorCreditListParams.Expand.COMPANY))
    ...
    fun getQueryParams() {
        ...
        expected.put("expand", listOf(VendorCreditListParams.Expand.COMPANY.toString()))
    ...
    fun getQueryParamsWithoutOptionalFields() {
        val params = VendorCreditListParams.builder().build()
        val expected = mutableMapOf<String, List<String>>()
        assertThat(params.getQueryParams()).isEqualTo(expected)
    }
}
