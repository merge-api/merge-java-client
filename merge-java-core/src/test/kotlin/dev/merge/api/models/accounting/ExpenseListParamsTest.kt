...
class ExpenseListParamsTest {

    @Test
    fun createExpenseListParams() {
        ExpenseListParams.builder()
            .companyId("string")
            .createdAfter(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .createdBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
            .cursor("string")
            .expand(listOf(ExpenseListParams.Expand.ACCOUNT))
    ...
    fun getQueryParams() {
        ...
        expected.put("expand", listOf(ExpenseListParams.Expand.ACCOUNT.toString()))
    ...
    fun getQueryParamsWithoutOptionalFields() {
        val params = ExpenseListParams.builder().build()
        val expected = mutableMapOf<String, List<String>>()
        assertThat(params.getQueryParams()).isEqualTo(expected)
    }
}
