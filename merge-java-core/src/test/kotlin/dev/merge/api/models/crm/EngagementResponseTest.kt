...
class EngagementResponseTest {

    @Test
    fun createEngagementResponse() {
        val engagementResponse =
            EngagementResponse.builder()
                .model(
                    Engagement.builder()
                ...
                .build()
        assertThat(engagementResponse).isNotNull
        assertThat(engagementResponse.model())
            .isEqualTo(
                Engagement.builder()
                    .owner("0358cbc6-2040-430a-848e-aafacbadf3aa")
                    .content("Call for negotiation")
        ...
        assertThat(engagementResponse.warnings())
            .containsExactly(
                ValidationWarning.builder()
                    .source(
                        ValidationWarning.ValidationProblemSource.builder()
        ...
        assertThat(engagementResponse.errors())
            .containsExactly(
                ValidationError.builder()
                    .source(
        ...
        assertThat(engagementResponse.logs().get())
            .containsExactly(
                DebugLog.builder()
                    .logId("99433219-8017-4acd-bb3c-ceb23d663832")
                    .dashboardView(
