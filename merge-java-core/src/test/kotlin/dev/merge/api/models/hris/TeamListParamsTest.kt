...
class TeamListParamsTest {
    ...
    fun createTeamListParams() {
        TeamListParams.builder()
            ...
            .cursor("string")
            .expand(listOf(TeamListParams.Expand.PARENT_TEAM))
    ...
    fun getQueryParams() {
        ...
        expected.put("expand", listOf(TeamListParams.Expand.PARENT_TEAM.toString()))
        ...
        expected.put("parent_team_id", listOf("string"))
