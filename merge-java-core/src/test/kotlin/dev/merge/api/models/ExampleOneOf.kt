...
import dev.merge.api.core.BaseDeserializer
import dev.merge.api.core.BaseSerializer
import dev.merge.api.core.ExcludeMissing
import dev.merge.api.core.JsonField
import dev.merge.api.core.JsonMissing
import dev.merge.api.core.JsonValue
import dev.merge.api.core.NoAutoDetect
import dev.merge.api.core.getOrThrow
...
private constructor(
    ...
    fun validate(): ExampleOneOf = apply {
        if (!validated) {
            if (cat == null && dog == null && cats == null && petName == null) {
                throw MergeInvalidDataException("Unknown ExampleOneOf: $_json")
            }
            cat?.validate()
            dog?.validate()
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw MergeInvalidDataException("Unknown ExampleOneOf: $json")
        }
    }
