...
import dev.merge.api.core.JsonArray;
import dev.merge.api.core.JsonField;
import dev.merge.api.core.JsonMissing;
import dev.merge.api.core.JsonNull;
import dev.merge.api.core.JsonNumber;
import dev.merge.api.core.JsonObject;
...
final class ExampleObjectJsonTest {
    ...
    void fromJson_required_unset_lenient() {
        ...
        assertThatThrownBy(entity::requiredField)
                .isInstanceOf(MergeInvalidDataException.class)
