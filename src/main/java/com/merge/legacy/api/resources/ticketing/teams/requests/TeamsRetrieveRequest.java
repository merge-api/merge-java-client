...
public final class TeamsRetrieveRequest {
    ...
    private TeamsRetrieveRequest(Optional<Boolean> includeRemoteData, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder {
        ...
        public TeamsRetrieveRequest build() {
            return new TeamsRetrieveRequest(includeRemoteData, additionalProperties);
        }
    }
}
