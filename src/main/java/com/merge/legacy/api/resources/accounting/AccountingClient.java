 ...
 */
package com.merge.legacy.api.resources.accounting;

import com.merge.legacy.api.core.ClientOptions;
import com.merge.legacy.api.core.Suppliers;
import com.merge.legacy.api.resources.accounting.accountdetails.AccountDetailsClient;
import com.merge.legacy.api.resources.accounting.accountingperiods.AccountingPeriodsClient;
import com.merge.legacy.api.resources.accounting.accounts.AccountsClient;
import com.merge.legacy.api.resources.accounting.accounttoken.AccountTokenClient;
import com.merge.legacy.api.resources.accounting.addresses.AddressesClient;
import com.merge.legacy.api.resources.accounting.asyncpassthrough.AsyncPassthroughClient;
import com.merge.legacy.api.resources.accounting.asynctasks.AsyncTasksClient;
import com.merge.legacy.api.resources.accounting.attachments.AttachmentsClient;
import com.merge.legacy.api.resources.accounting.audittrail.AuditTrailClient;
import com.merge.legacy.api.resources.accounting.availableactions.AvailableActionsClient;
import com.merge.legacy.api.resources.accounting.balancesheets.BalanceSheetsClient;
import com.merge.legacy.api.resources.accounting.bankfeedaccounts.BankFeedAccountsClient;
import com.merge.legacy.api.resources.accounting.bankfeedtransactions.BankFeedTransactionsClient;
import com.merge.legacy.api.resources.accounting.cashflowstatements.CashFlowStatementsClient;
import com.merge.legacy.api.resources.accounting.companyinfo.CompanyInfoClient;
import com.merge.legacy.api.resources.accounting.contacts.ContactsClient;
import com.merge.legacy.api.resources.accounting.creditnotes.CreditNotesClient;
import com.merge.legacy.api.resources.accounting.deleteaccount.DeleteAccountClient;
import com.merge.legacy.api.resources.accounting.employees.EmployeesClient;
import com.merge.legacy.api.resources.accounting.expenses.ExpensesClient;
import com.merge.legacy.api.resources.accounting.fieldmapping.FieldMappingClient;
import com.merge.legacy.api.resources.accounting.forceresync.ForceResyncClient;
import com.merge.legacy.api.resources.accounting.generalledgertransactions.GeneralLedgerTransactionsClient;
import com.merge.legacy.api.resources.accounting.generatekey.GenerateKeyClient;
import com.merge.legacy.api.resources.accounting.incomestatements.IncomeStatementsClient;
import com.merge.legacy.api.resources.accounting.invoices.InvoicesClient;
import com.merge.legacy.api.resources.accounting.issues.IssuesClient;
import com.merge.legacy.api.resources.accounting.items.ItemsClient;
import com.merge.legacy.api.resources.accounting.journalentries.JournalEntriesClient;
import com.merge.legacy.api.resources.accounting.linkedaccounts.LinkedAccountsClient;
import com.merge.legacy.api.resources.accounting.linktoken.LinkTokenClient;
import com.merge.legacy.api.resources.accounting.passthrough.PassthroughClient;
import com.merge.legacy.api.resources.accounting.payments.PaymentsClient;
import com.merge.legacy.api.resources.accounting.phonenumbers.PhoneNumbersClient;
import com.merge.legacy.api.resources.accounting.purchaseorders.PurchaseOrdersClient;
import com.merge.legacy.api.resources.accounting.regeneratekey.RegenerateKeyClient;
import com.merge.legacy.api.resources.accounting.scopes.ScopesClient;
import com.merge.legacy.api.resources.accounting.syncstatus.SyncStatusClient;
import com.merge.legacy.api.resources.accounting.taxrates.TaxRatesClient;
import com.merge.legacy.api.resources.accounting.trackingcategories.TrackingCategoriesClient;
