...
import com.merge.legacy.api.resources.hris.types.EmployeeRequest;
...
public final class EmployeeEndpointRequest {
    ...
    private EmployeeEndpointRequest(
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull EmployeeRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull EmployeeRequest model) {
            this.model = model;
            return this;
        }
        ...
        public EmployeeEndpointRequest build() {
            return new EmployeeEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
