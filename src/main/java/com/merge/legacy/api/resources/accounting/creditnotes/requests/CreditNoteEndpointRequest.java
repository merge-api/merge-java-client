 ...
 */
package com.merge.legacy.api.resources.accounting.creditnotes.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.legacy.api.core.ObjectMappers;
import com.merge.legacy.api.resources.accounting.types.CreditNoteRequest;
...
@JsonDeserialize(builder = CreditNoteEndpointRequest.Builder.class)
public final class CreditNoteEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final CreditNoteRequest model;

    private final Map<String, Object> additionalProperties;

    private CreditNoteEndpointRequest(
            Optional<Boolean> isDebugMode,
            Optional<Boolean> runAsync,
            CreditNoteRequest model,
    ...
    @JsonProperty("model")
    public CreditNoteRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreditNoteEndpointRequest && equalTo((CreditNoteEndpointRequest) other);
    }
    ...
    private boolean equalTo(CreditNoteEndpointRequest other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull CreditNoteRequest model);

        Builder from(CreditNoteEndpointRequest other);
    }

    public interface _FinalStage {
        CreditNoteEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private CreditNoteRequest model;
        ...
        @Override
        public Builder from(CreditNoteEndpointRequest other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull CreditNoteRequest model) {
            this.model = model;
            return this;
        }
        ...
        @Override
        public CreditNoteEndpointRequest build() {
            return new CreditNoteEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
