...
import com.merge.legacy.api.resources.accounting.vendorcredits.types.VendorCreditsRetrieveRequestExpand;
...
public final class VendorCreditsRetrieveRequest {
    ...
    private VendorCreditsRetrieveRequest(
            Optional<VendorCreditsRetrieveRequestExpand> expand,
    ...
    public static final class Builder {
        ...
        public VendorCreditsRetrieveRequest build() {
            return new VendorCreditsRetrieveRequest(expand, includeRemoteData, additionalProperties);
        }
    }
}
