 ...
 */
package com.merge.legacy.api.resources.crm.contacts.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.legacy.api.core.ObjectMappers;
import com.merge.legacy.api.resources.crm.types.PatchedContactRequest;
...
public final class PatchedCrmContactEndpointRequest {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull PatchedContactRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull PatchedContactRequest model) {
            this.model = model;
            return this;
        }
        ...
        public PatchedCrmContactEndpointRequest build() {
            return new PatchedCrmContactEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
