 ...
 */
package com.merge.legacy.api.resources.hris.employments;

import com.merge.legacy.api.core.*;
import com.merge.legacy.api.resources.hris.employments.requests.EmploymentsListRequest;
...
public class EmploymentsClient {
    ...
    public PaginatedEmploymentList list(EmploymentsListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedEmploymentList.class);
            }
    ...
    public Employment retrieve(String id, EmploymentsRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ResponseBody responseBody = response.body();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Employment.class);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
