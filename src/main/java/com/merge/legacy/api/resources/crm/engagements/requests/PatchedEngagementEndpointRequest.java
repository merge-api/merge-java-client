...
import com.merge.legacy.api.resources.crm.types.PatchedEngagementRequest;
...
public final class PatchedEngagementEndpointRequest {
    ...
    private PatchedEngagementEndpointRequest(
            ...
            PatchedEngagementRequest model,
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull PatchedEngagementRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull PatchedEngagementRequest model) {
            this.model = model;
            return this;
        }
        ...
        public PatchedEngagementEndpointRequest build() {
            return new PatchedEngagementEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
