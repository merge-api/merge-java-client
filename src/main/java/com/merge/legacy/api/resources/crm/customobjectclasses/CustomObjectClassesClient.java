 ...
 */
package com.merge.legacy.api.resources.crm.customobjectclasses;

import com.merge.api.core.*;
import com.merge.legacy.api.resources.crm.customobjectclasses.requests.CustomObjectClassesListRequest;
...
public class CustomObjectClassesClient {
    ...
    public PaginatedCustomObjectClassList list(CustomObjectClassesListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedCustomObjectClassList.class);
            }
    ...
    public CustomObjectClass retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ResponseBody responseBody = response.body();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), CustomObjectClass.class);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
