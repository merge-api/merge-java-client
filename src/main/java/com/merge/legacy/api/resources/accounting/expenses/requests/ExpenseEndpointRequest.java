...
import com.merge.legacy.api.resources.accounting.types.ExpenseRequest;
...
public final class ExpenseEndpointRequest {
    ...
    private ExpenseEndpointRequest(
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull ExpenseRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull ExpenseRequest model) {
            this.model = model;
            return this;
        }
        ...
        public ExpenseEndpointRequest build() {
            return new ExpenseEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
