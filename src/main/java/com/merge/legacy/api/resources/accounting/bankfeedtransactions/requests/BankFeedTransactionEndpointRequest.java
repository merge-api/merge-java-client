 ...
 */
package com.merge.legacy.api.resources.accounting.bankfeedtransactions.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.api.core.ObjectMappers;
import com.merge.legacy.api.resources.accounting.types.BankFeedTransactionRequestRequest;
...
public final class BankFeedTransactionEndpointRequest {
    ...
    private final BankFeedTransactionRequestRequest model;

    private final Map<String, Object> additionalProperties;

    private BankFeedTransactionEndpointRequest(
            Optional<Boolean> isDebugMode,
            Optional<Boolean> runAsync,
            BankFeedTransactionRequestRequest model,
    ...
    @JsonProperty("model")
    public BankFeedTransactionRequestRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BankFeedTransactionEndpointRequest
                && equalTo((BankFeedTransactionEndpointRequest) other);
    }
    ...
    private boolean equalTo(BankFeedTransactionEndpointRequest other) {
    ...
    public interface _FinalStage {
        BankFeedTransactionEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private BankFeedTransactionRequestRequest model;
        ...
        @Override
        public Builder from(BankFeedTransactionEndpointRequest other) {
        ...
        @Override
        public BankFeedTransactionEndpointRequest build() {
            return new BankFeedTransactionEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
