...
public final class DepartmentsRetrieveRequest {
    ...
    private DepartmentsRetrieveRequest(Optional<Boolean> includeRemoteData, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder {
        ...
        public DepartmentsRetrieveRequest build() {
            return new DepartmentsRetrieveRequest(includeRemoteData, additionalProperties);
        }
    }
}
