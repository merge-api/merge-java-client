 ...
 */
package com.merge.legacy.api.resources.accounting.attachments.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.api.core.ObjectMappers;
import com.merge.legacy.api.resources.accounting.types.AccountingAttachmentRequest;
...
public final class AccountingAttachmentEndpointRequest {
    ...
    private AccountingAttachmentEndpointRequest(
            ...
            AccountingAttachmentRequest model,
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        public AccountingAttachmentEndpointRequest build() {
            return new AccountingAttachmentEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
