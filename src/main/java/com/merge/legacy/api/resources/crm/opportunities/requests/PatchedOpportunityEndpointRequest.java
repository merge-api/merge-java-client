...
import com.merge.legacy.api.resources.crm.types.PatchedOpportunityRequest;
...
public final class PatchedOpportunityEndpointRequest {
    ...
    private PatchedOpportunityEndpointRequest(
            ...
            PatchedOpportunityRequest model,
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull PatchedOpportunityRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull PatchedOpportunityRequest model) {
            this.model = model;
            return this;
        }
        ...
        public PatchedOpportunityEndpointRequest build() {
            return new PatchedOpportunityEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
