...
import com.merge.legacy.api.resources.crm.types.PatchedTaskRequest;
...
public final class PatchedTaskEndpointRequest {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull PatchedTaskRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull PatchedTaskRequest model) {
            this.model = model;
            return this;
        }
        ...
        public PatchedTaskEndpointRequest build() {
            return new PatchedTaskEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
