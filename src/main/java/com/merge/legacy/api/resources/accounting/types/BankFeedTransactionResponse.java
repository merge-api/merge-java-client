...
@JsonDeserialize(builder = BankFeedTransactionResponse.Builder.class)
public final class BankFeedTransactionResponse {
    private final BankFeedTransaction model;
    ...
    private BankFeedTransactionResponse(
    ...
    @JsonProperty("model")
    public BankFeedTransaction getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BankFeedTransactionResponse && equalTo((BankFeedTransactionResponse) other);
    }
    ...
    private boolean equalTo(BankFeedTransactionResponse other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull BankFeedTransaction model);

        Builder from(BankFeedTransactionResponse other);
    }

    public interface _FinalStage {
        BankFeedTransactionResponse build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private BankFeedTransaction model;
        ...
        @Override
        public Builder from(BankFeedTransactionResponse other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull BankFeedTransaction model) {
            this.model = model;
            return this;
        }
        ...
        @Override
        public BankFeedTransactionResponse build() {
            return new BankFeedTransactionResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
