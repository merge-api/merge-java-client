 ...
 */
package com.merge.legacy.api.resources.filestorage.folders.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.legacy.api.core.ObjectMappers;
import com.merge.legacy.api.resources.filestorage.types.FolderRequest;
...
public final class FileStorageFolderEndpointRequest {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull FolderRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull FolderRequest model) {
            this.model = model;
            return this;
        }
        ...
        public FileStorageFolderEndpointRequest build() {
            return new FileStorageFolderEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
