...
public final class CrmAccountResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Account model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Account model) {
            this.model = model;
            return this;
        }
        ...
        public CrmAccountResponse build() {
            return new CrmAccountResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
