 ...
 */
package com.merge.legacy.api.resources.accounting.contacts.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.api.core.ObjectMappers;
import com.merge.legacy.api.resources.accounting.types.ContactRequest;
...
public final class ContactEndpointRequest {
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        public ContactEndpointRequest build() {
            return new ContactEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
