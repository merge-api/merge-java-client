 ...
 */
package com.merge.legacy.api.resources.ats.attachments.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.legacy.api.core.ObjectMappers;
import com.merge.legacy.api.resources.ats.types.AttachmentRequest;
...
public final class AttachmentEndpointRequest {
    ...
    public interface ModelStage {
        RemoteUserIdStage model(@NotNull AttachmentRequest model);
    ...
    public static final class Builder implements ModelStage, RemoteUserIdStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public RemoteUserIdStage model(@NotNull AttachmentRequest model) {
            this.model = model;
            return this;
        }
        ...
        public AttachmentEndpointRequest build() {
            return new AttachmentEndpointRequest(isDebugMode, runAsync, model, remoteUserId, additionalProperties);
        }
    }
}
