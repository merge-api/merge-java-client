...
import com.merge.legacy.api.resources.filestorage.types.FileRequest;
...
public final class FileStorageFileEndpointRequest {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull FileRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull FileRequest model) {
            this.model = model;
            return this;
        }
        ...
        public FileStorageFileEndpointRequest build() {
            return new FileStorageFileEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
