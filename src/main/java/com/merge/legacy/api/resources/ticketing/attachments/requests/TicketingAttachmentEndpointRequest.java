 ...
 */
package com.merge.legacy.api.resources.ticketing.attachments.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.legacy.api.core.ObjectMappers;
import com.merge.legacy.api.resources.ticketing.types.AttachmentRequest;
...
public final class TicketingAttachmentEndpointRequest {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull AttachmentRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull AttachmentRequest model) {
            this.model = model;
            return this;
        }
        ...
        public TicketingAttachmentEndpointRequest build() {
            return new TicketingAttachmentEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
