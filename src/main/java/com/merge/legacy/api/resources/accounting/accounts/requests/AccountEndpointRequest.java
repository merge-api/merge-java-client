...
import com.merge.legacy.api.resources.accounting.types.AccountRequest;
...
public final class AccountEndpointRequest {
    ...
    private AccountEndpointRequest(
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        public AccountEndpointRequest build() {
            return new AccountEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
