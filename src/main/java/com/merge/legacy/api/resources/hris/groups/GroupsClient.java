 ...
 */
package com.merge.legacy.api.resources.hris.groups;

import com.merge.legacy.api.core.*;
import com.merge.legacy.api.resources.hris.groups.requests.GroupsListRequest;
...
public class GroupsClient {
    ...
    public PaginatedGroupList list(GroupsListRequest request, RequestOptions requestOptions) {
        ...
        if (request.getTypes().isPresent()) {
            httpUrl.addQueryParameter("types", request.getTypes().get());
        }
