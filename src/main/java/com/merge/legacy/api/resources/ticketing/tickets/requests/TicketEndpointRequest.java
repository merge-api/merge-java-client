 ...
 */
package com.merge.legacy.api.resources.ticketing.tickets.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.legacy.api.core.ObjectMappers;
import com.merge.legacy.api.resources.ticketing.types.TicketRequest;
...
public final class TicketEndpointRequest {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull TicketRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull TicketRequest model) {
            this.model = model;
            return this;
        }
        ...
        public TicketEndpointRequest build() {
            return new TicketEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
