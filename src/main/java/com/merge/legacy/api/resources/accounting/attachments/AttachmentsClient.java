 ...
 */
package com.merge.legacy.api.resources.accounting.attachments;

import com.merge.legacy.api.core.*;
import com.merge.legacy.api.resources.accounting.attachments.requests.AccountingAttachmentEndpointRequest;
import com.merge.legacy.api.resources.accounting.attachments.requests.AttachmentsListRequest;
import com.merge.legacy.api.resources.accounting.attachments.requests.AttachmentsRetrieveRequest;
import com.merge.legacy.api.resources.accounting.types.AccountingAttachment;
import com.merge.legacy.api.resources.accounting.types.AccountingAttachmentResponse;
import com.merge.legacy.api.resources.accounting.types.MetaResponse;
import com.merge.legacy.api.resources.accounting.types.PaginatedAccountingAttachmentList;
import okhttp3.*;
...
public class AttachmentsClient {
    ...
    public AccountingAttachmentResponse create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ResponseBody responseBody = response.body();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), AccountingAttachmentResponse.class);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
    ...
    public AccountingAttachment retrieve(String id, AttachmentsRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ResponseBody responseBody = response.body();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), AccountingAttachment.class);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
