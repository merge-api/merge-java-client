...
import com.merge.legacy.api.resources.ats.types.PatchedCandidateRequest;
...
public final class PatchedCandidateEndpointRequest {
    ...
    public interface ModelStage {
        RemoteUserIdStage model(@NotNull PatchedCandidateRequest model);
    ...
    public static final class Builder implements ModelStage, RemoteUserIdStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public RemoteUserIdStage model(@NotNull PatchedCandidateRequest model) {
            this.model = model;
            return this;
        }
        ...
        public PatchedCandidateEndpointRequest build() {
            return new PatchedCandidateEndpointRequest(
