...
public final class EmployeeResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Employee model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Employee model) {
            this.model = model;
            return this;
        }
        ...
        public EmployeeResponse build() {
            return new EmployeeResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
