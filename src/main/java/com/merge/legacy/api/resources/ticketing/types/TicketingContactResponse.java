...
@JsonDeserialize(builder = TicketingContactResponse.Builder.class)
public final class TicketingContactResponse {
    ...
    private TicketingContactResponse(
            Contact model,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TicketingContactResponse && equalTo((TicketingContactResponse) other);
    }
    ...
    private boolean equalTo(TicketingContactResponse other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Contact model);

        Builder from(TicketingContactResponse other);
    }

    public interface _FinalStage {
        TicketingContactResponse build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        public Builder from(TicketingContactResponse other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Contact model) {
            this.model = model;
            return this;
        }
        ...
        @Override
        public TicketingContactResponse build() {
            return new TicketingContactResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
