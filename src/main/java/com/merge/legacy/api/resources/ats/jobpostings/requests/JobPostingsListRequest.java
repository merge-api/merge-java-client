 ...
 */
package com.merge.legacy.api.resources.ats.jobpostings.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.api.core.ObjectMappers;
import com.merge.legacy.api.resources.ats.jobpostings.types.JobPostingsListRequestStatus;
...
public final class JobPostingsListRequest {
    ...
    private final Optional<JobPostingsListRequestStatus> status;
    ...
    private JobPostingsListRequest(
            ...
            Optional<JobPostingsListRequestStatus> status,
    ...
    /**
     * @return If provided, will only return Job Postings with this status. Options: ('PUBLISHED', 'CLOSED', 'DRAFT', 'INTERNAL', 'PENDING')
     * <ul>
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof JobPostingsListRequest && equalTo((JobPostingsListRequest) other);
    }
    ...
    private boolean equalTo(JobPostingsListRequest other) {
    ...
    public static final class Builder {
        ...
        private Optional<JobPostingsListRequestStatus> status = Optional.empty();
        ...
        public Builder from(JobPostingsListRequest other) {
        ...
        public Builder status(Optional<JobPostingsListRequestStatus> status) {
            this.status = status;
            return this;
        }
        ...
        public JobPostingsListRequest build() {
            return new JobPostingsListRequest(
                    createdAfter,
                    createdBefore,
                    cursor,
                    expand,
