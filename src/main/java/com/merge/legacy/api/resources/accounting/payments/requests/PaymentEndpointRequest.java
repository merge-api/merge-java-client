...
import com.merge.legacy.api.resources.accounting.types.PaymentRequest;
...
public final class PaymentEndpointRequest {
    ...
    private PaymentEndpointRequest(
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull PaymentRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull PaymentRequest model) {
            this.model = model;
            return this;
        }
        ...
        public PaymentEndpointRequest build() {
            return new PaymentEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
