 ...
 */
package com.merge.legacy.api.resources.crm.accounts.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.legacy.api.core.ObjectMappers;
import com.merge.legacy.api.resources.crm.types.AccountRequest;
...
public final class CrmAccountEndpointRequest {
    ...
    private CrmAccountEndpointRequest(
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull AccountRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull AccountRequest model) {
            this.model = model;
            return this;
        }
        ...
        public CrmAccountEndpointRequest build() {
            return new CrmAccountEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
