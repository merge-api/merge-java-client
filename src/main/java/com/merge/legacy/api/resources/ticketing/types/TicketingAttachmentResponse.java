...
public final class TicketingAttachmentResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Attachment model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Attachment model) {
            this.model = model;
            return this;
        }
        ...
        public TicketingAttachmentResponse build() {
            return new TicketingAttachmentResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
