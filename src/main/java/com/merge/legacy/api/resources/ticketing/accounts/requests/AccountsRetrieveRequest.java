 ...
 */
package com.merge.legacy.api.resources.ticketing.accounts.requests;
...
public final class AccountsRetrieveRequest {
    ...
    private AccountsRetrieveRequest(Optional<Boolean> includeRemoteData, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder {
        ...
        public AccountsRetrieveRequest build() {
            return new AccountsRetrieveRequest(includeRemoteData, additionalProperties);
        }
    }
}
