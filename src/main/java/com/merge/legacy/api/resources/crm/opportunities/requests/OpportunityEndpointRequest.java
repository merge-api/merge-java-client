 ...
 */
package com.merge.legacy.api.resources.crm.opportunities.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.legacy.api.core.ObjectMappers;
import com.merge.legacy.api.resources.crm.types.OpportunityRequest;
...
public final class OpportunityEndpointRequest {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull OpportunityRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull OpportunityRequest model) {
            this.model = model;
            return this;
        }
        ...
        public OpportunityEndpointRequest build() {
            return new OpportunityEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
