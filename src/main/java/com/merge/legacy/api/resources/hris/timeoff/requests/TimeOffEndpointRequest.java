 ...
 */
package com.merge.legacy.api.resources.hris.timeoff.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.legacy.api.core.ObjectMappers;
import com.merge.legacy.api.resources.hris.types.TimeOffRequest;
...
public final class TimeOffEndpointRequest {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull TimeOffRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull TimeOffRequest model) {
            this.model = model;
            return this;
        }
        ...
        public TimeOffEndpointRequest build() {
            return new TimeOffEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
