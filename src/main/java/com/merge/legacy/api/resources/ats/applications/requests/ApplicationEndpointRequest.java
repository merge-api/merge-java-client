...
import com.merge.legacy.api.resources.ats.types.ApplicationRequest;
...
public final class ApplicationEndpointRequest {
    ...
    public interface ModelStage {
        RemoteUserIdStage model(@NotNull ApplicationRequest model);
    ...
    public static final class Builder implements ModelStage, RemoteUserIdStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public RemoteUserIdStage model(@NotNull ApplicationRequest model) {
            this.model = model;
            return this;
        }
        ...
        public ApplicationEndpointRequest build() {
            return new ApplicationEndpointRequest(isDebugMode, runAsync, model, remoteUserId, additionalProperties);
        }
    }
}
