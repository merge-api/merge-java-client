...
public final class ExpenseResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Expense model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Expense model) {
            this.model = model;
            return this;
        }
        ...
        public ExpenseResponse build() {
            return new ExpenseResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
