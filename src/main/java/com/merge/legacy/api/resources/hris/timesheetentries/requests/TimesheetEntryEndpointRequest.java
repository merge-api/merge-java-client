 ...
 */
package com.merge.legacy.api.resources.hris.timesheetentries.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.legacy.api.core.ObjectMappers;
import com.merge.legacy.api.resources.hris.types.TimesheetEntryRequest;
...
public final class TimesheetEntryEndpointRequest {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull TimesheetEntryRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull TimesheetEntryRequest model) {
            this.model = model;
            return this;
        }
        ...
        public TimesheetEntryEndpointRequest build() {
            return new TimesheetEntryEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
