...
import com.merge.legacy.api.resources.crm.types.NoteRequest;
...
public final class NoteEndpointRequest {
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        public NoteEndpointRequest build() {
            return new NoteEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
