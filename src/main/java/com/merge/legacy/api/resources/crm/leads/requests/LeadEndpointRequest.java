 ...
 */
package com.merge.legacy.api.resources.crm.leads.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.legacy.api.core.ObjectMappers;
import com.merge.legacy.api.resources.crm.types.LeadRequest;
...
public final class LeadEndpointRequest {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull LeadRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull LeadRequest model) {
            this.model = model;
            return this;
        }
        ...
        public LeadEndpointRequest build() {
            return new LeadEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
