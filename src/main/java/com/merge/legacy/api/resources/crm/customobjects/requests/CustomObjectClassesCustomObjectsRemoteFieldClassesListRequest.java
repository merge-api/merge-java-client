 ...
 */
package com.merge.legacy.api.resources.crm.customobjects.requests;
...
@JsonDeserialize(builder = CustomObjectClassesCustomObjectsRemoteFieldClassesListRequest.Builder.class)
public final class CustomObjectClassesCustomObjectsRemoteFieldClassesListRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CustomObjectClassesCustomObjectsRemoteFieldClassesListRequest
                && equalTo((CustomObjectClassesCustomObjectsRemoteFieldClassesListRequest) other);
    }
    ...
    private boolean equalTo(CustomObjectClassesCustomObjectsRemoteFieldClassesListRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CustomObjectClassesCustomObjectsRemoteFieldClassesListRequest other) {
        ...
        public CustomObjectClassesCustomObjectsRemoteFieldClassesListRequest build() {
            return new CustomObjectClassesCustomObjectsRemoteFieldClassesListRequest(
                    cursor,
                    includeDeletedData,
                    includeRemoteData,
                    includeRemoteFields,
