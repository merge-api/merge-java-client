...
import com.merge.legacy.api.resources.accounting.types.InvoiceRequest;
...
@JsonDeserialize(builder = PatchedInvoiceEndpointRequest.Builder.class)
public final class PatchedInvoiceEndpointRequest {
    ...
    private PatchedInvoiceEndpointRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PatchedInvoiceEndpointRequest && equalTo((PatchedInvoiceEndpointRequest) other);
    }
    ...
    private boolean equalTo(PatchedInvoiceEndpointRequest other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull InvoiceRequest model);

        Builder from(PatchedInvoiceEndpointRequest other);
    }

    public interface _FinalStage {
        PatchedInvoiceEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        public Builder from(PatchedInvoiceEndpointRequest other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull InvoiceRequest model) {
            this.model = model;
            return this;
        }
        ...
        public PatchedInvoiceEndpointRequest build() {
            return new PatchedInvoiceEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
