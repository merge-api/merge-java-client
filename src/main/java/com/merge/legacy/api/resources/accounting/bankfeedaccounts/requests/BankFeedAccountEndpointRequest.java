 ...
 */
package com.merge.legacy.api.resources.accounting.bankfeedaccounts.requests;

import com.fasterxml.jackson.annotation.*;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.merge.api.core.ObjectMappers;
import com.merge.legacy.api.resources.accounting.types.BankFeedAccountRequest;
...
@JsonDeserialize(builder = BankFeedAccountEndpointRequest.Builder.class)
public final class BankFeedAccountEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final BankFeedAccountRequest model;

    private final Map<String, Object> additionalProperties;

    private BankFeedAccountEndpointRequest(
            Optional<Boolean> isDebugMode,
            Optional<Boolean> runAsync,
            BankFeedAccountRequest model,
    ...
    @JsonProperty("model")
    public BankFeedAccountRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BankFeedAccountEndpointRequest && equalTo((BankFeedAccountEndpointRequest) other);
    }
    ...
    private boolean equalTo(BankFeedAccountEndpointRequest other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull BankFeedAccountRequest model);

        Builder from(BankFeedAccountEndpointRequest other);
    }

    public interface _FinalStage {
        BankFeedAccountEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private BankFeedAccountRequest model;
        ...
        @Override
        public Builder from(BankFeedAccountEndpointRequest other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull BankFeedAccountRequest model) {
            this.model = model;
            return this;
        }
        ...
        @Override
        public BankFeedAccountEndpointRequest build() {
            return new BankFeedAccountEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
