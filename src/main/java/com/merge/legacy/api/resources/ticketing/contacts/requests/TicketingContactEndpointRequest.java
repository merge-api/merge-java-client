...
import com.merge.legacy.api.resources.ticketing.types.ContactRequest;
...
@JsonDeserialize(builder = TicketingContactEndpointRequest.Builder.class)
public final class TicketingContactEndpointRequest {
    ...
    private TicketingContactEndpointRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TicketingContactEndpointRequest && equalTo((TicketingContactEndpointRequest) other);
    }
    ...
    private boolean equalTo(TicketingContactEndpointRequest other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull ContactRequest model);

        Builder from(TicketingContactEndpointRequest other);
    }

    public interface _FinalStage {
        TicketingContactEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        public Builder from(TicketingContactEndpointRequest other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull ContactRequest model) {
            this.model = model;
            return this;
        }
        ...
        @Override
        public TicketingContactEndpointRequest build() {
            return new TicketingContactEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
