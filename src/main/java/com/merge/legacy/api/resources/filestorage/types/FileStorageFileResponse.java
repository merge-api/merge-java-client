...
public final class FileStorageFileResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull File model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull File model) {
            this.model = model;
            return this;
        }
        ...
        public FileStorageFileResponse build() {
            return new FileStorageFileResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
