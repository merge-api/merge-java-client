 ...
 */
package com.merge.legacy.api.resources.accounting.phonenumbers.requests;
...
public final class PhoneNumbersRetrieveRequest {
    ...
    private PhoneNumbersRetrieveRequest(Optional<Boolean> includeRemoteData, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder {
        ...
        public PhoneNumbersRetrieveRequest build() {
            return new PhoneNumbersRetrieveRequest(includeRemoteData, additionalProperties);
        }
    }
}
