...
import com.merge.legacy.api.resources.accounting.types.VendorCreditRequest;
...
@JsonDeserialize(builder = VendorCreditEndpointRequest.Builder.class)
public final class VendorCreditEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final VendorCreditRequest model;

    private final Map<String, Object> additionalProperties;

    private VendorCreditEndpointRequest(
            Optional<Boolean> isDebugMode,
            Optional<Boolean> runAsync,
            VendorCreditRequest model,
    ...
    @JsonProperty("model")
    public VendorCreditRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VendorCreditEndpointRequest && equalTo((VendorCreditEndpointRequest) other);
    }
    ...
    private boolean equalTo(VendorCreditEndpointRequest other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull VendorCreditRequest model);

        Builder from(VendorCreditEndpointRequest other);
    }

    public interface _FinalStage {
        VendorCreditEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private VendorCreditRequest model;
        ...
        @Override
        public Builder from(VendorCreditEndpointRequest other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull VendorCreditRequest model) {
            this.model = model;
            return this;
        }
        ...
        @Override
        public VendorCreditEndpointRequest build() {
            return new VendorCreditEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
