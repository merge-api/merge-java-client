...
public final class EngagementResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Engagement model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Engagement model) {
            this.model = model;
            return this;
        }
        ...
        public EngagementResponse build() {
            return new EngagementResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
