 ...
 */
package com.merge.legacy.api.resources.hris;

import com.merge.legacy.api.core.ClientOptions;
import com.merge.legacy.api.core.Suppliers;
import com.merge.legacy.api.resources.hris.accountdetails.AccountDetailsClient;
import com.merge.legacy.api.resources.hris.accounttoken.AccountTokenClient;
import com.merge.legacy.api.resources.hris.asyncpassthrough.AsyncPassthroughClient;
import com.merge.legacy.api.resources.hris.audittrail.AuditTrailClient;
import com.merge.legacy.api.resources.hris.availableactions.AvailableActionsClient;
import com.merge.legacy.api.resources.hris.bankinfo.BankInfoClient;
import com.merge.legacy.api.resources.hris.benefits.BenefitsClient;
import com.merge.legacy.api.resources.hris.companies.CompaniesClient;
import com.merge.legacy.api.resources.hris.deleteaccount.DeleteAccountClient;
import com.merge.legacy.api.resources.hris.dependents.DependentsClient;
import com.merge.legacy.api.resources.hris.employeepayrollruns.EmployeePayrollRunsClient;
import com.merge.legacy.api.resources.hris.employees.EmployeesClient;
import com.merge.legacy.api.resources.hris.employerbenefits.EmployerBenefitsClient;
import com.merge.legacy.api.resources.hris.employments.EmploymentsClient;
import com.merge.legacy.api.resources.hris.fieldmapping.FieldMappingClient;
import com.merge.legacy.api.resources.hris.forceresync.ForceResyncClient;
import com.merge.legacy.api.resources.hris.generatekey.GenerateKeyClient;
import com.merge.legacy.api.resources.hris.groups.GroupsClient;
import com.merge.legacy.api.resources.hris.issues.IssuesClient;
import com.merge.legacy.api.resources.hris.linkedaccounts.LinkedAccountsClient;
import com.merge.legacy.api.resources.hris.linktoken.LinkTokenClient;
import com.merge.legacy.api.resources.hris.locations.LocationsClient;
import com.merge.legacy.api.resources.hris.passthrough.PassthroughClient;
import com.merge.legacy.api.resources.hris.paygroups.PayGroupsClient;
import com.merge.legacy.api.resources.hris.payrollruns.PayrollRunsClient;
import com.merge.legacy.api.resources.hris.regeneratekey.RegenerateKeyClient;
import com.merge.legacy.api.resources.hris.scopes.ScopesClient;
import com.merge.legacy.api.resources.hris.syncstatus.SyncStatusClient;
import com.merge.legacy.api.resources.hris.teams.TeamsClient;
import com.merge.legacy.api.resources.hris.timeoff.TimeOffClient;
