 ...
 */
package com.merge.legacy.api.resources.accounting.addresses.requests;
...
public final class AddressesRetrieveRequest {
    ...
    public static final class Builder {
        ...
        public AddressesRetrieveRequest build() {
            return new AddressesRetrieveRequest(includeRemoteData, remoteFields, showEnumOrigins, additionalProperties);
        }
    }
}
