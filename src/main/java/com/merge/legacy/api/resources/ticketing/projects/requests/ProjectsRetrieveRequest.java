...
public final class ProjectsRetrieveRequest {
    ...
    private ProjectsRetrieveRequest(Optional<Boolean> includeRemoteData, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder {
        ...
        public ProjectsRetrieveRequest build() {
            return new ProjectsRetrieveRequest(includeRemoteData, additionalProperties);
        }
    }
}
