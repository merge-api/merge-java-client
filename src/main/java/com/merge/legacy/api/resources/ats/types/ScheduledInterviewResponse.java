...
public final class ScheduledInterviewResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull ScheduledInterview model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull ScheduledInterview model) {
            this.model = model;
            return this;
        }
        ...
        public ScheduledInterviewResponse build() {
            return new ScheduledInterviewResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
