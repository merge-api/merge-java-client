...
public final class EmployeesRetrieveRequestShowEnumOrigins {
    public static final EmployeesRetrieveRequestShowEnumOrigins GENDER =
            new EmployeesRetrieveRequestShowEnumOrigins(Value.GENDER, "gender");

    public static final EmployeesRetrieveRequestShowEnumOrigins EMPLOYMENT_STATUS_GENDER_MARITAL_STATUS =
    ...
    public static final EmployeesRetrieveRequestShowEnumOrigins EMPLOYMENT_STATUS_ETHNICITY_GENDER_MARITAL_STATUS =
            new EmployeesRetrieveRequestShowEnumOrigins(
                    Value.EMPLOYMENT_STATUS_ETHNICITY_GENDER_MARITAL_STATUS,
                    "employment_status,ethnicity,gender,marital_status");

    public static final EmployeesRetrieveRequestShowEnumOrigins EMPLOYMENT_STATUS_MARITAL_STATUS =
            new EmployeesRetrieveRequestShowEnumOrigins(
                    Value.EMPLOYMENT_STATUS_MARITAL_STATUS, "employment_status,marital_status");

    public static final EmployeesRetrieveRequestShowEnumOrigins ETHNICITY_GENDER =
            new EmployeesRetrieveRequestShowEnumOrigins(Value.ETHNICITY_GENDER, "ethnicity,gender");

    public static final EmployeesRetrieveRequestShowEnumOrigins GENDER_MARITAL_STATUS =
            new EmployeesRetrieveRequestShowEnumOrigins(Value.GENDER_MARITAL_STATUS, "gender,marital_status");

    public static final EmployeesRetrieveRequestShowEnumOrigins EMPLOYMENT_STATUS_ETHNICITY =
            new EmployeesRetrieveRequestShowEnumOrigins(
                    Value.EMPLOYMENT_STATUS_ETHNICITY, "employment_status,ethnicity");

    public static final EmployeesRetrieveRequestShowEnumOrigins ETHNICITY =
            new EmployeesRetrieveRequestShowEnumOrigins(Value.ETHNICITY, "ethnicity");

    public static final EmployeesRetrieveRequestShowEnumOrigins MARITAL_STATUS =
            new EmployeesRetrieveRequestShowEnumOrigins(Value.MARITAL_STATUS, "marital_status");

    public static final EmployeesRetrieveRequestShowEnumOrigins EMPLOYMENT_STATUS =
            new EmployeesRetrieveRequestShowEnumOrigins(Value.EMPLOYMENT_STATUS, "employment_status");

    public static final EmployeesRetrieveRequestShowEnumOrigins EMPLOYMENT_STATUS_ETHNICITY_MARITAL_STATUS =
            new EmployeesRetrieveRequestShowEnumOrigins(
                    Value.EMPLOYMENT_STATUS_ETHNICITY_MARITAL_STATUS, "employment_status,ethnicity,marital_status");

    public static final EmployeesRetrieveRequestShowEnumOrigins EMPLOYMENT_STATUS_GENDER =
            new EmployeesRetrieveRequestShowEnumOrigins(Value.EMPLOYMENT_STATUS_GENDER, "employment_status,gender");

    public static final EmployeesRetrieveRequestShowEnumOrigins ETHNICITY_MARITAL_STATUS =
            new EmployeesRetrieveRequestShowEnumOrigins(Value.ETHNICITY_MARITAL_STATUS, "ethnicity,marital_status");

    public static final EmployeesRetrieveRequestShowEnumOrigins EMPLOYMENT_STATUS_ETHNICITY_GENDER =
            new EmployeesRetrieveRequestShowEnumOrigins(
                    Value.EMPLOYMENT_STATUS_ETHNICITY_GENDER, "employment_status,ethnicity,gender");

    public static final EmployeesRetrieveRequestShowEnumOrigins ETHNICITY_GENDER_MARITAL_STATUS =
            new EmployeesRetrieveRequestShowEnumOrigins(
    ...
    EmployeesRetrieveRequestShowEnumOrigins(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EmployeesRetrieveRequestShowEnumOrigins
                        && this.string.equals(((EmployeesRetrieveRequestShowEnumOrigins) other).string));
    }
    ...
    public static EmployeesRetrieveRequestShowEnumOrigins valueOf(String value) {
        switch (value) {
            case "gender":
                return GENDER;
            ...
            default:
                return new EmployeesRetrieveRequestShowEnumOrigins(Value.UNKNOWN, value);
        }
    }
