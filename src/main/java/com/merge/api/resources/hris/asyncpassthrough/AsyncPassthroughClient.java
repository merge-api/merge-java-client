...
public class AsyncPassthroughClient {
    ...
    public AsyncPassthroughReciept create(DataPassthroughRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), AsyncPassthroughReciept.class);
            }
            throw new ApiError(
                    response.code(),
    ...
    public RemoteResponse retrieve(String asyncPassthroughReceiptId, RequestOptions requestOptions) {
        ...
        try {
            ...
            Response response = client.newCall(okhttpRequest).execute();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), RemoteResponse.class);
            }
            throw new ApiError(
                    response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Object.class));
