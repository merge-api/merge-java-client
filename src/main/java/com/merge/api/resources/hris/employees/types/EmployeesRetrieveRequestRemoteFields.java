...
public final class EmployeesRetrieveRequestRemoteFields {
    public static final EmployeesRetrieveRequestRemoteFields GENDER =
            new EmployeesRetrieveRequestRemoteFields(Value.GENDER, "gender");

    public static final EmployeesRetrieveRequestRemoteFields EMPLOYMENT_STATUS_GENDER_MARITAL_STATUS =
            new EmployeesRetrieveRequestRemoteFields(
                    Value.EMPLOYMENT_STATUS_GENDER_MARITAL_STATUS, "employment_status,gender,marital_status");

    public static final EmployeesRetrieveRequestRemoteFields EMPLOYMENT_STATUS_ETHNICITY_GENDER_MARITAL_STATUS =
            new EmployeesRetrieveRequestRemoteFields(
                    Value.EMPLOYMENT_STATUS_ETHNICITY_GENDER_MARITAL_STATUS,
                    "employment_status,ethnicity,gender,marital_status");

    public static final EmployeesRetrieveRequestRemoteFields EMPLOYMENT_STATUS_MARITAL_STATUS =
            new EmployeesRetrieveRequestRemoteFields(
                    Value.EMPLOYMENT_STATUS_MARITAL_STATUS, "employment_status,marital_status");

    public static final EmployeesRetrieveRequestRemoteFields ETHNICITY_GENDER =
            new EmployeesRetrieveRequestRemoteFields(Value.ETHNICITY_GENDER, "ethnicity,gender");

    public static final EmployeesRetrieveRequestRemoteFields GENDER_MARITAL_STATUS =
            new EmployeesRetrieveRequestRemoteFields(Value.GENDER_MARITAL_STATUS, "gender,marital_status");

    public static final EmployeesRetrieveRequestRemoteFields EMPLOYMENT_STATUS_ETHNICITY =
            new EmployeesRetrieveRequestRemoteFields(Value.EMPLOYMENT_STATUS_ETHNICITY, "employment_status,ethnicity");

    public static final EmployeesRetrieveRequestRemoteFields ETHNICITY =
            new EmployeesRetrieveRequestRemoteFields(Value.ETHNICITY, "ethnicity");

    public static final EmployeesRetrieveRequestRemoteFields MARITAL_STATUS =
            new EmployeesRetrieveRequestRemoteFields(Value.MARITAL_STATUS, "marital_status");

    public static final EmployeesRetrieveRequestRemoteFields EMPLOYMENT_STATUS =
            new EmployeesRetrieveRequestRemoteFields(Value.EMPLOYMENT_STATUS, "employment_status");

    public static final EmployeesRetrieveRequestRemoteFields EMPLOYMENT_STATUS_ETHNICITY_MARITAL_STATUS =
            new EmployeesRetrieveRequestRemoteFields(
                    Value.EMPLOYMENT_STATUS_ETHNICITY_MARITAL_STATUS, "employment_status,ethnicity,marital_status");

    public static final EmployeesRetrieveRequestRemoteFields EMPLOYMENT_STATUS_GENDER =
            new EmployeesRetrieveRequestRemoteFields(Value.EMPLOYMENT_STATUS_GENDER, "employment_status,gender");

    public static final EmployeesRetrieveRequestRemoteFields ETHNICITY_MARITAL_STATUS =
            new EmployeesRetrieveRequestRemoteFields(Value.ETHNICITY_MARITAL_STATUS, "ethnicity,marital_status");

    public static final EmployeesRetrieveRequestRemoteFields EMPLOYMENT_STATUS_ETHNICITY_GENDER =
            new EmployeesRetrieveRequestRemoteFields(
                    Value.EMPLOYMENT_STATUS_ETHNICITY_GENDER, "employment_status,ethnicity,gender");

    public static final EmployeesRetrieveRequestRemoteFields ETHNICITY_GENDER_MARITAL_STATUS =
            new EmployeesRetrieveRequestRemoteFields(
    ...
    EmployeesRetrieveRequestRemoteFields(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EmployeesRetrieveRequestRemoteFields
                        && this.string.equals(((EmployeesRetrieveRequestRemoteFields) other).string));
    }
    ...
    public static EmployeesRetrieveRequestRemoteFields valueOf(String value) {
        switch (value) {
            case "gender":
                return GENDER;
            ...
            default:
                return new EmployeesRetrieveRequestRemoteFields(Value.UNKNOWN, value);
        }
    }
