...
@JsonDeserialize(builder = TimesheetEntryEndpointRequest.Builder.class)
public final class TimesheetEntryEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final TimesheetEntryRequest model;

    private TimesheetEntryEndpointRequest(
            Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, TimesheetEntryRequest model) {
    ...
    @JsonProperty("model")
    public TimesheetEntryRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TimesheetEntryEndpointRequest && equalTo((TimesheetEntryEndpointRequest) other);
    }

    private boolean equalTo(TimesheetEntryEndpointRequest other) {
    ...
    public interface ModelStage {
        _FinalStage model(TimesheetEntryRequest model);

        Builder from(TimesheetEntryEndpointRequest other);
    }

    public interface _FinalStage {
        TimesheetEntryEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private TimesheetEntryRequest model;
        ...
        @Override
        public Builder from(TimesheetEntryEndpointRequest other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(TimesheetEntryRequest model) {
            this.model = model;
            return this;
        }
        ...
        public TimesheetEntryEndpointRequest build() {
            return new TimesheetEntryEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
