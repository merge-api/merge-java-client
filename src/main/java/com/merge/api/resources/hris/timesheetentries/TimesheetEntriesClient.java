...
public class TimesheetEntriesClient {
    ...
    public PaginatedTimesheetEntryList list(TimesheetEntriesListRequest request, RequestOptions requestOptions) {
        ...
        if (request.getEndedAfter().isPresent()) {
            _httpUrl.addQueryParameter("ended_after", request.getEndedAfter().get());
        }
        if (request.getEndedBefore().isPresent()) {
            _httpUrl.addQueryParameter("ended_before", request.getEndedBefore().get());
        }
        ...
        if (request.getStartedAfter().isPresent()) {
            _httpUrl.addQueryParameter(
                    "started_after", request.getStartedAfter().get());
        }
        ...
        try {
            ...
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(
                        _response.body().string(), PaginatedTimesheetEntryList.class);
            }
            throw new ApiError(
                    _response.code(),
    ...
    public TimesheetEntryResponse create(TimesheetEntryEndpointRequest request, RequestOptions requestOptions) {
        ...
        try {
            Response _response = clientOptions.httpClient().newCall(_request).execute();
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), TimesheetEntryResponse.class);
            }
            throw new ApiError(
                    _response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), Object.class));
    ...
    public TimesheetEntry retrieve(String id, TimesheetEntriesRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try {
            Response _response = clientOptions.httpClient().newCall(_request).execute();
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), TimesheetEntry.class);
            }
            throw new ApiError(
                    _response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), Object.class));
