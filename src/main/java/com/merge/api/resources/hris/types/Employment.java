...
public final class Employment {
    ...
    public String toString() {
        return "Employment{" + "id: " + id + ", remoteId: " + remoteId + ", employee: " + employee + ", jobTitle: "
                + jobTitle + ", payRate: " + payRate + ", payPeriod: " + payPeriod + ", payFrequency: " + payFrequency
                + ", payCurrency: " + payCurrency + ", payGroup: " + payGroup + ", flsaStatus: " + flsaStatus
                + ", effectiveDate: " + effectiveDate + ", employmentType: " + employmentType + ", remoteWasDeleted: "
