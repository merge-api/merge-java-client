...
public class RawTimesheetEntriesClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedTimesheetEntryList> list() {
     ...
     * Returns a list of <code>TimesheetEntry</code> objects.
     */
    public MergeApiHttpResponse<PaginatedTimesheetEntryList> list(TimesheetEntriesListRequest request) {
