package com.merge.api.resources.hris.teams.requests;
...
@JsonDeserialize(builder = TeamsListRequest.Builder.class)
public final class TeamsListRequest {
    ...
    private final Optional<String> parentTeamId;

    private final Optional<String> remoteId;

    private TeamsListRequest(
    ...
    /**
     * @return If provided, will only return teams with this parent team.
     */
    @JsonProperty("parent_team_id")
    public Optional<String> getParentTeamId() {
        return parentTeamId;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TeamsListRequest && equalTo((TeamsListRequest) other);
    }

    private boolean equalTo(TeamsListRequest other) {
        return createdAfter.equals(other.createdAfter)
                ...
                && parentTeamId.equals(other.parentTeamId)
    ...
    public String toString() {
        return "TeamsListRequest{" + "createdAfter: " + createdAfter + ", createdBefore: " + createdBefore
                ...
                + ", modifiedBefore: " + modifiedBefore + ", pageSize: " + pageSize + ", parentTeamId: " + parentTeamId
                + ", remoteId: " + remoteId + "}";
    }
    ...
    public static final class Builder {
        ...
        private Optional<String> parentTeamId = Optional.empty();

        private Optional<String> remoteId = Optional.empty();

        private Builder() {}

        public Builder from(TeamsListRequest other) {
            ...
            parentTeamId(other.getParentTeamId());
        ...
        @JsonSetter(value = "parent_team_id", nulls = Nulls.SKIP)
        public Builder parentTeamId(Optional<String> parentTeamId) {
            this.parentTeamId = parentTeamId;
            return this;
        }

        public Builder parentTeamId(String parentTeamId) {
            this.parentTeamId = Optional.of(parentTeamId);
            return this;
        }
        ...
        public TeamsListRequest build() {
            return new TeamsListRequest(
                    createdAfter,
                    createdBefore,
                    cursor,
                    expand,
