...
public final class PaginatedBenefitList {
    ...
    private PaginatedBenefitList(Optional<String> next, Optional<String> previous, Optional<List<Benefit>> results) {
        this.next = next;
    ...
    public String toString() {
        return "PaginatedBenefitList{" + "next: " + next + ", previous: " + previous + ", results: " + results + "}";
    }
    ...
    public static final class Builder {
        ...
        public PaginatedBenefitList build() {
            return new PaginatedBenefitList(next, previous, results);
        }
    }
}
