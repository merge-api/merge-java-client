...
public final class TeamsRetrieveRequest {
    ...
    private TeamsRetrieveRequest(Optional<String> expand, Optional<Boolean> includeRemoteData) {
        this.expand = expand;
    ...
    public String toString() {
        return "TeamsRetrieveRequest{" + "expand: " + expand + ", includeRemoteData: " + includeRemoteData + "}";
    }
    ...
    public static final class Builder {
        ...
        public TeamsRetrieveRequest build() {
            return new TeamsRetrieveRequest(expand, includeRemoteData);
        }
    }
}
