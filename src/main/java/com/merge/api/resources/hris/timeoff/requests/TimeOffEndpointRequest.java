...
import com.merge.api.resources.hris.types.TimeOffRequest;
import java.util.Objects;
import java.util.Optional;

@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonDeserialize(builder = TimeOffEndpointRequest.Builder.class)
public final class TimeOffEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final TimeOffRequest model;

    private TimeOffEndpointRequest(Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, TimeOffRequest model) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TimeOffEndpointRequest && equalTo((TimeOffEndpointRequest) other);
    }

    private boolean equalTo(TimeOffEndpointRequest other) {
    ...
    public String toString() {
        return "TimeOffEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync + ", model: "
                + model + "}";
    }
    ...
    public interface ModelStage {
        _FinalStage model(TimeOffRequest model);

        Builder from(TimeOffEndpointRequest other);
    }
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        public Builder from(TimeOffEndpointRequest other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(TimeOffRequest model) {
            this.model = model;
            return this;
        }
        ...
        public TimeOffEndpointRequest build() {
            return new TimeOffEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
