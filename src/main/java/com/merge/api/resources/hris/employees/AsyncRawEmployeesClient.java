...
import com.merge.api.resources.hris.types.IgnoreCommonModelRequest;
...
public class AsyncRawEmployeesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<EmployeeResponse>> create(EmployeeEndpointRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<EmployeeResponse>> create(
        ...
        CompletableFuture<MergeApiHttpResponse<EmployeeResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
