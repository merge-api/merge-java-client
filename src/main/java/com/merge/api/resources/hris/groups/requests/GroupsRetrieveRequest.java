...
public final class GroupsRetrieveRequest {
    ...
    public String toString() {
        return "GroupsRetrieveRequest{" + "includeRemoteData: " + includeRemoteData + ", remoteFields: " + remoteFields
    ...
    public static final class Builder {
        ...
        public GroupsRetrieveRequest build() {
            return new GroupsRetrieveRequest(includeRemoteData, remoteFields, showEnumOrigins);
        }
    }
}
