...
public class AsyncRawTimesheetEntriesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedTimesheetEntryList>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedTimesheetEntryList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedTimesheetEntryList>> future = new CompletableFuture<>();
