    ...
    public PaginatedLocationList list(LocationsListRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), PaginatedLocationList.class);
            }
            throw new ApiError(
                    response.code(),
    ...
    public Location retrieve(String id, LocationsRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try {
            Response response =
                    clientOptions.httpClient().newCall(okhttpRequest).execute();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Location.class);
            }
            throw new ApiError(
                    response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Object.class));
