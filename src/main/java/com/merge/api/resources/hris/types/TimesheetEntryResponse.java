...
public final class TimesheetEntryResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull TimesheetEntry model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull TimesheetEntry model) {
            this.model = model;
            return this;
        }
        ...
        public TimesheetEntryResponse build() {
            return new TimesheetEntryResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
