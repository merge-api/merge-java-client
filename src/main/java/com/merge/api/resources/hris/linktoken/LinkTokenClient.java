package com.merge.api.resources.hris.linktoken;

import com.merge.api.core.ClientOptions;
import com.merge.api.core.ObjectMappers;
import com.merge.api.core.RequestOptions;
import com.merge.api.resources.hris.linktoken.requests.EndUserDetailsRequest;
import com.merge.api.resources.hris.types.LinkToken;
...
public class LinkTokenClient {
    ...
    public LinkToken create(EndUserDetailsRequest request, RequestOptions requestOptions) {
        HttpUrl _httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/hris/v1/link-token")
                .build();
