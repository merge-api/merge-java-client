    ...
    public PaginatedDependentList list(DependentsListRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), PaginatedDependentList.class);
            }
            throw new ApiError(
                    response.code(),
    ...
    public Dependent retrieve(String id, DependentsRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try {
            Response response =
                    clientOptions.httpClient().newCall(okhttpRequest).execute();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Dependent.class);
            }
            throw new ApiError(
                    response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Object.class));
