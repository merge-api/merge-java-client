...
public final class BankInfoRetrieveRequest {
    ...
    public String toString() {
        return "BankInfoRetrieveRequest{" + "expand: " + expand + ", includeRemoteData: " + includeRemoteData
    ...
    public static final class Builder {
        ...
        public BankInfoRetrieveRequest build() {
            return new BankInfoRetrieveRequest(expand, includeRemoteData, remoteFields, showEnumOrigins);
        }
    }
}
