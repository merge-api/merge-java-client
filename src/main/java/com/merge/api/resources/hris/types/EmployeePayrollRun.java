...
public final class EmployeePayrollRun {
    ...
    public String toString() {
        return "EmployeePayrollRun{" + "id: " + id + ", remoteId: " + remoteId + ", employee: " + employee
                + ", payrollRun: " + payrollRun + ", grossPay: " + grossPay + ", netPay: " + netPay + ", startDate: "
                + startDate + ", endDate: " + endDate + ", checkDate: " + checkDate + ", earnings: " + earnings
                + ", deductions: " + deductions + ", taxes: " + taxes + ", remoteWasDeleted: " + remoteWasDeleted
