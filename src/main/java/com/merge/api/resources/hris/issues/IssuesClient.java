package com.merge.api.resources.hris.issues;

import com.merge.api.core.ApiError;
import com.merge.api.core.ClientOptions;
import com.merge.api.core.ObjectMappers;
import com.merge.api.core.RequestOptions;
import com.merge.api.resources.hris.issues.requests.IssuesListRequest;
import com.merge.api.resources.hris.types.Issue;
import com.merge.api.resources.hris.types.PaginatedIssueList;
...
public class IssuesClient {
    ...
    public PaginatedIssueList list(IssuesListRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder _httpUrl = HttpUrl.parse(
                ...
                .newBuilder()
                .addPathSegments("api/hris/v1/issues");
