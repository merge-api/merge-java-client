...
public final class Employee {
    ...
    public String toString() {
        return "Employee{" + "id: " + id + ", remoteId: " + remoteId + ", employeeNumber: " + employeeNumber
                + ", company: " + company + ", firstName: " + firstName + ", lastName: " + lastName
                + ", displayFullName: " + displayFullName + ", username: " + username + ", groups: " + groups
                + ", workEmail: " + workEmail + ", personalEmail: " + personalEmail + ", mobilePhoneNumber: "
                + mobilePhoneNumber + ", employments: " + employments + ", homeLocation: " + homeLocation
                + ", workLocation: " + workLocation + ", manager: " + manager + ", team: " + team + ", payGroup: "
                + payGroup + ", ssn: " + ssn + ", gender: " + gender + ", ethnicity: " + ethnicity + ", maritalStatus: "
                + maritalStatus + ", dateOfBirth: " + dateOfBirth + ", hireDate: " + hireDate + ", startDate: "
                + startDate + ", remoteCreatedAt: " + remoteCreatedAt + ", employmentStatus: " + employmentStatus
                + ", terminationDate: " + terminationDate + ", avatar: " + avatar + ", customFields: " + customFields
