...
public final class TimeOffBalancesRetrieveRequest {
    ...
    public String toString() {
        return "TimeOffBalancesRetrieveRequest{" + "expand: " + expand + ", includeRemoteData: " + includeRemoteData
    ...
    public static final class Builder {
        ...
        public TimeOffBalancesRetrieveRequest build() {
            return new TimeOffBalancesRetrieveRequest(expand, includeRemoteData, remoteFields, showEnumOrigins);
        }
    }
}
