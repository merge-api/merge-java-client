...
public class EmploymentsClient {
    ...
    public PaginatedEmploymentList list(EmploymentsListRequest request) {
        ...
        try {
            ...
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), PaginatedEmploymentList.class);
            }
    ...
    public Employment retrieve(String id, EmploymentsRetrieveRequest request) {
        ...
        try {
            Response _response = clientOptions.httpClient().newCall(_request).execute();
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), Employment.class);
            }
            throw new RuntimeException();
        } catch (Exception e) {
            throw new RuntimeException(e);
