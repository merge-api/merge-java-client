...
public final class PayGroup {
    ...
    public Optional<String> getPayGroupName() {
        return payGroupName;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PayGroup && equalTo((PayGroup) other);
    }
    ...
    public String toString() {
        return "PayGroup{" + "id: " + id + ", remoteId: " + remoteId + ", payGroupName: " + payGroupName
    ...
    public static final class Builder {
        ...
        public PayGroup build() {
            return new PayGroup(id, remoteId, payGroupName, remoteWasDeleted, modifiedAt, fieldMappings, remoteData);
        }
    }
}
