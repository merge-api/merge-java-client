...
public class AsyncRawLinkTokenClient {
    protected final ClientOptions clientOptions;

    public AsyncRawLinkTokenClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<MergeApiHttpResponse<LinkToken>> create(
        ...
        CompletableFuture<MergeApiHttpResponse<LinkToken>> future = new CompletableFuture<>();
