...
public final class OffersListRequest {
    ...
    /**
     * @return If provided, will only return offers for this application.
     */
    ...
    /**
     * @return If provided, will only return offers created by this user.
     */
    ...
    public String toString() {
        return "OffersListRequest{" + "applicationId: " + applicationId + ", createdAfter: " + createdAfter
                + ", createdBefore: " + createdBefore + ", creatorId: " + creatorId + ", cursor: " + cursor
