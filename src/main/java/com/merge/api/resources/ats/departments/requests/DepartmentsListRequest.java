...
@JsonDeserialize(builder = DepartmentsListRequest.Builder.class)
public final class DepartmentsListRequest {
    ...
    private DepartmentsListRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DepartmentsListRequest && equalTo((DepartmentsListRequest) other);
    }

    private boolean equalTo(DepartmentsListRequest other) {
    ...
    public String toString() {
        return "DepartmentsListRequest{" + "createdAfter: " + createdAfter + ", createdBefore: " + createdBefore
    ...
    public static final class Builder {
        ...
        public Builder from(DepartmentsListRequest other) {
        ...
        public DepartmentsListRequest build() {
