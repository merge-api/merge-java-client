...
public final class JobInterviewStagesListRequest {
    ...
    public String toString() {
        return "JobInterviewStagesListRequest{" + "createdAfter: " + createdAfter + ", createdBefore: " + createdBefore
                + ", cursor: " + cursor + ", expand: " + expand + ", includeDeletedData: " + includeDeletedData
                + ", includeRemoteData: " + includeRemoteData + ", jobId: " + jobId + ", modifiedAfter: "
