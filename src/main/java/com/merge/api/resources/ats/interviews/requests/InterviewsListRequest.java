...
import com.merge.api.resources.ats.types.InterviewsListRequestExpand;
...
public final class InterviewsListRequest {
    ...
    public String toString() {
        return "InterviewsListRequest{" + "applicationId: " + applicationId + ", createdAfter: " + createdAfter
                ...
                + ", jobInterviewStageId: " + jobInterviewStageId + ", modifiedAfter: " + modifiedAfter
                + ", modifiedBefore: " + modifiedBefore + ", organizerId: " + organizerId + ", pageSize: " + pageSize
