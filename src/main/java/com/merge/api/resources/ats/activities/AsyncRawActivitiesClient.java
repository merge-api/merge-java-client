...
public class AsyncRawActivitiesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedActivityList>> list() {
     ...
     * Returns a list of <code>Activity</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedActivityList>> list(ActivitiesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedActivityList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedActivityList>> future = new CompletableFuture<>();
