...
public class AsyncRawEeocsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedEeocList>> list() {
     ...
     * Returns a list of <code>EEOC</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedEeocList>> list(EeocsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedEeocList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedEeocList>> future = new CompletableFuture<>();
