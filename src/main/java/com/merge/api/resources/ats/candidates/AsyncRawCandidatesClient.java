...
import com.merge.api.resources.ats.types.IgnoreCommonModelRequest;
...
public class AsyncRawCandidatesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedCandidateList>> list() {
     ...
     * Returns a list of <code>Candidate</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedCandidateList>> list(CandidatesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedCandidateList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedCandidateList>> future = new CompletableFuture<>();
