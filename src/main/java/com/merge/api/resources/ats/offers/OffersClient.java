...
public class OffersClient {
    ...
    public PaginatedOfferList list(OffersListRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), PaginatedOfferList.class);
            }
            throw new ApiError(
                    response.code(),
    ...
    public Offer retrieve(String id, OffersRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            Response response = client.newCall(okhttpRequest).execute();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Offer.class);
            }
            throw new ApiError(
                    response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Object.class));
