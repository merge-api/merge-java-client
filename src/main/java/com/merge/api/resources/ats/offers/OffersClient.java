...
public class OffersClient {
    ...
    public PaginatedOfferList list(OffersListRequest request, RequestOptions requestOptions) {
        ...
        if (request.getCreatorId().isPresent()) {
            _httpUrl.addQueryParameter("creator_id", request.getCreatorId().get());
        }
        ...
        try {
            ...
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), PaginatedOfferList.class);
            }
            throw new ApiError(
                    _response.code(),
    ...
    public Offer retrieve(String id, OffersRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try {
            Response _response = clientOptions.httpClient().newCall(_request).execute();
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), Offer.class);
            }
            throw new ApiError(
                    _response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), Object.class));
