...
public class RejectReasonsClient {
    ...
    public PaginatedRejectReasonList list(RejectReasonsListRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), PaginatedRejectReasonList.class);
            }
    ...
    public RejectReason retrieve(String id, RejectReasonsRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try {
            Response _response = clientOptions.httpClient().newCall(_request).execute();
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), RejectReason.class);
            }
            throw new RuntimeException();
        } catch (Exception e) {
            throw new RuntimeException(e);
