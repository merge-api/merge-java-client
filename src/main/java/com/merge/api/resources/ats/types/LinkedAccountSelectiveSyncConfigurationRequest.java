...
public final class LinkedAccountSelectiveSyncConfigurationRequest {
    ...
    private LinkedAccountSelectiveSyncConfigurationRequest(
            List<LinkedAccountConditionRequest> linkedAccountConditions, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder {
        ...
        public LinkedAccountSelectiveSyncConfigurationRequest build() {
            return new LinkedAccountSelectiveSyncConfigurationRequest(linkedAccountConditions, additionalProperties);
        }
    }
}
