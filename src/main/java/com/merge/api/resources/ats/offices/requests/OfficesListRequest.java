...
@JsonDeserialize(builder = OfficesListRequest.Builder.class)
public final class OfficesListRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof OfficesListRequest && equalTo((OfficesListRequest) other);
    }

    private boolean equalTo(OfficesListRequest other) {
    ...
    public String toString() {
        return "OfficesListRequest{" + "createdAfter: " + createdAfter + ", createdBefore: " + createdBefore
    ...
    public static final class Builder {
        ...
        public Builder from(OfficesListRequest other) {
        ...
        public OfficesListRequest build() {
            return new OfficesListRequest(
                    createdAfter,
                    createdBefore,
                    cursor,
                    includeDeletedData,
