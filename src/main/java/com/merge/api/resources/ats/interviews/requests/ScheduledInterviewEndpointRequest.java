...
import com.merge.api.resources.ats.types.ScheduledInterviewRequest;
...
public final class ScheduledInterviewEndpointRequest {
    ...
    public String toString() {
        return "ScheduledInterviewEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync
                + ", model: " + model + ", remoteUserId: " + remoteUserId + "}";
    }
    ...
    public interface ModelStage {
        RemoteUserIdStage model(ScheduledInterviewRequest model);
    ...
    public static final class Builder implements ModelStage, RemoteUserIdStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public RemoteUserIdStage model(ScheduledInterviewRequest model) {
            this.model = model;
            return this;
        }
        ...
        public ScheduledInterviewEndpointRequest build() {
            return new ScheduledInterviewEndpointRequest(isDebugMode, runAsync, model, remoteUserId);
        }
    }
}
