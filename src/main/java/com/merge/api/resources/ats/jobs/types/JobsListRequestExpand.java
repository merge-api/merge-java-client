...
public final class JobsListRequestExpand {
    public static final JobsListRequestExpand DEPARTMENTS_OFFICES_HIRING_MANAGERS_RECRUITERS =
            new JobsListRequestExpand(
                    Value.DEPARTMENTS_OFFICES_HIRING_MANAGERS_RECRUITERS,
                    "departments,offices,hiring_managers,recruiters");

    public static final JobsListRequestExpand DEPARTMENTS_RECRUITERS =
            new JobsListRequestExpand(Value.DEPARTMENTS_RECRUITERS, "departments,recruiters");

    public static final JobsListRequestExpand DEPARTMENTS_OFFICES =
            new JobsListRequestExpand(Value.DEPARTMENTS_OFFICES, "departments,offices");

    public static final JobsListRequestExpand DEPARTMENTS_OFFICES_JOB_POSTINGS_RECRUITERS = new JobsListRequestExpand(
            Value.DEPARTMENTS_OFFICES_JOB_POSTINGS_RECRUITERS, "departments,offices,job_postings,recruiters");

    public static final JobsListRequestExpand OFFICES_JOB_POSTINGS_RECRUITERS =
            new JobsListRequestExpand(Value.OFFICES_JOB_POSTINGS_RECRUITERS, "offices,job_postings,recruiters");

    public static final JobsListRequestExpand OFFICES_HIRING_MANAGERS_JOB_POSTINGS = new JobsListRequestExpand(
            Value.OFFICES_HIRING_MANAGERS_JOB_POSTINGS, "offices,hiring_managers,job_postings");

    public static final JobsListRequestExpand OFFICES = new JobsListRequestExpand(Value.OFFICES, "offices");

    public static final JobsListRequestExpand OFFICES_HIRING_MANAGERS_RECRUITERS =
            new JobsListRequestExpand(Value.OFFICES_HIRING_MANAGERS_RECRUITERS, "offices,hiring_managers,recruiters");

    public static final JobsListRequestExpand HIRING_MANAGERS_JOB_POSTINGS =
            new JobsListRequestExpand(Value.HIRING_MANAGERS_JOB_POSTINGS, "hiring_managers,job_postings");

    public static final JobsListRequestExpand DEPARTMENTS_HIRING_MANAGERS =
            new JobsListRequestExpand(Value.DEPARTMENTS_HIRING_MANAGERS, "departments,hiring_managers");

    public static final JobsListRequestExpand HIRING_MANAGERS =
            new JobsListRequestExpand(Value.HIRING_MANAGERS, "hiring_managers");

    public static final JobsListRequestExpand OFFICES_JOB_POSTINGS =
            new JobsListRequestExpand(Value.OFFICES_JOB_POSTINGS, "offices,job_postings");

    public static final JobsListRequestExpand RECRUITERS = new JobsListRequestExpand(Value.RECRUITERS, "recruiters");

    public static final JobsListRequestExpand OFFICES_RECRUITERS =
            new JobsListRequestExpand(Value.OFFICES_RECRUITERS, "offices,recruiters");

    public static final JobsListRequestExpand DEPARTMENTS_OFFICES_HIRING_MANAGERS_JOB_POSTINGS_RECRUITERS =
            new JobsListRequestExpand(
    ...
    public static final JobsListRequestExpand OFFICES_HIRING_MANAGERS =
            new JobsListRequestExpand(Value.OFFICES_HIRING_MANAGERS, "offices,hiring_managers");

    public static final JobsListRequestExpand HIRING_MANAGERS_RECRUITERS =
            new JobsListRequestExpand(Value.HIRING_MANAGERS_RECRUITERS, "hiring_managers,recruiters");

    public static final JobsListRequestExpand JOB_POSTINGS =
            new JobsListRequestExpand(Value.JOB_POSTINGS, "job_postings");

    public static final JobsListRequestExpand JOB_POSTINGS_RECRUITERS =
            new JobsListRequestExpand(Value.JOB_POSTINGS_RECRUITERS, "job_postings,recruiters");

    public static final JobsListRequestExpand DEPARTMENTS_OFFICES_JOB_POSTINGS =
            new JobsListRequestExpand(Value.DEPARTMENTS_OFFICES_JOB_POSTINGS, "departments,offices,job_postings");

    public static final JobsListRequestExpand DEPARTMENTS_JOB_POSTINGS_RECRUITERS =
            new JobsListRequestExpand(Value.DEPARTMENTS_JOB_POSTINGS_RECRUITERS, "departments,job_postings,recruiters");

    public static final JobsListRequestExpand DEPARTMENTS_HIRING_MANAGERS_JOB_POSTINGS = new JobsListRequestExpand(
            Value.DEPARTMENTS_HIRING_MANAGERS_JOB_POSTINGS, "departments,hiring_managers,job_postings");

    public static final JobsListRequestExpand DEPARTMENTS_JOB_POSTINGS =
            new JobsListRequestExpand(Value.DEPARTMENTS_JOB_POSTINGS, "departments,job_postings");

    public static final JobsListRequestExpand DEPARTMENTS_OFFICES_RECRUITERS =
            new JobsListRequestExpand(Value.DEPARTMENTS_OFFICES_RECRUITERS, "departments,offices,recruiters");

    public static final JobsListRequestExpand DEPARTMENTS_HIRING_MANAGERS_JOB_POSTINGS_RECRUITERS =
            new JobsListRequestExpand(
                    Value.DEPARTMENTS_HIRING_MANAGERS_JOB_POSTINGS_RECRUITERS,
                    "departments,hiring_managers,job_postings,recruiters");

    public static final JobsListRequestExpand DEPARTMENTS_OFFICES_HIRING_MANAGERS =
            new JobsListRequestExpand(Value.DEPARTMENTS_OFFICES_HIRING_MANAGERS, "departments,offices,hiring_managers");

    public static final JobsListRequestExpand DEPARTMENTS_HIRING_MANAGERS_RECRUITERS = new JobsListRequestExpand(
            Value.DEPARTMENTS_HIRING_MANAGERS_RECRUITERS, "departments,hiring_managers,recruiters");

    public static final JobsListRequestExpand DEPARTMENTS = new JobsListRequestExpand(Value.DEPARTMENTS, "departments");

    public static final JobsListRequestExpand HIRING_MANAGERS_JOB_POSTINGS_RECRUITERS = new JobsListRequestExpand(
            Value.HIRING_MANAGERS_JOB_POSTINGS_RECRUITERS, "hiring_managers,job_postings,recruiters");

    public static final JobsListRequestExpand OFFICES_HIRING_MANAGERS_JOB_POSTINGS_RECRUITERS =
            new JobsListRequestExpand(
                    Value.OFFICES_HIRING_MANAGERS_JOB_POSTINGS_RECRUITERS,
                    "offices,hiring_managers,job_postings,recruiters");

    public static final JobsListRequestExpand DEPARTMENTS_OFFICES_HIRING_MANAGERS_JOB_POSTINGS =
            new JobsListRequestExpand(
    ...
    JobsListRequestExpand(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof JobsListRequestExpand
                        && this.string.equals(((JobsListRequestExpand) other).string));
    }
    ...
    public static JobsListRequestExpand valueOf(String value) {
        switch (value) {
            ...
            default:
                return new JobsListRequestExpand(Value.UNKNOWN, value);
        }
    }
