...
@JsonDeserialize(builder = RejectReasonsListRequest.Builder.class)
public final class RejectReasonsListRequest {
    ...
    private RejectReasonsListRequest(
    ...
    private boolean equalTo(RejectReasonsListRequest other) {
    ...
    public String toString() {
        return "RejectReasonsListRequest{" + "createdAfter: " + createdAfter + ", createdBefore: " + createdBefore
    ...
    public static final class Builder {
        ...
        public Builder from(RejectReasonsListRequest other) {
        ...
        public RejectReasonsListRequest build() {
            return new RejectReasonsListRequest(
                    createdAfter,
                    createdBefore,
                    cursor,
                    includeDeletedData,
