...
public final class CandidateRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CandidateRequest && equalTo((CandidateRequest) other);
    }
    ...
    public String toString() {
        return "CandidateRequest{" + "firstName: " + firstName + ", lastName: " + lastName + ", company: " + company
                + ", title: " + title + ", lastInteractionAt: " + lastInteractionAt + ", isPrivate: " + isPrivate
                + ", canEmail: " + canEmail + ", locations: " + locations + ", phoneNumbers: " + phoneNumbers
                + ", emailAddresses: " + emailAddresses + ", urls: " + urls + ", tags: " + tags + ", applications: "
                + applications + ", attachments: " + attachments + ", remoteTemplateId: " + remoteTemplateId
