...
public final class PatchedCandidateRequest {
    ...
    public String toString() {
        return "PatchedCandidateRequest{" + "firstName: " + firstName + ", lastName: " + lastName + ", company: "
                + company + ", title: " + title + ", lastInteractionAt: " + lastInteractionAt + ", isPrivate: "
                + isPrivate + ", canEmail: " + canEmail + ", locations: " + locations + ", phoneNumbers: "
                + phoneNumbers + ", emailAddresses: " + emailAddresses + ", urls: " + urls + ", tags: " + tags
                + ", applications: " + applications + ", attachments: " + attachments + ", remoteTemplateId: "
