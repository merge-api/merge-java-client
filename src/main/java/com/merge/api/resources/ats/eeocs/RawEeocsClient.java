...
public class RawEeocsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedEeocList> list() {
     ...
     * Returns a list of <code>EEOC</code> objects.
     */
    public MergeApiHttpResponse<PaginatedEeocList> list(EeocsListRequest request) {
     ...
     * Returns a list of <code>EEOC</code> objects.
     */
    public MergeApiHttpResponse<PaginatedEeocList> list(EeocsListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedEeocList.class), response);
            }
