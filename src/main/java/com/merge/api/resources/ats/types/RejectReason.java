...
public final class RejectReason {
    ...
    public String toString() {
        return "RejectReason{" + "id: " + id + ", remoteId: " + remoteId + ", name: " + name + ", remoteWasDeleted: "
    ...
    public static final class Builder {
        ...
        public RejectReason build() {
            return new RejectReason(id, remoteId, name, remoteWasDeleted, modifiedAt, fieldMappings, remoteData);
        }
    }
}
