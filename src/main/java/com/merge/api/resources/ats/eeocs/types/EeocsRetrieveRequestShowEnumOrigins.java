...
public final class EeocsRetrieveRequestShowEnumOrigins {
    public static final EeocsRetrieveRequestShowEnumOrigins GENDER =
            new EeocsRetrieveRequestShowEnumOrigins(Value.GENDER, "gender");

    public static final EeocsRetrieveRequestShowEnumOrigins DISABILITY_STATUS_GENDER_RACE_VETERAN_STATUS =
            new EeocsRetrieveRequestShowEnumOrigins(
                    Value.DISABILITY_STATUS_GENDER_RACE_VETERAN_STATUS, "disability_status,gender,race,veteran_status");

    public static final EeocsRetrieveRequestShowEnumOrigins DISABILITY_STATUS_GENDER_VETERAN_STATUS =
            new EeocsRetrieveRequestShowEnumOrigins(
                    Value.DISABILITY_STATUS_GENDER_VETERAN_STATUS, "disability_status,gender,veteran_status");

    public static final EeocsRetrieveRequestShowEnumOrigins RACE_VETERAN_STATUS =
            new EeocsRetrieveRequestShowEnumOrigins(Value.RACE_VETERAN_STATUS, "race,veteran_status");

    public static final EeocsRetrieveRequestShowEnumOrigins DISABILITY_STATUS_GENDER_RACE =
            new EeocsRetrieveRequestShowEnumOrigins(
                    Value.DISABILITY_STATUS_GENDER_RACE, "disability_status,gender,race");

    public static final EeocsRetrieveRequestShowEnumOrigins DISABILITY_STATUS_VETERAN_STATUS =
            new EeocsRetrieveRequestShowEnumOrigins(
                    Value.DISABILITY_STATUS_VETERAN_STATUS, "disability_status,veteran_status");

    public static final EeocsRetrieveRequestShowEnumOrigins GENDER_RACE =
            new EeocsRetrieveRequestShowEnumOrigins(Value.GENDER_RACE, "gender,race");

    public static final EeocsRetrieveRequestShowEnumOrigins DISABILITY_STATUS_RACE =
            new EeocsRetrieveRequestShowEnumOrigins(Value.DISABILITY_STATUS_RACE, "disability_status,race");

    public static final EeocsRetrieveRequestShowEnumOrigins VETERAN_STATUS =
            new EeocsRetrieveRequestShowEnumOrigins(Value.VETERAN_STATUS, "veteran_status");

    public static final EeocsRetrieveRequestShowEnumOrigins DISABILITY_STATUS_RACE_VETERAN_STATUS =
            new EeocsRetrieveRequestShowEnumOrigins(
                    Value.DISABILITY_STATUS_RACE_VETERAN_STATUS, "disability_status,race,veteran_status");

    public static final EeocsRetrieveRequestShowEnumOrigins DISABILITY_STATUS_GENDER =
            new EeocsRetrieveRequestShowEnumOrigins(Value.DISABILITY_STATUS_GENDER, "disability_status,gender");

    public static final EeocsRetrieveRequestShowEnumOrigins GENDER_RACE_VETERAN_STATUS =
            new EeocsRetrieveRequestShowEnumOrigins(Value.GENDER_RACE_VETERAN_STATUS, "gender,race,veteran_status");

    public static final EeocsRetrieveRequestShowEnumOrigins DISABILITY_STATUS =
            new EeocsRetrieveRequestShowEnumOrigins(Value.DISABILITY_STATUS, "disability_status");

    public static final EeocsRetrieveRequestShowEnumOrigins GENDER_VETERAN_STATUS =
            new EeocsRetrieveRequestShowEnumOrigins(Value.GENDER_VETERAN_STATUS, "gender,veteran_status");

    public static final EeocsRetrieveRequestShowEnumOrigins RACE =
            new EeocsRetrieveRequestShowEnumOrigins(Value.RACE, "race");

    private final Value value;

    private final String string;

    EeocsRetrieveRequestShowEnumOrigins(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EeocsRetrieveRequestShowEnumOrigins
                        && this.string.equals(((EeocsRetrieveRequestShowEnumOrigins) other).string));
    }
    ...
    public static EeocsRetrieveRequestShowEnumOrigins valueOf(String value) {
        switch (value) {
            case "gender":
                return GENDER;
            ...
            case "race":
                return RACE;
            default:
                return new EeocsRetrieveRequestShowEnumOrigins(Value.UNKNOWN, value);
        }
    }
