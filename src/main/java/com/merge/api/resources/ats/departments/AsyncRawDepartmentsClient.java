...
public class AsyncRawDepartmentsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawDepartmentsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedDepartmentList>> list() {
     ...
     * Returns a list of <code>Department</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedDepartmentList>> list(DepartmentsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedDepartmentList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedDepartmentList>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<Department>> retrieve(String id) {
     ...
     * Returns a <code>Department</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<Department>> retrieve(String id, DepartmentsRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<Department>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<Department>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
