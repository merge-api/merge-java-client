...
public class ApplicationsClient {
    ...
    public PaginatedApplicationList list(ApplicationsListRequest request, RequestOptions requestOptions) {
        ...
        if (request.getSource().isPresent()) {
            _httpUrl.addQueryParameter("source", request.getSource().get());
        }
        ...
        try {
            ...
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), PaginatedApplicationList.class);
            }
            throw new ApiError(
                    _response.code(),
    ...
    public ApplicationResponse create(ApplicationEndpointRequest request, RequestOptions requestOptions) {
        ...
        try {
            Response _response = clientOptions.httpClient().newCall(_request).execute();
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), ApplicationResponse.class);
            }
            throw new ApiError(
                    _response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), Object.class));
    ...
    public Application retrieve(String id, ApplicationsRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try {
            Response _response = clientOptions.httpClient().newCall(_request).execute();
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), Application.class);
            }
            throw new ApiError(
                    _response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), Object.class));
    ...
    public ApplicationResponse changeStageCreate(
        ...
        if (request.getJobInterviewStage().isPresent()) {
            _requestBodyProperties.put("job_interview_stage", request.getJobInterviewStage());
        }
