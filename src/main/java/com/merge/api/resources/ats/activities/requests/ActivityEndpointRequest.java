...
public final class ActivityEndpointRequest {
    ...
    private ActivityEndpointRequest(
            Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, ActivityRequest model, String remoteUserId) {
    ...
    public String toString() {
        return "ActivityEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync + ", model: "
    ...
    public static final class Builder implements ModelStage, RemoteUserIdStage, _FinalStage {
        ...
        public ActivityEndpointRequest build() {
            return new ActivityEndpointRequest(isDebugMode, runAsync, model, remoteUserId);
        }
    }
}
