...
public final class TicketResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Ticket model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Ticket model) {
            this.model = model;
            return this;
        }
        ...
        public TicketResponse build() {
            return new TicketResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
