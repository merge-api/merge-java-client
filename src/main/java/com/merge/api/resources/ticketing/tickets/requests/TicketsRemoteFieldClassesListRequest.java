...
@JsonDeserialize(builder = TicketsRemoteFieldClassesListRequest.Builder.class)
public final class TicketsRemoteFieldClassesListRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TicketsRemoteFieldClassesListRequest
                && equalTo((TicketsRemoteFieldClassesListRequest) other);
    }
    ...
    public String toString() {
        return "TicketsRemoteFieldClassesListRequest{" + "cursor: " + cursor + ", includeDeletedData: "
    ...
    public static final class Builder {
        ...
        public TicketsRemoteFieldClassesListRequest build() {
            return new TicketsRemoteFieldClassesListRequest(cursor, includeDeletedData, includeRemoteData, pageSize);
        }
    }
}
