...
public class RawCollectionsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedCollectionList> list() {
     ...
     * Returns a list of <code>Collection</code> objects.
     */
    public MergeApiHttpResponse<PaginatedCollectionList> list(CollectionsListRequest request) {
     ...
     */
    public MergeApiHttpResponse<PaginatedViewerList> viewersList(String collectionId) {
