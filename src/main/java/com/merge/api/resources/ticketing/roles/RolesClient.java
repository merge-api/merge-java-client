...
public class RolesClient {
    ...
    public PaginatedRoleList list(RolesListRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), PaginatedRoleList.class);
            }
            throw new ApiError(
                    response.code(),
    ...
    public Role retrieve(String id, RolesRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            Response response = client.newCall(okhttpRequest).execute();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Role.class);
            }
            throw new ApiError(
                    response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Object.class));
