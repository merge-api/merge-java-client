...
public final class TagsListRequest {
    ...
    public String toString() {
        return "TagsListRequest{" + "createdAfter: " + createdAfter + ", createdBefore: " + createdBefore + ", cursor: "
                + cursor + ", includeDeletedData: " + includeDeletedData + ", includeRemoteData: " + includeRemoteData
