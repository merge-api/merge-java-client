...
@JsonDeserialize(builder = TicketingAttachmentEndpointRequest.Builder.class)
public final class TicketingAttachmentEndpointRequest {
    ...
    private TicketingAttachmentEndpointRequest(
            Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, AttachmentRequest model) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TicketingAttachmentEndpointRequest
                && equalTo((TicketingAttachmentEndpointRequest) other);
    }
    ...
    public String toString() {
        return "TicketingAttachmentEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync
                + ", model: " + model + "}";
    }
    ...
    public interface ModelStage {
        _FinalStage model(AttachmentRequest model);

        Builder from(TicketingAttachmentEndpointRequest other);
    }

    public interface _FinalStage {
        TicketingAttachmentEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        public TicketingAttachmentEndpointRequest build() {
            return new TicketingAttachmentEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
