...
public final class AttachmentsRetrieveRequest {
    ...
    private AttachmentsRetrieveRequest(Optional<String> expand, Optional<Boolean> includeRemoteData) {
        this.expand = expand;
    ...
    public String toString() {
        return "AttachmentsRetrieveRequest{" + "expand: " + expand + ", includeRemoteData: " + includeRemoteData + "}";
    }
    ...
    public static final class Builder {
        ...
        public AttachmentsRetrieveRequest build() {
            return new AttachmentsRetrieveRequest(expand, includeRemoteData);
        }
    }
}
