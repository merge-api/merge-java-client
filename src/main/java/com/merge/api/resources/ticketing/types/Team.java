...
public final class Team {
    ...
    public String toString() {
        return "Team{" + "id: " + id + ", remoteId: " + remoteId + ", name: " + name + ", description: " + description
    ...
    public static final class Builder {
        ...
        public Team build() {
            return new Team(id, remoteId, name, description, remoteWasDeleted, modifiedAt, fieldMappings, remoteData);
        }
    }
}
