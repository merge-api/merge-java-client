...
public final class PaginatedProjectList {
    ...
    private PaginatedProjectList(Optional<String> next, Optional<String> previous, Optional<List<Project>> results) {
        this.next = next;
    ...
    public String toString() {
        return "PaginatedProjectList{" + "next: " + next + ", previous: " + previous + ", results: " + results + "}";
    }
    ...
    public static final class Builder {
        ...
        public PaginatedProjectList build() {
            return new PaginatedProjectList(next, previous, results);
        }
    }
}
