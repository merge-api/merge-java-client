...
import com.merge.api.resources.ticketing.types.CollectionsListRequestCollectionType;
...
public final class CollectionsListRequest {
    ...
    /**
     * @return If provided, will only return collections whose parent collection matches the given id.
     */
    @JsonProperty("parent_collection_id")
    public Optional<String> getParentCollectionId() {
    ...
    private boolean equalTo(CollectionsListRequest other) {
    ...
    public String toString() {
        return "CollectionsListRequest{" + "collectionType: " + collectionType + ", createdAfter: " + createdAfter
                ...
                + pageSize + ", parentCollectionId: " + parentCollectionId + ", remoteFields: " + remoteFields
    ...
    public static final class Builder {
        ...
        public Builder from(CollectionsListRequest other) {
        ...
        @JsonSetter(value = "parent_collection_id", nulls = Nulls.SKIP)
        public Builder parentCollectionId(Optional<String> parentCollectionId) {
            this.parentCollectionId = parentCollectionId;
            return this;
        }

        public Builder parentCollectionId(String parentCollectionId) {
            this.parentCollectionId = Optional.of(parentCollectionId);
            return this;
        }
        ...
        public CollectionsListRequest build() {
            return new CollectionsListRequest(
                    collectionType,
                    createdAfter,
                    createdBefore,
                    cursor,
