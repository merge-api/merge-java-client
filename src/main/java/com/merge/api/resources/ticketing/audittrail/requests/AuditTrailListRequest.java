package com.merge.api.resources.ticketing.audittrail.requests;
...
public final class AuditTrailListRequest {
    ...
    /**
     * @return If included, will only include audit trail events that occured before this time
     */
    ...
    /**
     * @return If included, will only include audit trail events that occured after this time
     */
    ...
    public static final class Builder {
        ...
        public AuditTrailListRequest build() {
            return new AuditTrailListRequest(cursor, endDate, eventType, pageSize, startDate, userEmail);
        }
    }
}
