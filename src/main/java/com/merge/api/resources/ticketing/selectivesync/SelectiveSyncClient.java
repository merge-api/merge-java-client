...
import com.merge.api.resources.ticketing.selectivesync.requests.LinkedAccountSelectiveSyncConfigurationListRequest;
...
public class SelectiveSyncClient {
    ...
    public List<LinkedAccountSelectiveSyncConfiguration> configurationsList(RequestOptions requestOptions) {
        HttpUrl _httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/ticketing/v1/selective-sync/configurations")
                .build();
    ...
    public PaginatedConditionSchemaList metaList(SelectiveSyncMetaListRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder _httpUrl = HttpUrl.parse(
                ...
                .newBuilder()
                .addPathSegments("api/ticketing/v1/selective-sync/meta");
