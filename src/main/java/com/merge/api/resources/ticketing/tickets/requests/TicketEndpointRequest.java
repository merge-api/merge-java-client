...
@JsonDeserialize(builder = TicketEndpointRequest.Builder.class)
public final class TicketEndpointRequest {
    ...
    private TicketEndpointRequest(Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, TicketRequest model) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TicketEndpointRequest && equalTo((TicketEndpointRequest) other);
    }

    private boolean equalTo(TicketEndpointRequest other) {
    ...
    public String toString() {
        return "TicketEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync + ", model: "
                + model + "}";
    }
    ...
    public interface ModelStage {
        _FinalStage model(TicketRequest model);

        Builder from(TicketEndpointRequest other);
    }
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        public Builder from(TicketEndpointRequest other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(TicketRequest model) {
            this.model = model;
            return this;
        }
        ...
        public TicketEndpointRequest build() {
            return new TicketEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
