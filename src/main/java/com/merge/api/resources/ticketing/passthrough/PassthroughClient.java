package com.merge.api.resources.ticketing.passthrough;

import com.merge.api.core.ClientOptions;
import com.merge.api.core.ObjectMappers;
import com.merge.api.resources.ticketing.passthrough.requests.DataPassthroughRequest;
...
public class PassthroughClient {
    ...
    public RemoteResponse create(DataPassthroughRequest request) {
        HttpUrl _httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/ticketing/v1/passthrough")
                .build();
