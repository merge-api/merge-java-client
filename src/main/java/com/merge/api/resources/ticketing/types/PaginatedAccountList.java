...
@JsonDeserialize(builder = PaginatedAccountList.Builder.class)
public final class PaginatedAccountList {
    ...
    private PaginatedAccountList(Optional<String> next, Optional<String> previous, Optional<List<Account>> results) {
        this.next = next;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaginatedAccountList && equalTo((PaginatedAccountList) other);
    }

    private boolean equalTo(PaginatedAccountList other) {
    ...
    public String toString() {
        return "PaginatedAccountList{" + "next: " + next + ", previous: " + previous + ", results: " + results + "}";
    }
    ...
    public static final class Builder {
        ...
        public Builder from(PaginatedAccountList other) {
            next(other.getNext());
        ...
        public PaginatedAccountList build() {
            return new PaginatedAccountList(next, previous, results);
        }
    }
}
