...
public final class PatchedTicketRequest {
    ...
    public String toString() {
        return "PatchedTicketRequest{" + "name: " + name + ", assignees: " + assignees + ", creator: " + creator
                ...
                + ", parentTicket: " + parentTicket + ", tags: " + tags + ", completedAt: " + completedAt
                + ", ticketUrl: " + ticketUrl + ", priority: " + priority + ", integrationParams: " + integrationParams
