...
public final class CommentResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Comment model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Comment model) {
            this.model = model;
            return this;
        }
        ...
        public CommentResponse build() {
            return new CommentResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
