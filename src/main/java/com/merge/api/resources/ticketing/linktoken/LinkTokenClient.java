package com.merge.api.resources.ticketing.linktoken;

import com.merge.api.core.ClientOptions;
import com.merge.api.core.ObjectMappers;
import com.merge.api.resources.ticketing.linktoken.requests.EndUserDetailsRequest;
import com.merge.api.resources.ticketing.types.LinkToken;
...
public class LinkTokenClient {
    ...
    public LinkToken create(EndUserDetailsRequest request) {
        HttpUrl _httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/ticketing/v1/link-token")
                .build();
