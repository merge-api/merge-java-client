...
public final class CommentEndpointRequest {
    ...
    private CommentEndpointRequest(Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, CommentRequest model) {
    ...
    public String toString() {
        return "CommentEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync + ", model: "
                + model + "}";
    }
    ...
    public interface ModelStage {
        _FinalStage model(CommentRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(CommentRequest model) {
            this.model = model;
            return this;
        }
        ...
        public CommentEndpointRequest build() {
            return new CommentEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
