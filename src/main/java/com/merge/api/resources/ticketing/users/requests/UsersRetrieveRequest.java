...
import com.merge.api.resources.ticketing.users.types.UsersRetrieveRequestExpandItem;
...
public final class UsersRetrieveRequest {
    private final Optional<List<UsersRetrieveRequestExpandItem>> expand;
    ...
    private UsersRetrieveRequest(
            Optional<List<UsersRetrieveRequestExpandItem>> expand,
     ...
     */
    @JsonProperty("expand")
    public Optional<List<UsersRetrieveRequestExpandItem>> getExpand() {
        return expand;
    }
    ...
    public static final class Builder {
        private Optional<List<UsersRetrieveRequestExpandItem>> expand = Optional.empty();
        ...
        public Builder expand(Optional<List<UsersRetrieveRequestExpandItem>> expand) {
            this.expand = expand;
            return this;
        }

        public Builder expand(List<UsersRetrieveRequestExpandItem> expand) {
            this.expand = Optional.ofNullable(expand);
            return this;
        }

        public Builder expand(UsersRetrieveRequestExpandItem expand) {
        ...
        public UsersRetrieveRequest build() {
            return new UsersRetrieveRequest(expand, includeRemoteData, includeShellData, additionalProperties);
        }
    }
}
