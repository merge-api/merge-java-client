package com.merge.api.resources.ticketing.accounts.requests;
...
public final class AccountsRetrieveRequest {
    ...
    private AccountsRetrieveRequest(Optional<Boolean> includeRemoteData) {
    ...
    public String toString() {
        return "AccountsRetrieveRequest{" + "includeRemoteData: " + includeRemoteData + "}";
    }
    ...
    public static final class Builder {
        ...
        public AccountsRetrieveRequest build() {
            return new AccountsRetrieveRequest(includeRemoteData);
        }
    }
}
