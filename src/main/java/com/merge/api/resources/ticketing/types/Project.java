...
public final class Project {
    ...
    public String toString() {
        return "Project{" + "id: " + id + ", remoteId: " + remoteId + ", name: " + name + ", description: "
                + description + ", remoteWasDeleted: " + remoteWasDeleted + ", modifiedAt: " + modifiedAt
    ...
    public static final class Builder {
        ...
        public Project build() {
            return new Project(
                    id, remoteId, name, description, remoteWasDeleted, modifiedAt, fieldMappings, remoteData);
        }
    }
}
