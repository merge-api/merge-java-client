...
public final class Transaction {
    ...
    /**
     * @return The type of transaction, which can by any transaction object not already included in Merge’s common model.
     */
    ...
    /**
     * @return The transaction's number used for identifying purposes.
     */
    @JsonProperty("number")
    ...
    /**
     * @return The date upon which the transaction occurred.
     */
    ...
    /**
     * @return The total amount being paid after taxes.
     */
    ...
    /**
     * @return The transaction's currency.
     * <ul>
    ...
    /**
     * @return The transaction's exchange rate.
     */
    ...
    public String toString() {
        return "Transaction{" + "transactionType: " + transactionType + ", number: " + number + ", transactionDate: "
                + transactionDate + ", account: " + account + ", contact: " + contact + ", totalAmount: " + totalAmount
                + ", currency: " + currency + ", exchangeRate: " + exchangeRate + ", company: " + company
                + ", trackingCategories: " + trackingCategories + ", lineItems: " + lineItems + ", remoteWasDeleted: "
