...
public final class ExpenseRequest {
    ...
    public String toString() {
        return "ExpenseRequest{" + "transactionDate: " + transactionDate + ", account: " + account + ", contact: "
                + contact + ", totalAmount: " + totalAmount + ", currency: " + currency + ", exchangeRate: "
                + exchangeRate + ", company: " + company + ", memo: " + memo + ", lines: " + lines
                + ", trackingCategories: " + trackingCategories + ", integrationParams: " + integrationParams
