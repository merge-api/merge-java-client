...
public class RawAttachmentsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedAccountingAttachmentList> list() {
     ...
     * Returns a list of <code>AccountingAttachment</code> objects.
     */
    public MergeApiHttpResponse<PaginatedAccountingAttachmentList> list(AttachmentsListRequest request) {
