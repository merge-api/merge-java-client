...
public class AsyncRawAuditTrailClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedAuditLogEventList>> list() {
     ...
     * Gets a list of audit trail events.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedAuditLogEventList>> list(AuditTrailListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedAuditLogEventList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedAuditLogEventList>> future = new CompletableFuture<>();
