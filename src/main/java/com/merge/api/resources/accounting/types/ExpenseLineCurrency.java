...
public final class ExpenseLineCurrency {
    ...
    public static ExpenseLineCurrency of(TransactionCurrencyEnum value) {
    ...
    static final class Deserializer extends StdDeserializer<ExpenseLineCurrency> {
        ...
        @java.lang.Override
        public ExpenseLineCurrency deserialize(JsonParser p, DeserializationContext context) throws IOException {
