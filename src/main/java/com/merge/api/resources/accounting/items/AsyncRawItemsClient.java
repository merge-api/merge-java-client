...
public class AsyncRawItemsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedItemList>> list() {
     ...
     * Returns a list of <code>Item</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedItemList>> list(ItemsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedItemList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedItemList>> future = new CompletableFuture<>();
