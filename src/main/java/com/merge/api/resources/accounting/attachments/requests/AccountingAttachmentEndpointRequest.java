package com.merge.api.resources.accounting.attachments.requests;
...
import com.merge.api.resources.accounting.types.AccountingAttachmentRequest;
...
public final class AccountingAttachmentEndpointRequest {
    ...
    private final AccountingAttachmentRequest model;

    private AccountingAttachmentEndpointRequest(
            Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, AccountingAttachmentRequest model) {
    ...
    @JsonProperty("model")
    public AccountingAttachmentRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AccountingAttachmentEndpointRequest
                && equalTo((AccountingAttachmentEndpointRequest) other);
    }

    private boolean equalTo(AccountingAttachmentEndpointRequest other) {
    ...
    public String toString() {
        return "AccountingAttachmentEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync
                + ", model: " + model + "}";
    }
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private AccountingAttachmentRequest model;
        ...
        @Override
        public Builder from(AccountingAttachmentEndpointRequest other) {
        ...
        @Override
        public AccountingAttachmentEndpointRequest build() {
            return new AccountingAttachmentEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
