...
public class SelectiveSyncClient {
    ...
    public List<LinkedAccountSelectiveSyncConfiguration> configurationsList(RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("accounting/v1/selective-sync/configurations")
                .build();
        ...
        try {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(
                        responseBody.string(), new TypeReference<List<LinkedAccountSelectiveSyncConfiguration>>() {});
            }
            throw new ApiError(
                    response.code(),
    ...
    public PaginatedConditionSchemaList metaList(SelectiveSyncMetaListRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            ResponseBody responseBody = response.body();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedConditionSchemaList.class);
            }
            throw new ApiError(
                    response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(
