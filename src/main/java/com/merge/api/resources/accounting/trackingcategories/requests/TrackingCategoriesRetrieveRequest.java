...
public final class TrackingCategoriesRetrieveRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TrackingCategoriesRetrieveRequest && equalTo((TrackingCategoriesRetrieveRequest) other);
    }
    ...
    public String toString() {
        return "TrackingCategoriesRetrieveRequest{" + "expand: " + expand + ", includeRemoteData: " + includeRemoteData
    ...
    public static final class Builder {
        ...
        public TrackingCategoriesRetrieveRequest build() {
            return new TrackingCategoriesRetrieveRequest(expand, includeRemoteData, remoteFields, showEnumOrigins);
        }
    }
}
