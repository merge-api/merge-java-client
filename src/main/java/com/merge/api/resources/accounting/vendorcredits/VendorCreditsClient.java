...
public class VendorCreditsClient {
    ...
    public PaginatedVendorCreditList list(VendorCreditsListRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), PaginatedVendorCreditList.class);
            }
            throw new ApiError(
                    response.code(),
    ...
    public VendorCredit retrieve(String id, VendorCreditsRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            Response response = client.newCall(okhttpRequest).execute();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), VendorCredit.class);
            }
            throw new ApiError(
                    response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Object.class));
