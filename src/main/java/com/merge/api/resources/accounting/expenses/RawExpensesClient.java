...
public class RawExpensesClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedExpenseList> list() {
     ...
     * Returns a list of <code>Expense</code> objects.
     */
    public MergeApiHttpResponse<PaginatedExpenseList> list(ExpensesListRequest request) {
     ...
     * Returns a list of <code>Expense</code> objects.
     */
    public MergeApiHttpResponse<PaginatedExpenseList> list(ExpensesListRequest request, RequestOptions requestOptions) {
