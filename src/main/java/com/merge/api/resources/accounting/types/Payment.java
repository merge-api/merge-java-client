...
public final class Payment {
    ...
    public String toString() {
        return "Payment{" + "id: " + id + ", remoteId: " + remoteId + ", transactionDate: " + transactionDate
                + ", contact: " + contact + ", account: " + account + ", currency: " + currency + ", exchangeRate: "
                + exchangeRate + ", company: " + company + ", totalAmount: " + totalAmount + ", trackingCategories: "
                + trackingCategories + ", remoteUpdatedAt: " + remoteUpdatedAt + ", remoteWasDeleted: "
