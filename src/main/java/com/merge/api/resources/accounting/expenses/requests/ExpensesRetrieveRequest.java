...
import com.merge.api.resources.accounting.types.ExpensesRetrieveRequestExpand;
...
public final class ExpensesRetrieveRequest {
    ...
    private ExpensesRetrieveRequest(
            Optional<ExpensesRetrieveRequestExpand> expand, Optional<Boolean> includeRemoteData) {
        this.expand = expand;
    ...
    public String toString() {
        return "ExpensesRetrieveRequest{" + "expand: " + expand + ", includeRemoteData: " + includeRemoteData + "}";
    }
    ...
    public static final class Builder {
        ...
        public ExpensesRetrieveRequest build() {
            return new ExpensesRetrieveRequest(expand, includeRemoteData);
        }
    }
}
