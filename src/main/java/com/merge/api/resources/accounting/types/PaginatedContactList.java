...
@JsonDeserialize(builder = PaginatedContactList.Builder.class)
public final class PaginatedContactList {
    ...
    private PaginatedContactList(Optional<String> next, Optional<String> previous, Optional<List<Contact>> results) {
        this.next = next;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaginatedContactList && equalTo((PaginatedContactList) other);
    }

    private boolean equalTo(PaginatedContactList other) {
    ...
    public String toString() {
        return "PaginatedContactList{" + "next: " + next + ", previous: " + previous + ", results: " + results + "}";
    }
    ...
    public static final class Builder {
        ...
        public Builder from(PaginatedContactList other) {
            next(other.getNext());
        ...
        public Builder results(Optional<List<Contact>> results) {
            this.results = results;
            return this;
        }

        public Builder results(List<Contact> results) {
            this.results = Optional.of(results);
            return this;
        }

        public PaginatedContactList build() {
            return new PaginatedContactList(next, previous, results);
        }
    }
}
