package com.merge.api.resources.accounting.selectivesync.requests;
...
public final class SelectiveSyncMetaListRequest {
    ...
    private SelectiveSyncMetaListRequest(
            Optional<String> commonModel, Optional<String> cursor, Optional<Integer> pageSize) {
    ...
    public String toString() {
        return "SelectiveSyncMetaListRequest{" + "commonModel: " + commonModel + ", cursor: " + cursor + ", pageSize: "
                + pageSize + "}";
    }
    ...
    public static final class Builder {
        ...
        public SelectiveSyncMetaListRequest build() {
            return new SelectiveSyncMetaListRequest(commonModel, cursor, pageSize);
        }
    }
}
