...
public final class IncomeStatement {
    ...
    private IncomeStatement(
            ...
            Optional<List<ReportItem>> income,
            Optional<List<ReportItem>> costOfSales,
            Optional<Double> grossProfit,
            Optional<List<ReportItem>> operatingExpenses,
            Optional<Double> netOperatingIncome,
            Optional<List<ReportItem>> nonOperatingExpenses,
            Optional<Double> netIncome,
    ...
    /**
     * @return The income statement's name.
     */
    @JsonProperty("name")
    ...
    /**
     * @return The income statement's currency.
     * <ul>
    ...
    /**
     * @return The company the income statement belongs to.
     */
    ...
    /**
     * @return The income statement's start period.
     */
    ...
    /**
     * @return The income statement's end period.
     */
    ...
    /**
     * @return The revenue minus the cost of sale.
     */
    ...
    /**
     * @return The revenue minus the operating expenses.
     */
    ...
    /**
     * @return The gross profit minus the total expenses.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof IncomeStatement && equalTo((IncomeStatement) other);
    }
    ...
    private boolean equalTo(IncomeStatement other) {
        return id.equals(other.id)
                ...
                && income.equals(other.income)
                && costOfSales.equals(other.costOfSales)
                && grossProfit.equals(other.grossProfit)
                && operatingExpenses.equals(other.operatingExpenses)
                && netOperatingIncome.equals(other.netOperatingIncome)
                && nonOperatingExpenses.equals(other.nonOperatingExpenses)
    ...
    public String toString() {
        return "IncomeStatement{" + "id: " + id + ", remoteId: " + remoteId + ", name: " + name + ", currency: "
                + currency + ", company: " + company + ", startPeriod: " + startPeriod + ", endPeriod: " + endPeriod
                + ", income: " + income + ", costOfSales: " + costOfSales + ", grossProfit: " + grossProfit
                + ", operatingExpenses: " + operatingExpenses + ", netOperatingIncome: " + netOperatingIncome
                + ", nonOperatingExpenses: " + nonOperatingExpenses + ", netIncome: " + netIncome
    ...
    public static final class Builder {
        ...
        public Builder from(IncomeStatement other) {
            ...
            operatingExpenses(other.getOperatingExpenses());
            netOperatingIncome(other.getNetOperatingIncome());
            nonOperatingExpenses(other.getNonOperatingExpenses());
