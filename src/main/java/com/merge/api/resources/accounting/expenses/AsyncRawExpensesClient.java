...
public class AsyncRawExpensesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedExpenseList>> list() {
     ...
     * Returns a list of <code>Expense</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedExpenseList>> list(ExpensesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedExpenseList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedExpenseList>> future = new CompletableFuture<>();
