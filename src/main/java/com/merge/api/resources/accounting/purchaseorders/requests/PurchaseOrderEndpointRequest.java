...
import com.merge.api.resources.accounting.types.PurchaseOrderRequest;
...
public final class PurchaseOrderEndpointRequest {
    ...
    private PurchaseOrderEndpointRequest(
            Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, PurchaseOrderRequest model) {
    ...
    public String toString() {
        return "PurchaseOrderEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync + ", model: "
                + model + "}";
    }
    ...
    public interface ModelStage {
        _FinalStage model(PurchaseOrderRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(PurchaseOrderRequest model) {
            this.model = model;
            return this;
        }
        ...
        public PurchaseOrderEndpointRequest build() {
            return new PurchaseOrderEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
