...
public class AsyncRawAttachmentsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedAccountingAttachmentList>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedAccountingAttachmentList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedAccountingAttachmentList>> future = new CompletableFuture<>();
