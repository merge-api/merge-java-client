...
public final class JournalEntryEndpointRequest {
    ...
    private JournalEntryEndpointRequest(
            Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, JournalEntryRequest model) {
    ...
    public String toString() {
        return "JournalEntryEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync + ", model: "
                + model + "}";
    }
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        public JournalEntryEndpointRequest build() {
            return new JournalEntryEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
