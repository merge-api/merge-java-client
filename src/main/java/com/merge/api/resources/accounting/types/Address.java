...
public final class Address {
    ...
    public String toString() {
        return "Address{" + "type: " + type + ", street1: " + street1 + ", street2: " + street2 + ", city: " + city
                + ", state: " + state + ", countrySubdivision: " + countrySubdivision + ", country: " + country
                + ", zipCode: " + zipCode + ", modifiedAt: " + modifiedAt + "}";
    }
