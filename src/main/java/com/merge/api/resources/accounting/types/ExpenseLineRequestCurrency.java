...
public final class ExpenseLineRequestCurrency {
    ...
    public static ExpenseLineRequestCurrency of(TransactionCurrencyEnum value) {
    ...
    static final class Deserializer extends StdDeserializer<ExpenseLineRequestCurrency> {
        ...
        @java.lang.Override
        public ExpenseLineRequestCurrency deserialize(JsonParser p, DeserializationContext context) throws IOException {
