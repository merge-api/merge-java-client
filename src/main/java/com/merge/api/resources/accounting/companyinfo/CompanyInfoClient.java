...
public class CompanyInfoClient {
    ...
    public PaginatedCompanyInfoList list(CompanyInfoListRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder _httpUrl = HttpUrl.parse(
                ...
                .newBuilder()
                .addPathSegments("api/accounting/v1/company-info");
        ...
        try {
            ...
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), PaginatedCompanyInfoList.class);
            }
    ...
    public CompanyInfo retrieve(String id, CompanyInfoRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try {
            Response _response = clientOptions.httpClient().newCall(_request).execute();
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), CompanyInfo.class);
            }
            throw new RuntimeException();
        } catch (Exception e) {
            throw new RuntimeException(e);
