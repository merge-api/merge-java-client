...
public final class AttachmentsListRequest {
    ...
    /**
     * @return If provided, will only return accounting attachments for this company.
     */
    ...
    public String toString() {
        return "AttachmentsListRequest{" + "companyId: " + companyId + ", createdAfter: " + createdAfter
                + ", createdBefore: " + createdBefore + ", cursor: " + cursor + ", includeDeletedData: "
