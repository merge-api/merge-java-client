...
import com.merge.api.resources.accounting.types.ContactRequest;
import java.util.Objects;
import java.util.Optional;

@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonDeserialize(builder = ContactEndpointRequest.Builder.class)
public final class ContactEndpointRequest {
    ...
    private ContactEndpointRequest(Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, ContactRequest model) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ContactEndpointRequest && equalTo((ContactEndpointRequest) other);
    }

    private boolean equalTo(ContactEndpointRequest other) {
    ...
    public String toString() {
        return "ContactEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync + ", model: "
                + model + "}";
    }
    ...
    public interface ModelStage {
        ...
        Builder from(ContactEndpointRequest other);
    }

    public interface _FinalStage {
        ContactEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        public Builder from(ContactEndpointRequest other) {
        ...
        @Override
        public ContactEndpointRequest build() {
            return new ContactEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
