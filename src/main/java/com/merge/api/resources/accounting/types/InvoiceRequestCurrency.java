...
public final class InvoiceRequestCurrency {
    ...
    public static InvoiceRequestCurrency of(TransactionCurrencyEnum value) {
    ...
    static final class Deserializer extends StdDeserializer<InvoiceRequestCurrency> {
        ...
        @java.lang.Override
        public InvoiceRequestCurrency deserialize(JsonParser p, DeserializationContext context) throws IOException {
