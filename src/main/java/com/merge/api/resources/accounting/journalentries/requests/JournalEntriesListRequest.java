...
import com.merge.api.resources.accounting.journalentries.types.JournalEntriesListRequestExpand;
import java.time.OffsetDateTime;
import java.util.Objects;
import java.util.Optional;

@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonDeserialize(builder = JournalEntriesListRequest.Builder.class)
public final class JournalEntriesListRequest {
    ...
    private final Optional<JournalEntriesListRequestExpand> expand;
    ...
    private JournalEntriesListRequest(
    ...
    /**
     * @return If provided, will only return journal entries for this company.
     */
     ...
     */
    @JsonProperty("expand")
    public Optional<JournalEntriesListRequestExpand> getExpand() {
        return expand;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof JournalEntriesListRequest && equalTo((JournalEntriesListRequest) other);
    }

    private boolean equalTo(JournalEntriesListRequest other) {
    ...
    public static final class Builder {
        ...
        private Optional<JournalEntriesListRequestExpand> expand = Optional.empty();
        ...
        public Builder from(JournalEntriesListRequest other) {
        ...
        public Builder expand(Optional<JournalEntriesListRequestExpand> expand) {
            this.expand = expand;
            return this;
        }

        public Builder expand(JournalEntriesListRequestExpand expand) {
        ...
        public JournalEntriesListRequest build() {
            return new JournalEntriesListRequest(
                    companyId,
                    createdAfter,
                    createdBefore,
                    cursor,
