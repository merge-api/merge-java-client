...
public class ItemsClient {
    ...
    public PaginatedItemList list(ItemsListRequest request) {
        return list(request, null);
    }

    public PaginatedItemList list(ItemsListRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder _httpUrl = HttpUrl.parse(
                        this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/accounting/v1/items");
        ...
        try {
            ...
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), PaginatedItemList.class);
            }
    ...
    public Item retrieve(String id, ItemsRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try {
            Response _response = clientOptions.httpClient().newCall(_request).execute();
            if (_response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), Item.class);
            }
            throw new RuntimeException();
        } catch (Exception e) {
            throw new RuntimeException(e);
