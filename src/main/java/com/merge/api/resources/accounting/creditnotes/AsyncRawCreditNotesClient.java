...
public class AsyncRawCreditNotesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedCreditNoteList>> list() {
     ...
     * Returns a list of <code>CreditNote</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedCreditNoteList>> list(CreditNotesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedCreditNoteList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedCreditNoteList>> future = new CompletableFuture<>();
