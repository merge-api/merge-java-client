...
import com.merge.api.resources.accounting.types.ContactsRetrieveRequestExpand;
...
public final class ContactsRetrieveRequest {
    ...
    public static final class Builder {
        ...
        public ContactsRetrieveRequest build() {
            return new ContactsRetrieveRequest(expand, includeRemoteData, remoteFields, showEnumOrigins);
        }
    }
}
