...
import com.merge.api.resources.accounting.types.CompanyInfoRetrieveRequestExpand;
import java.util.Objects;
import java.util.Optional;

@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonDeserialize(builder = CompanyInfoRetrieveRequest.Builder.class)
public final class CompanyInfoRetrieveRequest {
    private final Optional<CompanyInfoRetrieveRequestExpand> expand;

    private final Optional<Boolean> includeRemoteData;

    private CompanyInfoRetrieveRequest(
            Optional<CompanyInfoRetrieveRequestExpand> expand, Optional<Boolean> includeRemoteData) {
        this.expand = expand;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CompanyInfoRetrieveRequest && equalTo((CompanyInfoRetrieveRequest) other);
    }
    ...
    public static final class Builder {
        ...
        public CompanyInfoRetrieveRequest build() {
            return new CompanyInfoRetrieveRequest(expand, includeRemoteData);
        }
    }
}
