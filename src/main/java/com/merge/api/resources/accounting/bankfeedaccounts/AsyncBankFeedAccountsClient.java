...
public class AsyncBankFeedAccountsClient {
     ...
     */
    public CompletableFuture<PaginatedBankFeedAccountList> list() {
     ...
     * Returns a list of <code>BankFeedAccount</code> objects.
     */
    public CompletableFuture<PaginatedBankFeedAccountList> list(BankFeedAccountsListRequest request) {
