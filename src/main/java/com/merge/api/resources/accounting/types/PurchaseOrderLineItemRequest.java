...
public final class PurchaseOrderLineItemRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PurchaseOrderLineItemRequest && equalTo((PurchaseOrderLineItemRequest) other);
    }

    private boolean equalTo(PurchaseOrderLineItemRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PurchaseOrderLineItemRequest other) {
