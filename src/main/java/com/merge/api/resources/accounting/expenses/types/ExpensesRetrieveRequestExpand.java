...
public final class ExpensesRetrieveRequestExpand {
    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_ACCOUNT =
            new ExpensesRetrieveRequestExpand(Value.TRACKING_CATEGORIES_ACCOUNT, "tracking_categories,account");

    public static final ExpensesRetrieveRequestExpand CONTACT_COMPANY_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES =
            new ExpensesRetrieveRequestExpand(Value.TRACKING_CATEGORIES, "tracking_categories");

    public static final ExpensesRetrieveRequestExpand ACCOUNT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand ACCOUNT_CONTACT =
            new ExpensesRetrieveRequestExpand(Value.ACCOUNT_CONTACT, "account,contact");
    ...
    public static final ExpensesRetrieveRequestExpand ACCOUNT_CONTACT_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
                    Value.ACCOUNT_CONTACT_ACCOUNTING_PERIOD, "account,contact,accounting_period");

    public static final ExpensesRetrieveRequestExpand ACCOUNT_CONTACT_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
                    Value.ACCOUNT_CONTACT_EMPLOYEE_ACCOUNTING_PERIOD, "account,contact,employee,accounting_period");

    public static final ExpensesRetrieveRequestExpand ACCOUNT_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(Value.ACCOUNT_EMPLOYEE, "account,employee");

    public static final ExpensesRetrieveRequestExpand ACCOUNT_COMPANY =
            new ExpensesRetrieveRequestExpand(Value.ACCOUNT_COMPANY, "account,company");

    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_COMPANY =
            new ExpensesRetrieveRequestExpand(Value.TRACKING_CATEGORIES_COMPANY, "tracking_categories,company");

    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_ACCOUNT_COMPANY_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(
                    Value.TRACKING_CATEGORIES_ACCOUNT_COMPANY_EMPLOYEE, "tracking_categories,account,company,employee");

    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_ACCOUNT_CONTACT_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_COMPANY_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand CONTACT_COMPANY_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(Value.CONTACT_COMPANY_EMPLOYEE, "contact,company,employee");

    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_ACCOUNT_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand ACCOUNT =
            new ExpensesRetrieveRequestExpand(Value.ACCOUNT, "account");

    public static final ExpensesRetrieveRequestExpand CONTACT_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
                    Value.CONTACT_EMPLOYEE_ACCOUNTING_PERIOD, "contact,employee,accounting_period");

    public static final ExpensesRetrieveRequestExpand ACCOUNT_CONTACT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
                    Value.ACCOUNT_CONTACT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD,
                    "account,contact,company,employee,accounting_period");

    public static final ExpensesRetrieveRequestExpand ACCOUNT_COMPANY_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(Value.ACCOUNT_COMPANY_EMPLOYEE, "account,company,employee");

    public static final ExpensesRetrieveRequestExpand CONTACT_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(Value.CONTACT_ACCOUNTING_PERIOD, "contact,accounting_period");

    public static final ExpensesRetrieveRequestExpand ACCOUNT_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(Value.ACCOUNT_ACCOUNTING_PERIOD, "account,accounting_period");

    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_ACCOUNT_CONTACT_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand COMPANY =
            new ExpensesRetrieveRequestExpand(Value.COMPANY, "company");

    public static final ExpensesRetrieveRequestExpand ACCOUNT_CONTACT_COMPANY_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(
                    Value.ACCOUNT_CONTACT_COMPANY_EMPLOYEE, "account,contact,company,employee");

    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_ACCOUNT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand CONTACT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
                    Value.CONTACT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD, "contact,company,employee,accounting_period");

    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_CONTACT_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand ACCOUNT_CONTACT_COMPANY =
            new ExpensesRetrieveRequestExpand(Value.ACCOUNT_CONTACT_COMPANY, "account,contact,company");

    public static final ExpensesRetrieveRequestExpand COMPANY_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_CONTACT_COMPANY_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(
                    Value.TRACKING_CATEGORIES_CONTACT_COMPANY_EMPLOYEE, "tracking_categories,contact,company,employee");

    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
                    Value.TRACKING_CATEGORIES_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD,
                    "tracking_categories,company,employee,accounting_period");

    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_CONTACT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(Value.TRACKING_CATEGORIES_EMPLOYEE, "tracking_categories,employee");
    ...
    public static final ExpensesRetrieveRequestExpand
            TRACKING_CATEGORIES_ACCOUNT_CONTACT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD = new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand EMPLOYEE =
            new ExpensesRetrieveRequestExpand(Value.EMPLOYEE, "employee");

    public static final ExpensesRetrieveRequestExpand ACCOUNT_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand CONTACT =
            new ExpensesRetrieveRequestExpand(Value.CONTACT, "contact");

    public static final ExpensesRetrieveRequestExpand ACCOUNT_CONTACT_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(Value.ACCOUNT_CONTACT_EMPLOYEE, "account,contact,employee");
    ...
    public static final ExpensesRetrieveRequestExpand ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(Value.ACCOUNTING_PERIOD, "accounting_period");

    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_ACCOUNT_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(
                    Value.TRACKING_CATEGORIES_ACCOUNT_EMPLOYEE, "tracking_categories,account,employee");

    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_CONTACT_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand COMPANY_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(Value.COMPANY_ACCOUNTING_PERIOD, "company,accounting_period");

    public static final ExpensesRetrieveRequestExpand CONTACT_COMPANY =
            new ExpensesRetrieveRequestExpand(Value.CONTACT_COMPANY, "contact,company");

    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_ACCOUNT_CONTACT_COMPANY_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(
                    Value.TRACKING_CATEGORIES_ACCOUNT_CONTACT_COMPANY_EMPLOYEE,
                    "tracking_categories,account,contact,company,employee");

    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(
    ...
    public static final ExpensesRetrieveRequestExpand TRACKING_CATEGORIES_CONTACT =
            new ExpensesRetrieveRequestExpand(Value.TRACKING_CATEGORIES_CONTACT, "tracking_categories,contact");
    ...
    public static final ExpensesRetrieveRequestExpand CONTACT_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(Value.CONTACT_EMPLOYEE, "contact,employee");
    ...
    public static final ExpensesRetrieveRequestExpand EMPLOYEE_ACCOUNTING_PERIOD =
            new ExpensesRetrieveRequestExpand(Value.EMPLOYEE_ACCOUNTING_PERIOD, "employee,accounting_period");
    ...
    public static final ExpensesRetrieveRequestExpand COMPANY_EMPLOYEE =
            new ExpensesRetrieveRequestExpand(Value.COMPANY_EMPLOYEE, "company,employee");

    private final Value value;

    private final String string;

    ExpensesRetrieveRequestExpand(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof ExpensesRetrieveRequestExpand
                        && this.string.equals(((ExpensesRetrieveRequestExpand) other).string));
    }
    ...
    public static ExpensesRetrieveRequestExpand valueOf(String value) {
        switch (value) {
            ...
            default:
                return new ExpensesRetrieveRequestExpand(Value.UNKNOWN, value);
        }
    }
