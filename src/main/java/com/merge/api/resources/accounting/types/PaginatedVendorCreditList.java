...
public final class PaginatedVendorCreditList {
    ...
    private PaginatedVendorCreditList(
            Optional<String> next, Optional<String> previous, Optional<List<VendorCredit>> results) {
        this.next = next;
    ...
    public String toString() {
        return "PaginatedVendorCreditList{" + "next: " + next + ", previous: " + previous + ", results: " + results
                + "}";
    }
    ...
    public static final class Builder {
        ...
        public PaginatedVendorCreditList build() {
            return new PaginatedVendorCreditList(next, previous, results);
        }
    }
}
