...
import com.merge.api.resources.accounting.vendorcredits.types.VendorCreditsRetrieveRequestExpandItem;
...
public final class VendorCreditsRetrieveRequest {
    private final Optional<List<VendorCreditsRetrieveRequestExpandItem>> expand;
    ...
    private VendorCreditsRetrieveRequest(
            Optional<List<VendorCreditsRetrieveRequestExpandItem>> expand,
     ...
     */
    @JsonProperty("expand")
    public Optional<List<VendorCreditsRetrieveRequestExpandItem>> getExpand() {
        return expand;
    }
    ...
    public static final class Builder {
        private Optional<List<VendorCreditsRetrieveRequestExpandItem>> expand = Optional.empty();
        ...
        public Builder expand(Optional<List<VendorCreditsRetrieveRequestExpandItem>> expand) {
            this.expand = expand;
            return this;
        }

        public Builder expand(List<VendorCreditsRetrieveRequestExpandItem> expand) {
            this.expand = Optional.ofNullable(expand);
            return this;
        }

        public Builder expand(VendorCreditsRetrieveRequestExpandItem expand) {
        ...
        public VendorCreditsRetrieveRequest build() {
            return new VendorCreditsRetrieveRequest(expand, includeRemoteData, includeShellData, additionalProperties);
        }
    }
}
