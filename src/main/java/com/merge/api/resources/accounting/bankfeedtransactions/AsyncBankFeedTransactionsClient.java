...
public class AsyncBankFeedTransactionsClient {
     ...
     */
    public CompletableFuture<PaginatedBankFeedTransactionList> list() {
     ...
     * Returns a list of <code>BankFeedTransaction</code> objects.
     */
    public CompletableFuture<PaginatedBankFeedTransactionList> list(BankFeedTransactionsListRequest request) {
