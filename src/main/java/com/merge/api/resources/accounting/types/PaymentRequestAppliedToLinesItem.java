...
@JsonDeserialize(using = PaymentRequestAppliedToLinesItem.Deserializer.class)
public final class PaymentRequestAppliedToLinesItem {
    private final Object value;

    private final int type;

    private PaymentRequestAppliedToLinesItem(Object value, int type) {
        this.value = value;
        this.type = type;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaymentRequestAppliedToLinesItem && equalTo((PaymentRequestAppliedToLinesItem) other);
    }

    private boolean equalTo(PaymentRequestAppliedToLinesItem other) {
    ...
    public static PaymentRequestAppliedToLinesItem of(String value) {
    ...
    static final class Deserializer extends StdDeserializer<PaymentRequestAppliedToLinesItem> {
        Deserializer() {
            super(PaymentRequestAppliedToLinesItem.class);
        }
