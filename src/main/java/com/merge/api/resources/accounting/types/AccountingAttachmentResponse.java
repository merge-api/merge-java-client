...
public final class AccountingAttachmentResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull AccountingAttachment model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull AccountingAttachment model) {
            this.model = model;
            return this;
        }
        ...
        public AccountingAttachmentResponse build() {
            return new AccountingAttachmentResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
