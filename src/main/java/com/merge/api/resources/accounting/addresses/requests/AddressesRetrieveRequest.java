package com.merge.api.resources.accounting.addresses.requests;
...
@JsonDeserialize(builder = AddressesRetrieveRequest.Builder.class)
public final class AddressesRetrieveRequest {
    ...
    private AddressesRetrieveRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AddressesRetrieveRequest && equalTo((AddressesRetrieveRequest) other);
    }

    private boolean equalTo(AddressesRetrieveRequest other) {
    ...
    public String toString() {
        return "AddressesRetrieveRequest{" + "includeRemoteData: " + includeRemoteData + ", remoteFields: "
    ...
    public static final class Builder {
        ...
        public Builder from(AddressesRetrieveRequest other) {
        ...
        public AddressesRetrieveRequest build() {
            return new AddressesRetrieveRequest(includeRemoteData, remoteFields, showEnumOrigins);
        }
    }
}
