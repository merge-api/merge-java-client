...
import com.merge.api.resources.filestorage.files.types.FilesRetrieveRequestExpandItem;
...
public final class FilesRetrieveRequest {
    private final Optional<List<FilesRetrieveRequestExpandItem>> expand;
    ...
    private FilesRetrieveRequest(
            Optional<List<FilesRetrieveRequestExpandItem>> expand,
     ...
     */
    @JsonProperty("expand")
    public Optional<List<FilesRetrieveRequestExpandItem>> getExpand() {
        return expand;
    }
    ...
    public static final class Builder {
        private Optional<List<FilesRetrieveRequestExpandItem>> expand = Optional.empty();
        ...
        public Builder expand(Optional<List<FilesRetrieveRequestExpandItem>> expand) {
            this.expand = expand;
            return this;
        }

        public Builder expand(List<FilesRetrieveRequestExpandItem> expand) {
            this.expand = Optional.ofNullable(expand);
            return this;
        }

        public Builder expand(FilesRetrieveRequestExpandItem expand) {
        ...
        public FilesRetrieveRequest build() {
            return new FilesRetrieveRequest(expand, includeRemoteData, includeShellData, additionalProperties);
        }
    }
}
