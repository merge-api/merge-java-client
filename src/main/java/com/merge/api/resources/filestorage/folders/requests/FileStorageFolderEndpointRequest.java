...
import com.merge.api.resources.filestorage.types.FolderRequest;
import java.util.Objects;
import java.util.Optional;

@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonDeserialize(builder = FileStorageFolderEndpointRequest.Builder.class)
public final class FileStorageFolderEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final FolderRequest model;

    private FileStorageFolderEndpointRequest(
            Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, FolderRequest model) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FileStorageFolderEndpointRequest && equalTo((FileStorageFolderEndpointRequest) other);
    }

    private boolean equalTo(FileStorageFolderEndpointRequest other) {
    ...
    public String toString() {
        return "FileStorageFolderEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync
                + ", model: " + model + "}";
    }
    ...
    public interface ModelStage {
        _FinalStage model(FolderRequest model);

        Builder from(FileStorageFolderEndpointRequest other);
    }

    public interface _FinalStage {
        FileStorageFolderEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        public Builder from(FileStorageFolderEndpointRequest other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(FolderRequest model) {
            this.model = model;
            return this;
        }
        ...
        @Override
        public FileStorageFolderEndpointRequest build() {
            return new FileStorageFolderEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
