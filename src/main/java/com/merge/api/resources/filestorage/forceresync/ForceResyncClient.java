package com.merge.api.resources.filestorage.forceresync;
...
import com.merge.api.resources.filestorage.types.SyncStatus;
...
public class ForceResyncClient {
    ...
    public List<SyncStatus> syncStatusResyncCreate(RequestOptions requestOptions) {
        HttpUrl _httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/filestorage/v1/sync-status/resync")
                .build();
