...
public final class GroupsRetrieveRequest {
    ...
    private GroupsRetrieveRequest(Optional<Boolean> includeRemoteData) {
    ...
    public String toString() {
        return "GroupsRetrieveRequest{" + "includeRemoteData: " + includeRemoteData + "}";
    }
    ...
    public static final class Builder {
        ...
        public GroupsRetrieveRequest build() {
            return new GroupsRetrieveRequest(includeRemoteData);
        }
    }
}
