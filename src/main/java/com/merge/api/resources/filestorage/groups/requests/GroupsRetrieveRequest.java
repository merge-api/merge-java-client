...
import com.merge.api.resources.filestorage.groups.types.GroupsRetrieveRequestExpandItem;
...
public final class GroupsRetrieveRequest {
    private final Optional<List<GroupsRetrieveRequestExpandItem>> expand;
    ...
    private GroupsRetrieveRequest(
            Optional<List<GroupsRetrieveRequestExpandItem>> expand,
     ...
     */
    @JsonProperty("expand")
    public Optional<List<GroupsRetrieveRequestExpandItem>> getExpand() {
        return expand;
    }
    ...
    public static final class Builder {
        private Optional<List<GroupsRetrieveRequestExpandItem>> expand = Optional.empty();
        ...
        public Builder expand(Optional<List<GroupsRetrieveRequestExpandItem>> expand) {
            this.expand = expand;
            return this;
        }

        public Builder expand(List<GroupsRetrieveRequestExpandItem> expand) {
            this.expand = Optional.ofNullable(expand);
            return this;
        }

        public Builder expand(GroupsRetrieveRequestExpandItem expand) {
        ...
        public GroupsRetrieveRequest build() {
            return new GroupsRetrieveRequest(expand, includeRemoteData, includeShellData, additionalProperties);
        }
    }
}
