...
public class AsyncRawIssuesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedIssueList>> list() {
     ...
     * Gets all issues for Organization.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedIssueList>> list(IssuesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedIssueList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedIssueList>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<MergeApiHttpResponse<Issue>> retrieve(String id, RequestOptions requestOptions) {
        ...
        CompletableFuture<MergeApiHttpResponse<Issue>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
