...
public class AsyncRawGroupsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedGroupList>> list() {
     ...
     * Returns a list of <code>Group</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedGroupList>> list(GroupsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedGroupList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedGroupList>> future = new CompletableFuture<>();
