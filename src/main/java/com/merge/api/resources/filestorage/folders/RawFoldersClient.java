...
public class RawFoldersClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedFolderList> list() {
     ...
     * Returns a list of <code>Folder</code> objects.
     */
    public MergeApiHttpResponse<PaginatedFolderList> list(FoldersListRequest request) {
     ...
     * Returns a list of <code>Folder</code> objects.
     */
    public MergeApiHttpResponse<PaginatedFolderList> list(FoldersListRequest request, RequestOptions requestOptions) {
