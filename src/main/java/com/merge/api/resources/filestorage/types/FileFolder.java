...
@JsonDeserialize(using = FileFolder.Deserializer.class)
public final class FileFolder {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FileFolder && equalTo((FileFolder) other);
    }
    ...
    static final class Deserializer extends StdDeserializer<FileFolder> {
        Deserializer() {
