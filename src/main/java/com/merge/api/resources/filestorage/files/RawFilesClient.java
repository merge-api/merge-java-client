...
public class RawFilesClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedFileList> list() {
     ...
     * Returns a list of <code>File</code> objects.
     */
    public MergeApiHttpResponse<PaginatedFileList> list(FilesListRequest request) {
     ...
     * Returns a list of <code>File</code> objects.
     */
    public MergeApiHttpResponse<PaginatedFileList> list(FilesListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedFileList.class), response);
            }
     ...
     */
    public MergeApiHttpResponse<PaginatedDownloadRequestMetaList> downloadRequestMetaList() {
