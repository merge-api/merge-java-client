...
public class RawGroupsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedGroupList> list() {
     ...
     * Returns a list of <code>Group</code> objects.
     */
    public MergeApiHttpResponse<PaginatedGroupList> list(GroupsListRequest request) {
     ...
     * Returns a list of <code>Group</code> objects.
     */
    public MergeApiHttpResponse<PaginatedGroupList> list(GroupsListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedGroupList.class), response);
            }
     ...
     */
    public MergeApiHttpResponse<Group> retrieve(String id) {
     ...
     * Returns a <code>Group</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Group> retrieve(String id, GroupsRetrieveRequest request) {
