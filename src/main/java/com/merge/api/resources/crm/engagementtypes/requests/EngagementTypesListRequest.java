...
@JsonDeserialize(builder = EngagementTypesListRequest.Builder.class)
public final class EngagementTypesListRequest {
    ...
    private EngagementTypesListRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EngagementTypesListRequest && equalTo((EngagementTypesListRequest) other);
    }

    private boolean equalTo(EngagementTypesListRequest other) {
    ...
    public String toString() {
        return "EngagementTypesListRequest{" + "createdAfter: " + createdAfter + ", createdBefore: " + createdBefore
                + ", cursor: " + cursor + ", includeDeletedData: " + includeDeletedData + ", includeRemoteData: "
                + includeRemoteData + ", includeRemoteFields: " + includeRemoteFields + ", modifiedAfter: "
    ...
    public static final class Builder {
        ...
        public Builder from(EngagementTypesListRequest other) {
        ...
        public EngagementTypesListRequest build() {
            return new EngagementTypesListRequest(
                    createdAfter,
                    createdBefore,
                    cursor,
                    includeDeletedData,
