...
@JsonDeserialize(builder = CustomObjectClassesAssociationTypesListRequest.Builder.class)
public final class CustomObjectClassesAssociationTypesListRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CustomObjectClassesAssociationTypesListRequest
                && equalTo((CustomObjectClassesAssociationTypesListRequest) other);
    }

    private boolean equalTo(CustomObjectClassesAssociationTypesListRequest other) {
    ...
    public String toString() {
        return "CustomObjectClassesAssociationTypesListRequest{" + "createdAfter: " + createdAfter + ", createdBefore: "
    ...
    public static final class Builder {
        ...
        public Builder from(CustomObjectClassesAssociationTypesListRequest other) {
        ...
        public CustomObjectClassesAssociationTypesListRequest build() {
