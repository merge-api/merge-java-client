...
public final class Task {
    ...
    public String toString() {
        return "Task{" + "subject: " + subject + ", content: " + content + ", owner: " + owner + ", account: " + account
                + ", opportunity: " + opportunity + ", completedDate: " + completedDate + ", dueDate: " + dueDate
                + ", status: " + status + ", remoteWasDeleted: " + remoteWasDeleted + ", id: " + id + ", remoteId: "
