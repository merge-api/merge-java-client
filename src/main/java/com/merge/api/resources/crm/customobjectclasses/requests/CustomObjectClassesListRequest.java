...
public final class CustomObjectClassesListRequest {
    ...
    private boolean equalTo(CustomObjectClassesListRequest other) {
    ...
    public String toString() {
        return "CustomObjectClassesListRequest{" + "createdAfter: " + createdAfter + ", createdBefore: " + createdBefore
    ...
    public static final class Builder {
        ...
        public Builder from(CustomObjectClassesListRequest other) {
        ...
        public CustomObjectClassesListRequest build() {
            return new CustomObjectClassesListRequest(
                    createdAfter,
                    createdBefore,
                    cursor,
                    expand,
