...
public final class OpportunityResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Opportunity model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Opportunity model) {
            this.model = model;
            return this;
        }
        ...
        public OpportunityResponse build() {
            return new OpportunityResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
