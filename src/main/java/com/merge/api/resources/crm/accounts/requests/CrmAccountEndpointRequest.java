...
import com.merge.api.resources.crm.types.AccountRequest;
import java.util.Objects;
import java.util.Optional;

@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonDeserialize(builder = CrmAccountEndpointRequest.Builder.class)
public final class CrmAccountEndpointRequest {
    ...
    private CrmAccountEndpointRequest(Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, AccountRequest model) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CrmAccountEndpointRequest && equalTo((CrmAccountEndpointRequest) other);
    }

    private boolean equalTo(CrmAccountEndpointRequest other) {
    ...
    public String toString() {
        return "CrmAccountEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync + ", model: "
                + model + "}";
    }
    ...
    public interface ModelStage {
        ...
        Builder from(CrmAccountEndpointRequest other);
    }
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        public Builder from(CrmAccountEndpointRequest other) {
        ...
        public CrmAccountEndpointRequest build() {
            return new CrmAccountEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
