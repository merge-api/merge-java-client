...
public final class Note {
    ...
    public String toString() {
        return "Note{" + "owner: " + owner + ", content: " + content + ", contact: " + contact + ", account: " + account
                + ", opportunity: " + opportunity + ", remoteUpdatedAt: " + remoteUpdatedAt + ", remoteCreatedAt: "
                + remoteCreatedAt + ", remoteWasDeleted: " + remoteWasDeleted + ", id: " + id + ", remoteId: "
