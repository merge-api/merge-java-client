...
public class AsyncRawOpportunitiesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedOpportunityList>> list() {
     ...
     * Returns a list of <code>Opportunity</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedOpportunityList>> list(OpportunitiesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedOpportunityList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedOpportunityList>> future = new CompletableFuture<>();
