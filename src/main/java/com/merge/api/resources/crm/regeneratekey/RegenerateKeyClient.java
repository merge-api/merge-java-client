package com.merge.api.resources.crm.regeneratekey;

import com.merge.api.core.ApiError;
import com.merge.api.core.ClientOptions;
import com.merge.api.core.ObjectMappers;
import com.merge.api.core.RequestOptions;
import com.merge.api.resources.crm.regeneratekey.requests.RemoteKeyForRegenerationRequest;
import com.merge.api.resources.crm.types.RemoteKey;
...
public class RegenerateKeyClient {
    ...
    public RemoteKey create(RemoteKeyForRegenerationRequest request, RequestOptions requestOptions) {
        HttpUrl _httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/crm/v1/regenerate-key")
                .build();
