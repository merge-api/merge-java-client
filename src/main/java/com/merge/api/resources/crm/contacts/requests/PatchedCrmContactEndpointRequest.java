...
import com.merge.api.resources.crm.types.PatchedContactRequest;
import java.util.Objects;
import java.util.Optional;

@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonDeserialize(builder = PatchedCrmContactEndpointRequest.Builder.class)
public final class PatchedCrmContactEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final PatchedContactRequest model;

    private PatchedCrmContactEndpointRequest(
            Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, PatchedContactRequest model) {
    ...
    @JsonProperty("model")
    public PatchedContactRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PatchedCrmContactEndpointRequest && equalTo((PatchedCrmContactEndpointRequest) other);
    }

    private boolean equalTo(PatchedCrmContactEndpointRequest other) {
    ...
    public String toString() {
        return "PatchedCrmContactEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync
                + ", model: " + model + "}";
    }
    ...
    public interface ModelStage {
        _FinalStage model(PatchedContactRequest model);

        Builder from(PatchedCrmContactEndpointRequest other);
    }

    public interface _FinalStage {
        PatchedCrmContactEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private PatchedContactRequest model;
        ...
        @Override
        public Builder from(PatchedCrmContactEndpointRequest other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(PatchedContactRequest model) {
            this.model = model;
            return this;
        }
        ...
        public PatchedCrmContactEndpointRequest build() {
            return new PatchedCrmContactEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
