...
public class AsyncRawAssociationTypesClient {
    protected final ClientOptions clientOptions;

    public AsyncRawAssociationTypesClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedAssociationTypeList>>
            customObjectClassesAssociationTypesList(String customObjectClassId) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedAssociationTypeList>>
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedAssociationTypeList>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<CrmAssociationTypeResponse>>
    ...
    public CompletableFuture<MergeApiHttpResponse<CrmAssociationTypeResponse>>
        ...
        CompletableFuture<MergeApiHttpResponse<CrmAssociationTypeResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<AssociationType>> customObjectClassesAssociationTypesRetrieve(
    ...
    public CompletableFuture<MergeApiHttpResponse<AssociationType>> customObjectClassesAssociationTypesRetrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<AssociationType>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<MetaResponse>> customObjectClassesAssociationTypesMetaPostRetrieve(
            String customObjectClassId) {
