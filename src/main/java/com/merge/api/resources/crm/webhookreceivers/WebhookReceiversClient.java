package com.merge.api.resources.crm.webhookreceivers;

import com.fasterxml.jackson.core.type.TypeReference;
import com.merge.api.core.ClientOptions;
import com.merge.api.core.ObjectMappers;
import com.merge.api.resources.crm.types.WebhookReceiver;
import com.merge.api.resources.crm.webhookreceivers.requests.WebhookReceiverRequest;
...
public class WebhookReceiversClient {
    ...
    public List<WebhookReceiver> list() {
        HttpUrl _httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/crm/v1/webhook-receivers")
                .build();
