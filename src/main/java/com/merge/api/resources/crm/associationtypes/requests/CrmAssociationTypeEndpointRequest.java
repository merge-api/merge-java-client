...
public final class CrmAssociationTypeEndpointRequest {
    ...
    private CrmAssociationTypeEndpointRequest(
            Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, AssociationTypeRequestRequest model) {
    ...
    public String toString() {
        return "CrmAssociationTypeEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync
                + ", model: " + model + "}";
    }
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        public CrmAssociationTypeEndpointRequest build() {
            return new CrmAssociationTypeEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
