...
public final class CrmCustomObjectEndpointRequest {
    ...
    private CrmCustomObjectEndpointRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CrmCustomObjectEndpointRequest && equalTo((CrmCustomObjectEndpointRequest) other);
    }

    private boolean equalTo(CrmCustomObjectEndpointRequest other) {
    ...
    public String toString() {
        return "CrmCustomObjectEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync
                + ", model: " + model + "}";
    }
    ...
    public interface _FinalStage {
        CrmCustomObjectEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        public Builder from(CrmCustomObjectEndpointRequest other) {
        ...
        @Override
        public CrmCustomObjectEndpointRequest build() {
            return new CrmCustomObjectEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
