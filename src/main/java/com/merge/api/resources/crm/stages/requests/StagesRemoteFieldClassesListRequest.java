...
@JsonDeserialize(builder = StagesRemoteFieldClassesListRequest.Builder.class)
public final class StagesRemoteFieldClassesListRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof StagesRemoteFieldClassesListRequest
                && equalTo((StagesRemoteFieldClassesListRequest) other);
    }

    private boolean equalTo(StagesRemoteFieldClassesListRequest other) {
    ...
    public String toString() {
        return "StagesRemoteFieldClassesListRequest{" + "cursor: " + cursor + ", includeDeletedData: "
    ...
    public static final class Builder {
        ...
        public Builder from(StagesRemoteFieldClassesListRequest other) {
        ...
        public StagesRemoteFieldClassesListRequest build() {
            return new StagesRemoteFieldClassesListRequest(
