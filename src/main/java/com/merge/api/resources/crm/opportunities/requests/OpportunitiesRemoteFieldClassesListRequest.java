...
@JsonDeserialize(builder = OpportunitiesRemoteFieldClassesListRequest.Builder.class)
public final class OpportunitiesRemoteFieldClassesListRequest {
    ...
    private OpportunitiesRemoteFieldClassesListRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof OpportunitiesRemoteFieldClassesListRequest
                && equalTo((OpportunitiesRemoteFieldClassesListRequest) other);
    }

    private boolean equalTo(OpportunitiesRemoteFieldClassesListRequest other) {
    ...
    public String toString() {
        return "OpportunitiesRemoteFieldClassesListRequest{" + "cursor: " + cursor + ", includeDeletedData: "
    ...
    public static final class Builder {
        ...
        public Builder from(OpportunitiesRemoteFieldClassesListRequest other) {
        ...
        public OpportunitiesRemoteFieldClassesListRequest build() {
            return new OpportunitiesRemoteFieldClassesListRequest(
