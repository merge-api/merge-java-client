...
public class AsyncRawLinkedAccountsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedAccountDetailsAndActionsList>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedAccountDetailsAndActionsList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedAccountDetailsAndActionsList>> future =
