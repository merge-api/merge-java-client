...
@JsonDeserialize(builder = AccountsRemoteFieldClassesListRequest.Builder.class)
public final class AccountsRemoteFieldClassesListRequest {
    ...
    private AccountsRemoteFieldClassesListRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AccountsRemoteFieldClassesListRequest
                && equalTo((AccountsRemoteFieldClassesListRequest) other);
    }

    private boolean equalTo(AccountsRemoteFieldClassesListRequest other) {
    ...
    public String toString() {
        return "AccountsRemoteFieldClassesListRequest{" + "cursor: " + cursor + ", includeDeletedData: "
    ...
    public static final class Builder {
        ...
        public Builder from(AccountsRemoteFieldClassesListRequest other) {
        ...
        public AccountsRemoteFieldClassesListRequest build() {
