...
public final class PatchedContactRequest {
    ...
    public String toString() {
        return "PatchedContactRequest{" + "firstName: " + firstName + ", lastName: " + lastName + ", account: "
                + account + ", addresses: " + addresses + ", emailAddresses: " + emailAddresses + ", phoneNumbers: "
                + phoneNumbers + ", lastActivityAt: " + lastActivityAt + ", integrationParams: " + integrationParams
