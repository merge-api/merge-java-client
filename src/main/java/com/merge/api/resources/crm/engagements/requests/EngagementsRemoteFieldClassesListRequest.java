...
@JsonDeserialize(builder = EngagementsRemoteFieldClassesListRequest.Builder.class)
public final class EngagementsRemoteFieldClassesListRequest {
    ...
    private EngagementsRemoteFieldClassesListRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EngagementsRemoteFieldClassesListRequest
                && equalTo((EngagementsRemoteFieldClassesListRequest) other);
    }

    private boolean equalTo(EngagementsRemoteFieldClassesListRequest other) {
    ...
    public String toString() {
        return "EngagementsRemoteFieldClassesListRequest{" + "cursor: " + cursor + ", includeDeletedData: "
    ...
    public static final class Builder {
        ...
        public Builder from(EngagementsRemoteFieldClassesListRequest other) {
        ...
        public EngagementsRemoteFieldClassesListRequest build() {
            return new EngagementsRemoteFieldClassesListRequest(
