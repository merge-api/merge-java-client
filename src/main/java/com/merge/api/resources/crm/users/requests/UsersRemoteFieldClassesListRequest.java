...
public final class UsersRemoteFieldClassesListRequest {
    ...
    private UsersRemoteFieldClassesListRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UsersRemoteFieldClassesListRequest
                && equalTo((UsersRemoteFieldClassesListRequest) other);
    }

    private boolean equalTo(UsersRemoteFieldClassesListRequest other) {
    ...
    public String toString() {
        return "UsersRemoteFieldClassesListRequest{" + "cursor: " + cursor + ", includeDeletedData: "
    ...
    public static final class Builder {
        ...
        public Builder from(UsersRemoteFieldClassesListRequest other) {
        ...
        public UsersRemoteFieldClassesListRequest build() {
            return new UsersRemoteFieldClassesListRequest(
