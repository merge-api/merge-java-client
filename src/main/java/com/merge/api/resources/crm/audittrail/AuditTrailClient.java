package com.merge.api.resources.crm.audittrail;

import com.merge.api.core.ApiError;
import com.merge.api.core.ClientOptions;
import com.merge.api.core.ObjectMappers;
import com.merge.api.core.RequestOptions;
import com.merge.api.resources.crm.audittrail.requests.AuditTrailListRequest;
import com.merge.api.resources.crm.types.PaginatedAuditLogEventList;
...
public class AuditTrailClient {
    ...
    public PaginatedAuditLogEventList list(AuditTrailListRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder _httpUrl = HttpUrl.parse(
                ...
                .newBuilder()
                .addPathSegments("api/crm/v1/audit-trail");
