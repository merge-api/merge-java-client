...
public final class TaskResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Task model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Task model) {
            this.model = model;
            return this;
        }
        ...
        public TaskResponse build() {
            return new TaskResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
