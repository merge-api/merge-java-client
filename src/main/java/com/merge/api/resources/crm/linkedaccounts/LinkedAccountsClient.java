package com.merge.api.resources.crm.linkedaccounts;

import com.merge.api.core.ApiError;
import com.merge.api.core.ClientOptions;
import com.merge.api.core.ObjectMappers;
import com.merge.api.core.RequestOptions;
import com.merge.api.resources.crm.linkedaccounts.requests.LinkedAccountsListRequest;
import com.merge.api.resources.crm.types.PaginatedAccountDetailsAndActionsList;
...
public class LinkedAccountsClient {
    ...
    public PaginatedAccountDetailsAndActionsList list(
        ...
        HttpUrl.Builder _httpUrl = HttpUrl.parse(
                ...
                .newBuilder()
                .addPathSegments("api/crm/v1/linked-accounts");
