...
@JsonDeserialize(builder = NotesRemoteFieldClassesListRequest.Builder.class)
public final class NotesRemoteFieldClassesListRequest {
    ...
    private NotesRemoteFieldClassesListRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof NotesRemoteFieldClassesListRequest
                && equalTo((NotesRemoteFieldClassesListRequest) other);
    }

    private boolean equalTo(NotesRemoteFieldClassesListRequest other) {
    ...
    public String toString() {
        return "NotesRemoteFieldClassesListRequest{" + "cursor: " + cursor + ", includeDeletedData: "
    ...
    public static final class Builder {
        ...
        public Builder from(NotesRemoteFieldClassesListRequest other) {
        ...
        public NotesRemoteFieldClassesListRequest build() {
            return new NotesRemoteFieldClassesListRequest(
