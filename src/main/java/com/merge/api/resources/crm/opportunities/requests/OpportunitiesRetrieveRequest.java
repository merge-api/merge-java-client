...
public final class OpportunitiesRetrieveRequest {
    ...
    public String toString() {
        return "OpportunitiesRetrieveRequest{" + "expand: " + expand + ", includeRemoteData: " + includeRemoteData
                + ", includeRemoteFields: " + includeRemoteFields + ", remoteFields: " + remoteFields
