...
@JsonDeserialize(builder = LeadsRemoteFieldClassesListRequest.Builder.class)
public final class LeadsRemoteFieldClassesListRequest {
    ...
    private LeadsRemoteFieldClassesListRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LeadsRemoteFieldClassesListRequest
                && equalTo((LeadsRemoteFieldClassesListRequest) other);
    }

    private boolean equalTo(LeadsRemoteFieldClassesListRequest other) {
    ...
    public String toString() {
        return "LeadsRemoteFieldClassesListRequest{" + "cursor: " + cursor + ", includeDeletedData: "
    ...
    public static final class Builder {
        ...
        public Builder from(LeadsRemoteFieldClassesListRequest other) {
        ...
        public LeadsRemoteFieldClassesListRequest build() {
            return new LeadsRemoteFieldClassesListRequest(
