...
public final class Account {
    ...
    public String toString() {
        return "Account{" + "owner: " + owner + ", name: " + name + ", description: " + description + ", industry: "
                + industry + ", website: " + website + ", numberOfEmployees: " + numberOfEmployees + ", addresses: "
                + addresses + ", phoneNumbers: " + phoneNumbers + ", lastActivityAt: " + lastActivityAt
                + ", remoteUpdatedAt: " + remoteUpdatedAt + ", remoteCreatedAt: " + remoteCreatedAt
