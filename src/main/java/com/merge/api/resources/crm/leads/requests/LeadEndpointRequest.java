...
import com.merge.api.resources.crm.types.LeadRequest;
import java.util.Objects;
import java.util.Optional;

@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonDeserialize(builder = LeadEndpointRequest.Builder.class)
public final class LeadEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final LeadRequest model;

    private LeadEndpointRequest(Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, LeadRequest model) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LeadEndpointRequest && equalTo((LeadEndpointRequest) other);
    }

    private boolean equalTo(LeadEndpointRequest other) {
    ...
    public String toString() {
        return "LeadEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync + ", model: " + model
                + "}";
    }
    ...
    public interface ModelStage {
        _FinalStage model(LeadRequest model);

        Builder from(LeadEndpointRequest other);
    }

    public interface _FinalStage {
        LeadEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        public Builder from(LeadEndpointRequest other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(LeadRequest model) {
            this.model = model;
            return this;
        }
        ...
        public LeadEndpointRequest build() {
            return new LeadEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
