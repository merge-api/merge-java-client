...
@JsonDeserialize(using = TaskStatus.Deserializer.class)
public final class TaskStatus {
    private final Object value;

    private final int type;

    private TaskStatus(Object value, int type) {
        this.value = value;
        this.type = type;
    }
    ...
    public static TaskStatus of(TaskStatusEnum value) {
        return new TaskStatus(value, 0);
    }

    public static TaskStatus of(String value) {
        return new TaskStatus(value, 1);
    }
    ...
    static final class Deserializer extends StdDeserializer<TaskStatus> {
        Deserializer() {
