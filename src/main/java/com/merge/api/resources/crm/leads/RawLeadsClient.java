...
public class RawLeadsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedLeadList> list() {
     ...
     * Returns a list of <code>Lead</code> objects.
     */
    public MergeApiHttpResponse<PaginatedLeadList> list(LeadsListRequest request) {
     ...
     * Returns a list of <code>Lead</code> objects.
     */
    public MergeApiHttpResponse<PaginatedLeadList> list(LeadsListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedLeadList.class), response);
            }
     ...
     */
    public MergeApiHttpResponse<LeadResponse> create(LeadEndpointRequest request) {
    ...
    public MergeApiHttpResponse<LeadResponse> create(LeadEndpointRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), LeadResponse.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
     ...
     */
    public MergeApiHttpResponse<Lead> retrieve(String id) {
     ...
     * Returns a <code>Lead</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Lead> retrieve(String id, LeadsRetrieveRequest request) {
