...
import com.merge.api.resources.crm.types.TaskRequest;
...
public final class TaskEndpointRequest {
    ...
    private TaskEndpointRequest(Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, TaskRequest model) {
    ...
    public String toString() {
        return "TaskEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync + ", model: " + model
                + "}";
    }
    ...
    public interface ModelStage {
        _FinalStage model(TaskRequest model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(TaskRequest model) {
            this.model = model;
            return this;
        }
        ...
        public TaskEndpointRequest build() {
            return new TaskEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
