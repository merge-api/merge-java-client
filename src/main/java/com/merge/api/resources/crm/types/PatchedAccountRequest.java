...
public final class PatchedAccountRequest {
    ...
    public String toString() {
        return "PatchedAccountRequest{" + "owner: " + owner + ", name: " + name + ", description: " + description
                + ", industry: " + industry + ", website: " + website + ", numberOfEmployees: " + numberOfEmployees
                + ", lastActivityAt: " + lastActivityAt + ", integrationParams: " + integrationParams
