package com.merge.api.resources.crm.availableactions;

import com.merge.api.core.ClientOptions;
import com.merge.api.core.ObjectMappers;
import com.merge.api.resources.crm.types.AvailableActions;
...
public class AvailableActionsClient {
    ...
    public AvailableActions retrieve() {
        HttpUrl _httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/crm/v1/available-actions")
                .build();
