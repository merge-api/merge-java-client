...
import com.merge.api.resources.crm.types.ContactRequest;
import java.util.Objects;
import java.util.Optional;

@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonDeserialize(builder = CrmContactEndpointRequest.Builder.class)
public final class CrmContactEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final ContactRequest model;

    private CrmContactEndpointRequest(Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, ContactRequest model) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CrmContactEndpointRequest && equalTo((CrmContactEndpointRequest) other);
    }

    private boolean equalTo(CrmContactEndpointRequest other) {
    ...
    public String toString() {
        return "CrmContactEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync + ", model: "
                + model + "}";
    }
    ...
    public interface ModelStage {
        _FinalStage model(ContactRequest model);

        Builder from(CrmContactEndpointRequest other);
    }

    public interface _FinalStage {
        CrmContactEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @Override
        public Builder from(CrmContactEndpointRequest other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(ContactRequest model) {
            this.model = model;
            return this;
        }
        ...
        @Override
        public CrmContactEndpointRequest build() {
            return new CrmContactEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
