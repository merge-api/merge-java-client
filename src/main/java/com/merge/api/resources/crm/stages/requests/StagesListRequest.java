...
@JsonDeserialize(builder = StagesListRequest.Builder.class)
public final class StagesListRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof StagesListRequest && equalTo((StagesListRequest) other);
    }

    private boolean equalTo(StagesListRequest other) {
    ...
    public String toString() {
        return "StagesListRequest{" + "createdAfter: " + createdAfter + ", createdBefore: " + createdBefore
    ...
    public static final class Builder {
        ...
        public Builder from(StagesListRequest other) {
        ...
        public StagesListRequest build() {
            return new StagesListRequest(
                    createdAfter,
                    createdBefore,
                    cursor,
                    includeDeletedData,
