...
public class TasksClient {
    ...
    public PaginatedTaskList list(TasksListRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), PaginatedTaskList.class);
            }
            throw new ApiError(
                    response.code(),
    ...
    public TaskResponse create(TaskEndpointRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            Response response = client.newCall(okhttpRequest).execute();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), TaskResponse.class);
            }
            throw new ApiError(
                    response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Object.class));
    ...
    public Task retrieve(String id, TasksRetrieveRequest request, RequestOptions requestOptions) {
        ...
        try {
            ...
            Response response = client.newCall(okhttpRequest).execute();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Task.class);
            }
            throw new ApiError(
                    response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Object.class));
