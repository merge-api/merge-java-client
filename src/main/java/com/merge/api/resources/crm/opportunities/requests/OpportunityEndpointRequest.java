...
import com.merge.api.resources.crm.types.OpportunityRequest;
import java.util.Objects;
import java.util.Optional;

@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonDeserialize(builder = OpportunityEndpointRequest.Builder.class)
public final class OpportunityEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final OpportunityRequest model;

    private OpportunityEndpointRequest(
            Optional<Boolean> isDebugMode, Optional<Boolean> runAsync, OpportunityRequest model) {
    ...
    @JsonProperty("model")
    public OpportunityRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof OpportunityEndpointRequest && equalTo((OpportunityEndpointRequest) other);
    }

    private boolean equalTo(OpportunityEndpointRequest other) {
    ...
    public String toString() {
        return "OpportunityEndpointRequest{" + "isDebugMode: " + isDebugMode + ", runAsync: " + runAsync + ", model: "
                + model + "}";
    }
    ...
    public interface ModelStage {
        _FinalStage model(OpportunityRequest model);

        Builder from(OpportunityEndpointRequest other);
    }

    public interface _FinalStage {
        OpportunityEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private OpportunityRequest model;
        ...
        @Override
        public Builder from(OpportunityEndpointRequest other) {
        ...
        @Override
        @JsonSetter("model")
        public _FinalStage model(OpportunityRequest model) {
            this.model = model;
            return this;
        }
        ...
        public OpportunityEndpointRequest build() {
            return new OpportunityEndpointRequest(isDebugMode, runAsync, model);
        }
    }
}
