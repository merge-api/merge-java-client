...
public final class PatchedOpportunityRequest {
    ...
    private PatchedOpportunityRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PatchedOpportunityRequest && equalTo((PatchedOpportunityRequest) other);
    }
    ...
    public String toString() {
        return "PatchedOpportunityRequest{" + "name: " + name + ", description: " + description + ", amount: " + amount
    ...
    public static final class Builder {
        ...
        public PatchedOpportunityRequest build() {
            return new PatchedOpportunityRequest(
                    name,
                    description,
                    amount,
                    owner,
