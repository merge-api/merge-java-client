...
import com.merge.api.chat.types.AsyncPassthroughReciept;
import com.merge.api.chat.types.AsyncPassthroughRetrieveResponse;
import com.merge.api.chat.types.DataPassthroughRequest;
...
public class AsyncRawAsyncPassthroughClient {
    ...
    public CompletableFuture<MergeApiHttpResponse<AsyncPassthroughReciept>> create(
        ...
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("chat/v1/async-passthrough")
                .build();
        RequestBody body;
        try {
