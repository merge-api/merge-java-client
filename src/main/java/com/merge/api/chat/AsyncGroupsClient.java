...
public class AsyncGroupsClient {
     ...
     * Returns a list of <code>Group</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<Group>> list(GroupsListRequest request) {
     ...
     * Returns a list of <code>Group</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<Group>> list(GroupsListRequest request, RequestOptions requestOptions) {
