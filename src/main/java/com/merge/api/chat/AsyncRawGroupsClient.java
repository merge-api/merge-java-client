...
import com.merge.api.chat.types.Group;
import com.merge.api.chat.types.GroupsListRequest;
import com.merge.api.chat.types.GroupsRetrieveRequest;
import com.merge.api.chat.types.PaginatedGroupList;
...
public class AsyncRawGroupsClient {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Group>>> list(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("chat/v1/groups");
