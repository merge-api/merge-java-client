...
@JsonDeserialize(builder = MessagesListRequest.Builder.class)
public final class MessagesListRequest {
    ...
    private final Optional<MessagesListRequestOrderBy> orderBy;

    private final Optional<Integer> pageSize;

    private final Optional<String> remoteId;

    private final Optional<String> rootMessage;

    private final Map<String, Object> additionalProperties;

    private MessagesListRequest(
            ...
            Optional<MessagesListRequestOrderBy> orderBy,
            Optional<Integer> pageSize,
            Optional<String> remoteId,
            Optional<String> rootMessage,
    ...
    /**
     * @return Filter messages by conversation ID.
     */
    ...
    public Optional<MessagesListRequestOrderBy> getOrderBy() {
        return orderBy;
    }
    ...
    /**
     * @return If provided as 'true', will only return root messages (messages without a parent message).
     */
    @JsonProperty("root_message")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MessagesListRequest && equalTo((MessagesListRequest) other);
    }
    ...
    private boolean equalTo(MessagesListRequest other) {
        return conversationId.equals(other.conversationId)
                ...
                && rootMessage.equals(other.rootMessage);
    }
    ...
    public static final class Builder {
        ...
        private Optional<MessagesListRequestOrderBy> orderBy = Optional.empty();

        private Optional<Integer> pageSize = Optional.empty();

        private Optional<String> remoteId = Optional.empty();

        private Optional<String> rootMessage = Optional.empty();
        ...
        public Builder from(MessagesListRequest other) {
            ...
            rootMessage(other.getRootMessage());
            return this;
        }

        /**
         * <p>Filter messages by conversation ID.</p>
         */
        ...
        public Builder orderBy(Optional<MessagesListRequestOrderBy> orderBy) {
            this.orderBy = orderBy;
            return this;
        }

        public Builder orderBy(MessagesListRequestOrderBy orderBy) {
        ...
        /**
         * <p>If provided as 'true', will only return root messages (messages without a parent message).</p>
         */
        @JsonSetter(value = "root_message", nulls = Nulls.SKIP)
        public Builder rootMessage(Optional<String> rootMessage) {
            this.rootMessage = rootMessage;
            return this;
        }
        ...
        public MessagesListRequest build() {
            return new MessagesListRequest(
                    conversationId,
                    createdAfter,
                    createdBefore,
                    cursor,
