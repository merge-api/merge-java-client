...
public class GroupsClient {
     ...
     * Returns a list of <code>Group</code> objects.
     */
    public SyncPagingIterable<Group> list(GroupsListRequest request) {
     ...
     * Returns a list of <code>Group</code> objects.
     */
    public SyncPagingIterable<Group> list(GroupsListRequest request, RequestOptions requestOptions) {
