...
public class AsyncRawItemsClient {
     ...
     * Returns a list of <code>Item</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Item>>> list(ItemsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Item>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Item>>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<Item>(!startingAfter.isEmpty(), result, parsedResponse, () -> {
                                    try {
     ...
     * Returns an <code>Item</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<Item>> retrieve(String id, ItemsRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<Item>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<Item>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<MergeApiHttpResponse<MetaResponse>> metaPatchRetrieve(
            String id, ItemsMetaPatchRetrieveRequest request) {
