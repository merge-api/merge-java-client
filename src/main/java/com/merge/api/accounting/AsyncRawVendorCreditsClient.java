...
import com.merge.api.accounting.types.PaginatedVendorCreditList;
...
public class AsyncRawVendorCreditsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawVendorCreditsClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<VendorCredit>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<VendorCredit>>> future = new CompletableFuture<>();
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        PaginatedVendorCreditList parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, PaginatedVendorCreditList.class);
                        Optional<String> startingAfter = parsedResponse.getNext();
                        VendorCreditsListRequest nextRequest = VendorCreditsListRequest.builder()
                                .from(request)
                                .cursor(startingAfter)
                                .build();
                        List<VendorCredit> result = parsedResponse.getResults().orElse(Collections.emptyList());
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<VendorCredit>(
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<VendorCreditResponse>> create(VendorCreditEndpointRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<VendorCreditResponse>> create(
        ...
        CompletableFuture<MergeApiHttpResponse<VendorCreditResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, VendorCreditResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<VendorCredit>> retrieve(String id) {
    ...
    public CompletableFuture<MergeApiHttpResponse<VendorCredit>> retrieve(
            String id, VendorCreditsRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<VendorCredit>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<VendorCredit>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<VendorCreditResponse>> partialUpdate(
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<VendorCreditResponse>> applicationCreate(
            String id, ApplyVendorCreditRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<MetaResponse>> metaPatchRetrieve(
        ...
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("accounting/v1/vendor-credits/meta/patch")
                .addPathSegment(id)
                .build();
