...
public class AsyncRawVendorCreditsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedVendorCreditList>> list() {
     ...
     * Returns a list of <code>VendorCredit</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedVendorCreditList>> list(VendorCreditsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedVendorCreditList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedVendorCreditList>> future = new CompletableFuture<>();
