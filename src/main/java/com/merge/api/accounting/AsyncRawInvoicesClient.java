...
public class AsyncRawInvoicesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedInvoiceList>> list() {
     ...
     * Returns a list of <code>Invoice</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedInvoiceList>> list(InvoicesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedInvoiceList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedInvoiceList>> future = new CompletableFuture<>();
