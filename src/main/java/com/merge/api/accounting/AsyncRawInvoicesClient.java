...
public class AsyncRawInvoicesClient {
     ...
     * Returns a list of <code>Invoice</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Invoice>>> list(InvoicesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Invoice>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Invoice>>> future = new CompletableFuture<>();
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        PaginatedInvoiceList parsedResponse =
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaginatedInvoiceList.class);
                        Optional<String> startingAfter = parsedResponse.getNext();
                        InvoicesListRequest nextRequest = InvoicesListRequest.builder()
                                .from(request)
                                .cursor(startingAfter)
                                .build();
                        List<Invoice> result = parsedResponse.getResults().orElse(Collections.emptyList());
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<InvoiceResponse>> create(InvoiceEndpointRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<InvoiceResponse>> create(
        ...
        CompletableFuture<MergeApiHttpResponse<InvoiceResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<Invoice>> retrieve(String id) {
     ...
     * Returns an <code>Invoice</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<Invoice>> retrieve(String id, InvoicesRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<Invoice>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<Invoice>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<MergeApiHttpResponse<InvoiceResponse>> partialUpdate(
            String id, PatchedInvoiceEndpointRequest request) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<AsyncBulkCreateResponse>> bulkCreate(InvoiceBulkRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<AsyncBulkCreateResponse>> bulkCreate(
        ...
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("accounting/v1/invoices/bulk")
                .build();
        RequestBody body;
        try {
            body = RequestBody.create(
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<RemoteFieldClass>>>
            lineItemsRemoteFieldClassesList(InvoicesLineItemsRemoteFieldClassesListRequest request) {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        Optional<String> startingAfter = parsedResponse.getNext();
                        InvoicesLineItemsRemoteFieldClassesListRequest nextRequest =
                                InvoicesLineItemsRemoteFieldClassesListRequest.builder()
                                        .from(request)
                                        .cursor(startingAfter)
                                        .build();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        PaginatedRemoteFieldClassList parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, PaginatedRemoteFieldClassList.class);
                        Optional<String> startingAfter = parsedResponse.getNext();
                        InvoicesRemoteFieldClassesListRequest nextRequest =
                                InvoicesRemoteFieldClassesListRequest.builder()
                                        .from(request)
                                        .cursor(startingAfter)
                                        .build();
                        List<RemoteFieldClass> result =
