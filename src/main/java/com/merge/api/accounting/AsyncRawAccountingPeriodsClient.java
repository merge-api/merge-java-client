...
public class AsyncRawAccountingPeriodsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedAccountingPeriodList>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedAccountingPeriodList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedAccountingPeriodList>> future = new CompletableFuture<>();
