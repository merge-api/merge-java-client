...
public class RawInvoicesClient {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Invoice>(!startingAfter.isEmpty(), result, parsedResponse, () -> list(
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<RemoteFieldClass>(
                                !startingAfter.isEmpty(), result, parsedResponse, () -> lineItemsRemoteFieldClassesList(
                                                nextRequest, requestOptions)
                                        .body()),
                        response);
            }
    ...
    public MergeApiHttpResponse<MetaResponse> metaPatchRetrieve(String id) {
        return metaPatchRetrieve(id, InvoicesMetaPatchRetrieveRequest.builder().build());
    }

    /**
     * Returns metadata for <code>Invoice</code> PATCHs.
     */
    public MergeApiHttpResponse<MetaResponse> metaPatchRetrieve(String id, InvoicesMetaPatchRetrieveRequest request) {
