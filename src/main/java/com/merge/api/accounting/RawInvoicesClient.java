...
public class RawInvoicesClient {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<Invoice>> list() {
     ...
     * Returns a list of <code>Invoice</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Invoice>> list(InvoicesListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Invoice>(startingAfter.isPresent(), result, parsedResponse, () -> list(
    ...
    public MergeApiHttpResponse<InvoiceResponse> create(InvoiceEndpointRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, InvoiceResponse.class), response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new ApiError("Error with status code " + response.code(), response.code(), errorBody, response);
        } catch (IOException e) {
     ...
     */
    public MergeApiHttpResponse<AsyncBulkCreateResponse> bulkCreate(InvoiceBulkRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedRemoteFieldClassList parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaginatedRemoteFieldClassList.class);
                Optional<String> startingAfter = parsedResponse.getNext();
                InvoicesRemoteFieldClassesListRequest nextRequest = InvoicesRemoteFieldClassesListRequest.builder()
                        .from(request)
                        .cursor(startingAfter)
                        .build();
                List<RemoteFieldClass> result = parsedResponse.getResults().orElse(Collections.emptyList());
