...
public class RawJournalEntriesClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedJournalEntryList> list() {
     ...
     * Returns a list of <code>JournalEntry</code> objects.
     */
    public MergeApiHttpResponse<PaginatedJournalEntryList> list(JournalEntriesListRequest request) {
     ...
     */
    public MergeApiHttpResponse<PaginatedRemoteFieldClassList> linesRemoteFieldClassesList() {
