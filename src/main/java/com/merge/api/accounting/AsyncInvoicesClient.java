...
public class AsyncInvoicesClient {
     ...
     */
    public CompletableFuture<PaginatedInvoiceList> list() {
     ...
     * Returns a list of <code>Invoice</code> objects.
     */
    public CompletableFuture<PaginatedInvoiceList> list(InvoicesListRequest request) {
     ...
     * Returns a list of <code>Invoice</code> objects.
     */
    public CompletableFuture<PaginatedInvoiceList> list(InvoicesListRequest request, RequestOptions requestOptions) {
