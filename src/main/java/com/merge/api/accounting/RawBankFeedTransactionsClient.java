...
public class RawBankFeedTransactionsClient {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<BankFeedTransaction>> list() {
     ...
     * Returns a list of <code>BankFeedTransaction</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<BankFeedTransaction>> list(BankFeedTransactionsListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                BankFeedTransactionsListRequest nextRequest = BankFeedTransactionsListRequest.builder()
                        ...
                        .build();
                List<BankFeedTransaction> result = parsedResponse.getResults().orElse(Collections.emptyList());
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<BankFeedTransaction>(
