...
public class AsyncRawCashFlowStatementsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedCashFlowStatementList>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedCashFlowStatementList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedCashFlowStatementList>> future = new CompletableFuture<>();
