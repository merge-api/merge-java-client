...
public class AsyncRawGeneralLedgerTransactionsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedGeneralLedgerTransactionList>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedGeneralLedgerTransactionList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedGeneralLedgerTransactionList>> future =
