...
public class AsyncRawJournalEntriesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedJournalEntryList>> list() {
     ...
     * Returns a list of <code>JournalEntry</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedJournalEntryList>> list(JournalEntriesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedJournalEntryList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedJournalEntryList>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedRemoteFieldClassList>> linesRemoteFieldClassesList() {
