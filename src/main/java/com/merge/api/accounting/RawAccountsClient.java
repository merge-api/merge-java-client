...
public class RawAccountsClient {
     ...
     */
    public MergeApiHttpResponse<AccountResponse> create(AccountEndpointRequest request) {
    ...
    public MergeApiHttpResponse<AccountResponse> create(AccountEndpointRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), AccountResponse.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
