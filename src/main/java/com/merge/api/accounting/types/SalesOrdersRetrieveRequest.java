...
@JsonDeserialize(builder = SalesOrdersRetrieveRequest.Builder.class)
public final class SalesOrdersRetrieveRequest {
    private final Optional<List<SalesOrdersRetrieveRequestExpandItem>> expand;
    ...
    private SalesOrdersRetrieveRequest(
            Optional<List<SalesOrdersRetrieveRequestExpandItem>> expand,
     ...
     */
    @JsonProperty("expand")
    public Optional<List<SalesOrdersRetrieveRequestExpandItem>> getExpand() {
        return expand;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SalesOrdersRetrieveRequest && equalTo((SalesOrdersRetrieveRequest) other);
    }
    ...
    private boolean equalTo(SalesOrdersRetrieveRequest other) {
    ...
    public static final class Builder {
        private Optional<List<SalesOrdersRetrieveRequestExpandItem>> expand = Optional.empty();
        ...
        public Builder from(SalesOrdersRetrieveRequest other) {
        ...
        public Builder expand(Optional<List<SalesOrdersRetrieveRequestExpandItem>> expand) {
            this.expand = expand;
            return this;
        }

        public Builder expand(List<SalesOrdersRetrieveRequestExpandItem> expand) {
            this.expand = Optional.ofNullable(expand);
            return this;
        }

        public Builder expand(SalesOrdersRetrieveRequestExpandItem expand) {
        ...
        public SalesOrdersRetrieveRequest build() {
            return new SalesOrdersRetrieveRequest(
                    expand,
                    includeRemoteData,
                    includeRemoteFields,
                    includeShellData,
