...
@JsonDeserialize(builder = ItemEndpointRequest.Builder.class)
public final class ItemEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final ItemRequestRequest model;

    private final Map<String, Object> additionalProperties;

    private ItemEndpointRequest(
            Optional<Boolean> isDebugMode,
            Optional<Boolean> runAsync,
            ItemRequestRequest model,
    ...
    @JsonProperty("model")
    public ItemRequestRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ItemEndpointRequest && equalTo((ItemEndpointRequest) other);
    }
    ...
    private boolean equalTo(ItemEndpointRequest other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull ItemRequestRequest model);

        Builder from(ItemEndpointRequest other);
    }

    public interface _FinalStage {
        ItemEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private ItemRequestRequest model;
        ...
        @java.lang.Override
        public Builder from(ItemEndpointRequest other) {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull ItemRequestRequest model) {
            this.model = model;
            return this;
        }
        ...
        @java.lang.Override
        public ItemEndpointRequest build() {
            return new ItemEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
