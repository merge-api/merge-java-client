...
public final class AccountRequest {
    ...
    private final Optional<AccountRequestAccountType> accountType;
    ...
    private AccountRequest(
            ...
            Optional<AccountRequestAccountType> accountType,
     ...
     */
    @JsonIgnore
    public Optional<AccountRequestAccountType> getAccountType() {
        if (accountType == null) {
            return Optional.empty();
        }
        return accountType;
    ...
    private Optional<AccountRequestClassification> _getClassification() {
        return classification;
    }
    ...
    private Optional<AccountRequestAccountType> _getAccountType() {
        return accountType;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("status")
    private Optional<AccountRequestStatus> _getStatus() {
        return status;
    }
    ...
    private Optional<AccountRequestCurrency> _getCurrency() {
        return currency;
    }
    ...
    public static final class Builder {
        ...
        private Optional<AccountRequestAccountType> accountType = Optional.empty();
        ...
        /**
         * <p>The account's broadest grouping.</p>
         * <ul>
         * <li><code>ASSET</code> - ASSET</li>
         * <li><code>EQUITY</code> - EQUITY</li>
         * <li><code>EXPENSE</code> - EXPENSE</li>
        ...
        public Builder classification(Nullable<AccountRequestClassification> classification) {
        ...
        /**
         * <p>Normalized account type- which is a narrower and more specific grouping within the account's classification.</p>
         * <ul>
         * <li><code>BANK</code> - BANK</li>
         * <li><code>CREDIT_CARD</code> - CREDIT_CARD</li>
         * <li><code>ACCOUNTS_PAYABLE</code> - ACCOUNTS_PAYABLE</li>
        ...
        public Builder accountType(Optional<AccountRequestAccountType> accountType) {
            this.accountType = accountType;
            return this;
        }
        ...
        public Builder accountType(Nullable<AccountRequestAccountType> accountType) {
        ...
        public Builder status(Nullable<AccountRequestStatus> status) {
            if (status.isNull()) {
                this.status = null;
        ...
        public Builder currency(Nullable<AccountRequestCurrency> currency) {
            if (currency.isNull()) {
                this.currency = null;
