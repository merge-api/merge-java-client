...
@JsonDeserialize(builder = ExpenseReportsListRequest.Builder.class)
public final class ExpenseReportsListRequest {
    private final Optional<List<ExpenseReportsListRequestExpandItem>> expand;
    ...
    private ExpenseReportsListRequest(
            Optional<List<ExpenseReportsListRequestExpandItem>> expand,
     ...
     */
    @JsonProperty("expand")
    public Optional<List<ExpenseReportsListRequestExpandItem>> getExpand() {
        return expand;
    }

    /**
     * @return If provided, will only return expense reports for this company.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExpenseReportsListRequest && equalTo((ExpenseReportsListRequest) other);
    }
    ...
    private boolean equalTo(ExpenseReportsListRequest other) {
    ...
    public static final class Builder {
        private Optional<List<ExpenseReportsListRequestExpandItem>> expand = Optional.empty();
        ...
        public Builder from(ExpenseReportsListRequest other) {
        ...
        public Builder expand(Optional<List<ExpenseReportsListRequestExpandItem>> expand) {
            this.expand = expand;
            return this;
        }

        public Builder expand(List<ExpenseReportsListRequestExpandItem> expand) {
            this.expand = Optional.ofNullable(expand);
            return this;
        }

        public Builder expand(ExpenseReportsListRequestExpandItem expand) {
            this.expand = Optional.of(Collections.singletonList(expand));
            return this;
        }

        /**
         * <p>If provided, will only return expense reports for this company.</p>
         */
        ...
        public ExpenseReportsListRequest build() {
            return new ExpenseReportsListRequest(
                    expand,
                    companyId,
                    createdAfter,
                    createdBefore,
