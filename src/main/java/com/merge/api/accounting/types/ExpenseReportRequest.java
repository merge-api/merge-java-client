...
@JsonDeserialize(builder = ExpenseReportRequest.Builder.class)
public final class ExpenseReportRequest {
    private final Optional<String> expenseReportUrl;

    private final Optional<OffsetDateTime> reportDate;

    private final Optional<String> reportIdentifier;

    private final Optional<ExpenseReportRequestEmployee> employee;

    private final Optional<ExpenseReportRequestStatus> status;

    private final Optional<Double> totalAmount;

    private final Optional<ExpenseReportRequestCurrency> currency;

    private final Optional<String> description;

    private final Optional<ExpenseReportRequestAccountingPeriod> accountingPeriod;

    private final Optional<ExpenseReportRequestCompany> company;
    ...
    private ExpenseReportRequest(
            Optional<String> expenseReportUrl,
            Optional<OffsetDateTime> reportDate,
            Optional<String> reportIdentifier,
            Optional<ExpenseReportRequestEmployee> employee,
            Optional<ExpenseReportRequestStatus> status,
            Optional<Double> totalAmount,
            Optional<ExpenseReportRequestCurrency> currency,
            Optional<String> description,
            Optional<ExpenseReportRequestAccountingPeriod> accountingPeriod,
            Optional<ExpenseReportRequestCompany> company,
        ...
        this.expenseReportUrl = expenseReportUrl;
    ...
    /**
     * @return The 3rd party URL of the expense report.
     */
    @JsonProperty("expense_report_url")
    public Optional<String> getExpenseReportUrl() {
        return expenseReportUrl;
    }

    /**
     * @return The date of the expense report.
     */
    @JsonProperty("report_date")
    public Optional<OffsetDateTime> getReportDate() {
        return reportDate;
    }

    /**
     * @return Human-readable expense report identifier.
     */
    @JsonProperty("report_identifier")
    public Optional<String> getReportIdentifier() {
    ...
    public Optional<ExpenseReportRequestEmployee> getEmployee() {
        return employee;
    }

    /**
     * @return Overall status of the expense report. One of DRAFT, SUBMITTED, APPROVED, REJECTED
     * <ul>
     ...
     */
    @JsonProperty("status")
    public Optional<ExpenseReportRequestStatus> getStatus() {
        return status;
    }

    /**
     * @return Total amount of the expense report
     */
    ...
    /**
     * @return Currency code for the expense report
     * <ul>
    ...
    public Optional<ExpenseReportRequestCurrency> getCurrency() {
        return currency;
    }

    /**
     * @return A brief description or purpose for the expense report
     */
    ...
    /**
     * @return The accounting period the report was posted in
     */
    @JsonProperty("accounting_period")
    public Optional<ExpenseReportRequestAccountingPeriod> getAccountingPeriod() {
    ...
    public Optional<ExpenseReportRequestCompany> getCompany() {
        return company;
    }

    /**
     * @return The related tracking categories associated with the expense report
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExpenseReportRequest && equalTo((ExpenseReportRequest) other);
    }
    ...
    private boolean equalTo(ExpenseReportRequest other) {
        return expenseReportUrl.equals(other.expenseReportUrl)
                && reportDate.equals(other.reportDate)
                && reportIdentifier.equals(other.reportIdentifier)
    ...
    public static final class Builder {
        private Optional<String> expenseReportUrl = Optional.empty();

        private Optional<OffsetDateTime> reportDate = Optional.empty();

        private Optional<String> reportIdentifier = Optional.empty();

        private Optional<ExpenseReportRequestEmployee> employee = Optional.empty();

        private Optional<ExpenseReportRequestStatus> status = Optional.empty();

        private Optional<Double> totalAmount = Optional.empty();

        private Optional<ExpenseReportRequestCurrency> currency = Optional.empty();

        private Optional<String> description = Optional.empty();

        private Optional<ExpenseReportRequestAccountingPeriod> accountingPeriod = Optional.empty();

        private Optional<ExpenseReportRequestCompany> company = Optional.empty();
        ...
        public Builder from(ExpenseReportRequest other) {
            expenseReportUrl(other.getExpenseReportUrl());
            reportDate(other.getReportDate());
            reportIdentifier(other.getReportIdentifier());
        ...
        /**
         * <p>The 3rd party URL of the expense report.</p>
         */
        @JsonSetter(value = "expense_report_url", nulls = Nulls.SKIP)
        public Builder expenseReportUrl(Optional<String> expenseReportUrl) {
            this.expenseReportUrl = expenseReportUrl;
            return this;
        }

        public Builder expenseReportUrl(String expenseReportUrl) {
            this.expenseReportUrl = Optional.ofNullable(expenseReportUrl);
            return this;
        }

        /**
         * <p>The date of the expense report.</p>
         */
        @JsonSetter(value = "report_date", nulls = Nulls.SKIP)
        public Builder reportDate(Optional<OffsetDateTime> reportDate) {
            this.reportDate = reportDate;
            return this;
        }

        public Builder reportDate(OffsetDateTime reportDate) {
            this.reportDate = Optional.ofNullable(reportDate);
            return this;
        }

        /**
         * <p>Human-readable expense report identifier.</p>
         */
        @JsonSetter(value = "report_identifier", nulls = Nulls.SKIP)
        public Builder reportIdentifier(Optional<String> reportIdentifier) {
            this.reportIdentifier = reportIdentifier;
            return this;
        }

        public Builder reportIdentifier(String reportIdentifier) {
            this.reportIdentifier = Optional.ofNullable(reportIdentifier);
            return this;
        }
        ...
        public Builder employee(Optional<ExpenseReportRequestEmployee> employee) {
            this.employee = employee;
            return this;
        }

        public Builder employee(ExpenseReportRequestEmployee employee) {
            this.employee = Optional.ofNullable(employee);
            return this;
        }

        /**
         * <p>Overall status of the expense report. One of DRAFT, SUBMITTED, APPROVED, REJECTED</p>
         * <ul>
         * <li><code>DRAFT</code> - DRAFT</li>
         * <li><code>SUBMITTED</code> - SUBMITTED</li>
         * <li><code>APPROVED</code> - APPROVED</li>
        ...
        public Builder status(Optional<ExpenseReportRequestStatus> status) {
            this.status = status;
            return this;
        }

        public Builder status(ExpenseReportRequestStatus status) {
            this.status = Optional.ofNullable(status);
            return this;
        }

        /**
         * <p>Total amount of the expense report</p>
         */
        ...
        /**
         * <p>Currency code for the expense report</p>
         * <ul>
         * <li><code>XUA</code> - ADB Unit of Account</li>
         * <li><code>AFN</code> - Afghan Afghani</li>
         * <li><code>AFA</code> - Afghan Afghani (1927–2002)</li>
        ...
        public Builder currency(Optional<ExpenseReportRequestCurrency> currency) {
            this.currency = currency;
            return this;
        }

        public Builder currency(ExpenseReportRequestCurrency currency) {
            this.currency = Optional.ofNullable(currency);
            return this;
        }

        /**
         * <p>A brief description or purpose for the expense report</p>
         */
        ...
        /**
         * <p>The accounting period the report was posted in</p>
         */
        @JsonSetter(value = "accounting_period", nulls = Nulls.SKIP)
        public Builder accountingPeriod(Optional<ExpenseReportRequestAccountingPeriod> accountingPeriod) {
            this.accountingPeriod = accountingPeriod;
            return this;
        }

        public Builder accountingPeriod(ExpenseReportRequestAccountingPeriod accountingPeriod) {
        ...
        public Builder company(Optional<ExpenseReportRequestCompany> company) {
            this.company = company;
            return this;
        }

        public Builder company(ExpenseReportRequestCompany company) {
            this.company = Optional.ofNullable(company);
            return this;
        }

        /**
         * <p>The related tracking categories associated with the expense report</p>
         */
        ...
        public ExpenseReportRequest build() {
            return new ExpenseReportRequest(
                    expenseReportUrl,
                    reportDate,
                    reportIdentifier,
                    employee,
