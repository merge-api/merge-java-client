...
@JsonDeserialize(using = TaxRateTaxComponentsItem.Deserializer.class)
public final class TaxRateTaxComponentsItem {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TaxRateTaxComponentsItem && equalTo((TaxRateTaxComponentsItem) other);
    }
    ...
    public interface Visitor<T> {
        ...
        T visit(TaxComponent value);
    }

    static final class Deserializer extends StdDeserializer<TaxRateTaxComponentsItem> {
        Deserializer() {
            super(TaxRateTaxComponentsItem.class);
        }

        @java.lang.Override
        public TaxRateTaxComponentsItem deserialize(JsonParser p, DeserializationContext context) throws IOException {
            ...
            try {
                return of(ObjectMappers.JSON_MAPPER.convertValue(value, TaxComponent.class));
            } catch (IllegalArgumentException e) {
            }
