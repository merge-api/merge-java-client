...
public final class JournalLineRequest {
    ...
    private final Optional<JournalLineRequestProject> project;
    ...
    private JournalLineRequest(
            ...
            Optional<JournalLineRequestProject> project,
    ...
    @JsonIgnore
    public Optional<JournalLineRequestProject> getProject() {
        if (project == null) {
            return Optional.empty();
        }
        return project;
    ...
    private Optional<JournalLineRequestAccount> _getAccount() {
        return account;
    }
    ...
    private Optional<JournalLineRequestTrackingCategory> _getTrackingCategory() {
        return trackingCategory;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("currency")
    private Optional<JournalLineRequestCurrency> _getCurrency() {
        return currency;
    }
    ...
    private Optional<JournalLineRequestProject> _getProject() {
        return project;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("contact")
    private Optional<String> _getContact() {
        return contact;
    }
    ...
    public static final class Builder {
        ...
        private Optional<JournalLineRequestProject> project = Optional.empty();
        ...
        public Builder account(Nullable<JournalLineRequestAccount> account) {
            if (account.isNull()) {
                this.account = null;
        ...
        /**
         * <p>The value of the line item including taxes and other fees.</p>
         */
        ...
        public Builder trackingCategory(Nullable<JournalLineRequestTrackingCategory> trackingCategory) {
        ...
        /**
         * <p>The journal line item's associated tracking categories.</p>
         */
        ...
        /**
         * <p>The journal line item's currency.</p>
         * <ul>
         * <li><code>XUA</code> - ADB Unit of Account</li>
         * <li><code>AFN</code> - Afghan Afghani</li>
         * <li><code>AFA</code> - Afghan Afghani (1927–2002)</li>
        ...
        public Builder currency(Nullable<JournalLineRequestCurrency> currency) {
            if (currency.isNull()) {
                this.currency = null;
        ...
        /**
         * <p>The company the journal entry belongs to.</p>
         */
        ...
        public Builder project(Optional<JournalLineRequestProject> project) {
            this.project = project;
            return this;
        }

        public Builder project(JournalLineRequestProject project) {
            this.project = Optional.ofNullable(project);
            return this;
        }

        public Builder project(Nullable<JournalLineRequestProject> project) {
            if (project.isNull()) {
                this.project = null;
        ...
        /**
         * <p>The journal line item's exchange rate.</p>
         */
