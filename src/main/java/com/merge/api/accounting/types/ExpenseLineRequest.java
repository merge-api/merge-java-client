...
public final class ExpenseLineRequest {
    ...
    private final Optional<ExpenseLineRequestProject> project;
    ...
    private ExpenseLineRequest(
            ...
            Optional<ExpenseLineRequestProject> project,
    ...
    @JsonIgnore
    public Optional<ExpenseLineRequestProject> getProject() {
        if (project == null) {
            return Optional.empty();
        }
        return project;
    ...
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("item")
    private Optional<ExpenseLineRequestItem> _getItem() {
        return item;
    }
    ...
    private Optional<ExpenseLineRequestTrackingCategory> _getTrackingCategory() {
        return trackingCategory;
    }
    ...
    private Optional<ExpenseLineRequestEmployee> _getEmployee() {
        return employee;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("currency")
    private Optional<ExpenseLineRequestCurrency> _getCurrency() {
        return currency;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("account")
    private Optional<ExpenseLineRequestAccount> _getAccount() {
        return account;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("contact")
    private Optional<ExpenseLineRequestContact> _getContact() {
        return contact;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("project")
    private Optional<ExpenseLineRequestProject> _getProject() {
        return project;
    }
    ...
    public static final class Builder {
        ...
        private Optional<ExpenseLineRequestProject> project = Optional.empty();
        ...
        public Builder item(Nullable<ExpenseLineRequestItem> item) {
            if (item.isNull()) {
                this.item = null;
        ...
        public Builder trackingCategory(Nullable<ExpenseLineRequestTrackingCategory> trackingCategory) {
        ...
        /**
         * <p>The expense line item's associated tracking categories.</p>
         */
        ...
        /**
         * <p>The company the expense belongs to.</p>
         */
        ...
        public Builder employee(Nullable<ExpenseLineRequestEmployee> employee) {
            if (employee.isNull()) {
                this.employee = null;
        ...
        /**
         * <p>The expense line item's currency.</p>
         * <ul>
         * <li><code>XUA</code> - ADB Unit of Account</li>
         * <li><code>AFN</code> - Afghan Afghani</li>
         * <li><code>AFA</code> - Afghan Afghani (1927–2002)</li>
        ...
        public Builder currency(Nullable<ExpenseLineRequestCurrency> currency) {
            if (currency.isNull()) {
                this.currency = null;
        ...
        /**
         * <p>The expense's payment account.</p>
         */
        ...
        public Builder account(Nullable<ExpenseLineRequestAccount> account) {
            if (account.isNull()) {
                this.account = null;
        ...
        public Builder contact(Nullable<ExpenseLineRequestContact> contact) {
            if (contact.isNull()) {
                this.contact = null;
        ...
        public Builder project(Optional<ExpenseLineRequestProject> project) {
            this.project = project;
            return this;
        }

        public Builder project(ExpenseLineRequestProject project) {
            this.project = Optional.ofNullable(project);
            return this;
        }

        public Builder project(Nullable<ExpenseLineRequestProject> project) {
            if (project.isNull()) {
                this.project = null;
        ...
        /**
         * <p>The description of the item that was purchased by the company.</p>
         */
        ...
        /**
         * <p>The expense line item's exchange rate.</p>
         */
