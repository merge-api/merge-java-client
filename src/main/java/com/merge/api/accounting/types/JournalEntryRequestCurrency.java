...
public final class JournalEntryRequestCurrency {
    ...
    public static JournalEntryRequestCurrency of(TransactionCurrencyEnum value) {
    ...
    static final class Deserializer extends StdDeserializer<JournalEntryRequestCurrency> {
        ...
        @java.lang.Override
        public JournalEntryRequestCurrency deserialize(JsonParser p, DeserializationContext context)
                throws IOException {
