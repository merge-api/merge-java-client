...
public final class JournalLine {
    ...
    private final Optional<JournalLineProject> project;
    ...
    private JournalLine(
            ...
            Optional<JournalLineProject> project,
    ...
    @JsonIgnore
    public Optional<JournalLineProject> getProject() {
        if (project == null) {
            return Optional.empty();
        }
        return project;
    ...
    private Optional<JournalLineAccount> _getAccount() {
        return account;
    }
    ...
    private Optional<JournalLineTrackingCategory> _getTrackingCategory() {
        return trackingCategory;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("currency")
    private Optional<JournalLineCurrency> _getCurrency() {
        return currency;
    }
    ...
    private Optional<JournalLineProject> _getProject() {
        return project;
    }
    ...
    public static final class Builder {
        ...
        private Optional<JournalLineProject> project = Optional.empty();
        ...
        public Builder account(Nullable<JournalLineAccount> account) {
            if (account.isNull()) {
                this.account = null;
        ...
        public Builder trackingCategory(Nullable<JournalLineTrackingCategory> trackingCategory) {
        ...
        public Builder currency(Nullable<JournalLineCurrency> currency) {
            if (currency.isNull()) {
                this.currency = null;
        ...
        public Builder project(Optional<JournalLineProject> project) {
            this.project = project;
            return this;
        }

        public Builder project(JournalLineProject project) {
            this.project = Optional.ofNullable(project);
            return this;
        }

        public Builder project(Nullable<JournalLineProject> project) {
            if (project.isNull()) {
                this.project = null;
