...
@JsonDeserialize(builder = PatchedVendorCreditEndpointRequest.Builder.class)
public final class PatchedVendorCreditEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final PatchedVendorCreditRequest model;

    private final Map<String, Object> additionalProperties;

    private PatchedVendorCreditEndpointRequest(
            Optional<Boolean> isDebugMode,
            Optional<Boolean> runAsync,
            PatchedVendorCreditRequest model,
    ...
    @JsonProperty("model")
    public PatchedVendorCreditRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PatchedVendorCreditEndpointRequest
                && equalTo((PatchedVendorCreditEndpointRequest) other);
    }
    ...
    private boolean equalTo(PatchedVendorCreditEndpointRequest other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull PatchedVendorCreditRequest model);

        Builder from(PatchedVendorCreditEndpointRequest other);
    }

    public interface _FinalStage {
        PatchedVendorCreditEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private PatchedVendorCreditRequest model;
        ...
        @java.lang.Override
        public Builder from(PatchedVendorCreditEndpointRequest other) {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull PatchedVendorCreditRequest model) {
            this.model = model;
            return this;
        }
        ...
        @java.lang.Override
        public PatchedVendorCreditEndpointRequest build() {
            return new PatchedVendorCreditEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
