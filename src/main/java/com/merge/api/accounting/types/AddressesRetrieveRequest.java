...
public final class AddressesRetrieveRequest {
    ...
    private final Optional<AddressesRetrieveRequestRemoteFields> remoteFields;

    private final Optional<AddressesRetrieveRequestShowEnumOrigins> showEnumOrigins;
    ...
    private AddressesRetrieveRequest(
            ...
            Optional<AddressesRetrieveRequestRemoteFields> remoteFields,
            Optional<AddressesRetrieveRequestShowEnumOrigins> showEnumOrigins,
    ...
    public Optional<AddressesRetrieveRequestRemoteFields> getRemoteFields() {
        return remoteFields;
    }
    ...
    public Optional<AddressesRetrieveRequestShowEnumOrigins> getShowEnumOrigins() {
    ...
    public static final class Builder {
        ...
        private Optional<AddressesRetrieveRequestRemoteFields> remoteFields = Optional.empty();

        private Optional<AddressesRetrieveRequestShowEnumOrigins> showEnumOrigins = Optional.empty();
        ...
        public Builder remoteFields(Optional<AddressesRetrieveRequestRemoteFields> remoteFields) {
            this.remoteFields = remoteFields;
            return this;
        }

        public Builder remoteFields(AddressesRetrieveRequestRemoteFields remoteFields) {
        ...
        public Builder showEnumOrigins(Optional<AddressesRetrieveRequestShowEnumOrigins> showEnumOrigins) {
            this.showEnumOrigins = showEnumOrigins;
            return this;
        }

        public Builder showEnumOrigins(AddressesRetrieveRequestShowEnumOrigins showEnumOrigins) {
            this.showEnumOrigins = Optional.ofNullable(showEnumOrigins);
            return this;
        }

        public AddressesRetrieveRequest build() {
            return new AddressesRetrieveRequest(
