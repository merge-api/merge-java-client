...
@JsonDeserialize(builder = ItemFulfillmentEndpointRequest.Builder.class)
public final class ItemFulfillmentEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final ItemFulfillmentRequestRequest model;
    ...
    private ItemFulfillmentEndpointRequest(
            ...
            ItemFulfillmentRequestRequest model,
    ...
    @JsonProperty("model")
    public ItemFulfillmentRequestRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ItemFulfillmentEndpointRequest && equalTo((ItemFulfillmentEndpointRequest) other);
    }
    ...
    private boolean equalTo(ItemFulfillmentEndpointRequest other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull ItemFulfillmentRequestRequest model);

        Builder from(ItemFulfillmentEndpointRequest other);
    }
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private ItemFulfillmentRequestRequest model;
        ...
        @java.lang.Override
        public Builder from(ItemFulfillmentEndpointRequest other) {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull ItemFulfillmentRequestRequest model) {
            this.model = model;
            return this;
        }
        ...
        @java.lang.Override
        public ItemFulfillmentEndpointRequest build() {
            return new ItemFulfillmentEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
