...
public final class CreditNoteRequest {
    ...
    private CreditNoteRequest(
            ...
            Optional<List<CreditNoteApplyLineForCreditNoteRequest>> appliedToLines,
    ...
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("status")
    private Optional<CreditNoteRequestStatus> _getStatus() {
        return status;
    }
    ...
    private Optional<CreditNoteRequestContact> _getContact() {
        return contact;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("company")
    private Optional<CreditNoteRequestCompany> _getCompany() {
        return company;
    }
    ...
    private Optional<Double> _getRemainingCredit() {
        return remainingCredit;
    }
    ...
    private Optional<CreditNoteRequestCurrency> _getCurrency() {
        return currency;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("accounting_period")
    private Optional<CreditNoteRequestAccountingPeriod> _getAccountingPeriod() {
        return accountingPeriod;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreditNoteRequest && equalTo((CreditNoteRequest) other);
    }
    ...
    private boolean equalTo(CreditNoteRequest other) {
    ...
    public static final class Builder {
        ...
        private Optional<CreditNoteRequestContact> contact = Optional.empty();

        private Optional<CreditNoteRequestCompany> company = Optional.empty();
        ...
        private Optional<List<CreditNoteRequestLineItemsItem>> lineItems = Optional.empty();
        ...
        private Optional<List<Optional<CreditNoteRequestAppliedPaymentsItem>>> appliedPayments = Optional.empty();

        private Optional<CreditNoteRequestAccountingPeriod> accountingPeriod = Optional.empty();

        private Optional<List<CreditNoteApplyLineForCreditNoteRequest>> appliedToLines = Optional.empty();
        ...
        public Builder from(CreditNoteRequest other) {
        ...
        /**
         * <p>The credit note's transaction date.</p>
         */
        ...
        public Builder status(Nullable<CreditNoteRequestStatus> status) {
            if (status.isNull()) {
                this.status = null;
        ...
        public Builder contact(Optional<CreditNoteRequestContact> contact) {
            this.contact = contact;
            return this;
        }
        ...
        public Builder contact(Nullable<CreditNoteRequestContact> contact) {
            if (contact.isNull()) {
                this.contact = null;
        ...
        public Builder company(Optional<CreditNoteRequestCompany> company) {
            this.company = company;
            return this;
        }
        ...
        public Builder company(Nullable<CreditNoteRequestCompany> company) {
            if (company.isNull()) {
                this.company = null;
        ...
        /**
         * <p>The credit note's exchange rate.</p>
         */
        ...
        /**
         * <p>The credit note's total amount.</p>
         */
        ...
        /**
         * <p>The amount of value remaining in the credit note that the customer can use.</p>
         */
        ...
        public Builder remainingCredit(Nullable<Double> remainingCredit) {
            ...
            } else if (remainingCredit.isEmpty()) {
                this.remainingCredit = Optional.empty();
            } else {
                this.remainingCredit = Optional.of(remainingCredit.get());
            }
            return this;
        }
        ...
        public Builder lineItems(Optional<List<CreditNoteRequestLineItemsItem>> lineItems) {
            this.lineItems = lineItems;
            return this;
        }
        ...
        /**
         * <p>The credit note's currency.</p>
         * <ul>
         * <li><code>XUA</code> - ADB Unit of Account</li>
         * <li><code>AFN</code> - Afghan Afghani</li>
         * <li><code>AFA</code> - Afghan Afghani (1927–2002)</li>
        ...
        public Builder currency(Nullable<CreditNoteRequestCurrency> currency) {
            if (currency.isNull()) {
                this.currency = null;
        ...
        public Builder payments(Optional<List<Optional<CreditNoteRequestPaymentsItem>>> payments) {
            this.payments = payments;
            return this;
        }
        ...
        /**
         * <p>A list of the Payment Applied to Lines common models related to a given Invoice, Credit Note, or Journal Entry.</p>
         */
        @JsonSetter(value = "applied_payments", nulls = Nulls.SKIP)
        public Builder appliedPayments(Optional<List<Optional<CreditNoteRequestAppliedPaymentsItem>>> appliedPayments) {
            this.appliedPayments = appliedPayments;
            return this;
        }
        ...
        /**
         * <p>The accounting period that the CreditNote was generated in.</p>
         */
        @JsonSetter(value = "accounting_period", nulls = Nulls.SKIP)
        public Builder accountingPeriod(Optional<CreditNoteRequestAccountingPeriod> accountingPeriod) {
            this.accountingPeriod = accountingPeriod;
            return this;
        }
        ...
        public Builder accountingPeriod(Nullable<CreditNoteRequestAccountingPeriod> accountingPeriod) {
        ...
        /**
         * <p>A list of the CreditNote Applied to Lines common models related to a given Credit Note</p>
         */
        @JsonSetter(value = "applied_to_lines", nulls = Nulls.SKIP)
        public Builder appliedToLines(Optional<List<CreditNoteApplyLineForCreditNoteRequest>> appliedToLines) {
            this.appliedToLines = appliedToLines;
            return this;
        }
