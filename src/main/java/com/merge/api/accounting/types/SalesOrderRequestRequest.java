...
@JsonDeserialize(builder = SalesOrderRequestRequest.Builder.class)
public final class SalesOrderRequestRequest {
    private final Optional<SalesOrderRequestRequestCustomer> customer;

    private final Optional<SalesOrderRequestRequestCurrency> currency;

    private final Optional<String> exchangeRate;

    private final Optional<SalesOrderRequestRequestCompany> company;

    private final Optional<SalesOrderRequestRequestStatus> status;

    private final Optional<SalesOrderRequestRequestPaymentTerm> paymentTerm;

    private final Optional<String> memo;

    private final Optional<SalesOrderRequestRequestShippingAddress> shippingAddress;

    private final Optional<List<Optional<SalesOrderRequestRequestTrackingCategoriesItem>>> trackingCategories;
    ...
    private final Optional<List<SalesOrderRequestRequestLinesItem>> lines;
    ...
    private SalesOrderRequestRequest(
            Optional<SalesOrderRequestRequestCustomer> customer,
            Optional<SalesOrderRequestRequestCurrency> currency,
            Optional<String> exchangeRate,
            Optional<SalesOrderRequestRequestCompany> company,
            Optional<SalesOrderRequestRequestStatus> status,
            Optional<SalesOrderRequestRequestPaymentTerm> paymentTerm,
            Optional<String> memo,
            Optional<SalesOrderRequestRequestShippingAddress> shippingAddress,
            Optional<List<Optional<SalesOrderRequestRequestTrackingCategoriesItem>>> trackingCategories,
            Optional<OffsetDateTime> issueDate,
            Optional<String> transactionNumber,
            Optional<Double> total,
            Optional<List<SalesOrderRequestRequestLinesItem>> lines,
    ...
    public Optional<SalesOrderRequestRequestCustomer> getCustomer() {
        return customer;
    }
    ...
    public Optional<SalesOrderRequestRequestCurrency> getCurrency() {
        return currency;
    }

    /**
     * @return The exchange rate applied if the order currency differs from the base currency.
     */
    ...
    public Optional<SalesOrderRequestRequestCompany> getCompany() {
        return company;
    }

    /**
     * @return The status of the sales order.
     * <ul>
     * <li><code>DRAFT</code> - DRAFT</li>
     * <li><code>PENDING_APPROVAL</code> - PENDING_APPROVAL</li>
     * <li><code>OPEN</code> - OPEN</li>
     * <li><code>PARTIALLY_COMPLETED</code> - PARTIALLY_COMPLETED</li>
     * <li><code>COMPLETED</code> - COMPLETED</li>
     * <li><code>CLOSED</code> - CLOSED</li>
     * </ul>
     */
    @JsonProperty("status")
    public Optional<SalesOrderRequestRequestStatus> getStatus() {
        return status;
    }

    /**
     * @return The payment terms applied to this order.
     */
    @JsonProperty("payment_term")
    public Optional<SalesOrderRequestRequestPaymentTerm> getPaymentTerm() {
        return paymentTerm;
    }

    /**
     * @return Notes or comments attached to the order.
     */
    @JsonProperty("memo")
    ...
    public Optional<SalesOrderRequestRequestShippingAddress> getShippingAddress() {
        return shippingAddress;
    }

    @JsonProperty("tracking_categories")
    public Optional<List<Optional<SalesOrderRequestRequestTrackingCategoriesItem>>> getTrackingCategories() {
        return trackingCategories;
    }

    /**
     * @return The date the sales order was issued.
     */
    ...
    /**
     * @return The human-readable sales order number or transaction reference.
     */
    ...
    @JsonProperty("lines")
    public Optional<List<SalesOrderRequestRequestLinesItem>> getLines() {
        return lines;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SalesOrderRequestRequest && equalTo((SalesOrderRequestRequest) other);
    }
    ...
    private boolean equalTo(SalesOrderRequestRequest other) {
    ...
    public static final class Builder {
        private Optional<SalesOrderRequestRequestCustomer> customer = Optional.empty();

        private Optional<SalesOrderRequestRequestCurrency> currency = Optional.empty();

        private Optional<String> exchangeRate = Optional.empty();

        private Optional<SalesOrderRequestRequestCompany> company = Optional.empty();

        private Optional<SalesOrderRequestRequestStatus> status = Optional.empty();

        private Optional<SalesOrderRequestRequestPaymentTerm> paymentTerm = Optional.empty();

        private Optional<String> memo = Optional.empty();

        private Optional<SalesOrderRequestRequestShippingAddress> shippingAddress = Optional.empty();

        private Optional<List<Optional<SalesOrderRequestRequestTrackingCategoriesItem>>> trackingCategories =
                Optional.empty();
        ...
        private Optional<List<SalesOrderRequestRequestLinesItem>> lines = Optional.empty();
        ...
        public Builder from(SalesOrderRequestRequest other) {
        ...
        /**
         * <p>The customer associated with the sales order.</p>
         */
        @JsonSetter(value = "customer", nulls = Nulls.SKIP)
        public Builder customer(Optional<SalesOrderRequestRequestCustomer> customer) {
            this.customer = customer;
            return this;
        }

        public Builder customer(SalesOrderRequestRequestCustomer customer) {
            this.customer = Optional.ofNullable(customer);
            return this;
        }

        /**
         * <p>The currency code for the order.</p>
         * <ul>
         * <li><code>XUA</code> - ADB Unit of Account</li>
         * <li><code>AFN</code> - Afghan Afghani</li>
         * <li><code>AFA</code> - Afghan Afghani (1927–2002)</li>
        ...
        public Builder currency(Optional<SalesOrderRequestRequestCurrency> currency) {
            this.currency = currency;
            return this;
        }

        public Builder currency(SalesOrderRequestRequestCurrency currency) {
            this.currency = Optional.ofNullable(currency);
            return this;
        }

        /**
         * <p>The exchange rate applied if the order currency differs from the base currency.</p>
         */
        ...
        public Builder company(Optional<SalesOrderRequestRequestCompany> company) {
            this.company = company;
            return this;
        }

        public Builder company(SalesOrderRequestRequestCompany company) {
            this.company = Optional.ofNullable(company);
            return this;
        }

        /**
         * <p>The status of the sales order.</p>
         * <ul>
         * <li><code>DRAFT</code> - DRAFT</li>
         * <li><code>PENDING_APPROVAL</code> - PENDING_APPROVAL</li>
         * <li><code>OPEN</code> - OPEN</li>
        ...
        public Builder status(Optional<SalesOrderRequestRequestStatus> status) {
            this.status = status;
            return this;
        }

        public Builder status(SalesOrderRequestRequestStatus status) {
            this.status = Optional.ofNullable(status);
            return this;
        }

        /**
         * <p>The payment terms applied to this order.</p>
         */
        @JsonSetter(value = "payment_term", nulls = Nulls.SKIP)
        public Builder paymentTerm(Optional<SalesOrderRequestRequestPaymentTerm> paymentTerm) {
            this.paymentTerm = paymentTerm;
            return this;
        }

        public Builder paymentTerm(SalesOrderRequestRequestPaymentTerm paymentTerm) {
            this.paymentTerm = Optional.ofNullable(paymentTerm);
            return this;
        }

        /**
         * <p>Notes or comments attached to the order.</p>
         */
        ...
        public Builder shippingAddress(Optional<SalesOrderRequestRequestShippingAddress> shippingAddress) {
            this.shippingAddress = shippingAddress;
            return this;
        }

        public Builder shippingAddress(SalesOrderRequestRequestShippingAddress shippingAddress) {
        ...
        public Builder trackingCategories(
                List<Optional<SalesOrderRequestRequestTrackingCategoriesItem>> trackingCategories) {
            this.trackingCategories = Optional.ofNullable(trackingCategories);
            return this;
        }

        /**
         * <p>The date the sales order was issued.</p>
         */
        ...
        /**
         * <p>The human-readable sales order number or transaction reference.</p>
         */
        @JsonSetter(value = "transaction_number", nulls = Nulls.SKIP)
        ...
        public Builder lines(Optional<List<SalesOrderRequestRequestLinesItem>> lines) {
            this.lines = lines;
            return this;
        }

        public Builder lines(List<SalesOrderRequestRequestLinesItem> lines) {
        ...
        public SalesOrderRequestRequest build() {
            return new SalesOrderRequestRequest(
                    customer,
                    currency,
                    exchangeRate,
                    company,
