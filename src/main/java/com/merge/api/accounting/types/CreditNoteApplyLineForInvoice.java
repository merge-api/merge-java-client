...
public final class CreditNoteApplyLineForInvoice {
    ...
    private Optional<CreditNoteApplyLineForInvoiceCreditNote> _getCreditNote() {
        return creditNote;
    }
    ...
    public static final class Builder {
        ...
        public Builder creditNote(Nullable<CreditNoteApplyLineForInvoiceCreditNote> creditNote) {
            if (creditNote.isNull()) {
                this.creditNote = null;
            } else if (creditNote.isEmpty()) {
                this.creditNote = Optional.empty();
            } else {
                this.creditNote = Optional.of(creditNote.get());
            }
            return this;
        }
