...
public final class VendorCreditApplyLineForVendorCredit {
    ...
    private Optional<VendorCreditApplyLineForVendorCreditInvoice> _getInvoice() {
        return invoice;
    }
    ...
    public static final class Builder {
        ...
        public Builder invoice(Nullable<VendorCreditApplyLineForVendorCreditInvoice> invoice) {
            if (invoice.isNull()) {
                this.invoice = null;
