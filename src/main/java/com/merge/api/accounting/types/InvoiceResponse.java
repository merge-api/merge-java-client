...
public final class InvoiceResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Invoice model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Invoice model) {
            this.model = model;
            return this;
        }
        ...
        public InvoiceResponse build() {
            return new InvoiceResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
