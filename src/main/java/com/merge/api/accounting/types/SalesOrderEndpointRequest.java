...
@JsonDeserialize(builder = SalesOrderEndpointRequest.Builder.class)
public final class SalesOrderEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final SalesOrderRequestRequest model;

    private final Map<String, Object> additionalProperties;

    private SalesOrderEndpointRequest(
            Optional<Boolean> isDebugMode,
            Optional<Boolean> runAsync,
            SalesOrderRequestRequest model,
    ...
    @JsonProperty("model")
    public SalesOrderRequestRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SalesOrderEndpointRequest && equalTo((SalesOrderEndpointRequest) other);
    }
    ...
    private boolean equalTo(SalesOrderEndpointRequest other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull SalesOrderRequestRequest model);

        Builder from(SalesOrderEndpointRequest other);
    }

    public interface _FinalStage {
        SalesOrderEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private SalesOrderRequestRequest model;
        ...
        @java.lang.Override
        public Builder from(SalesOrderEndpointRequest other) {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull SalesOrderRequestRequest model) {
            this.model = model;
            return this;
        }
        ...
        @java.lang.Override
        public SalesOrderEndpointRequest build() {
            return new SalesOrderEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
