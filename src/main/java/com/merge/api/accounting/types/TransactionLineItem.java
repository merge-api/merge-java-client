...
public final class TransactionLineItem {
    ...
    /**
     * @return The transaction line item's associated tracking categories.
     */
    ...
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("item")
    private Optional<TransactionLineItemItem> _getItem() {
        return item;
    }
    ...
    private Optional<TransactionLineItemCurrency> _getCurrency() {
        return currency;
    }
    ...
    public static final class Builder {
        ...
        /**
         * <p>An internal note used by the business to clarify purpose of the transaction.</p>
         */
        ...
        public Builder item(Nullable<TransactionLineItemItem> item) {
            if (item.isNull()) {
                this.item = null;
        ...
        /**
         * <p>The transaction line item's associated tracking categories.</p>
         */
        ...
        public Builder currency(Nullable<TransactionLineItemCurrency> currency) {
            if (currency.isNull()) {
                this.currency = null;
