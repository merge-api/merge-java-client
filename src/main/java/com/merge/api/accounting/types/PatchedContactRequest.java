...
public final class PatchedContactRequest {
    ...
    private final Optional<PatchedContactRequestStatus> status;
    ...
    private PatchedContactRequest(
            ...
            Optional<PatchedContactRequestStatus> status,
     ...
     */
    @JsonProperty("status")
    public Optional<PatchedContactRequestStatus> getStatus() {
        return status;
    }
    ...
    public static final class Builder {
        ...
        private Optional<PatchedContactRequestStatus> status = Optional.empty();
        ...
        public Builder status(Optional<PatchedContactRequestStatus> status) {
            this.status = status;
            return this;
        }

        public Builder status(PatchedContactRequestStatus status) {
