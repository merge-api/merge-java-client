...
@JsonDeserialize(builder = ExpenseReportsLinesListRequest.Builder.class)
public final class ExpenseReportsLinesListRequest {
    private final Optional<List<ExpenseReportsLinesListRequestExpandItem>> expand;
    ...
    private ExpenseReportsLinesListRequest(
            Optional<List<ExpenseReportsLinesListRequestExpandItem>> expand,
     ...
     */
    @JsonProperty("expand")
    public Optional<List<ExpenseReportsLinesListRequestExpandItem>> getExpand() {
        return expand;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExpenseReportsLinesListRequest && equalTo((ExpenseReportsLinesListRequest) other);
    }
    ...
    private boolean equalTo(ExpenseReportsLinesListRequest other) {
    ...
    public static final class Builder {
        private Optional<List<ExpenseReportsLinesListRequestExpandItem>> expand = Optional.empty();
        ...
        public Builder from(ExpenseReportsLinesListRequest other) {
        ...
        public Builder expand(Optional<List<ExpenseReportsLinesListRequestExpandItem>> expand) {
            this.expand = expand;
            return this;
        }

        public Builder expand(List<ExpenseReportsLinesListRequestExpandItem> expand) {
            this.expand = Optional.ofNullable(expand);
            return this;
        }

        public Builder expand(ExpenseReportsLinesListRequestExpandItem expand) {
        ...
        public ExpenseReportsLinesListRequest build() {
            return new ExpenseReportsLinesListRequest(
                    expand,
                    cursor,
                    includeDeletedData,
                    includeRemoteData,
