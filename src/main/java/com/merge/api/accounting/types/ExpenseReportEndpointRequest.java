...
@JsonDeserialize(builder = ExpenseReportEndpointRequest.Builder.class)
public final class ExpenseReportEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final ExpenseReportRequest model;

    private final Map<String, Object> additionalProperties;

    private ExpenseReportEndpointRequest(
            Optional<Boolean> isDebugMode,
            Optional<Boolean> runAsync,
            ExpenseReportRequest model,
    ...
    @JsonProperty("model")
    public ExpenseReportRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExpenseReportEndpointRequest && equalTo((ExpenseReportEndpointRequest) other);
    }
    ...
    private boolean equalTo(ExpenseReportEndpointRequest other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull ExpenseReportRequest model);

        Builder from(ExpenseReportEndpointRequest other);
    }

    public interface _FinalStage {
        ExpenseReportEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private ExpenseReportRequest model;
        ...
        @java.lang.Override
        public Builder from(ExpenseReportEndpointRequest other) {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull ExpenseReportRequest model) {
            this.model = model;
            return this;
        }
        ...
        @java.lang.Override
        public ExpenseReportEndpointRequest build() {
            return new ExpenseReportEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
