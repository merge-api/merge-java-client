...
@JsonDeserialize(builder = ExpenseReportLineRequest.Builder.class)
public final class ExpenseReportLineRequest {
    private final Optional<String> remoteId;

    private final Optional<ExpenseReportLineRequestAccount> account;

    private final Optional<String> description;

    private final Optional<OffsetDateTime> expenseDate;

    private final Optional<Double> amount;

    private final Optional<ExpenseReportLineRequestCurrency> currency;
    ...
    private final Optional<ExpenseReportLineRequestEmployee> employee;

    private final Optional<ExpenseReportLineRequestProject> project;

    private final Optional<ExpenseReportLineRequestCompany> company;

    private final Optional<ExpenseReportLineRequestContact> contact;

    private final Optional<Double> quantity;

    private final Optional<Double> unitPrice;

    private final Optional<Boolean> nonReimbursable;

    private final Optional<Double> taxAmount;

    private final Optional<Boolean> inclusiveOfTax;

    private final Optional<ExpenseReportLineRequestTaxRate> taxRate;
    ...
    private ExpenseReportLineRequest(
            ...
            Optional<ExpenseReportLineRequestAccount> account,
            Optional<String> description,
            Optional<OffsetDateTime> expenseDate,
            Optional<Double> amount,
            Optional<ExpenseReportLineRequestCurrency> currency,
            Optional<String> exchangeRate,
            Optional<Boolean> isBillable,
            List<String> trackingCategories,
            Optional<ExpenseReportLineRequestEmployee> employee,
            Optional<ExpenseReportLineRequestProject> project,
            Optional<ExpenseReportLineRequestCompany> company,
            Optional<ExpenseReportLineRequestContact> contact,
            Optional<Double> quantity,
            Optional<Double> unitPrice,
            Optional<Boolean> nonReimbursable,
            Optional<Double> taxAmount,
            Optional<Boolean> inclusiveOfTax,
            Optional<ExpenseReportLineRequestTaxRate> taxRate,
    ...
    public Optional<ExpenseReportLineRequestAccount> getAccount() {
        return account;
    }

    /**
     * @return Description of the individual expense.
     */
    ...
    /**
     * @return The date the individual expense was incurred.
     */
    @JsonProperty("expense_date")
    public Optional<OffsetDateTime> getExpenseDate() {
        return expenseDate;
    }

    /**
     * @return The amount of the expense for the line item.
     */
    @JsonProperty("amount")
    ...
    /**
     * @return Currency of the expense line (if different from the report currency).
     * <ul>
    ...
    public Optional<ExpenseReportLineRequestCurrency> getCurrency() {
        return currency;
    }

    /**
     * @return Exchange rate used if the line item is in a foreign currency.
     */
    ...
    /**
     * @return Whether the expense line is billable to a client or project.
     */
    ...
    /**
     * @return The related tracking categories associated with the expense report (Department, Location, Class, Expense Category)
     */
    ...
    /**
     * @return Identifier for the employee who submitted or is associated with the expense report
     */
    @JsonProperty("employee")
    public Optional<ExpenseReportLineRequestEmployee> getEmployee() {
        return employee;
    }

    @JsonProperty("project")
    public Optional<ExpenseReportLineRequestProject> getProject() {
        return project;
    }

    /**
     * @return The subsidiary that the expense report is created in
     */
    @JsonProperty("company")
    public Optional<ExpenseReportLineRequestCompany> getCompany() {
        return company;
    }

    @JsonProperty("contact")
    public Optional<ExpenseReportLineRequestContact> getContact() {
        return contact;
    }

    /**
     * @return Quantity for the expense line (e.g., miles driven, items purchased).
     */
    ...
    /**
     * @return Price per unit for the expense line (if applicable).
     */
    ...
    /**
     * @return Whether the expense line is non-reimbursable (e.g., paid via company card).
     */
    @JsonProperty("non_reimbursable")
    public Optional<Boolean> getNonReimbursable() {
        return nonReimbursable;
    }

    /**
     * @return Tax amount applicable for the line item.
     */
    ...
    /**
     * @return Whether the amount is inclusive of tax.
     */
    ...
    public Optional<ExpenseReportLineRequestTaxRate> getTaxRate() {
        return taxRate;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExpenseReportLineRequest && equalTo((ExpenseReportLineRequest) other);
    }
    ...
    private boolean equalTo(ExpenseReportLineRequest other) {
        return remoteId.equals(other.remoteId)
                ...
                && nonReimbursable.equals(other.nonReimbursable)
    ...
    public static final class Builder {
        ...
        private Optional<ExpenseReportLineRequestAccount> account = Optional.empty();

        private Optional<String> description = Optional.empty();

        private Optional<OffsetDateTime> expenseDate = Optional.empty();

        private Optional<Double> amount = Optional.empty();

        private Optional<ExpenseReportLineRequestCurrency> currency = Optional.empty();
        ...
        private Optional<ExpenseReportLineRequestEmployee> employee = Optional.empty();

        private Optional<ExpenseReportLineRequestProject> project = Optional.empty();

        private Optional<ExpenseReportLineRequestCompany> company = Optional.empty();

        private Optional<ExpenseReportLineRequestContact> contact = Optional.empty();

        private Optional<Double> quantity = Optional.empty();

        private Optional<Double> unitPrice = Optional.empty();

        private Optional<Boolean> nonReimbursable = Optional.empty();

        private Optional<Double> taxAmount = Optional.empty();

        private Optional<Boolean> inclusiveOfTax = Optional.empty();

        private Optional<ExpenseReportLineRequestTaxRate> taxRate = Optional.empty();
        ...
        public Builder from(ExpenseReportLineRequest other) {
            remoteId(other.getRemoteId());
            account(other.getAccount());
            description(other.getDescription());
            expenseDate(other.getExpenseDate());
            ...
            nonReimbursable(other.getNonReimbursable());
        ...
        public Builder account(Optional<ExpenseReportLineRequestAccount> account) {
            this.account = account;
            return this;
        }

        public Builder account(ExpenseReportLineRequestAccount account) {
            this.account = Optional.ofNullable(account);
            return this;
        }

        /**
         * <p>Description of the individual expense.</p>
         */
        ...
        /**
         * <p>The date the individual expense was incurred.</p>
         */
        @JsonSetter(value = "expense_date", nulls = Nulls.SKIP)
        public Builder expenseDate(Optional<OffsetDateTime> expenseDate) {
            this.expenseDate = expenseDate;
            return this;
        }

        public Builder expenseDate(OffsetDateTime expenseDate) {
            this.expenseDate = Optional.ofNullable(expenseDate);
            return this;
        }

        /**
         * <p>The amount of the expense for the line item.</p>
         */
        ...
        /**
         * <p>Currency of the expense line (if different from the report currency).</p>
         * <ul>
         * <li><code>XUA</code> - ADB Unit of Account</li>
         * <li><code>AFN</code> - Afghan Afghani</li>
         * <li><code>AFA</code> - Afghan Afghani (1927–2002)</li>
        ...
        public Builder currency(Optional<ExpenseReportLineRequestCurrency> currency) {
            this.currency = currency;
            return this;
        }

        public Builder currency(ExpenseReportLineRequestCurrency currency) {
            this.currency = Optional.ofNullable(currency);
            return this;
        }

        /**
         * <p>Exchange rate used if the line item is in a foreign currency.</p>
         */
        ...
        /**
         * <p>Whether the expense line is billable to a client or project.</p>
         */
        ...
        /**
         * <p>The related tracking categories associated with the expense report (Department, Location, Class, Expense Category)</p>
         */
        ...
        /**
         * <p>Identifier for the employee who submitted or is associated with the expense report</p>
         */
        @JsonSetter(value = "employee", nulls = Nulls.SKIP)
        public Builder employee(Optional<ExpenseReportLineRequestEmployee> employee) {
            this.employee = employee;
            return this;
        }

        public Builder employee(ExpenseReportLineRequestEmployee employee) {
            this.employee = Optional.ofNullable(employee);
            return this;
        }

        @JsonSetter(value = "project", nulls = Nulls.SKIP)
        public Builder project(Optional<ExpenseReportLineRequestProject> project) {
            this.project = project;
            return this;
        }

        public Builder project(ExpenseReportLineRequestProject project) {
            this.project = Optional.ofNullable(project);
            return this;
        }

        /**
         * <p>The subsidiary that the expense report is created in</p>
         */
        @JsonSetter(value = "company", nulls = Nulls.SKIP)
        public Builder company(Optional<ExpenseReportLineRequestCompany> company) {
            this.company = company;
            return this;
        }

        public Builder company(ExpenseReportLineRequestCompany company) {
            this.company = Optional.ofNullable(company);
            return this;
        }

        @JsonSetter(value = "contact", nulls = Nulls.SKIP)
        public Builder contact(Optional<ExpenseReportLineRequestContact> contact) {
            this.contact = contact;
            return this;
        }

        public Builder contact(ExpenseReportLineRequestContact contact) {
            this.contact = Optional.ofNullable(contact);
            return this;
        }

        /**
         * <p>Quantity for the expense line (e.g., miles driven, items purchased).</p>
         */
        ...
        /**
         * <p>Price per unit for the expense line (if applicable).</p>
         */
        ...
        /**
         * <p>Whether the expense line is non-reimbursable (e.g., paid via company card).</p>
         */
        @JsonSetter(value = "non_reimbursable", nulls = Nulls.SKIP)
        public Builder nonReimbursable(Optional<Boolean> nonReimbursable) {
            this.nonReimbursable = nonReimbursable;
            return this;
        }

        public Builder nonReimbursable(Boolean nonReimbursable) {
            this.nonReimbursable = Optional.ofNullable(nonReimbursable);
            return this;
        }

        /**
         * <p>Tax amount applicable for the line item.</p>
         */
        ...
        /**
         * <p>Whether the amount is inclusive of tax.</p>
         */
        ...
        public Builder taxRate(Optional<ExpenseReportLineRequestTaxRate> taxRate) {
            this.taxRate = taxRate;
            return this;
        }

        public Builder taxRate(ExpenseReportLineRequestTaxRate taxRate) {
        ...
        public ExpenseReportLineRequest build() {
            return new ExpenseReportLineRequest(
                    remoteId,
                    account,
                    description,
                    expenseDate,
