...
public final class CashFlowStatement {
    ...
    private Optional<CashFlowStatementCurrency> _getCurrency() {
        return currency;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("company")
    private Optional<CashFlowStatementCompany> _getCompany() {
        return company;
    }
    ...
    private Optional<Double> _getCashAtBeginningOfPeriod() {
        return cashAtBeginningOfPeriod;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("cash_at_end_of_period")
    private Optional<Double> _getCashAtEndOfPeriod() {
        return cashAtEndOfPeriod;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("remote_generated_at")
    private Optional<OffsetDateTime> _getRemoteGeneratedAt() {
        return remoteGeneratedAt;
    }
    ...
    public static final class Builder {
        ...
        /**
         * <p>The cash flow statement's name.</p>
         */
        ...
        /**
         * <p>The cash flow statement's currency.</p>
         * <ul>
         * <li><code>XUA</code> - ADB Unit of Account</li>
         * <li><code>AFN</code> - Afghan Afghani</li>
         * <li><code>AFA</code> - Afghan Afghani (1927–2002)</li>
        ...
        public Builder currency(Nullable<CashFlowStatementCurrency> currency) {
            if (currency.isNull()) {
                this.currency = null;
        ...
        /**
         * <p>The company the cash flow statement belongs to.</p>
         */
        ...
        public Builder company(Nullable<CashFlowStatementCompany> company) {
            if (company.isNull()) {
                this.company = null;
        ...
        /**
         * <p>The cash flow statement's start period.</p>
         */
        ...
        /**
         * <p>The cash flow statement's end period.</p>
         */
        ...
        /**
         * <p>Cash and cash equivalents at the beginning of the cash flow statement's period.</p>
         */
        ...
        public Builder cashAtBeginningOfPeriod(Double cashAtBeginningOfPeriod) {
            this.cashAtBeginningOfPeriod = Optional.ofNullable(cashAtBeginningOfPeriod);
            return this;
        }

        public Builder cashAtBeginningOfPeriod(Nullable<Double> cashAtBeginningOfPeriod) {
            if (cashAtBeginningOfPeriod.isNull()) {
                this.cashAtBeginningOfPeriod = null;
            } else if (cashAtBeginningOfPeriod.isEmpty()) {
                this.cashAtBeginningOfPeriod = Optional.empty();
            } else {
                this.cashAtBeginningOfPeriod = Optional.of(cashAtBeginningOfPeriod.get());
            }
            return this;
        }
        ...
        public Builder cashAtEndOfPeriod(Double cashAtEndOfPeriod) {
            this.cashAtEndOfPeriod = Optional.ofNullable(cashAtEndOfPeriod);
            return this;
        }

        public Builder cashAtEndOfPeriod(Nullable<Double> cashAtEndOfPeriod) {
            if (cashAtEndOfPeriod.isNull()) {
                this.cashAtEndOfPeriod = null;
            } else if (cashAtEndOfPeriod.isEmpty()) {
                this.cashAtEndOfPeriod = Optional.empty();
            } else {
                this.cashAtEndOfPeriod = Optional.of(cashAtEndOfPeriod.get());
            }
            return this;
        }
        ...
        public Builder operatingActivities(List<ReportItem> operatingActivities) {
            this.operatingActivities = Optional.ofNullable(operatingActivities);
            return this;
        }
        ...
        public Builder investingActivities(List<ReportItem> investingActivities) {
            this.investingActivities = Optional.ofNullable(investingActivities);
            return this;
        }
        ...
        public Builder financingActivities(List<ReportItem> financingActivities) {
            this.financingActivities = Optional.ofNullable(financingActivities);
            return this;
        }

        /**
         * <p>The time that cash flow statement was generated by the accounting system.</p>
         */
        ...
        public Builder remoteGeneratedAt(Nullable<OffsetDateTime> remoteGeneratedAt) {
            if (remoteGeneratedAt.isNull()) {
                this.remoteGeneratedAt = null;
            } else if (remoteGeneratedAt.isEmpty()) {
                this.remoteGeneratedAt = Optional.empty();
            } else {
                this.remoteGeneratedAt = Optional.of(remoteGeneratedAt.get());
            }
            return this;
        }
