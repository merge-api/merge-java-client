...
@JsonDeserialize(builder = SalesOrderResponse.Builder.class)
public final class SalesOrderResponse {
    private final SalesOrder model;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SalesOrderResponse && equalTo((SalesOrderResponse) other);
    }
    ...
    private boolean equalTo(SalesOrderResponse other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull SalesOrder model);

        Builder from(SalesOrderResponse other);
    }

    public interface _FinalStage {
        SalesOrderResponse build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(SalesOrderResponse other) {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull SalesOrder model) {
            this.model = model;
            return this;
        }
        ...
        @java.lang.Override
        public SalesOrderResponse build() {
            return new SalesOrderResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
