...
public final class PurchaseOrderResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull PurchaseOrder model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull PurchaseOrder model) {
            this.model = model;
            return this;
        }
        ...
        public PurchaseOrderResponse build() {
            return new PurchaseOrderResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
