...
@JsonDeserialize(builder = ItemResponse.Builder.class)
public final class ItemResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ItemResponse && equalTo((ItemResponse) other);
    }
    ...
    private boolean equalTo(ItemResponse other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Item model);

        Builder from(ItemResponse other);
    }
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ItemResponse other) {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Item model) {
            this.model = model;
            return this;
        }
        ...
        public ItemResponse build() {
            return new ItemResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
