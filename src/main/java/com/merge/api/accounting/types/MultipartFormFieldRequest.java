...
public final class MultipartFormFieldRequest {
    ...
    private Optional<EncodingEnum> _getEncoding() {
        return encoding;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage encoding(Nullable<EncodingEnum> encoding);
    ...
    public static final class Builder implements NameStage, DataStage, _FinalStage {
         ...
         */
        @java.lang.Override
        public _FinalStage encoding(Nullable<EncodingEnum> encoding) {
            if (encoding.isNull()) {
                this.encoding = null;
