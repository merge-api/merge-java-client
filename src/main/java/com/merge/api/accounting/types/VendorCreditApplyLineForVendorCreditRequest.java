...
public final class VendorCreditApplyLineForVendorCreditRequest {
    ...
    private Optional<VendorCreditApplyLineForVendorCreditRequestInvoice> _getInvoice() {
        return invoice;
    }
    ...
    public static final class Builder {
        ...
        public Builder invoice(Nullable<VendorCreditApplyLineForVendorCreditRequestInvoice> invoice) {
            if (invoice.isNull()) {
                this.invoice = null;
