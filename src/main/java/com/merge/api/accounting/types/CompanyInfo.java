...
public final class CompanyInfo {
    ...
    private Optional<Integer> _getFiscalYearEndMonth() {
        return fiscalYearEndMonth;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("fiscal_year_end_day")
    private Optional<Integer> _getFiscalYearEndDay() {
        return fiscalYearEndDay;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("currency")
    private Optional<JsonNode> _getCurrency() {
        return currency;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("urls")
    private Optional<List<Optional<String>>> _getUrls() {
        return urls;
    }
    ...
    public static final class Builder {
        ...
        public Builder fiscalYearEndMonth(Nullable<Integer> fiscalYearEndMonth) {
        ...
        public Builder fiscalYearEndDay(Nullable<Integer> fiscalYearEndDay) {
            if (fiscalYearEndDay.isNull()) {
                this.fiscalYearEndDay = null;
            } else if (fiscalYearEndDay.isEmpty()) {
                this.fiscalYearEndDay = Optional.empty();
            } else {
                this.fiscalYearEndDay = Optional.of(fiscalYearEndDay.get());
            }
            return this;
        }
        ...
        public Builder currency(Nullable<JsonNode> currency) {
            if (currency.isNull()) {
                this.currency = null;
        ...
        public Builder urls(Nullable<List<Optional<String>>> urls) {
            if (urls.isNull()) {
                this.urls = null;
