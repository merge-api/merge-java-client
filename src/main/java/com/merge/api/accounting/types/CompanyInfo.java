...
public final class CompanyInfo {
    private final Optional<String> companyInfoUrl;
    ...
    private final Optional<List<CompanyInfoAddressesItem>> addresses;

    private final Optional<List<CompanyInfoPhoneNumbersItem>> phoneNumbers;
    ...
    private CompanyInfo(
            Optional<String> companyInfoUrl,
            Optional<String> id,
            ...
            Optional<List<CompanyInfoAddressesItem>> addresses,
            Optional<List<CompanyInfoPhoneNumbersItem>> phoneNumbers,
    ...
    /**
     * @return The 3rd party URL of the company info.
     */
    @JsonProperty("company_info_url")
    public Optional<String> getCompanyInfoUrl() {
    ...
    public Optional<List<CompanyInfoAddressesItem>> getAddresses() {
        return addresses;
    }

    @JsonProperty("phone_numbers")
    public Optional<List<CompanyInfoPhoneNumbersItem>> getPhoneNumbers() {
        return phoneNumbers;
    }
    ...
    private boolean equalTo(CompanyInfo other) {
        return companyInfoUrl.equals(other.companyInfoUrl)
                && id.equals(other.id)
    ...
    public static final class Builder {
        private Optional<String> companyInfoUrl = Optional.empty();
        ...
        private Optional<List<CompanyInfoAddressesItem>> addresses = Optional.empty();

        private Optional<List<CompanyInfoPhoneNumbersItem>> phoneNumbers = Optional.empty();
        ...
        public Builder from(CompanyInfo other) {
            companyInfoUrl(other.getCompanyInfoUrl());
            id(other.getId());
        ...
        /**
         * <p>The 3rd party URL of the company info.</p>
         */
        @JsonSetter(value = "company_info_url", nulls = Nulls.SKIP)
        public Builder companyInfoUrl(Optional<String> companyInfoUrl) {
            this.companyInfoUrl = companyInfoUrl;
            return this;
        }

        public Builder companyInfoUrl(String companyInfoUrl) {
            this.companyInfoUrl = Optional.ofNullable(companyInfoUrl);
            return this;
        }
        ...
        /**
         * <p>The currency set in the company's accounting platform.</p>
         * <ul>
         * <li><code>XUA</code> - ADB Unit of Account</li>
         * <li><code>AFN</code> - Afghan Afghani</li>
         * <li><code>AFA</code> - Afghan Afghani (1927–2002)</li>
        ...
        public Builder addresses(Optional<List<CompanyInfoAddressesItem>> addresses) {
            this.addresses = addresses;
            return this;
        }

        public Builder addresses(List<CompanyInfoAddressesItem> addresses) {
            this.addresses = Optional.ofNullable(addresses);
            return this;
        }

        @JsonSetter(value = "phone_numbers", nulls = Nulls.SKIP)
        public Builder phoneNumbers(Optional<List<CompanyInfoPhoneNumbersItem>> phoneNumbers) {
            this.phoneNumbers = phoneNumbers;
            return this;
        }

        public Builder phoneNumbers(List<CompanyInfoPhoneNumbersItem> phoneNumbers) {
