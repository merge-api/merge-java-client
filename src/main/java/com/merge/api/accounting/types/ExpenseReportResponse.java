...
@JsonDeserialize(builder = ExpenseReportResponse.Builder.class)
public final class ExpenseReportResponse {
    private final ExpenseReport model;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExpenseReportResponse && equalTo((ExpenseReportResponse) other);
    }
    ...
    private boolean equalTo(ExpenseReportResponse other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull ExpenseReport model);

        Builder from(ExpenseReportResponse other);
    }

    public interface _FinalStage {
        ExpenseReportResponse build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ExpenseReportResponse other) {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull ExpenseReport model) {
            this.model = model;
            return this;
        }
        ...
        @java.lang.Override
        public ExpenseReportResponse build() {
            return new ExpenseReportResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
