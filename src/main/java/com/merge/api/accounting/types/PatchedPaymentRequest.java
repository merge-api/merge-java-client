...
public final class PatchedPaymentRequest {
    ...
    private Optional<PatchedPaymentRequestContact> _getContact() {
        return contact;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("account")
    private Optional<PatchedPaymentRequestAccount> _getAccount() {
        return account;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("payment_method")
    private Optional<PatchedPaymentRequestPaymentMethod> _getPaymentMethod() {
        return paymentMethod;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("currency")
    private Optional<PatchedPaymentRequestCurrency> _getCurrency() {
        return currency;
    }
    ...
    private Optional<PatchedPaymentRequestCompany> _getCompany() {
        return company;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("type")
    private Optional<PatchedPaymentRequestType> _getType() {
        return type;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("accounting_period")
    private Optional<PatchedPaymentRequestAccountingPeriod> _getAccountingPeriod() {
        return accountingPeriod;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PatchedPaymentRequest && equalTo((PatchedPaymentRequest) other);
    }
    ...
    public static final class Builder {
        ...
        /**
         * <p>The payment's transaction date.</p>
         */
        ...
        public Builder contact(Nullable<PatchedPaymentRequestContact> contact) {
            if (contact.isNull()) {
                this.contact = null;
        ...
        public Builder account(Nullable<PatchedPaymentRequestAccount> account) {
            if (account.isNull()) {
                this.account = null;
        ...
        public Builder paymentMethod(Nullable<PatchedPaymentRequestPaymentMethod> paymentMethod) {
        ...
        public Builder currency(Optional<PatchedPaymentRequestCurrency> currency) {
            this.currency = currency;
            return this;
        }
        ...
        public Builder currency(Nullable<PatchedPaymentRequestCurrency> currency) {
            if (currency.isNull()) {
                this.currency = null;
        ...
        public Builder company(Nullable<PatchedPaymentRequestCompany> company) {
            if (company.isNull()) {
                this.company = null;
        ...
        public Builder type(Nullable<PatchedPaymentRequestType> type) {
            if (type.isNull()) {
                this.type = null;
        ...
        public Builder accountingPeriod(Nullable<PatchedPaymentRequestAccountingPeriod> accountingPeriod) {
