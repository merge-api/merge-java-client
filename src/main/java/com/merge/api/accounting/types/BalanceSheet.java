...
public final class BalanceSheet {
    ...
    private Optional<BalanceSheetCurrency> _getCurrency() {
        return currency;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("company")
    private Optional<BalanceSheetCompany> _getCompany() {
        return company;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("date")
    private Optional<OffsetDateTime> _getDate() {
        return date;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("net_assets")
    private Optional<Double> _getNetAssets() {
        return netAssets;
    }
    ...
    public static final class Builder {
        ...
        /**
         * <p>The balance sheet's currency.</p>
         * <ul>
         * <li><code>XUA</code> - ADB Unit of Account</li>
         * <li><code>AFN</code> - Afghan Afghani</li>
         * <li><code>AFA</code> - Afghan Afghani (1927–2002)</li>
        ...
        public Builder currency(Nullable<BalanceSheetCurrency> currency) {
            if (currency.isNull()) {
                this.currency = null;
        ...
        /**
         * <p><code>Company</code> object for the given <code>BalanceSheet</code> object.</p>
         */
        ...
        public Builder company(Nullable<BalanceSheetCompany> company) {
            if (company.isNull()) {
                this.company = null;
        ...
        /**
         * <p>The balance sheet's date. The balance sheet data will reflect the company's financial position this point in time.</p>
         */
        ...
        /**
         * <p>The balance sheet's net assets.</p>
         */
        ...
        public Builder netAssets(Nullable<Double> netAssets) {
            if (netAssets.isNull()) {
                this.netAssets = null;
            } else if (netAssets.isEmpty()) {
                this.netAssets = Optional.empty();
            } else {
                this.netAssets = Optional.of(netAssets.get());
            }
            return this;
        }
        ...
        /**
         * <p>The time that balance sheet was generated by the accounting system.</p>
         */
