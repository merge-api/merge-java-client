...
public final class InvoicesRetrieveRequest {
    private final Optional<List<InvoicesRetrieveRequestExpandItem>> expand;
    ...
    private final Optional<InvoicesRetrieveRequestRemoteFields> remoteFields;

    private final Optional<InvoicesRetrieveRequestShowEnumOrigins> showEnumOrigins;

    private final Map<String, Object> additionalProperties;

    private InvoicesRetrieveRequest(
            Optional<List<InvoicesRetrieveRequestExpandItem>> expand,
            Optional<Boolean> includeRemoteData,
            Optional<Boolean> includeRemoteFields,
            Optional<Boolean> includeShellData,
            Optional<InvoicesRetrieveRequestRemoteFields> remoteFields,
            Optional<InvoicesRetrieveRequestShowEnumOrigins> showEnumOrigins,
     ...
     */
    @JsonProperty("expand")
    public Optional<List<InvoicesRetrieveRequestExpandItem>> getExpand() {
        return expand;
    }
    ...
    public Optional<InvoicesRetrieveRequestRemoteFields> getRemoteFields() {
        return remoteFields;
    }
    ...
    public Optional<InvoicesRetrieveRequestShowEnumOrigins> getShowEnumOrigins() {
    ...
    public static final class Builder {
        private Optional<List<InvoicesRetrieveRequestExpandItem>> expand = Optional.empty();
        ...
        private Optional<InvoicesRetrieveRequestRemoteFields> remoteFields = Optional.empty();

        private Optional<InvoicesRetrieveRequestShowEnumOrigins> showEnumOrigins = Optional.empty();
        ...
        public Builder expand(Optional<List<InvoicesRetrieveRequestExpandItem>> expand) {
            this.expand = expand;
            return this;
        }

        public Builder expand(List<InvoicesRetrieveRequestExpandItem> expand) {
            this.expand = Optional.ofNullable(expand);
            return this;
        }

        public Builder expand(InvoicesRetrieveRequestExpandItem expand) {
        ...
        public Builder remoteFields(Optional<InvoicesRetrieveRequestRemoteFields> remoteFields) {
            this.remoteFields = remoteFields;
            return this;
        }

        public Builder remoteFields(InvoicesRetrieveRequestRemoteFields remoteFields) {
        ...
        public Builder showEnumOrigins(Optional<InvoicesRetrieveRequestShowEnumOrigins> showEnumOrigins) {
            this.showEnumOrigins = showEnumOrigins;
            return this;
        }

        public Builder showEnumOrigins(InvoicesRetrieveRequestShowEnumOrigins showEnumOrigins) {
