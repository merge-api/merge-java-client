...
public final class VendorCreditResponse {
    private final VendorCredit model;
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull VendorCredit model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull VendorCredit model) {
            this.model = model;
            return this;
        }
        ...
        public VendorCreditResponse build() {
            return new VendorCreditResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
