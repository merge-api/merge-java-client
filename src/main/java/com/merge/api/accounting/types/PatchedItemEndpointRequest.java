...
@JsonDeserialize(builder = PatchedItemEndpointRequest.Builder.class)
public final class PatchedItemEndpointRequest {
    private final Optional<Boolean> isDebugMode;

    private final Optional<Boolean> runAsync;

    private final PatchedItemRequestRequest model;

    private final Map<String, Object> additionalProperties;

    private PatchedItemEndpointRequest(
            Optional<Boolean> isDebugMode,
            Optional<Boolean> runAsync,
            PatchedItemRequestRequest model,
    ...
    @JsonProperty("model")
    public PatchedItemRequestRequest getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PatchedItemEndpointRequest && equalTo((PatchedItemEndpointRequest) other);
    }
    ...
    private boolean equalTo(PatchedItemEndpointRequest other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull PatchedItemRequestRequest model);

        Builder from(PatchedItemEndpointRequest other);
    }

    public interface _FinalStage {
        PatchedItemEndpointRequest build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private PatchedItemRequestRequest model;
        ...
        @java.lang.Override
        public Builder from(PatchedItemEndpointRequest other) {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull PatchedItemRequestRequest model) {
            this.model = model;
            return this;
        }
        ...
        @java.lang.Override
        public PatchedItemEndpointRequest build() {
            return new PatchedItemEndpointRequest(isDebugMode, runAsync, model, additionalProperties);
        }
    }
}
