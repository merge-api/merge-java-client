...
public final class PurchaseOrdersRetrieveRequest {
    private final Optional<List<PurchaseOrdersRetrieveRequestExpandItem>> expand;
    ...
    private final Optional<PurchaseOrdersRetrieveRequestRemoteFields> remoteFields;

    private final Optional<PurchaseOrdersRetrieveRequestShowEnumOrigins> showEnumOrigins;

    private final Map<String, Object> additionalProperties;

    private PurchaseOrdersRetrieveRequest(
            Optional<List<PurchaseOrdersRetrieveRequestExpandItem>> expand,
            Optional<Boolean> includeRemoteData,
            Optional<Boolean> includeRemoteFields,
            Optional<Boolean> includeShellData,
            Optional<PurchaseOrdersRetrieveRequestRemoteFields> remoteFields,
            Optional<PurchaseOrdersRetrieveRequestShowEnumOrigins> showEnumOrigins,
     ...
     */
    @JsonProperty("expand")
    public Optional<List<PurchaseOrdersRetrieveRequestExpandItem>> getExpand() {
        return expand;
    }
    ...
    public Optional<PurchaseOrdersRetrieveRequestRemoteFields> getRemoteFields() {
        return remoteFields;
    }
    ...
    public Optional<PurchaseOrdersRetrieveRequestShowEnumOrigins> getShowEnumOrigins() {
    ...
    public static final class Builder {
        private Optional<List<PurchaseOrdersRetrieveRequestExpandItem>> expand = Optional.empty();
        ...
        private Optional<PurchaseOrdersRetrieveRequestRemoteFields> remoteFields = Optional.empty();

        private Optional<PurchaseOrdersRetrieveRequestShowEnumOrigins> showEnumOrigins = Optional.empty();
        ...
        public Builder expand(Optional<List<PurchaseOrdersRetrieveRequestExpandItem>> expand) {
            this.expand = expand;
            return this;
        }

        public Builder expand(List<PurchaseOrdersRetrieveRequestExpandItem> expand) {
            this.expand = Optional.ofNullable(expand);
            return this;
        }

        public Builder expand(PurchaseOrdersRetrieveRequestExpandItem expand) {
        ...
        public Builder remoteFields(Optional<PurchaseOrdersRetrieveRequestRemoteFields> remoteFields) {
            this.remoteFields = remoteFields;
            return this;
        }

        public Builder remoteFields(PurchaseOrdersRetrieveRequestRemoteFields remoteFields) {
        ...
        public Builder showEnumOrigins(Optional<PurchaseOrdersRetrieveRequestShowEnumOrigins> showEnumOrigins) {
            this.showEnumOrigins = showEnumOrigins;
            return this;
        }

        public Builder showEnumOrigins(PurchaseOrdersRetrieveRequestShowEnumOrigins showEnumOrigins) {
