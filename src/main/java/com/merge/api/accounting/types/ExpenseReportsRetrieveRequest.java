...
@JsonDeserialize(builder = ExpenseReportsRetrieveRequest.Builder.class)
public final class ExpenseReportsRetrieveRequest {
    private final Optional<List<ExpenseReportsRetrieveRequestExpandItem>> expand;
    ...
    private ExpenseReportsRetrieveRequest(
            Optional<List<ExpenseReportsRetrieveRequestExpandItem>> expand,
     ...
     */
    @JsonProperty("expand")
    public Optional<List<ExpenseReportsRetrieveRequestExpandItem>> getExpand() {
        return expand;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExpenseReportsRetrieveRequest && equalTo((ExpenseReportsRetrieveRequest) other);
    }
    ...
    private boolean equalTo(ExpenseReportsRetrieveRequest other) {
    ...
    public static final class Builder {
        private Optional<List<ExpenseReportsRetrieveRequestExpandItem>> expand = Optional.empty();
        ...
        public Builder from(ExpenseReportsRetrieveRequest other) {
        ...
        public Builder expand(Optional<List<ExpenseReportsRetrieveRequestExpandItem>> expand) {
            this.expand = expand;
            return this;
        }

        public Builder expand(List<ExpenseReportsRetrieveRequestExpandItem> expand) {
            this.expand = Optional.ofNullable(expand);
            return this;
        }

        public Builder expand(ExpenseReportsRetrieveRequestExpandItem expand) {
        ...
        public ExpenseReportsRetrieveRequest build() {
            return new ExpenseReportsRetrieveRequest(
