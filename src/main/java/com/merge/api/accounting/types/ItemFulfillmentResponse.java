...
@JsonDeserialize(builder = ItemFulfillmentResponse.Builder.class)
public final class ItemFulfillmentResponse {
    private final ItemFulfillment model;
    ...
    @JsonProperty("model")
    public ItemFulfillment getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ItemFulfillmentResponse && equalTo((ItemFulfillmentResponse) other);
    }
    ...
    private boolean equalTo(ItemFulfillmentResponse other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull ItemFulfillment model);

        Builder from(ItemFulfillmentResponse other);
    }

    public interface _FinalStage {
        ItemFulfillmentResponse build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ItemFulfillmentResponse other) {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull ItemFulfillment model) {
            this.model = model;
            return this;
        }
        ...
        @java.lang.Override
        public ItemFulfillmentResponse build() {
            return new ItemFulfillmentResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
