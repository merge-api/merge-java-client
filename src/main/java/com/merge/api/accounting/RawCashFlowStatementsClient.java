...
public class RawCashFlowStatementsClient {
    protected final ClientOptions clientOptions;

    public RawCashFlowStatementsClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>CashFlowStatement</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<CashFlowStatement>> list(CashFlowStatementsListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                CashFlowStatementsListRequest nextRequest = CashFlowStatementsListRequest.builder()
                        ...
                        .build();
                List<CashFlowStatement> result = parsedResponse.getResults().orElse(Collections.emptyList());
     ...
     */
    public MergeApiHttpResponse<CashFlowStatement> retrieve(String id) {
     ...
     * Returns a <code>CashFlowStatement</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<CashFlowStatement> retrieve(String id, CashFlowStatementsRetrieveRequest request) {
    ...
    public MergeApiHttpResponse<CashFlowStatement> retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), CashFlowStatement.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
