...
public class RawCashFlowStatementsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedCashFlowStatementList> list() {
     ...
     * Returns a list of <code>CashFlowStatement</code> objects.
     */
    public MergeApiHttpResponse<PaginatedCashFlowStatementList> list(CashFlowStatementsListRequest request) {
