...
public class AsyncPurchaseOrdersClient {
     ...
     */
    public CompletableFuture<SyncPagingIterable<PurchaseOrder>> list() {
     ...
     * Returns a list of <code>PurchaseOrder</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<PurchaseOrder>> list(PurchaseOrdersListRequest request) {
