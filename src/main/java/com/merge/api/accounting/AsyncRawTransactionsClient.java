...
public class AsyncRawTransactionsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedTransactionList>> list() {
     ...
     * Returns a list of <code>Transaction</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedTransactionList>> list(TransactionsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedTransactionList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedTransactionList>> future = new CompletableFuture<>();
