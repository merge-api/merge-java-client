...
public class AsyncRawIncomeStatementsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedIncomeStatementList>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedIncomeStatementList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedIncomeStatementList>> future = new CompletableFuture<>();
