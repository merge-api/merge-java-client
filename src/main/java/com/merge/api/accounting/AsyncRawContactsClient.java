...
public class AsyncRawContactsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<ContactResponse>> partialUpdate(
            String id, PatchedContactEndpointRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<MetaResponse>> metaPatchRetrieve(
        ...
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("accounting/v1/contacts/meta/patch")
                .addPathSegment(id)
                .build();
