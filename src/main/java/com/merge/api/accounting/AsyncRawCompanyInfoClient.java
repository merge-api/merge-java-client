...
public class AsyncRawCompanyInfoClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedCompanyInfoList>> list() {
     ...
     * Returns a list of <code>CompanyInfo</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedCompanyInfoList>> list(CompanyInfoListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedCompanyInfoList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedCompanyInfoList>> future = new CompletableFuture<>();
