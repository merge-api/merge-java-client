...
public class AsyncTransactionsClient {
     ...
     */
    public CompletableFuture<SyncPagingIterable<Transaction>> list() {
     ...
     * Returns a list of <code>Transaction</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<Transaction>> list(TransactionsListRequest request) {
