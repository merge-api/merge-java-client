...
public class PurchaseOrdersClient {
     ...
     */
    public SyncPagingIterable<PurchaseOrder> list() {
     ...
     * Returns a list of <code>PurchaseOrder</code> objects.
     */
    public SyncPagingIterable<PurchaseOrder> list(PurchaseOrdersListRequest request) {
     ...
     * Returns a list of <code>PurchaseOrder</code> objects.
     */
    public SyncPagingIterable<PurchaseOrder> list(PurchaseOrdersListRequest request, RequestOptions requestOptions) {
