...
public class AsyncVendorCreditsClient {
     ...
     */
    public CompletableFuture<SyncPagingIterable<VendorCredit>> list() {
     ...
     * Returns a list of <code>VendorCredit</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<VendorCredit>> list(VendorCreditsListRequest request) {
