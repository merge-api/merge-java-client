...
public class AsyncRawBankFeedAccountsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedBankFeedAccountList>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedBankFeedAccountList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedBankFeedAccountList>> future = new CompletableFuture<>();
