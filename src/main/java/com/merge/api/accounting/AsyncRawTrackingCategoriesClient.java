...
public class AsyncRawTrackingCategoriesClient {
    protected final ClientOptions clientOptions;

    public AsyncRawTrackingCategoriesClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<TrackingCategory>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<TrackingCategory>>> future =
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        PaginatedTrackingCategoryList parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBody.string(), PaginatedTrackingCategoryList.class);
                        Optional<String> startingAfter = parsedResponse.getNext();
                        TrackingCategoriesListRequest nextRequest = TrackingCategoriesListRequest.builder()
                                .from(request)
                                .cursor(startingAfter)
                                .build();
                        List<TrackingCategory> result =
                                parsedResponse.getResults().orElse(Collections.emptyList());
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<TrackingCategory>(startingAfter.isPresent(), result, () -> {
                                    try {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<TrackingCategory>> retrieve(String id) {
    ...
    public CompletableFuture<MergeApiHttpResponse<TrackingCategory>> retrieve(
            String id, TrackingCategoriesRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<TrackingCategory>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<TrackingCategory>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TrackingCategory.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
