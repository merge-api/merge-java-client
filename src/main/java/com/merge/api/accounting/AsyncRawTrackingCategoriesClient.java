...
public class AsyncRawTrackingCategoriesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedTrackingCategoryList>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedTrackingCategoryList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedTrackingCategoryList>> future = new CompletableFuture<>();
