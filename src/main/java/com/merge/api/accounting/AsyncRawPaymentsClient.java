...
public class AsyncRawPaymentsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedPaymentList>> list() {
     ...
     * Returns a list of <code>Payment</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedPaymentList>> list(PaymentsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedPaymentList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedPaymentList>> future = new CompletableFuture<>();
