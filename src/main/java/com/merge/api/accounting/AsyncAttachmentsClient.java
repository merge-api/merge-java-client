...
public class AsyncAttachmentsClient {
     ...
     */
    public CompletableFuture<SyncPagingIterable<AccountingAttachment>> list() {
     ...
     * Returns a list of <code>AccountingAttachment</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<AccountingAttachment>> list(AttachmentsListRequest request) {
