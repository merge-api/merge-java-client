...
import com.merge.api.accounting.types.PaginatedCreditNoteList;
...
public class AsyncRawCreditNotesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<CreditNote>>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<CreditNote>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<CreditNote>>> future = new CompletableFuture<>();
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        PaginatedCreditNoteList parsedResponse =
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaginatedCreditNoteList.class);
                        Optional<String> startingAfter = parsedResponse.getNext();
                        CreditNotesListRequest nextRequest = CreditNotesListRequest.builder()
                                .from(request)
                                .cursor(startingAfter)
                                .build();
                        List<CreditNote> result = parsedResponse.getResults().orElse(Collections.emptyList());
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<CreditNote>(
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<CreditNoteResponse>> create(CreditNoteEndpointRequest request) {
     ...
     * Creates a <code>CreditNote</code> object with the given values.
     */
    public CompletableFuture<MergeApiHttpResponse<CreditNoteResponse>> create(
        ...
        CompletableFuture<MergeApiHttpResponse<CreditNoteResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreditNoteResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<CreditNote>> retrieve(String id) {
     ...
     * Returns a <code>CreditNote</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<CreditNote>> retrieve(String id, CreditNotesRetrieveRequest request) {
     ...
     * Returns a <code>CreditNote</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<CreditNote>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<CreditNote>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<CreditNoteResponse>> partialUpdate(
            String id, PatchedCreditNoteEndpointRequest request) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<CreditNoteResponse>> applicationCreate(
            String id, ApplyCreditNoteRequest request) {
        return applicationCreate(id, request, null);
    }
    ...
    public CompletableFuture<MergeApiHttpResponse<MetaResponse>> metaPatchRetrieve(
        ...
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("accounting/v1/credit-notes/meta/patch")
                .addPathSegment(id)
                .build();
