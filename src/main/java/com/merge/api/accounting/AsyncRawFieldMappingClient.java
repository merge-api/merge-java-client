...
import com.merge.api.accounting.types.CreateFieldMappingRequest;
import com.merge.api.accounting.types.ExternalTargetFieldApiResponse;
import com.merge.api.accounting.types.FieldMappingApiInstanceResponse;
import com.merge.api.accounting.types.FieldMappingInstanceResponse;
import com.merge.api.accounting.types.FieldMappingsDestroyRequest;
import com.merge.api.accounting.types.FieldMappingsRetrieveRequest;
import com.merge.api.accounting.types.PatchedEditFieldMappingRequest;
import com.merge.api.accounting.types.RemoteFieldApiResponse;
import com.merge.api.accounting.types.RemoteFieldsRetrieveRequest;
...
public class AsyncRawFieldMappingClient {
    ...
    public CompletableFuture<MergeApiHttpResponse<FieldMappingApiInstanceResponse>> fieldMappingsRetrieve(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("accounting/v1/field-mappings");
    ...
    public CompletableFuture<MergeApiHttpResponse<FieldMappingInstanceResponse>> fieldMappingsDestroy(
        ...
        return fieldMappingsDestroy(
                fieldMappingId, FieldMappingsDestroyRequest.builder().build());
    }
    ...
    public CompletableFuture<MergeApiHttpResponse<FieldMappingInstanceResponse>> fieldMappingsDestroy(
        ...
        return fieldMappingsDestroy(fieldMappingId, request, null);
    }
    ...
    public CompletableFuture<MergeApiHttpResponse<RemoteFieldApiResponse>> remoteFieldsRetrieve(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("accounting/v1/remote-fields");
    ...
    public CompletableFuture<MergeApiHttpResponse<ExternalTargetFieldApiResponse>> targetFieldsRetrieve(
        ...
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("accounting/v1/target-fields")
                .build();
        Request okhttpRequest = new Request.Builder()
                .url(httpUrl)
                .method("GET", null)
