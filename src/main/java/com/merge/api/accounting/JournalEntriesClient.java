...
public class JournalEntriesClient {
     ...
     */
    public SyncPagingIterable<JournalEntry> list() {
     ...
     * Returns a list of <code>JournalEntry</code> objects.
     */
    public SyncPagingIterable<JournalEntry> list(JournalEntriesListRequest request) {
     ...
     * Returns a list of <code>JournalEntry</code> objects.
     */
    public SyncPagingIterable<JournalEntry> list(JournalEntriesListRequest request, RequestOptions requestOptions) {
