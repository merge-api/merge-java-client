...
public class AsyncRawPhoneNumbersClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<AccountingPhoneNumber>> retrieve(String id) {
    ...
    public CompletableFuture<MergeApiHttpResponse<AccountingPhoneNumber>> retrieve(
            String id, PhoneNumbersRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<AccountingPhoneNumber>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<AccountingPhoneNumber>> future = new CompletableFuture<>();
