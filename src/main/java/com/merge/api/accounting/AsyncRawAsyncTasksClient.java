...
public class AsyncRawAsyncTasksClient {
    protected final ClientOptions clientOptions;

    public AsyncRawAsyncTasksClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<AsyncPostTask>> retrieve(String id) {
     ...
     * Returns an <code>AsyncPostTask</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<AsyncPostTask>> retrieve(
            String id, AsyncTasksRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<AsyncPostTask>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<AsyncPostTask>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AsyncPostTask.class),
                                response));
                        return;
                    }
