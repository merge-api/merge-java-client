...
public class RawPurchaseOrdersClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedPurchaseOrderList> list() {
     ...
     * Returns a list of <code>PurchaseOrder</code> objects.
     */
    public MergeApiHttpResponse<PaginatedPurchaseOrderList> list(PurchaseOrdersListRequest request) {
