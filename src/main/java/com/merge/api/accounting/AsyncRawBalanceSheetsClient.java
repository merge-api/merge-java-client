...
public class AsyncRawBalanceSheetsClient {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<BalanceSheet>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<BalanceSheet>>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        PaginatedBalanceSheetList parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                        ...
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<BalanceSheet>(startingAfter.isPresent(), result, () -> {
                                    try {
