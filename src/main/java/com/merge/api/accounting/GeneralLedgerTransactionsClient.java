...
public class GeneralLedgerTransactionsClient {
     ...
     */
    public SyncPagingIterable<GeneralLedgerTransaction> list() {
     ...
     * Returns a list of <code>GeneralLedgerTransaction</code> objects.
     */
    public SyncPagingIterable<GeneralLedgerTransaction> list(GeneralLedgerTransactionsListRequest request) {
