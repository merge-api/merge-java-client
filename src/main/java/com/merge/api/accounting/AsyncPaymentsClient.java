...
public class AsyncPaymentsClient {
     ...
     * Returns a list of <code>Payment</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<Payment>> list(PaymentsListRequest request) {
     ...
     * Returns metadata for <code>Payment</code> PATCHs.
     */
    public CompletableFuture<MetaResponse> metaPatchRetrieve(String id, PaymentsMetaPatchRetrieveRequest request) {
