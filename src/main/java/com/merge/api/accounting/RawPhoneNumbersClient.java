...
public class RawPhoneNumbersClient {
     ...
     */
    public MergeApiHttpResponse<AccountingPhoneNumber> retrieve(String id) {
     ...
     * Returns an <code>AccountingPhoneNumber</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<AccountingPhoneNumber> retrieve(String id, PhoneNumbersRetrieveRequest request) {
     ...
     * Returns an <code>AccountingPhoneNumber</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<AccountingPhoneNumber> retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), AccountingPhoneNumber.class),
                        response);
            }
