...
public class AsyncRawAttachmentsClient {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<AccountingAttachment>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<AccountingAttachment>>> future =
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        PaginatedAccountingAttachmentList parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, PaginatedAccountingAttachmentList.class);
                        ...
                        AttachmentsListRequest nextRequest = AttachmentsListRequest.builder()
                                ...
                                .build();
                        List<AccountingAttachment> result =
    ...
    public CompletableFuture<MergeApiHttpResponse<AccountingAttachmentResponse>> create(
        ...
        CompletableFuture<MergeApiHttpResponse<AccountingAttachmentResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, AccountingAttachmentResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<AccountingAttachment>> retrieve(String id) {
    ...
    public CompletableFuture<MergeApiHttpResponse<AccountingAttachment>> retrieve(
            String id, AttachmentsRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<AccountingAttachment>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<AccountingAttachment>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AccountingAttachment.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
