...
public class RawPaymentsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedPaymentList> list() {
     ...
     * Returns a list of <code>Payment</code> objects.
     */
    public MergeApiHttpResponse<PaginatedPaymentList> list(PaymentsListRequest request) {
     ...
     * Returns a list of <code>Payment</code> objects.
     */
    public MergeApiHttpResponse<PaginatedPaymentList> list(PaymentsListRequest request, RequestOptions requestOptions) {
