...
public class RawItemsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedItemList> list() {
     ...
     * Returns a list of <code>Item</code> objects.
     */
    public MergeApiHttpResponse<PaginatedItemList> list(ItemsListRequest request) {
     ...
     * Returns a list of <code>Item</code> objects.
     */
    public MergeApiHttpResponse<PaginatedItemList> list(ItemsListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedItemList.class), response);
            }
