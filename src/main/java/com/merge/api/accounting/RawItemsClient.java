...
public class RawItemsClient {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Item>(!startingAfter.isEmpty(), result, parsedResponse, () -> list(
    ...
    public MergeApiHttpResponse<MetaResponse> metaPatchRetrieve(String id) {
        return metaPatchRetrieve(id, ItemsMetaPatchRetrieveRequest.builder().build());
    }

    /**
     * Returns metadata for <code>Item</code> PATCHs.
     */
    public MergeApiHttpResponse<MetaResponse> metaPatchRetrieve(String id, ItemsMetaPatchRetrieveRequest request) {
