...
public class RawIncomeStatementsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedIncomeStatementList> list() {
     ...
     * Returns a list of <code>IncomeStatement</code> objects.
     */
    public MergeApiHttpResponse<PaginatedIncomeStatementList> list(IncomeStatementsListRequest request) {
