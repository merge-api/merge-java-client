...
public class RawIncomeStatementsClient {
    protected final ClientOptions clientOptions;

    public RawIncomeStatementsClient(ClientOptions clientOptions) {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<IncomeStatement>> list() {
     ...
     * Returns a list of <code>IncomeStatement</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<IncomeStatement>> list(IncomeStatementsListRequest request) {
    ...
    public MergeApiHttpResponse<SyncPagingIterable<IncomeStatement>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedIncomeStatementList parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedIncomeStatementList.class);
                Optional<String> startingAfter = parsedResponse.getNext();
                IncomeStatementsListRequest nextRequest = IncomeStatementsListRequest.builder()
                        .from(request)
                        .cursor(startingAfter)
                        .build();
                List<IncomeStatement> result = parsedResponse.getResults().orElse(Collections.emptyList());
     ...
     */
    public MergeApiHttpResponse<IncomeStatement> retrieve(String id) {
     ...
     * Returns an <code>IncomeStatement</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<IncomeStatement> retrieve(String id, IncomeStatementsRetrieveRequest request) {
     ...
     * Returns an <code>IncomeStatement</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<IncomeStatement> retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), IncomeStatement.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
