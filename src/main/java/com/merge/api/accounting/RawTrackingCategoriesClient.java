...
public class RawTrackingCategoriesClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedTrackingCategoryList> list() {
     ...
     * Returns a list of <code>TrackingCategory</code> objects.
     */
    public MergeApiHttpResponse<PaginatedTrackingCategoryList> list(TrackingCategoriesListRequest request) {
