...
public class RawTrackingCategoriesClient {
    protected final ClientOptions clientOptions;

    public RawTrackingCategoriesClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>TrackingCategory</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<TrackingCategory>> list(TrackingCategoriesListRequest request) {
    ...
    public MergeApiHttpResponse<SyncPagingIterable<TrackingCategory>> list(
        ...
        if (request.getCategoryType().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "category_type", request.getCategoryType().get(), false);
        }
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedTrackingCategoryList parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedTrackingCategoryList.class);
                Optional<String> startingAfter = parsedResponse.getNext();
                TrackingCategoriesListRequest nextRequest = TrackingCategoriesListRequest.builder()
                        .from(request)
                        .cursor(startingAfter)
                        .build();
                List<TrackingCategory> result = parsedResponse.getResults().orElse(Collections.emptyList());
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<TrackingCategory>(
     ...
     */
    public MergeApiHttpResponse<TrackingCategory> retrieve(String id) {
     ...
     * Returns a <code>TrackingCategory</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<TrackingCategory> retrieve(String id, TrackingCategoriesRetrieveRequest request) {
    ...
    public MergeApiHttpResponse<TrackingCategory> retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TrackingCategory.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
