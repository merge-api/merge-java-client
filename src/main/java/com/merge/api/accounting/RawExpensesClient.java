...
public class RawExpensesClient {
    protected final ClientOptions clientOptions;

    public RawExpensesClient(ClientOptions clientOptions) {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<Expense>> list() {
     ...
     * Returns a list of <code>Expense</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Expense>> list(ExpensesListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Expense>(startingAfter.isPresent(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<ExpenseResponse> create(ExpenseEndpointRequest request) {
     ...
     * Creates an <code>Expense</code> object with the given values.
     */
    public MergeApiHttpResponse<ExpenseResponse> create(ExpenseEndpointRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("accounting/v1/expenses");
     ...
     */
    public MergeApiHttpResponse<Expense> retrieve(String id) {
     ...
     * Returns an <code>Expense</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Expense> retrieve(String id, ExpensesRetrieveRequest request) {
     ...
     * Returns an <code>Expense</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Expense> retrieve(
     ...
     */
    public MergeApiHttpResponse<AsyncBulkCreateResponse> bulkCreate(ExpenseBulkRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedRemoteFieldClassList parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaginatedRemoteFieldClassList.class);
                Optional<String> startingAfter = parsedResponse.getNext();
                ExpensesRemoteFieldClassesListRequest nextRequest = ExpensesRemoteFieldClassesListRequest.builder()
                        .from(request)
                        .cursor(startingAfter)
                        .build();
                List<RemoteFieldClass> result = parsedResponse.getResults().orElse(Collections.emptyList());
