...
public class RawTimeOffClient {
     ...
     * Returns a list of <code>TimeOff</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<TimeOff>> list(TimeOffListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<TimeOff>(startingAfter.isPresent(), result, parsedResponse, () -> list(
