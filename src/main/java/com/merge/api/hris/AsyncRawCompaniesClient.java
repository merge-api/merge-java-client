...
public class AsyncRawCompaniesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedCompanyList>> list() {
     ...
     * Returns a list of <code>Company</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedCompanyList>> list(CompaniesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedCompanyList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedCompanyList>> future = new CompletableFuture<>();
