...
public class AsyncRawTimeOffBalancesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedTimeOffBalanceList>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedTimeOffBalanceList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedTimeOffBalanceList>> future = new CompletableFuture<>();
