...
public class RawTimesheetEntriesClient {
    protected final ClientOptions clientOptions;

    public RawTimesheetEntriesClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>TimesheetEntry</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<TimesheetEntry>> list(TimesheetEntriesListRequest request) {
    ...
    public MergeApiHttpResponse<SyncPagingIterable<TimesheetEntry>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedTimesheetEntryList parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedTimesheetEntryList.class);
                Optional<String> startingAfter = parsedResponse.getNext();
                TimesheetEntriesListRequest nextRequest = TimesheetEntriesListRequest.builder()
                        .from(request)
                        .cursor(startingAfter)
                        .build();
                List<TimesheetEntry> result = parsedResponse.getResults().orElse(Collections.emptyList());
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<TimesheetEntry>(
     ...
     */
    public MergeApiHttpResponse<TimesheetEntryResponse> create(TimesheetEntryEndpointRequest request) {
    ...
    public MergeApiHttpResponse<TimesheetEntryResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TimesheetEntryResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
     ...
     */
    public MergeApiHttpResponse<TimesheetEntry> retrieve(String id) {
     ...
     * Returns a <code>TimesheetEntry</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<TimesheetEntry> retrieve(String id, TimesheetEntriesRetrieveRequest request) {
    ...
    public MergeApiHttpResponse<TimesheetEntry> retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TimesheetEntry.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
