...
public class RawTimeOffBalancesClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedTimeOffBalanceList> list() {
     ...
     * Returns a list of <code>TimeOffBalance</code> objects.
     */
    public MergeApiHttpResponse<PaginatedTimeOffBalanceList> list(TimeOffBalancesListRequest request) {
