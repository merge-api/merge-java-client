...
public class DependentsClient {
     ...
     */
    public SyncPagingIterable<Dependent> list() {
     ...
     * Returns a list of <code>Dependent</code> objects.
     */
    public SyncPagingIterable<Dependent> list(DependentsListRequest request) {
     ...
     * Returns a list of <code>Dependent</code> objects.
     */
    public SyncPagingIterable<Dependent> list(DependentsListRequest request, RequestOptions requestOptions) {
