...
public class AsyncRawTeamsClient {
     ...
     * Returns a list of <code>Team</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Team>>> list(TeamsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Team>>> list(
        ...
        if (request.getParentTeamId().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "parent_team_id", request.getParentTeamId().get(), false);
        }
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Team>>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<Team>(!startingAfter.isEmpty(), result, parsedResponse, () -> {
                                    try {
