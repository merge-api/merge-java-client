...
public class RawLocationsClient {
     ...
     * Returns a list of <code>Location</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Location>> list(LocationsListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Location>(startingAfter.isPresent(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<Location> retrieve(String id) {
     ...
     * Returns a <code>Location</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Location> retrieve(String id, LocationsRetrieveRequest request) {
