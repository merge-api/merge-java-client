...
public class TimesheetEntriesClient {
     ...
     */
    public SyncPagingIterable<TimesheetEntry> list() {
     ...
     * Returns a list of <code>TimesheetEntry</code> objects.
     */
    public SyncPagingIterable<TimesheetEntry> list(TimesheetEntriesListRequest request) {
     ...
     * Returns a list of <code>TimesheetEntry</code> objects.
     */
    public SyncPagingIterable<TimesheetEntry> list(TimesheetEntriesListRequest request, RequestOptions requestOptions) {
