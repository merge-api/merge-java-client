...
public class AsyncRawPayGroupsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawPayGroupsClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>PayGroup</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<PayGroup>>> list(PayGroupsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<PayGroup>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<PayGroup>>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        PaginatedPayGroupList parsedResponse =
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedPayGroupList.class);
                        Optional<String> startingAfter = parsedResponse.getNext();
                        PayGroupsListRequest nextRequest = PayGroupsListRequest.builder()
                                .from(request)
                                .cursor(startingAfter)
                                .build();
                        List<PayGroup> result = parsedResponse.getResults().orElse(Collections.emptyList());
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<PayGroup>(startingAfter.isPresent(), result, () -> {
                                    try {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PayGroup>> retrieve(String id) {
     ...
     * Returns a <code>PayGroup</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<PayGroup>> retrieve(String id, PayGroupsRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PayGroup>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<PayGroup>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PayGroup.class), response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    future.completeExceptionally(new ApiError(
