...
public class AsyncRawPayGroupsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedPayGroupList>> list() {
     ...
     * Returns a list of <code>PayGroup</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedPayGroupList>> list(PayGroupsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedPayGroupList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedPayGroupList>> future = new CompletableFuture<>();
