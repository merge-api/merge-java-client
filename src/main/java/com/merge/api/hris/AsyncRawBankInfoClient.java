...
public class AsyncRawBankInfoClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedBankInfoList>> list() {
     ...
     * Returns a list of <code>BankInfo</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedBankInfoList>> list(BankInfoListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedBankInfoList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedBankInfoList>> future = new CompletableFuture<>();
