...
public class AsyncRawBenefitsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedBenefitList>> list() {
     ...
     * Returns a list of <code>Benefit</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedBenefitList>> list(BenefitsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedBenefitList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedBenefitList>> future = new CompletableFuture<>();
