...
public class AsyncRawBenefitsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawBenefitsClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>Benefit</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Benefit>>> list(BenefitsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Benefit>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Benefit>>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        PaginatedBenefitList parsedResponse =
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedBenefitList.class);
                        ...
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<Benefit>(startingAfter.isPresent(), result, () -> {
                                    try {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<Benefit>> retrieve(String id) {
     ...
     * Returns a <code>Benefit</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<Benefit>> retrieve(String id, BenefitsRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<Benefit>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<Benefit>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Benefit.class), response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    future.completeExceptionally(new ApiError(
