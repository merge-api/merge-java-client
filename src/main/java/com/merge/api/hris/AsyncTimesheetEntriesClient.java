...
public class AsyncTimesheetEntriesClient {
     ...
     */
    public CompletableFuture<SyncPagingIterable<TimesheetEntry>> list() {
     ...
     * Returns a list of <code>TimesheetEntry</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<TimesheetEntry>> list(TimesheetEntriesListRequest request) {
