...
public final class PayGroup {
    ...
    private Optional<String> _getPayGroupName() {
        return payGroupName;
    }
    ...
    public static final class Builder {
        ...
        public Builder payGroupName(String payGroupName) {
            this.payGroupName = Optional.ofNullable(payGroupName);
            return this;
        }

        public Builder payGroupName(Nullable<String> payGroupName) {
            if (payGroupName.isNull()) {
                this.payGroupName = null;
            } else if (payGroupName.isEmpty()) {
                this.payGroupName = Optional.empty();
            } else {
                this.payGroupName = Optional.of(payGroupName.get());
            }
            return this;
        }
