...
public final class EmploymentsListRequestRemoteFields {
    public static final EmploymentsListRequestRemoteFields PAY_PERIOD =
            new EmploymentsListRequestRemoteFields(Value.PAY_PERIOD, "pay_period");

    public static final EmploymentsListRequestRemoteFields FLSA_STATUS =
            new EmploymentsListRequestRemoteFields(Value.FLSA_STATUS, "flsa_status");

    public static final EmploymentsListRequestRemoteFields EMPLOYMENT_TYPE_PAY_FREQUENCY =
            new EmploymentsListRequestRemoteFields(
                    Value.EMPLOYMENT_TYPE_PAY_FREQUENCY, "employment_type,pay_frequency");

    public static final EmploymentsListRequestRemoteFields EMPLOYMENT_TYPE_FLSA_STATUS =
            new EmploymentsListRequestRemoteFields(Value.EMPLOYMENT_TYPE_FLSA_STATUS, "employment_type,flsa_status");

    public static final EmploymentsListRequestRemoteFields PAY_FREQUENCY =
            new EmploymentsListRequestRemoteFields(Value.PAY_FREQUENCY, "pay_frequency");

    public static final EmploymentsListRequestRemoteFields FLSA_STATUS_PAY_FREQUENCY_PAY_PERIOD =
            new EmploymentsListRequestRemoteFields(
                    Value.FLSA_STATUS_PAY_FREQUENCY_PAY_PERIOD, "flsa_status,pay_frequency,pay_period");

    public static final EmploymentsListRequestRemoteFields EMPLOYMENT_TYPE_FLSA_STATUS_PAY_FREQUENCY_PAY_PERIOD =
            new EmploymentsListRequestRemoteFields(
                    Value.EMPLOYMENT_TYPE_FLSA_STATUS_PAY_FREQUENCY_PAY_PERIOD,
                    "employment_type,flsa_status,pay_frequency,pay_period");

    public static final EmploymentsListRequestRemoteFields EMPLOYMENT_TYPE_FLSA_STATUS_PAY_PERIOD =
            new EmploymentsListRequestRemoteFields(
                    Value.EMPLOYMENT_TYPE_FLSA_STATUS_PAY_PERIOD, "employment_type,flsa_status,pay_period");

    public static final EmploymentsListRequestRemoteFields EMPLOYMENT_TYPE_PAY_PERIOD =
            new EmploymentsListRequestRemoteFields(Value.EMPLOYMENT_TYPE_PAY_PERIOD, "employment_type,pay_period");

    public static final EmploymentsListRequestRemoteFields EMPLOYMENT_TYPE =
            new EmploymentsListRequestRemoteFields(Value.EMPLOYMENT_TYPE, "employment_type");

    public static final EmploymentsListRequestRemoteFields EMPLOYMENT_TYPE_FLSA_STATUS_PAY_FREQUENCY =
            new EmploymentsListRequestRemoteFields(
                    Value.EMPLOYMENT_TYPE_FLSA_STATUS_PAY_FREQUENCY, "employment_type,flsa_status,pay_frequency");

    public static final EmploymentsListRequestRemoteFields PAY_FREQUENCY_PAY_PERIOD =
            new EmploymentsListRequestRemoteFields(Value.PAY_FREQUENCY_PAY_PERIOD, "pay_frequency,pay_period");

    public static final EmploymentsListRequestRemoteFields FLSA_STATUS_PAY_FREQUENCY =
            new EmploymentsListRequestRemoteFields(Value.FLSA_STATUS_PAY_FREQUENCY, "flsa_status,pay_frequency");

    public static final EmploymentsListRequestRemoteFields EMPLOYMENT_TYPE_PAY_FREQUENCY_PAY_PERIOD =
            new EmploymentsListRequestRemoteFields(
                    Value.EMPLOYMENT_TYPE_PAY_FREQUENCY_PAY_PERIOD, "employment_type,pay_frequency,pay_period");

    public static final EmploymentsListRequestRemoteFields FLSA_STATUS_PAY_PERIOD =
            new EmploymentsListRequestRemoteFields(Value.FLSA_STATUS_PAY_PERIOD, "flsa_status,pay_period");

    private final Value value;

    private final String string;

    EmploymentsListRequestRemoteFields(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EmploymentsListRequestRemoteFields
                        && this.string.equals(((EmploymentsListRequestRemoteFields) other).string));
    }
    ...
    public static EmploymentsListRequestRemoteFields valueOf(String value) {
        switch (value) {
            case "pay_period":
                return PAY_PERIOD;
            case "flsa_status":
            ...
            default:
                return new EmploymentsListRequestRemoteFields(Value.UNKNOWN, value);
        }
    }
