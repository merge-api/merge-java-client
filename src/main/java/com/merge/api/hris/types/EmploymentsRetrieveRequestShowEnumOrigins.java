...
public final class EmploymentsRetrieveRequestShowEnumOrigins {
    public static final EmploymentsRetrieveRequestShowEnumOrigins PAY_PERIOD =
            new EmploymentsRetrieveRequestShowEnumOrigins(Value.PAY_PERIOD, "pay_period");

    public static final EmploymentsRetrieveRequestShowEnumOrigins FLSA_STATUS =
            new EmploymentsRetrieveRequestShowEnumOrigins(Value.FLSA_STATUS, "flsa_status");

    public static final EmploymentsRetrieveRequestShowEnumOrigins EMPLOYMENT_TYPE_PAY_FREQUENCY =
            new EmploymentsRetrieveRequestShowEnumOrigins(
                    Value.EMPLOYMENT_TYPE_PAY_FREQUENCY, "employment_type,pay_frequency");

    public static final EmploymentsRetrieveRequestShowEnumOrigins EMPLOYMENT_TYPE_FLSA_STATUS =
            new EmploymentsRetrieveRequestShowEnumOrigins(
                    Value.EMPLOYMENT_TYPE_FLSA_STATUS, "employment_type,flsa_status");

    public static final EmploymentsRetrieveRequestShowEnumOrigins PAY_FREQUENCY =
            new EmploymentsRetrieveRequestShowEnumOrigins(Value.PAY_FREQUENCY, "pay_frequency");

    public static final EmploymentsRetrieveRequestShowEnumOrigins FLSA_STATUS_PAY_FREQUENCY_PAY_PERIOD =
            new EmploymentsRetrieveRequestShowEnumOrigins(
                    Value.FLSA_STATUS_PAY_FREQUENCY_PAY_PERIOD, "flsa_status,pay_frequency,pay_period");

    public static final EmploymentsRetrieveRequestShowEnumOrigins EMPLOYMENT_TYPE_FLSA_STATUS_PAY_FREQUENCY_PAY_PERIOD =
            new EmploymentsRetrieveRequestShowEnumOrigins(
                    Value.EMPLOYMENT_TYPE_FLSA_STATUS_PAY_FREQUENCY_PAY_PERIOD,
                    "employment_type,flsa_status,pay_frequency,pay_period");

    public static final EmploymentsRetrieveRequestShowEnumOrigins EMPLOYMENT_TYPE_FLSA_STATUS_PAY_PERIOD =
            new EmploymentsRetrieveRequestShowEnumOrigins(
                    Value.EMPLOYMENT_TYPE_FLSA_STATUS_PAY_PERIOD, "employment_type,flsa_status,pay_period");

    public static final EmploymentsRetrieveRequestShowEnumOrigins EMPLOYMENT_TYPE_PAY_PERIOD =
            new EmploymentsRetrieveRequestShowEnumOrigins(
                    Value.EMPLOYMENT_TYPE_PAY_PERIOD, "employment_type,pay_period");

    public static final EmploymentsRetrieveRequestShowEnumOrigins EMPLOYMENT_TYPE =
            new EmploymentsRetrieveRequestShowEnumOrigins(Value.EMPLOYMENT_TYPE, "employment_type");

    public static final EmploymentsRetrieveRequestShowEnumOrigins EMPLOYMENT_TYPE_FLSA_STATUS_PAY_FREQUENCY =
            new EmploymentsRetrieveRequestShowEnumOrigins(
                    Value.EMPLOYMENT_TYPE_FLSA_STATUS_PAY_FREQUENCY, "employment_type,flsa_status,pay_frequency");

    public static final EmploymentsRetrieveRequestShowEnumOrigins PAY_FREQUENCY_PAY_PERIOD =
            new EmploymentsRetrieveRequestShowEnumOrigins(Value.PAY_FREQUENCY_PAY_PERIOD, "pay_frequency,pay_period");

    public static final EmploymentsRetrieveRequestShowEnumOrigins FLSA_STATUS_PAY_FREQUENCY =
            new EmploymentsRetrieveRequestShowEnumOrigins(Value.FLSA_STATUS_PAY_FREQUENCY, "flsa_status,pay_frequency");

    public static final EmploymentsRetrieveRequestShowEnumOrigins EMPLOYMENT_TYPE_PAY_FREQUENCY_PAY_PERIOD =
            new EmploymentsRetrieveRequestShowEnumOrigins(
                    Value.EMPLOYMENT_TYPE_PAY_FREQUENCY_PAY_PERIOD, "employment_type,pay_frequency,pay_period");

    public static final EmploymentsRetrieveRequestShowEnumOrigins FLSA_STATUS_PAY_PERIOD =
            new EmploymentsRetrieveRequestShowEnumOrigins(Value.FLSA_STATUS_PAY_PERIOD, "flsa_status,pay_period");

    private final Value value;

    private final String string;

    EmploymentsRetrieveRequestShowEnumOrigins(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EmploymentsRetrieveRequestShowEnumOrigins
                        && this.string.equals(((EmploymentsRetrieveRequestShowEnumOrigins) other).string));
    }
    ...
    public static EmploymentsRetrieveRequestShowEnumOrigins valueOf(String value) {
        switch (value) {
            case "pay_period":
                return PAY_PERIOD;
            case "flsa_status":
            ...
            default:
                return new EmploymentsRetrieveRequestShowEnumOrigins(Value.UNKNOWN, value);
        }
    }
