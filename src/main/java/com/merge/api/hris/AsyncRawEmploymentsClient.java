...
public class AsyncRawEmploymentsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawEmploymentsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Employment>>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Employment>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Employment>>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        PaginatedEmploymentList parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBody.string(), PaginatedEmploymentList.class);
                        ...
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<Employment>(startingAfter.isPresent(), result, () -> {
                                    try {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<Employment>> retrieve(String id) {
     ...
     * Returns an <code>Employment</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<Employment>> retrieve(String id, EmploymentsRetrieveRequest request) {
     ...
     * Returns an <code>Employment</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<Employment>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<Employment>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Employment.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
