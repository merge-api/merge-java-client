...
public class AsyncRawEmploymentsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedEmploymentList>> list() {
     ...
     * Returns a list of <code>Employment</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedEmploymentList>> list(EmploymentsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedEmploymentList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedEmploymentList>> future = new CompletableFuture<>();
