...
public class AsyncRawEmployeePayrollRunsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedEmployeePayrollRunList>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedEmployeePayrollRunList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedEmployeePayrollRunList>> future = new CompletableFuture<>();
