...
public class RawPayrollRunsClient {
    protected final ClientOptions clientOptions;

    public RawPayrollRunsClient(ClientOptions clientOptions) {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<PayrollRun>> list() {
     ...
     * Returns a list of <code>PayrollRun</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<PayrollRun>> list(PayrollRunsListRequest request) {
    ...
    public MergeApiHttpResponse<SyncPagingIterable<PayrollRun>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedPayrollRunList parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedPayrollRunList.class);
     ...
     */
    public MergeApiHttpResponse<PayrollRun> retrieve(String id) {
     ...
     * Returns a <code>PayrollRun</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<PayrollRun> retrieve(String id, PayrollRunsRetrieveRequest request) {
     ...
     * Returns a <code>PayrollRun</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<PayrollRun> retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PayrollRun.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
