        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedPayrollRunList parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaginatedPayrollRunList.class);
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<PayrollRun>(!startingAfter.isEmpty(), result, parsedResponse, () -> list(
