...
public class AsyncRawPayrollRunsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedPayrollRunList>> list() {
     ...
     * Returns a list of <code>PayrollRun</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedPayrollRunList>> list(PayrollRunsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedPayrollRunList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedPayrollRunList>> future = new CompletableFuture<>();
