...
public class RawEmployerBenefitsClient {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<EmployerBenefit>> list() {
     ...
     * Returns a list of <code>EmployerBenefit</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<EmployerBenefit>> list(EmployerBenefitsListRequest request) {
