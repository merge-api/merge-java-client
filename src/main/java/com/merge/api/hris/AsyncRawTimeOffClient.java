...
public class AsyncRawTimeOffClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedTimeOffList>> list() {
     ...
     * Returns a list of <code>TimeOff</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedTimeOffList>> list(TimeOffListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedTimeOffList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedTimeOffList>> future = new CompletableFuture<>();
