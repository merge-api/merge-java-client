...
public class RawBenefitsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedBenefitList> list() {
     ...
     * Returns a list of <code>Benefit</code> objects.
     */
    public MergeApiHttpResponse<PaginatedBenefitList> list(BenefitsListRequest request) {
     ...
     * Returns a list of <code>Benefit</code> objects.
     */
    public MergeApiHttpResponse<PaginatedBenefitList> list(BenefitsListRequest request, RequestOptions requestOptions) {
