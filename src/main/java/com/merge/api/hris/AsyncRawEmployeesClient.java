...
public class AsyncRawEmployeesClient {
     ...
     * Returns a list of <code>Employee</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Employee>>> list(EmployeesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Employee>>> list(
        ...
        if (request.getEmployeeNumber().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "employee_number", request.getEmployeeNumber().get(), false);
        }
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Employee>>> future = new CompletableFuture<>();
