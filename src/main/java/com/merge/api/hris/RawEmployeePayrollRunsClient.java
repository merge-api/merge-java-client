...
public class RawEmployeePayrollRunsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedEmployeePayrollRunList> list() {
     ...
     * Returns a list of <code>EmployeePayrollRun</code> objects.
     */
    public MergeApiHttpResponse<PaginatedEmployeePayrollRunList> list(EmployeePayrollRunsListRequest request) {
