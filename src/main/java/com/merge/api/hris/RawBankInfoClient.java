...
public class RawBankInfoClient {
    protected final ClientOptions clientOptions;

    public RawBankInfoClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>BankInfo</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<BankInfo>> list(BankInfoListRequest request) {
     ...
     */
    public MergeApiHttpResponse<BankInfo> retrieve(String id) {
     ...
     * Returns a <code>BankInfo</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<BankInfo> retrieve(String id, BankInfoRetrieveRequest request) {
