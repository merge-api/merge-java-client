...
public class RawDependentsClient {
    protected final ClientOptions clientOptions;

    public RawDependentsClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>Dependent</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Dependent>> list(DependentsListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Dependent>(startingAfter.isPresent(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<Dependent> retrieve(String id) {
     ...
     * Returns a <code>Dependent</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Dependent> retrieve(String id, DependentsRetrieveRequest request) {
