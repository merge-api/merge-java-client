...
public class RawTeamsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedTeamList> list() {
     ...
     * Returns a list of <code>Team</code> objects.
     */
    public MergeApiHttpResponse<PaginatedTeamList> list(TeamsListRequest request) {
     ...
     * Returns a list of <code>Team</code> objects.
     */
    public MergeApiHttpResponse<PaginatedTeamList> list(TeamsListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedTeamList.class), response);
            }
