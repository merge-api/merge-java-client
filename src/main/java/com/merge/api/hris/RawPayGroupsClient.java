...
public class RawPayGroupsClient {
    protected final ClientOptions clientOptions;

    public RawPayGroupsClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>PayGroup</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<PayGroup>> list(PayGroupsListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<PayGroup>(startingAfter.isPresent(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<PayGroup> retrieve(String id) {
     ...
     * Returns a <code>PayGroup</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<PayGroup> retrieve(String id, PayGroupsRetrieveRequest request) {
