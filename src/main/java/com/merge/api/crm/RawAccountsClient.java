...
public class RawAccountsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedAccountList> list() {
     ...
     * Returns a list of <code>Account</code> objects.
     */
    public MergeApiHttpResponse<PaginatedAccountList> list(AccountsListRequest request) {
     ...
     * Returns a list of <code>Account</code> objects.
     */
    public MergeApiHttpResponse<PaginatedAccountList> list(AccountsListRequest request, RequestOptions requestOptions) {
    ...
    public MergeApiHttpResponse<CrmAccountResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), CrmAccountResponse.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
