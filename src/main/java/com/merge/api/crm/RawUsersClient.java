...
public class RawUsersClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedUserList> list() {
     ...
     * Returns a list of <code>User</code> objects.
     */
    public MergeApiHttpResponse<PaginatedUserList> list(UsersListRequest request) {
     ...
     * Returns a list of <code>User</code> objects.
     */
    public MergeApiHttpResponse<PaginatedUserList> list(UsersListRequest request, RequestOptions requestOptions) {
     ...
     */
    public MergeApiHttpResponse<User> retrieve(String id) {
     ...
     * Returns a <code>User</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<User> retrieve(String id, UsersRetrieveRequest request) {
