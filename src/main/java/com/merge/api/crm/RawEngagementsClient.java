...
public class RawEngagementsClient {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<Engagement>> list() {
     ...
     * Returns a list of <code>Engagement</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Engagement>> list(EngagementsListRequest request) {
