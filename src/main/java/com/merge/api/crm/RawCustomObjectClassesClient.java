...
public class RawCustomObjectClassesClient {
     ...
     * Returns a list of <code>CustomObjectClass</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<CustomObjectClass>> list(CustomObjectClassesListRequest request) {
    ...
    public MergeApiHttpResponse<SyncPagingIterable<CustomObjectClass>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedCustomObjectClassList parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                        responseBody.string(), PaginatedCustomObjectClassList.class);
                Optional<String> startingAfter = parsedResponse.getNext();
                CustomObjectClassesListRequest nextRequest = CustomObjectClassesListRequest.builder()
                        .from(request)
                        .cursor(startingAfter)
                        .build();
                List<CustomObjectClass> result = parsedResponse.getResults().orElse(Collections.emptyList());
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<CustomObjectClass>(
