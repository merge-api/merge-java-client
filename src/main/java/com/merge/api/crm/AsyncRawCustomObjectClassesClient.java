...
public class AsyncRawCustomObjectClassesClient {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<CustomObjectClass>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<CustomObjectClass>>> future =
                ...
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        ...
                        CustomObjectClassesListRequest nextRequest = CustomObjectClassesListRequest.builder()
                                ...
                                .build();
                        List<CustomObjectClass> result =
                                parsedResponse.getResults().orElse(Collections.emptyList());
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<CustomObjectClass>(startingAfter.isPresent(), result, () -> {
                                    try {
