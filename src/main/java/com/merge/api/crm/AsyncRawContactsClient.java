...
public class AsyncRawContactsClient {
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        PaginatedContactList parsedResponse =
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaginatedContactList.class);
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<CrmContactResponse>> create(CrmContactEndpointRequest request) {
     ...
     * Creates a <code>Contact</code> object with the given values.
     */
    public CompletableFuture<MergeApiHttpResponse<CrmContactResponse>> create(
        ...
        CompletableFuture<MergeApiHttpResponse<CrmContactResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CrmContactResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<CrmContactResponse>> partialUpdate(
            String id, PatchedCrmContactEndpointRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<Void>> ignoreCreate(
            String modelId, ContactsIgnoreCreateRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<MetaResponse>> metaPatchRetrieve(String id) {
        return metaPatchRetrieve(id, ContactsMetaPatchRetrieveRequest.builder().build());
    }
    ...
    public CompletableFuture<MergeApiHttpResponse<MetaResponse>> metaPatchRetrieve(
            String id, ContactsMetaPatchRetrieveRequest request) {
