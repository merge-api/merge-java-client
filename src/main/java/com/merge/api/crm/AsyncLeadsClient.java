...
public class AsyncLeadsClient {
     ...
     */
    public CompletableFuture<SyncPagingIterable<Lead>> list() {
     ...
     * Returns a list of <code>Lead</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<Lead>> list(LeadsListRequest request) {
     ...
     * Returns a list of <code>Lead</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<Lead>> list(LeadsListRequest request, RequestOptions requestOptions) {
