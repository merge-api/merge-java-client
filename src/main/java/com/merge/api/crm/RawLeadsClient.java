...
public class RawLeadsClient {
     ...
     * Returns a list of <code>Lead</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Lead>> list(LeadsListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Lead>(startingAfter.isPresent(), result, parsedResponse, () -> list(
