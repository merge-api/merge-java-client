...
public class AsyncRawNotesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedNoteList>> list() {
     ...
     * Returns a list of <code>Note</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedNoteList>> list(NotesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedNoteList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedNoteList>> future = new CompletableFuture<>();
