...
public class TasksClient {
     ...
     */
    public SyncPagingIterable<Task> list() {
     ...
     * Returns a list of <code>Task</code> objects.
     */
    public SyncPagingIterable<Task> list(TasksListRequest request) {
     ...
     * Returns a list of <code>Task</code> objects.
     */
    public SyncPagingIterable<Task> list(TasksListRequest request, RequestOptions requestOptions) {
     ...
     * Returns a list of <code>RemoteFieldClass</code> objects.
     */
    public SyncPagingIterable<RemoteFieldClass> remoteFieldClassesList(TasksRemoteFieldClassesListRequest request) {
