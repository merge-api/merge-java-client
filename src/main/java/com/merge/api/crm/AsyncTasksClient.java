...
public class AsyncTasksClient {
     ...
     */
    public CompletableFuture<PaginatedTaskList> list() {
     ...
     * Returns a list of <code>Task</code> objects.
     */
    public CompletableFuture<PaginatedTaskList> list(TasksListRequest request) {
     ...
     * Returns a list of <code>Task</code> objects.
     */
    public CompletableFuture<PaginatedTaskList> list(TasksListRequest request, RequestOptions requestOptions) {
