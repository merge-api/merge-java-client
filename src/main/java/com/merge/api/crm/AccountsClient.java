...
public class AccountsClient {
     ...
     * Returns metadata for <code>CRMAccount</code> PATCHs.
     */
    public MetaResponse metaPatchRetrieve(String id, AccountsMetaPatchRetrieveRequest request) {
     ...
     * Returns a list of <code>RemoteFieldClass</code> objects.
     */
    public SyncPagingIterable<RemoteFieldClass> remoteFieldClassesList(AccountsRemoteFieldClassesListRequest request) {
