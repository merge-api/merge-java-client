...
public class RawTasksClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedTaskList> list() {
     ...
     * Returns a list of <code>Task</code> objects.
     */
    public MergeApiHttpResponse<PaginatedTaskList> list(TasksListRequest request) {
     ...
     * Returns a list of <code>Task</code> objects.
     */
    public MergeApiHttpResponse<PaginatedTaskList> list(TasksListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedTaskList.class), response);
            }
