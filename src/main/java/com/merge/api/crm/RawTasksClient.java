...
public class RawTasksClient {
     ...
     * Returns a list of <code>Task</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Task>> list(TasksListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Task>(!startingAfter.isEmpty(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<TaskResponse> create(TaskEndpointRequest request) {
     ...
     */
    public MergeApiHttpResponse<Task> retrieve(String id) {
     ...
     * Returns a <code>Task</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Task> retrieve(String id, TasksRetrieveRequest request) {
     ...
     */
    public MergeApiHttpResponse<TaskResponse> partialUpdate(String id, PatchedTaskEndpointRequest request) {
     ...
     * Returns metadata for <code>Task</code> PATCHs.
     */
    public MergeApiHttpResponse<MetaResponse> metaPatchRetrieve(String id, TasksMetaPatchRetrieveRequest request) {
