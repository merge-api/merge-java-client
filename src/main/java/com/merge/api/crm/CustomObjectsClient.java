...
public class CustomObjectsClient {
     ...
     */
    public SyncPagingIterable<CustomObject> customObjectClassesCustomObjectsList(String customObjectClassId) {
        return this.rawClient
     ...
     * Returns a list of <code>CustomObject</code> objects.
     */
    public SyncPagingIterable<CustomObject> customObjectClassesCustomObjectsList(
     ...
     */
    public SyncPagingIterable<RemoteFieldClass> customObjectClassesCustomObjectsRemoteFieldClassesList() {
        return this.rawClient
