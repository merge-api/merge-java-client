...
public class AsyncRawEngagementsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedEngagementList>> list() {
     ...
     * Returns a list of <code>Engagement</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedEngagementList>> list(EngagementsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedEngagementList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedEngagementList>> future = new CompletableFuture<>();
