...
public class AsyncEngagementsClient {
     ...
     */
    public CompletableFuture<SyncPagingIterable<Engagement>> list() {
     ...
     * Returns a list of <code>Engagement</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<Engagement>> list(EngagementsListRequest request) {
     ...
     * Returns metadata for <code>Engagement</code> PATCHs.
     */
    public CompletableFuture<MetaResponse> metaPatchRetrieve(String id, EngagementsMetaPatchRetrieveRequest request) {
