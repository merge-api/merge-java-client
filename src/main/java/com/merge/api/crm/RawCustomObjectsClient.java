...
public class RawCustomObjectsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedCustomObjectList> customObjectClassesCustomObjectsList(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedCustomObjectList.class),
                        response);
            }
    ...
    public MergeApiHttpResponse<CrmCustomObjectResponse> customObjectClassesCustomObjectsCreate(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), CrmCustomObjectResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
    ...
    public MergeApiHttpResponse<CustomObject> customObjectClassesCustomObjectsRetrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), CustomObject.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
     ...
     */
    public MergeApiHttpResponse<PaginatedRemoteFieldClassList>
     ...
     * Returns a list of <code>RemoteFieldClass</code> objects.
     */
    public MergeApiHttpResponse<PaginatedRemoteFieldClassList> customObjectClassesCustomObjectsRemoteFieldClassesList(
