...
import com.merge.api.crm.types.PaginatedUserList;
...
public class AsyncRawUsersClient {
     ...
     * Returns a list of <code>User</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<User>>> list(UsersListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<User>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<User>>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<MergeApiHttpResponse<Void>> ignoreCreate(
            String modelId, UsersIgnoreCreateRequest request) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<Void>> ignoreCreate(
            String modelId, UsersIgnoreCreateRequest request, RequestOptions requestOptions) {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        String startingAfter = parsedResponse.getNext().orElse(null);
                        UsersRemoteFieldClassesListRequest nextRequest = UsersRemoteFieldClassesListRequest.builder()
                                .from(request)
                                .cursor(startingAfter)
                                .build();
