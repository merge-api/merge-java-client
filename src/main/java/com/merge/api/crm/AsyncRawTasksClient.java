...
public class AsyncRawTasksClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedTaskList>> list() {
     ...
     * Returns a list of <code>Task</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedTaskList>> list(TasksListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedTaskList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedTaskList>> future = new CompletableFuture<>();
