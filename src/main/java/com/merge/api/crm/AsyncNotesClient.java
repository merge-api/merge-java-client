...
public class AsyncNotesClient {
     ...
     * Returns a list of <code>Note</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<Note>> list(NotesListRequest request) {
     ...
     * Returns a list of <code>Note</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<Note>> list(NotesListRequest request, RequestOptions requestOptions) {
