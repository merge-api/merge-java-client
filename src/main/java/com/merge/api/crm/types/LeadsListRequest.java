...
public final class LeadsListRequest {
    private final Optional<List<LeadsListRequestExpandItem>> expand;
    ...
    private LeadsListRequest(
            Optional<List<LeadsListRequestExpandItem>> expand,
     ...
     */
    @JsonProperty("expand")
    public Optional<List<LeadsListRequestExpandItem>> getExpand() {
        return expand;
    }
    ...
    private boolean equalTo(LeadsListRequest other) {
        return expand.equals(other.expand)
                && convertedAccountId.equals(other.convertedAccountId)
    ...
    public static final class Builder {
        private Optional<List<LeadsListRequestExpandItem>> expand = Optional.empty();
        ...
        public Builder expand(Optional<List<LeadsListRequestExpandItem>> expand) {
            this.expand = expand;
            return this;
        }

        public Builder expand(List<LeadsListRequestExpandItem> expand) {
            this.expand = Optional.ofNullable(expand);
            return this;
        }

        public Builder expand(LeadsListRequestExpandItem expand) {
            this.expand = Optional.of(Collections.singletonList(expand));
            return this;
        }

        /**
         * <p>If provided, will only return leads with this account.</p>
         */
        ...
        /**
         * <p>If provided, will only return leads with this contact.</p>
         */
        ...
        /**
         * <p>If provided, will only return contacts matching the email addresses; multiple email_addresses can be separated by commas.</p>
         */
        ...
        /**
         * <p>If provided, will only return leads with this owner.</p>
         */
        ...
        /**
         * <p>If provided, will only return contacts matching the phone numbers; multiple phone numbers can be separated by commas.</p>
         */
