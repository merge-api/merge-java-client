...
public final class PatchedEngagementRequest {
    ...
    private Optional<PatchedEngagementRequestDirection> _getDirection() {
        return direction;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("engagement_type")
    private Optional<String> _getEngagementType() {
        return engagementType;
    }
    ...
    public static final class Builder {
        ...
        public Builder direction(Nullable<PatchedEngagementRequestDirection> direction) {
            if (direction.isNull()) {
                this.direction = null;
        ...
        public Builder engagementType(Nullable<String> engagementType) {
