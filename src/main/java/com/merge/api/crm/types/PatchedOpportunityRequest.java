...
public final class PatchedOpportunityRequest {
    ...
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("stage")
    private Optional<String> _getStage() {
        return stage;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("status")
    private Optional<PatchedOpportunityRequestStatus> _getStatus() {
        return status;
    }
    ...
    public static final class Builder {
        ...
        public Builder status(Nullable<PatchedOpportunityRequestStatus> status) {
            if (status.isNull()) {
                this.status = null;
