...
public final class LeadResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Lead model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Lead model) {
            this.model = model;
            return this;
        }
        ...
        public LeadResponse build() {
            return new LeadResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
