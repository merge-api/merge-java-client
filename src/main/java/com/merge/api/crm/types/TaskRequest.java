...
public final class TaskRequest {
    ...
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("owner")
    private Optional<TaskRequestOwner> _getOwner() {
        return owner;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("account")
    private Optional<TaskRequestAccount> _getAccount() {
        return account;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("opportunity")
    private Optional<TaskRequestOpportunity> _getOpportunity() {
        return opportunity;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("status")
    private Optional<TaskRequestStatus> _getStatus() {
        return status;
    }
    ...
    public static final class Builder {
        ...
        public Builder owner(Nullable<TaskRequestOwner> owner) {
            if (owner.isNull()) {
                this.owner = null;
        ...
        public Builder account(Nullable<TaskRequestAccount> account) {
            if (account.isNull()) {
                this.account = null;
        ...
        public Builder opportunity(Nullable<TaskRequestOpportunity> opportunity) {
        ...
        public Builder status(Nullable<TaskRequestStatus> status) {
            if (status.isNull()) {
                this.status = null;
