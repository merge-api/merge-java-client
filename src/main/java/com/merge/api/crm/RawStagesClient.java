...
public class RawStagesClient {
    protected final ClientOptions clientOptions;

    public RawStagesClient(ClientOptions clientOptions) {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<Stage>> list() {
     ...
     * Returns a list of <code>Stage</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Stage>> list(StagesListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Stage>(startingAfter.isPresent(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<Stage> retrieve(String id) {
     ...
     * Returns a <code>Stage</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Stage> retrieve(String id, StagesRetrieveRequest request) {
     ...
     * Returns a <code>Stage</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Stage> retrieve(
