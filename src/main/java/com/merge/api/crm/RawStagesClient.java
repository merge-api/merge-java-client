...
public class RawStagesClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedStageList> list() {
     ...
     * Returns a list of <code>Stage</code> objects.
     */
    public MergeApiHttpResponse<PaginatedStageList> list(StagesListRequest request) {
     ...
     * Returns a list of <code>Stage</code> objects.
     */
    public MergeApiHttpResponse<PaginatedStageList> list(StagesListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedStageList.class), response);
            }
