...
import com.merge.api.crm.types.PaginatedAssociationList;
...
public class AsyncRawAssociationsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawAssociationsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Association>>>
            customObjectClassesCustomObjectsAssociationsList(String customObjectClassId, String objectId) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Association>>>
        ...
        if (request.getAssociationTypeId().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl,
                    "association_type_id",
                    request.getAssociationTypeId().get(),
                    false);
        }
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Association>>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        PaginatedAssociationList parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBody.string(), PaginatedAssociationList.class);
                        Optional<String> startingAfter = parsedResponse.getNext();
                        CustomObjectClassesCustomObjectsAssociationsListRequest nextRequest =
                                CustomObjectClassesCustomObjectsAssociationsListRequest.builder()
                                        .from(request)
    ...
    public CompletableFuture<MergeApiHttpResponse<Association>> customObjectClassesCustomObjectsAssociationsUpdate(
        ...
        CompletableFuture<MergeApiHttpResponse<Association>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Association.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
