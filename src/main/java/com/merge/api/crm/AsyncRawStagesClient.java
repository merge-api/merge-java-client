...
public class AsyncRawStagesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedStageList>> list() {
     ...
     * Returns a list of <code>Stage</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedStageList>> list(StagesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedStageList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedStageList>> future = new CompletableFuture<>();
