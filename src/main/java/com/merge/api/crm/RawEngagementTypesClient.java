...
public class RawEngagementTypesClient {
    protected final ClientOptions clientOptions;

    public RawEngagementTypesClient(ClientOptions clientOptions) {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<EngagementType>> list() {
     ...
     * Returns a list of <code>EngagementType</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<EngagementType>> list(EngagementTypesListRequest request) {
    ...
    public MergeApiHttpResponse<SyncPagingIterable<EngagementType>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedEngagementTypeList parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedEngagementTypeList.class);
                Optional<String> startingAfter = parsedResponse.getNext();
                EngagementTypesListRequest nextRequest = EngagementTypesListRequest.builder()
                        .from(request)
                        .cursor(startingAfter)
                        .build();
                List<EngagementType> result = parsedResponse.getResults().orElse(Collections.emptyList());
     ...
     */
    public MergeApiHttpResponse<EngagementType> retrieve(String id) {
     ...
     * Returns an <code>EngagementType</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<EngagementType> retrieve(String id, EngagementTypesRetrieveRequest request) {
     ...
     * Returns an <code>EngagementType</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<EngagementType> retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), EngagementType.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
