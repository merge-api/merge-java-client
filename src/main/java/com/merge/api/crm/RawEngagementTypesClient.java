...
public class RawEngagementTypesClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedEngagementTypeList> list() {
     ...
     * Returns a list of <code>EngagementType</code> objects.
     */
    public MergeApiHttpResponse<PaginatedEngagementTypeList> list(EngagementTypesListRequest request) {
