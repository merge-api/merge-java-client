...
public class AsyncMergeApiClientBuilder {
     ...
     */
    public AsyncMergeApiClientBuilder addHeader(String name, String value) {
    ...
    protected void setCustomHeaders(ClientOptions.Builder builder) {
        if (this.accountToken != null) {
            builder.addHeader("X-Account-Token", this.accountToken);
        }
    }
    ...
    public AsyncMergeApiClient build() {
        ...
        return new AsyncMergeApiClient(buildClientOptions());
    }
}
