...
public class AsyncFilesClient {
     ...
     */
    public CompletableFuture<SyncPagingIterable<File>> list() {
     ...
     * Returns a list of <code>File</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<File>> list(FilesListRequest request) {
     ...
     * Returns a list of <code>File</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<File>> list(FilesListRequest request, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<SyncPagingIterable<DownloadRequestMeta>> downloadRequestMetaList() {
