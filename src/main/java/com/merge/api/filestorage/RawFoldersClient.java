...
public class RawFoldersClient {
     ...
     * Returns a list of <code>Folder</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Folder>> list(FoldersListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Folder>(startingAfter.isPresent(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<FileStorageFolderResponse> create(FileStorageFolderEndpointRequest request) {
    ...
    public MergeApiHttpResponse<FileStorageFolderResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), FileStorageFolderResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
     ...
     */
    public MergeApiHttpResponse<Folder> retrieve(String id) {
     ...
     * Returns a <code>Folder</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Folder> retrieve(String id, FoldersRetrieveRequest request) {
