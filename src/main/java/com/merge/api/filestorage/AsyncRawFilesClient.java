...
public class AsyncRawFilesClient {
     ...
     * Returns a list of <code>File</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<File>>> list(FilesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<File>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<File>>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<File>(!startingAfter.isEmpty(), result, parsedResponse, () -> {
                                    try {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DownloadRequestMeta.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<DownloadRequestMeta>>> downloadRequestMetaList(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<DownloadRequestMeta>>> future =
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        PaginatedDownloadRequestMetaList parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, PaginatedDownloadRequestMetaList.class);
                        String startingAfter = parsedResponse.getNext().orElse(null);
