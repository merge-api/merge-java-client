...
public class AsyncRawFilesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedFileList>> list() {
     ...
     * Returns a list of <code>File</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedFileList>> list(FilesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedFileList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedFileList>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<MergeApiHttpResponse<FileStorageFileResponse>> create(
        ...
        CompletableFuture<MergeApiHttpResponse<FileStorageFileResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), FileStorageFileResponse.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<File>> retrieve(String id) {
     ...
     * Returns a <code>File</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<File>> retrieve(String id, FilesRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<File>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<File>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<MergeApiHttpResponse<InputStream>> downloadRetrieve(
            String id, FilesDownloadRetrieveRequest request) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<DownloadRequestMeta>> downloadRequestMetaRetrieve(String id) {
    ...
    public CompletableFuture<MergeApiHttpResponse<DownloadRequestMeta>> downloadRequestMetaRetrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<DownloadRequestMeta>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedDownloadRequestMetaList>> downloadRequestMetaList() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedDownloadRequestMetaList>> downloadRequestMetaList(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedDownloadRequestMetaList>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
