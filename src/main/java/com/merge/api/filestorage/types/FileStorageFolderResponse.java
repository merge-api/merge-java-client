...
public final class FileStorageFolderResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Folder model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Folder model) {
            this.model = model;
            return this;
        }
        ...
        public FileStorageFolderResponse build() {
            return new FileStorageFolderResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
