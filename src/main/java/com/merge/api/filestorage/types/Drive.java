...
public final class Drive {
    ...
    private Optional<String> _getDriveUrl() {
        return driveUrl;
    }
    ...
    public static final class Builder {
        ...
        /**
         * <p>When the third party's drive was created.</p>
         */
        ...
        public Builder driveUrl(Nullable<String> driveUrl) {
            if (driveUrl.isNull()) {
                this.driveUrl = null;
            } else if (driveUrl.isEmpty()) {
                this.driveUrl = Optional.empty();
            } else {
                this.driveUrl = Optional.of(driveUrl.get());
            }
            return this;
        }
