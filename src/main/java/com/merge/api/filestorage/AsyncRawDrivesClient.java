...
public class AsyncRawDrivesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedDriveList>> list() {
     ...
     * Returns a list of <code>Drive</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedDriveList>> list(DrivesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedDriveList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedDriveList>> future = new CompletableFuture<>();
