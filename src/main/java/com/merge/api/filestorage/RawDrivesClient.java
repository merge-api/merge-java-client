...
public class RawDrivesClient {
    protected final ClientOptions clientOptions;

    public RawDrivesClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>Drive</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Drive>> list(DrivesListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Drive>(startingAfter.isPresent(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<Drive> retrieve(String id) {
     ...
     * Returns a <code>Drive</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Drive> retrieve(String id, DrivesRetrieveRequest request) {
