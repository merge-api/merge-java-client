...
public class FilesClient {
     ...
     */
    public SyncPagingIterable<File> list() {
     ...
     * Returns a list of <code>File</code> objects.
     */
    public SyncPagingIterable<File> list(FilesListRequest request) {
     ...
     * Returns a list of <code>File</code> objects.
     */
    public SyncPagingIterable<File> list(FilesListRequest request, RequestOptions requestOptions) {
     ...
     */
    public SyncPagingIterable<DownloadRequestMeta> downloadRequestMetaList() {
