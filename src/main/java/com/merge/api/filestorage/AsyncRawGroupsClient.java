...
import com.merge.api.filestorage.types.Group;
import com.merge.api.filestorage.types.GroupsListRequest;
import com.merge.api.filestorage.types.GroupsRetrieveRequest;
import com.merge.api.filestorage.types.PaginatedGroupList;
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<Group>(!startingAfter.isEmpty(), result, parsedResponse, () -> {
                                    try {
