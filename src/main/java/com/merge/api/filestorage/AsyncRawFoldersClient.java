...
public class AsyncRawFoldersClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedFolderList>> list() {
     ...
     * Returns a list of <code>Folder</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedFolderList>> list(FoldersListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedFolderList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedFolderList>> future = new CompletableFuture<>();
