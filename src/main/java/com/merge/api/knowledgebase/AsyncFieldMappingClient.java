...
public class AsyncFieldMappingClient {
     ...
     */
    public CompletableFuture<ExternalTargetFieldApiResponse> targetFieldsCreate(CreateTargetFieldRequest request) {
        return this.rawClient.targetFieldsCreate(request).thenApply(response -> response.body());
    }

    /**
     * Create a new organization-wide Target Field. Target Fields are custom fields that your organization defines to collect supplemental data from integrations. <a href="https://docs.merge.dev/supplemental-data/field-mappings/target-fields/">Learn more</a>.
     */
    public CompletableFuture<ExternalTargetFieldApiResponse> targetFieldsCreate(
            CreateTargetFieldRequest request, RequestOptions requestOptions) {
        return this.rawClient.targetFieldsCreate(request, requestOptions).thenApply(response -> response.body());
    }
}
