...
import com.merge.api.knowledgebase.types.AsyncPassthroughReciept;
import com.merge.api.knowledgebase.types.AsyncPassthroughRetrieveResponse;
import com.merge.api.knowledgebase.types.DataPassthroughRequest;
...
public class AsyncRawAsyncPassthroughClient {
    ...
    public CompletableFuture<MergeApiHttpResponse<AsyncPassthroughReciept>> create(
        ...
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("knowledgebase/v1/async-passthrough")
                .build();
        RequestBody body;
        try {
