...
import com.merge.api.knowledgebase.types.PaginatedAccountDetailsAndActionsList;
...
public class RawLinkedAccountsClient {
     ...
     * List linked accounts for your organization.
     */
    public MergeApiHttpResponse<SyncPagingIterable<AccountDetailsAndActions>> list(LinkedAccountsListRequest request) {
    ...
    public MergeApiHttpResponse<SyncPagingIterable<AccountDetailsAndActions>> list(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("knowledgebase/v1/linked-accounts");
