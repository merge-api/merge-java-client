...
import com.merge.api.knowledgebase.types.Group;
import com.merge.api.knowledgebase.types.GroupsListRequest;
import com.merge.api.knowledgebase.types.GroupsRetrieveRequest;
import com.merge.api.knowledgebase.types.PaginatedGroupList;
...
public class AsyncRawGroupsClient {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Group>>> list(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("knowledgebase/v1/groups");
