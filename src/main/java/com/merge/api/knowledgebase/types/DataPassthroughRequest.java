...
public final class DataPassthroughRequest {
    private final DataPassthroughRequestMethod method;
    ...
    private final Optional<DataPassthroughRequestRequestFormat> requestFormat;
    ...
    private DataPassthroughRequest(
            DataPassthroughRequestMethod method,
            String path,
            ...
            Optional<DataPassthroughRequestRequestFormat> requestFormat,
    ...
    @JsonProperty("method")
    public DataPassthroughRequestMethod getMethod() {
        return method;
    }
    ...
    public Optional<DataPassthroughRequestRequestFormat> getRequestFormat() {
    ...
    public interface MethodStage {
        PathStage method(@NotNull DataPassthroughRequestMethod method);
    ...
    public interface _FinalStage {
        ...
        _FinalStage requestFormat(Optional<DataPassthroughRequestRequestFormat> requestFormat);

        _FinalStage requestFormat(DataPassthroughRequestRequestFormat requestFormat);
    ...
    public static final class Builder implements MethodStage, PathStage, _FinalStage {
        private DataPassthroughRequestMethod method;

        private String path;

        private Optional<Boolean> normalizeResponse = Optional.empty();

        private Optional<DataPassthroughRequestRequestFormat> requestFormat = Optional.empty();
        ...
        @java.lang.Override
        @JsonSetter("method")
        public PathStage method(@NotNull DataPassthroughRequestMethod method) {
            this.method = method;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage requestFormat(DataPassthroughRequestRequestFormat requestFormat) {
        ...
        public _FinalStage requestFormat(Optional<DataPassthroughRequestRequestFormat> requestFormat) {
            this.requestFormat = requestFormat;
            return this;
        }
