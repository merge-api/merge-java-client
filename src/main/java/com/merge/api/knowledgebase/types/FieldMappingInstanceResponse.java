...
@JsonDeserialize(builder = FieldMappingInstanceResponse.Builder.class)
public final class FieldMappingInstanceResponse {
    private final FieldMappingApiInstance model;
    ...
    private FieldMappingInstanceResponse(
            FieldMappingApiInstance model,
    ...
    @JsonProperty("model")
    public FieldMappingApiInstance getModel() {
        return model;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FieldMappingInstanceResponse && equalTo((FieldMappingInstanceResponse) other);
    }
    ...
    private boolean equalTo(FieldMappingInstanceResponse other) {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull FieldMappingApiInstance model);

        Builder from(FieldMappingInstanceResponse other);
    }

    public interface _FinalStage {
        FieldMappingInstanceResponse build();
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        private FieldMappingApiInstance model;
        ...
        @java.lang.Override
        public Builder from(FieldMappingInstanceResponse other) {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull FieldMappingApiInstance model) {
            this.model = model;
            return this;
        }
        ...
        @java.lang.Override
        public FieldMappingInstanceResponse build() {
            return new FieldMappingInstanceResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
