...
public class RawFieldMappingClient {
    protected final ClientOptions clientOptions;

    public RawFieldMappingClient(ClientOptions clientOptions) {
    ...
    public MergeApiHttpResponse<FieldMappingApiInstanceResponse> fieldMappingsRetrieve(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("knowledgebase/v1/field-mappings");
     ...
     */
    public MergeApiHttpResponse<FieldMappingInstanceResponse> fieldMappingsCreate(CreateFieldMappingRequest request) {
     ...
     */
    public MergeApiHttpResponse<FieldMappingInstanceResponse> fieldMappingsDestroy(String fieldMappingId) {
     ...
     */
    public MergeApiHttpResponse<FieldMappingInstanceResponse> fieldMappingsPartialUpdate(String fieldMappingId) {
     ...
     * Get all remote fields for a Linked Account. Remote fields are third-party fields that are accessible after initial sync if remote_data is enabled. You can use remote fields to override existing Merge fields or map a new Merge field. <a href="https://docs.merge.dev/supplemental-data/field-mappings/overview/">Learn more</a>.
     */
    public MergeApiHttpResponse<RemoteFieldApiResponse> remoteFieldsRetrieve(RemoteFieldsRetrieveRequest request) {
    ...
    public MergeApiHttpResponse<RemoteFieldApiResponse> remoteFieldsRetrieve(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("knowledgebase/v1/remote-fields");
        if (request.getCommonModels().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "common_models", request.getCommonModels().get(), false);
        }
        if (request.getIncludeExampleValues().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl,
                    "include_example_values",
                    request.getIncludeExampleValues().get(),
                    false);
        }
        Request.Builder _requestBuilder = new Request.Builder()
                .url(httpUrl.build())
     ...
     */
    public MergeApiHttpResponse<ExternalTargetFieldApiResponse> targetFieldsRetrieve() {
    ...
    public MergeApiHttpResponse<ExternalTargetFieldApiResponse> targetFieldsRetrieve(RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("knowledgebase/v1/target-fields")
                .build();
        Request okhttpRequest = new Request.Builder()
                .url(httpUrl)
                .method("GET", null)
     ...
     */
    public MergeApiHttpResponse<ExternalTargetFieldApiResponse> targetFieldsCreate(CreateTargetFieldRequest request) {
        return targetFieldsCreate(request, null);
    }

    /**
     * Create a new organization-wide Target Field. Target Fields are custom fields that your organization defines to collect supplemental data from integrations. <a href="https://docs.merge.dev/supplemental-data/field-mappings/target-fields/">Learn more</a>.
     */
    public MergeApiHttpResponse<ExternalTargetFieldApiResponse> targetFieldsCreate(
