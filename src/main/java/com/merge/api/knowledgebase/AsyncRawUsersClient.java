...
import com.merge.api.knowledgebase.types.PaginatedUserList;
import com.merge.api.knowledgebase.types.User;
import com.merge.api.knowledgebase.types.UsersListRequest;
import com.merge.api.knowledgebase.types.UsersRetrieveRequest;
...
public class AsyncRawUsersClient {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<User>>> list(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("knowledgebase/v1/users");
