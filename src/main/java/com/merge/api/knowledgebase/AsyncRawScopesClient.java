...
public class AsyncRawScopesClient {
    ...
    public CompletableFuture<MergeApiHttpResponse<CommonModelScopeApi>> defaultScopesRetrieve(
        ...
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("knowledgebase/v1/default-scopes")
                .build();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CommonModelScopeApi.class),
                                response));
                        return;
                    }
    ...
    public CompletableFuture<MergeApiHttpResponse<CommonModelScopeApi>> linkedAccountScopesRetrieve(
        ...
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("knowledgebase/v1/linked-account-scopes")
                .build();
        Request okhttpRequest = new Request.Builder()
                .url(httpUrl)
                .method("GET", null)
