...
public class AsyncRawFieldMappingClient {
    protected final ClientOptions clientOptions;

    public AsyncRawFieldMappingClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<MergeApiHttpResponse<FieldMappingApiInstanceResponse>> fieldMappingsRetrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<FieldMappingApiInstanceResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, FieldMappingApiInstanceResponse.class),
                                response));
                        return;
                    }
    ...
    public CompletableFuture<MergeApiHttpResponse<FieldMappingInstanceResponse>> fieldMappingsCreate(
        ...
        CompletableFuture<MergeApiHttpResponse<FieldMappingInstanceResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, FieldMappingInstanceResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
    ...
    public CompletableFuture<MergeApiHttpResponse<RemoteFieldApiResponse>> remoteFieldsRetrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<RemoteFieldApiResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<MergeApiHttpResponse<ExternalTargetFieldApiResponse>> targetFieldsRetrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<ExternalTargetFieldApiResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, ExternalTargetFieldApiResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<ExternalTargetFieldApiResponse>> targetFieldsCreate(
            CreateTargetFieldRequest request) {
