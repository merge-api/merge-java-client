...
public class AsyncKnowledgebaseClient {
    ...
    protected final Supplier<AsyncContainersClient> containersClient;
    ...
    public AsyncKnowledgebaseClient(ClientOptions clientOptions) {
        ...
        this.containersClient = Suppliers.memoize(() -> new AsyncContainersClient(clientOptions));
    ...
    public AsyncContainersClient containers() {
