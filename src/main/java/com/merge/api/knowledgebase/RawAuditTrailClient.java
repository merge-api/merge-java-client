...
import com.merge.api.knowledgebase.types.PaginatedAuditLogEventList;
...
public class RawAuditTrailClient {
     ...
     * Gets a list of audit trail events.
     */
    public MergeApiHttpResponse<SyncPagingIterable<AuditLogEvent>> list(AuditTrailListRequest request) {
    ...
    public MergeApiHttpResponse<SyncPagingIterable<AuditLogEvent>> list(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("knowledgebase/v1/audit-trail");
