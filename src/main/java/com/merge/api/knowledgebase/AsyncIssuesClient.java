...
public class AsyncIssuesClient {
     ...
     */
    public CompletableFuture<SyncPagingIterable<Issue>> list() {
     ...
     * Gets all issues for Organization.
     */
    public CompletableFuture<SyncPagingIterable<Issue>> list(IssuesListRequest request) {
     ...
     * Gets all issues for Organization.
     */
    public CompletableFuture<SyncPagingIterable<Issue>> list(IssuesListRequest request, RequestOptions requestOptions) {
