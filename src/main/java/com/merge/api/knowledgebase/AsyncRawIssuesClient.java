...
import com.merge.api.knowledgebase.types.Issue;
import com.merge.api.knowledgebase.types.IssuesListRequest;
import com.merge.api.knowledgebase.types.PaginatedIssueList;
...
public class AsyncRawIssuesClient {
     ...
     * Gets all issues for Organization.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Issue>>> list(IssuesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Issue>>> list(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("knowledgebase/v1/issues");
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Issue>>> future = new CompletableFuture<>();
