...
public class RawTagsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedTagList> list() {
     ...
     * Returns a list of <code>Tag</code> objects.
     */
    public MergeApiHttpResponse<PaginatedTagList> list(TagsListRequest request) {
     ...
     * Returns a list of <code>Tag</code> objects.
     */
    public MergeApiHttpResponse<PaginatedTagList> list(TagsListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedTagList.class), response);
            }
     ...
     */
    public MergeApiHttpResponse<Tag> retrieve(String id) {
     ...
     * Returns a <code>Tag</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Tag> retrieve(String id, TagsRetrieveRequest request) {
