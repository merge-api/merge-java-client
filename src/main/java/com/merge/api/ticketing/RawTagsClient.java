...
public class RawTagsClient {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<Tag>> list() {
     ...
     * Returns a list of <code>Tag</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Tag>> list(TagsListRequest request) {
