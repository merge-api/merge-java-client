...
import com.merge.api.ticketing.types.PaginatedTagList;
...
public class AsyncRawTagsClient {
     ...
     * Returns a list of <code>Tag</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Tag>>> list(TagsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Tag>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Tag>>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<Tag>(!startingAfter.isEmpty(), result, parsedResponse, () -> {
                                    try {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<Tag>> retrieve(String id) {
     ...
     * Returns a <code>Tag</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<Tag>> retrieve(String id, TagsRetrieveRequest request) {
     ...
     * Returns a <code>Tag</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<Tag>> retrieve(
            String id, TagsRetrieveRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("ticketing/v1/tags")
                .addPathSegment(id);
        ...
        CompletableFuture<MergeApiHttpResponse<Tag>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
