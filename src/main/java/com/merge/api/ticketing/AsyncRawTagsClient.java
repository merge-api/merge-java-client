...
public class AsyncRawTagsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedTagList>> list() {
     ...
     * Returns a list of <code>Tag</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedTagList>> list(TagsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedTagList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedTagList>> future = new CompletableFuture<>();
