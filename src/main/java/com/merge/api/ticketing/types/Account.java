...
public final class Account {
    ...
    private Optional<List<Optional<String>>> _getDomains() {
        return domains;
    }
    ...
    public static final class Builder {
        ...
        /**
         * <p>The account's domain names.</p>
         */
        ...
        public Builder domains(Nullable<List<Optional<String>>> domains) {
            if (domains.isNull()) {
                this.domains = null;
            } else if (domains.isEmpty()) {
                this.domains = Optional.empty();
            } else {
                this.domains = Optional.of(domains.get());
            }
            return this;
        }
