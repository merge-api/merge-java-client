...
public class RawCommentsClient {
     ...
     * Returns a list of <code>Comment</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Comment>> list(CommentsListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Comment>(startingAfter.isPresent(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<CommentResponse> create(CommentEndpointRequest request) {
    ...
    public MergeApiHttpResponse<CommentResponse> create(CommentEndpointRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), CommentResponse.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
     ...
     */
    public MergeApiHttpResponse<Comment> retrieve(String id) {
     ...
     * Returns a <code>Comment</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Comment> retrieve(String id, CommentsRetrieveRequest request) {
