...
public class RawTicketsClient {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<Ticket>> list() {
     ...
     * Returns a list of <code>Ticket</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Ticket>> list(TicketsListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Ticket>(!startingAfter.isEmpty(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<TicketResponse> create(TicketEndpointRequest request) {
     ...
     * Creates a <code>Ticket</code> object with the given values.
     */
    public MergeApiHttpResponse<TicketResponse> create(TicketEndpointRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("ticketing/v1/tickets");
     ...
     */
    public MergeApiHttpResponse<Ticket> retrieve(String id) {
     ...
     * Returns a <code>Ticket</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Ticket> retrieve(String id, TicketsRetrieveRequest request) {
     ...
     * Returns a <code>Ticket</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Ticket> retrieve(
     ...
     */
    public MergeApiHttpResponse<TicketResponse> partialUpdate(String id, PatchedTicketEndpointRequest request) {
     ...
     * Updates a <code>Ticket</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<TicketResponse> partialUpdate(
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<Viewer>> viewersList(String ticketId) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Viewer>(
                                !startingAfter.isEmpty(), result, parsedResponse, () -> viewersList(
                                                ticketId, nextRequest, requestOptions)
                                        .body()),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * Returns metadata for <code>Ticket</code> PATCHs.
     */
    public MergeApiHttpResponse<MetaResponse> metaPatchRetrieve(String id, TicketsMetaPatchRetrieveRequest request) {
     ...
     * Returns metadata for <code>Ticket</code> POSTs.
     */
    public MergeApiHttpResponse<MetaResponse> metaPostRetrieve(TicketsMetaPostRetrieveRequest request) {
