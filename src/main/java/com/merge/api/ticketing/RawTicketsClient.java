...
public class RawTicketsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedTicketList> list() {
     ...
     * Returns a list of <code>Ticket</code> objects.
     */
    public MergeApiHttpResponse<PaginatedTicketList> list(TicketsListRequest request) {
     ...
     * Returns a list of <code>Ticket</code> objects.
     */
    public MergeApiHttpResponse<PaginatedTicketList> list(TicketsListRequest request, RequestOptions requestOptions) {
     ...
     */
    public MergeApiHttpResponse<PaginatedViewerList> viewersList(String ticketId) {
     ...
     * Returns a list of <code>Viewer</code> objects that point to a User id or Team id that is either an assignee or viewer on a <code>Ticket</code> with the given id. <a href="https://help.merge.dev/en/articles/10333658-ticketing-access-control-list-acls">Learn more.</a>
     */
    public MergeApiHttpResponse<PaginatedViewerList> viewersList(String ticketId, TicketsViewersListRequest request) {
     ...
     * Returns a list of <code>Viewer</code> objects that point to a User id or Team id that is either an assignee or viewer on a <code>Ticket</code> with the given id. <a href="https://help.merge.dev/en/articles/10333658-ticketing-access-control-list-acls">Learn more.</a>
     */
    public MergeApiHttpResponse<PaginatedViewerList> viewersList(
