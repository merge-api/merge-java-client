...
public class RawContactsClient {
     ...
     */
    public MergeApiHttpResponse<TicketingContactResponse> create(TicketingContactEndpointRequest request) {
    ...
    public MergeApiHttpResponse<TicketingContactResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TicketingContactResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
