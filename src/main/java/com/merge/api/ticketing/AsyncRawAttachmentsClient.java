...
public class AsyncRawAttachmentsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedAttachmentList>> list() {
     ...
     * Returns a list of <code>Attachment</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedAttachmentList>> list(AttachmentsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedAttachmentList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedAttachmentList>> future = new CompletableFuture<>();
