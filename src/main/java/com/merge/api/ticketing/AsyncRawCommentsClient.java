...
public class AsyncRawCommentsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedCommentList>> list() {
     ...
     * Returns a list of <code>Comment</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedCommentList>> list(CommentsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedCommentList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedCommentList>> future = new CompletableFuture<>();
