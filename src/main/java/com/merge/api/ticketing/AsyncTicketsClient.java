...
public class AsyncTicketsClient {
     ...
     */
    public CompletableFuture<PaginatedTicketList> list() {
     ...
     * Returns a list of <code>Ticket</code> objects.
     */
    public CompletableFuture<PaginatedTicketList> list(TicketsListRequest request) {
     ...
     * Returns a list of <code>Ticket</code> objects.
     */
    public CompletableFuture<PaginatedTicketList> list(TicketsListRequest request, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<PaginatedViewerList> viewersList(String ticketId) {
     ...
     * Returns a list of <code>Viewer</code> objects that point to a User id or Team id that is either an assignee or viewer on a <code>Ticket</code> with the given id. <a href="https://help.merge.dev/en/articles/10333658-ticketing-access-control-list-acls">Learn more.</a>
     */
    public CompletableFuture<PaginatedViewerList> viewersList(String ticketId, TicketsViewersListRequest request) {
