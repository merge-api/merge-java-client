...
public class AsyncCollectionsClient {
     ...
     * Returns a list of <code>Collection</code> objects.
     */
    public CompletableFuture<SyncPagingIterable<Collection>> list(CollectionsListRequest request) {
     ...
     */
    public CompletableFuture<SyncPagingIterable<Viewer>> viewersList(String collectionId) {
