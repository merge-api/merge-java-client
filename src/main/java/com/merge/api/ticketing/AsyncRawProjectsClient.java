...
public class AsyncRawProjectsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<User>>> usersList(String parentId) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<User>>> usersList(
            String parentId, ProjectsUsersListRequest request) {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        ...
                        Optional<String> startingAfter = parsedResponse.getNext();
                        ProjectsUsersListRequest nextRequest = ProjectsUsersListRequest.builder()
                                .from(request)
                                .cursor(startingAfter)
                                .build();
