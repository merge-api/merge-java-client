...
public class AsyncRawProjectsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedUserList>> usersList(String parentId) {
     ...
     * Returns a list of <code>User</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedUserList>> usersList(
