...
public class AsyncRawRolesClient {
     ...
     * Returns a list of <code>Role</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Role>>> list(RolesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Role>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Role>>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        PaginatedRoleList parsedResponse =
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedRoleList.class);
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<Role>> retrieve(String id) {
     ...
     * Returns a <code>Role</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<Role>> retrieve(String id, RolesRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<Role>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<Role>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Role.class), response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    future.completeExceptionally(new ApiError(
