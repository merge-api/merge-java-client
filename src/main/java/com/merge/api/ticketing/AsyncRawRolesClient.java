...
public class AsyncRawRolesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedRoleList>> list() {
     ...
     * Returns a list of <code>Role</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedRoleList>> list(RolesListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedRoleList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedRoleList>> future = new CompletableFuture<>();
