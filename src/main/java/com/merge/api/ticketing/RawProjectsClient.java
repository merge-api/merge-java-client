...
public class RawProjectsClient {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Project>(!startingAfter.isEmpty(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<User>> usersList(String parentId) {
     ...
     * Returns a list of <code>User</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<User>> usersList(String parentId, ProjectsUsersListRequest request) {
    ...
    public MergeApiHttpResponse<SyncPagingIterable<User>> usersList(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<User>(!startingAfter.isEmpty(), result, parsedResponse, () -> usersList(
