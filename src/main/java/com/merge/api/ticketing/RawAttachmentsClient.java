...
public class RawAttachmentsClient {
     ...
     * Returns a list of <code>Attachment</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Attachment>> list(AttachmentsListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedAttachmentList parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedAttachmentList.class);
     ...
     */
    public MergeApiHttpResponse<TicketingAttachmentResponse> create(TicketingAttachmentEndpointRequest request) {
    ...
    public MergeApiHttpResponse<TicketingAttachmentResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TicketingAttachmentResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
     ...
     */
    public MergeApiHttpResponse<Attachment> retrieve(String id) {
     ...
     * Returns an <code>Attachment</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Attachment> retrieve(String id, AttachmentsRetrieveRequest request) {
    ...
    public MergeApiHttpResponse<Attachment> retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Attachment.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
     ...
     * Returns the <code>File</code> content with the given <code>id</code> as a stream of bytes.
     */
    public MergeApiHttpResponse<InputStream> downloadRetrieve(String id, AttachmentsDownloadRetrieveRequest request) {
