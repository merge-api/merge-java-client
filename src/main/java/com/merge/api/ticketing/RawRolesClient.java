...
public class RawRolesClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedRoleList> list() {
     ...
     * Returns a list of <code>Role</code> objects.
     */
    public MergeApiHttpResponse<PaginatedRoleList> list(RolesListRequest request) {
     ...
     * Returns a list of <code>Role</code> objects.
     */
    public MergeApiHttpResponse<PaginatedRoleList> list(RolesListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedRoleList.class), response);
            }
