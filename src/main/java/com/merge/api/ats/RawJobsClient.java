...
public class RawJobsClient {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<Job>> list() {
     ...
     * Returns a list of <code>Job</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Job>> list(JobsListRequest request) {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<ScreeningQuestion>> screeningQuestionsList(String jobId) {
