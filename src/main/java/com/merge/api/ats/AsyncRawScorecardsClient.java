...
import com.merge.api.ats.types.PaginatedScorecardList;
...
public class AsyncRawScorecardsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawScorecardsClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>Scorecard</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Scorecard>>> list(ScorecardsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Scorecard>>> list(
        ...
        if (request.getInterviewId().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "interview_id", request.getInterviewId().get(), false);
        }
        if (request.getInterviewerId().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "interviewer_id", request.getInterviewerId().get(), false);
        }
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Scorecard>>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        PaginatedScorecardList parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBody.string(), PaginatedScorecardList.class);
                        Optional<String> startingAfter = parsedResponse.getNext();
                        ScorecardsListRequest nextRequest = ScorecardsListRequest.builder()
                                .from(request)
                                .cursor(startingAfter)
                                .build();
                        List<Scorecard> result = parsedResponse.getResults().orElse(Collections.emptyList());
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<Scorecard>(startingAfter.isPresent(), result, () -> {
                                    try {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<Scorecard>> retrieve(String id) {
     ...
     * Returns a <code>Scorecard</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<Scorecard>> retrieve(String id, ScorecardsRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<Scorecard>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<Scorecard>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Scorecard.class), response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    future.completeExceptionally(new ApiError(
