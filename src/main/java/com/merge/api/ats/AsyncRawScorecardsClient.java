...
public class AsyncRawScorecardsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedScorecardList>> list() {
     ...
     * Returns a list of <code>Scorecard</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedScorecardList>> list(ScorecardsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedScorecardList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedScorecardList>> future = new CompletableFuture<>();
