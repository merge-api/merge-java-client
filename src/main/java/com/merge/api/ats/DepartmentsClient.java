...
public class DepartmentsClient {
     ...
     */
    public SyncPagingIterable<Department> list() {
     ...
     * Returns a list of <code>Department</code> objects.
     */
    public SyncPagingIterable<Department> list(DepartmentsListRequest request) {
     ...
     * Returns a list of <code>Department</code> objects.
     */
    public SyncPagingIterable<Department> list(DepartmentsListRequest request, RequestOptions requestOptions) {
