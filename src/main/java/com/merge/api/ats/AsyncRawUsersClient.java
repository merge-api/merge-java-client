...
public class AsyncRawUsersClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedRemoteUserList>> list() {
     ...
     * Returns a list of <code>RemoteUser</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedRemoteUserList>> list(UsersListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedRemoteUserList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedRemoteUserList>> future = new CompletableFuture<>();
