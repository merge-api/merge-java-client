...
public class RawRejectReasonsClient {
    protected final ClientOptions clientOptions;

    public RawRejectReasonsClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>RejectReason</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<RejectReason>> list(RejectReasonsListRequest request) {
    ...
    public MergeApiHttpResponse<SyncPagingIterable<RejectReason>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedRejectReasonList parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedRejectReasonList.class);
     ...
     */
    public MergeApiHttpResponse<RejectReason> retrieve(String id) {
     ...
     * Returns a <code>RejectReason</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<RejectReason> retrieve(String id, RejectReasonsRetrieveRequest request) {
    ...
    public MergeApiHttpResponse<RejectReason> retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), RejectReason.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
