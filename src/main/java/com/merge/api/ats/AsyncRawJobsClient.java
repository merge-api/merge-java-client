...
public class AsyncRawJobsClient {
     ...
     * Returns a list of <code>Job</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Job>>> list(JobsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Job>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Job>>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<Job>(!startingAfter.isEmpty(), result, parsedResponse, () -> {
                                    try {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<ScreeningQuestion>>> screeningQuestionsList(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<ScreeningQuestion>>> future =
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        PaginatedScreeningQuestionList parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, PaginatedScreeningQuestionList.class);
                        String startingAfter = parsedResponse.getNext().orElse(null);
