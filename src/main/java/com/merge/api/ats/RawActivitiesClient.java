...
public class RawActivitiesClient {
     ...
     * Returns a list of <code>Activity</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Activity>> list(ActivitiesListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Activity>(startingAfter.isPresent(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<ActivityResponse> create(ActivityEndpointRequest request) {
    ...
    public MergeApiHttpResponse<ActivityResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), ActivityResponse.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
     ...
     */
    public MergeApiHttpResponse<Activity> retrieve(String id) {
     ...
     * Returns an <code>Activity</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Activity> retrieve(String id, ActivitiesRetrieveRequest request) {
