...
public class AsyncRawJobInterviewStagesClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedJobInterviewStageList>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedJobInterviewStageList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedJobInterviewStageList>> future = new CompletableFuture<>();
