...
public class RawAttachmentsClient {
     ...
     */
    public MergeApiHttpResponse<AttachmentResponse> create(AttachmentEndpointRequest request) {
    ...
    public MergeApiHttpResponse<AttachmentResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), AttachmentResponse.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
