...
public class RawOffersClient {
    protected final ClientOptions clientOptions;

    public RawOffersClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>Offer</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Offer>> list(OffersListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Offer>(startingAfter.isPresent(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<Offer> retrieve(String id) {
     ...
     * Returns an <code>Offer</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Offer> retrieve(String id, OffersRetrieveRequest request) {
