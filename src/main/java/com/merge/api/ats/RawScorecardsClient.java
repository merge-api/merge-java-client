...
public class RawScorecardsClient {
    protected final ClientOptions clientOptions;

    public RawScorecardsClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>Scorecard</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<Scorecard>> list(ScorecardsListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedScorecardList parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedScorecardList.class);
                ...
                return new MergeApiHttpResponse<>(
                        new SyncPagingIterable<Scorecard>(startingAfter.isPresent(), result, parsedResponse, () -> list(
     ...
     */
    public MergeApiHttpResponse<Scorecard> retrieve(String id) {
     ...
     * Returns a <code>Scorecard</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<Scorecard> retrieve(String id, ScorecardsRetrieveRequest request) {
