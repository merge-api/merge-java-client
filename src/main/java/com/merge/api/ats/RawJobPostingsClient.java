...
public class RawJobPostingsClient {
    protected final ClientOptions clientOptions;

    public RawJobPostingsClient(ClientOptions clientOptions) {
     ...
     */
    public MergeApiHttpResponse<SyncPagingIterable<JobPosting>> list() {
     ...
     * Returns a list of <code>JobPosting</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<JobPosting>> list(JobPostingsListRequest request) {
    ...
    public MergeApiHttpResponse<SyncPagingIterable<JobPosting>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedJobPostingList parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedJobPostingList.class);
     ...
     */
    public MergeApiHttpResponse<JobPosting> retrieve(String id) {
     ...
     * Returns a <code>JobPosting</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<JobPosting> retrieve(String id, JobPostingsRetrieveRequest request) {
     ...
     * Returns a <code>JobPosting</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<JobPosting> retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), JobPosting.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
