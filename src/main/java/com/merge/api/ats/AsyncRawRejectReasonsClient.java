...
public class AsyncRawRejectReasonsClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedRejectReasonList>> list() {
     ...
     * Returns a list of <code>RejectReason</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedRejectReasonList>> list(RejectReasonsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedRejectReasonList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedRejectReasonList>> future = new CompletableFuture<>();
