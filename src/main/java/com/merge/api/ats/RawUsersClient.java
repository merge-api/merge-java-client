...
public class RawUsersClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedRemoteUserList> list() {
     ...
     * Returns a list of <code>RemoteUser</code> objects.
     */
    public MergeApiHttpResponse<PaginatedRemoteUserList> list(UsersListRequest request) {
     ...
     * Returns a list of <code>RemoteUser</code> objects.
     */
    public MergeApiHttpResponse<PaginatedRemoteUserList> list(UsersListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedRemoteUserList.class),
                        response);
            }
     ...
     */
    public MergeApiHttpResponse<RemoteUser> retrieve(String id) {
     ...
     * Returns a <code>RemoteUser</code> object with the given <code>id</code>.
     */
    public MergeApiHttpResponse<RemoteUser> retrieve(String id, UsersRetrieveRequest request) {
    ...
    public MergeApiHttpResponse<RemoteUser> retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MergeApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), RemoteUser.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new ApiError(
                    "Error with status code " + response.code(),
