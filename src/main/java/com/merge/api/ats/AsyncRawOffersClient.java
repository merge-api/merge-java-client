...
public class AsyncRawOffersClient {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedOfferList>> list() {
     ...
     * Returns a list of <code>Offer</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedOfferList>> list(OffersListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedOfferList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedOfferList>> future = new CompletableFuture<>();
