...
import com.merge.api.ats.types.PaginatedOfferList;
...
public class AsyncRawOffersClient {
     ...
     * Returns a list of <code>Offer</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Offer>>> list(OffersListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Offer>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Offer>>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        PaginatedOfferList parsedResponse =
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaginatedOfferList.class);
                        Optional<String> startingAfter = parsedResponse.getNext();
                        OffersListRequest nextRequest = OffersListRequest.builder()
                                .from(request)
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<Offer>> retrieve(String id) {
     ...
     * Returns an <code>Offer</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<Offer>> retrieve(String id, OffersRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<Offer>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<Offer>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new MergeApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Offer.class), response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    future.completeExceptionally(new ApiError(
