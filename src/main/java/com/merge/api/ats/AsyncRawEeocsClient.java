...
public class AsyncRawEeocsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawEeocsClient(ClientOptions clientOptions) {
     ...
     * Returns a list of <code>EEOC</code> objects.
     */
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Eeoc>>> list(EeocsListRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Eeoc>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Eeoc>>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<Eeoc>(!startingAfter.isEmpty(), result, parsedResponse, () -> {
                                    try {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<Eeoc>> retrieve(String id) {
     ...
     * Returns an <code>EEOC</code> object with the given <code>id</code>.
     */
    public CompletableFuture<MergeApiHttpResponse<Eeoc>> retrieve(String id, EeocsRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<Eeoc>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<Eeoc>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
