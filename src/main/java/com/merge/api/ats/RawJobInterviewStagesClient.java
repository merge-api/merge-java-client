...
public class RawJobInterviewStagesClient {
     ...
     * Returns a list of <code>JobInterviewStage</code> objects.
     */
    public MergeApiHttpResponse<SyncPagingIterable<JobInterviewStage>> list(JobInterviewStagesListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                JobInterviewStagesListRequest nextRequest = JobInterviewStagesListRequest.builder()
                        ...
                        .build();
                List<JobInterviewStage> result = parsedResponse.getResults().orElse(Collections.emptyList());
