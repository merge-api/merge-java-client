...
public class AsyncRawInterviewsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawInterviewsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<PaginatedScheduledInterviewList>> list() {
    ...
    public CompletableFuture<MergeApiHttpResponse<PaginatedScheduledInterviewList>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<PaginatedScheduledInterviewList>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<MergeApiHttpResponse<ScheduledInterviewResponse>> create(
        ...
        CompletableFuture<MergeApiHttpResponse<ScheduledInterviewResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MergeApiHttpResponse<ScheduledInterview>> retrieve(String id) {
    ...
    public CompletableFuture<MergeApiHttpResponse<ScheduledInterview>> retrieve(
            String id, InterviewsRetrieveRequest request) {
    ...
    public CompletableFuture<MergeApiHttpResponse<ScheduledInterview>> retrieve(
        ...
        CompletableFuture<MergeApiHttpResponse<ScheduledInterview>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
