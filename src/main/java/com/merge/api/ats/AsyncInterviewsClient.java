...
public class AsyncInterviewsClient {
     ...
     */
    public CompletableFuture<PaginatedScheduledInterviewList> list() {
     ...
     * Returns a list of <code>ScheduledInterview</code> objects.
     */
    public CompletableFuture<PaginatedScheduledInterviewList> list(InterviewsListRequest request) {
