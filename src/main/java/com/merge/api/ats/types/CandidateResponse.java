...
public final class CandidateResponse {
    ...
    public interface ModelStage {
        _FinalStage model(@NotNull Candidate model);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("model")
        public _FinalStage model(@NotNull Candidate model) {
            this.model = model;
            return this;
        }
        ...
        public CandidateResponse build() {
            return new CandidateResponse(model, warnings, errors, logs, additionalProperties);
        }
    }
}
