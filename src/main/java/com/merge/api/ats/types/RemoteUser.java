...
public final class RemoteUser {
    ...
    private Optional<RemoteUserAccessRole> _getAccessRole() {
        return accessRole;
    }
    ...
    public static final class Builder {
        ...
        public Builder accessRole(Nullable<RemoteUserAccessRole> accessRole) {
            if (accessRole.isNull()) {
                this.accessRole = null;
            } else if (accessRole.isEmpty()) {
                this.accessRole = Optional.empty();
            } else {
                this.accessRole = Optional.of(accessRole.get());
            }
            return this;
        }
