...
public final class InterviewsRetrieveRequest {
    private final Optional<List<InterviewsRetrieveRequestExpandItem>> expand;

    private final Optional<Boolean> includeRemoteData;

    private final Optional<Boolean> includeShellData;

    private final Optional<InterviewsRetrieveRequestRemoteFields> remoteFields;

    private final Optional<InterviewsRetrieveRequestShowEnumOrigins> showEnumOrigins;

    private final Map<String, Object> additionalProperties;

    private InterviewsRetrieveRequest(
            Optional<List<InterviewsRetrieveRequestExpandItem>> expand,
            Optional<Boolean> includeRemoteData,
            Optional<Boolean> includeShellData,
            Optional<InterviewsRetrieveRequestRemoteFields> remoteFields,
            Optional<InterviewsRetrieveRequestShowEnumOrigins> showEnumOrigins,
     ...
     */
    @JsonProperty("expand")
    public Optional<List<InterviewsRetrieveRequestExpandItem>> getExpand() {
        return expand;
    }
    ...
    public Optional<InterviewsRetrieveRequestRemoteFields> getRemoteFields() {
        return remoteFields;
    }
    ...
    public Optional<InterviewsRetrieveRequestShowEnumOrigins> getShowEnumOrigins() {
    ...
    public static final class Builder {
        private Optional<List<InterviewsRetrieveRequestExpandItem>> expand = Optional.empty();

        private Optional<Boolean> includeRemoteData = Optional.empty();

        private Optional<Boolean> includeShellData = Optional.empty();

        private Optional<InterviewsRetrieveRequestRemoteFields> remoteFields = Optional.empty();

        private Optional<InterviewsRetrieveRequestShowEnumOrigins> showEnumOrigins = Optional.empty();
        ...
        public Builder expand(Optional<List<InterviewsRetrieveRequestExpandItem>> expand) {
            this.expand = expand;
            return this;
        }

        public Builder expand(List<InterviewsRetrieveRequestExpandItem> expand) {
            this.expand = Optional.ofNullable(expand);
            return this;
        }

        public Builder expand(InterviewsRetrieveRequestExpandItem expand) {
        ...
        public Builder remoteFields(Optional<InterviewsRetrieveRequestRemoteFields> remoteFields) {
            this.remoteFields = remoteFields;
            return this;
        }

        public Builder remoteFields(InterviewsRetrieveRequestRemoteFields remoteFields) {
        ...
        public Builder showEnumOrigins(Optional<InterviewsRetrieveRequestShowEnumOrigins> showEnumOrigins) {
            this.showEnumOrigins = showEnumOrigins;
            return this;
        }

        public Builder showEnumOrigins(InterviewsRetrieveRequestShowEnumOrigins showEnumOrigins) {
            this.showEnumOrigins = Optional.ofNullable(showEnumOrigins);
            return this;
        }

        public InterviewsRetrieveRequest build() {
            return new InterviewsRetrieveRequest(
