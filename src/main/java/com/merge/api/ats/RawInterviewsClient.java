...
public class RawInterviewsClient {
     ...
     */
    public MergeApiHttpResponse<PaginatedScheduledInterviewList> list() {
     ...
     * Returns a list of <code>ScheduledInterview</code> objects.
     */
    public MergeApiHttpResponse<PaginatedScheduledInterviewList> list(InterviewsListRequest request) {
