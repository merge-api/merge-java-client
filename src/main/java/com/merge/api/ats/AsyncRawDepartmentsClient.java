...
public class AsyncRawDepartmentsClient {
    ...
    public CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Department>>> list(
        ...
        CompletableFuture<MergeApiHttpResponse<SyncPagingIterable<Department>>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new MergeApiHttpResponse<>(
                                new SyncPagingIterable<Department>(startingAfter.isPresent(), result, () -> {
                                    try {
